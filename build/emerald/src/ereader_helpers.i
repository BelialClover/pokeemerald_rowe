# 0 "src/ereader_helpers.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/ereader_helpers.c"
...
# 12 "src/ereader_helpers.c" 2
# 1 "include/trainer_hill.h" 1
# 13 "src/ereader_helpers.c" 2
# 1 "include/constants/easy_chat.h" 1
# 14 "src/ereader_helpers.c" 2
...
# 15 "src/ereader_helpers.c" 2
# 1 "include/constants/moves.h" 1
# 16 "src/ereader_helpers.c" 2
# 1 "include/constants/items.h" 1
# 17 "src/ereader_helpers.c" 2
...
static const struct TrainerHillTrainer sTrainerHillTrainerTemplates_JP[] = {
    [0] = {
        ...
        .facilityClass = 0xc,
        .unused = 0x1,
        .speechBefore = { (0xa << 9) | 0x2e, (0x7 << 9) | 0xc, (0x8 << 9) | 0x23, (0x5 << 9) | 0x47, (0x3 << 9) | 0x1f, (0x7 << 9) | 0x24 },
        .speechWin = { (0x5 << 9) | 0x48, (0x3 << 9) | 0xf, ((0x13 << 9) | 290), (0xb << 9) | 0x2c, (0x3 << 9) | 0x7, (0x6 << 9) | 0x1 },
        .speechLose = { (0x5 << 9) | 0x47, (0x3 << 9) | 0x6, (0x7 << 9) | 0x24, (0xf << 9) | 0x0, (0x9 << 9) | 0x19, (0x6 << 9) | 0x5 },
        .speechAfter = { (0xb << 9) | 0x25, (0x8 << 9) | 0x25, (0xe << 9) | 0xd, (0xe << 9) | 0x2a, (0x5 << 9) | 0x6, (0x6 << 9) | 0x6 },
        .mons = {
            [0] = { .nickname = __("$$$$$$$$$$$") },
            [1] = { .nickname = __("$$$$$$$$$$$") },
            [2] = { .nickname = __("$$$$$$$$$$$") },
    ...
    [1] = {
        ...
        .facilityClass = 0x1b,
        .unused = 0x1,
        .speechBefore = { ((0x13 << 9) | 340), (0x7 << 9) | 0x2b, 0xFFFF, (0x5 << 9) | 0x3b, (0x3 << 9) | 0x20, (0x6 << 9) | 0x0 },
        .speechWin = { ((0x12 << 9) | 19), (0x7 << 9) | 0x2b, 0xFFFF, (0x5 << 9) | 0x3b, (0x9 << 9) | 0x5, (0x6 << 9) | 0x0 },
        .speechLose = { ((0x13 << 9) | 107), (0x7 << 9) | 0x2b, 0xFFFF, (0x5 << 9) | 0x3b, (0x9 << 9) | 0xe, (0x6 << 9) | 0x0 },
        .speechAfter = { ((0x12 << 9) | 44), (0x7 << 9) | 0x2b, 0xFFFF, (0x5 << 9) | 0x3b, (0x9 << 9) | 0x17, (0x6 << 9) | 0x0 },
        .mons = {
            [0] = { .nickname = __("$$$$$$$$$$$") },
            [1] = { .nickname = __("$$$$$$$$$$$") },
            [2] = { .nickname = __("$$$$$$$$$$$") },
    ...
    [2] = {
        ...
        .facilityClass = 0x27,
        .unused = 0x1,
        .speechBefore = { (0x2 << 9) | 0x4a, (0x1 << 9) | 0xe, (0xb << 9) | 0x35, (0x8 << 9) | 0x10, ((0x13 << 9) | 218), (0x8 << 9) | 0x3e },
        .speechWin = { (0x2 << 9) | 0x4a, (0x1 << 9) | 0xe, (0x5 << 9) | 0x47, ((0x13 << 9) | 217), (0xb << 9) | 0x21, (0x8 << 9) | 0x3e },
        .speechLose = { (0xf << 9) | 0x14, (0xf << 9) | 0x7, (0x3 << 9) | 0x30, (0xb << 9) | 0x23, (0x7 << 9) | 0x24, (0x6 << 9) | 0x6 },
        .speechAfter = { (0xa << 9) | 0x18, (0xa << 9) | 0x2f, (0x4 << 9) | 0x1a, (0xe << 9) | 0x27, (0x6 << 9) | 0x0, 0xFFFF },
        .mons = {
            [0] = { .nickname = __("$$$$$$$$$$$") },
            [1] = { .nickname = __("$$$$$$$$$$$") },
            [2] = { .nickname = __("$$$$$$$$$$$") },
    ...
    [3] = {
        ...
        .facilityClass = 0x20,
        .unused = 0x1,
        .speechBefore = { (0x5 << 9) | 0x46, (0x3 << 9) | 0x2, (0x3 << 9) | 0x20, (0x5 << 9) | 0xa, (0x8 << 9) | 0x23, (0x6 << 9) | 0x0 },
        .speechWin = { (0x6 << 9) | 0x28, (0xc << 9) | 0x14, (0xa << 9) | 0x32, (0xb << 9) | 0x2, (0x8 << 9) | 0x5, 0xFFFF },
        .speechLose = { (0xf << 9) | 0xc, (0x5 << 9) | 0xa, (0x9 << 9) | 0x34, (0xf << 9) | 0x11, (0x4 << 9) | 0x1a, (0x6 << 9) | 0x5 },
        .speechAfter = { (0x5 << 9) | 0x1e, (0x3 << 9) | 0x2, (0x3 << 9) | 0x20, (0x5 << 9) | 0x22, (0x8 << 9) | 0x15, (0x6 << 9) | 0x1 },
        .mons = {
            [0] = { .nickname = __("$$$$$$$$$$$") },
            [1] = { .nickname = __("$$$$$$$$$$$") },
            [2] = { .nickname = __("$$$$$$$$$$$") },
...
static bool32 TrainerHill_VerifyChecksum(struct EReaderTrainerHillSet *buffer)
{
    ...
    checksum = CalcByteArraySum((u8 *)buffer->unk_8, sizeof(struct EReaderTrainerHillSet) - ((size_t)&((struct EReaderTrainerHillSet *)0)->unk_8));
    if (checksum != buffer->checksum)
        return 0;
...
static bool32 TryWriteTrainerHill_r(struct EReaderTrainerHillSet *ttdata, struct TrHillTag *buffer2)
{
    ...
    if (TryWriteSpecialSaveSection(30, (u8 *)buffer2) != 1)
        return 0;
...
{
    if (TryReadSpecialSaveSection(30, buffer) != 1)
        return 0;
...
int EReader_Send(int arg0, u32 *arg1)
{
    ...
    while (1)
    {
        ...
        var1 = EReaderHandleTransfer(1, arg0, arg1, ((void *)0));
    ...
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, &gUnknown_030012C8, 0x04000000 | 0x01000000 | ((sizeof(struct Unknown030012C8))/(32/8) & 0x1FFFFF)); };
...
int EReader_Recv(u32 *arg0)
{
    ...
    while (1)
    {
        ...
        var1 = EReaderHandleTransfer(0, 0, ((void *)0), arg0);
        gUnknown_030012E4 = var1;
        if ((gUnknown_030012E4 & 0x13) == 0x10)
        {
            result = 0;
...
{
    (*(vu16 *)(0x4000000 + 0x134)) = 0;
    (*(vu16 *)(0x4000000 + 0x128)) = 0x1000 | 0x4000;
    (*(vu16 *)(0x4000000 + 0x128)) |= 0x0008;
...
{
    u16 terminal = (*(vu32 *)(0x4000000 + 0x128)) & (0x0004 | 0x0008);
    if (terminal == 0x0008 && arg0)
    {
...
static void sub_81D3F1C(u32 arg0, u32 *arg1, u32 *arg2)
{
    if (gUnknown_030012C8.unk0[0])
    {
        ...
        (*(vu32 *)(0x4000000 + 0x120)) = arg0;
        gUnknown_030012C8.unk10 = arg0 / 4 + 1;
        sub_81D3F68();
    }
    else
    {
        (*(vu16 *)(0x4000000 + 0x128)) = (*(vu16 *)(0x4000000 + 0x128));
...
static void sub_81D3F68(void)
{
    (*(vu16 *)(0x4000000 + 0x10c)) = 0xFDA7;
    (*(vu16 *)(0x4000000 + 0x10e)) = 0x40;
    (*(vu16 *)(0x4000000 + 0x208)) = 0;
...
void sub_81D3FAC(void)
{
    ...
    {
    case 1:
        (*(vu16 *)(0x4000000 + 0x12a)) = 0xCCD0;
        *(u64 *)recvBuffer = (*(vu64 *)(0x4000000 + 0x120));
    ...
    case 3:
        ...
        if (gUnknown_030012C8.unk0[0] == 1)
        {
            ...
            {
                (*(vu32 *)(0x4000000 + 0x120)) = gUnknown_030012C8.unk8[gUnknown_030012C8.unkC];
                gUnknown_030012C8.unk14 += gUnknown_030012C8.unk8[gUnknown_030012C8.unkC];
            }
            else
            {
                (*(vu32 *)(0x4000000 + 0x120)) = gUnknown_030012C8.unk14;
            }
        }
        else
        {
    ...
    case 5:
        if (!gUnknown_030012C8.unk0[0])
            (*(vu16 *)(0x4000000 + 0x12a)) = gUnknown_030012C8.unk0[3];
...
static void sub_81D4170(void)
{
    int keysMask = (*(vu16 *)(0x4000000 + 0x130)) ^ 0x03FF;
...
void EReaderHelper_SaveRegsState(void)
{
    gUnknown_030012EC = (*(vu16 *)(0x4000000 + 0x208));
    gUnknown_030012EE = (*(vu16 *)(0x4000000 + 0x200));
    gUnknown_030012F0 = (*(vu16 *)(0x4000000 + 0x10e));
    gUnknown_030012F2 = (*(vu16 *)(0x4000000 + 0x128));
    gUnknown_030012F4 = (*(vu16 *)(0x4000000 + 0x134));
}

void EReaderHelper_RestoreRegsState(void)
{
    (*(vu16 *)(0x4000000 + 0x208)) = gUnknown_030012EC;
    (*(vu16 *)(0x4000000 + 0x200)) = gUnknown_030012EE;
    (*(vu16 *)(0x4000000 + 0x10e)) = gUnknown_030012F0;
    (*(vu16 *)(0x4000000 + 0x128)) = gUnknown_030012F2;
    (*(vu16 *)(0x4000000 + 0x134)) = gUnknown_030012F4;
}
