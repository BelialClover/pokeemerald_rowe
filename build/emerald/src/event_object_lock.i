# 0 "src/event_object_lock.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/event_object_lock.c"
...
# 9 "src/event_object_lock.c" 2
# 1 "include/constants/event_objects.h" 1
# 10 "src/event_object_lock.c" 2
...
static void sub_8098400(u8 taskId)
{
    ...
    if (!task->data[0] && IsPlayerStandingStill() == 1)
    {
        sub_808B864();
        task->data[0] = 1;
    }
