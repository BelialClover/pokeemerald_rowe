# 0 "src/ereader_screen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/ereader_screen.c"
...
# 14 "src/ereader_screen.c" 2
# 1 "include/constants/songs.h" 1
# 15 "src/ereader_screen.c" 2
...
{
    volatile u16 backupIME = (*(vu16 *)(0x4000000 + 0x208));
    ...
    (*(vu16 *)(0x4000000 + 0x208)) = backupIME;
    arg0->unk0 = 0;
    arg0->unk4 = arg1;
    arg0->unk8 = arg2;
}
...
{
    u8 var0 = 0;
    arg0->unk0 = EReaderHandleTransfer(1, arg0->unk4, arg0->unk8, ((void *)0));
...
static bool32 sub_81D4E60(void)
{
    ...
    backupIME = (*(vu16 *)(0x4000000 + 0x208));
    (*(vu16 *)(0x4000000 + 0x208)) = 0;
...
static void sub_81D5084(u8 taskId)
{
    ...
    case 18:
        ...
        break;
    case 19:
        if (IsFanfareTaskInactive() && (({(gMain.newKeys) & (0x0001 | 0x0002);})))
            data->unk8 = 26;
        break;
    case 23:
