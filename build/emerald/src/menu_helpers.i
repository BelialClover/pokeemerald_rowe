# 0 "src/menu_helpers.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/menu_helpers.c"
...
# 17 "src/menu_helpers.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/menu_helpers.c" 2
# 1 "include/constants/items.h" 1
# 19 "src/menu_helpers.c" 2
...
__attribute__((section("ewram_data"))) static struct YesNoFuncTable gUnknown_0203A138 = {0};
__attribute__((section("ewram_data"))) static u8 gUnknown_0203A140 = 0;
...
void ResetVramOamAndBgCntRegs(void)
{
    ...
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, (void*) 0x5000000, 0x00000000 | 0x01000000 | ((0x400)/(16/8) & 0x1FFFFF)); };
}
...
void DisplayMessageAndContinueTask(u8 taskId, u8 windowId, u16 arg2, u8 arg3, u8 fontId, u8 textSpeed, const u8 *string, void *taskFunc)
{
    ...
    DrawDialogFrameWithCustomTileAndPalette(windowId, 1, arg2, arg3);

    if (string != gStringVar4)
        StringExpandPlaceholders(gStringVar4, string);

    gTextFlags.canABSpeedUpPrint = 1;
    AddTextPrinterParameterized2(windowId, fontId, gStringVar4, textSpeed, ((void *)0), 2, 1, 3);
...
bool8 AdjustQuantityAccordingToDPadInput(s16 *arg0, u16 arg1)
{
    ...
    else if ((({(gMain.newAndRepeatedKeys) & (((0x0010 | 0x0020 | 0x0040 | 0x0080)));})) == 0x0010)
    {
        (*arg0) += 10;
        if ((*arg0) > arg1)
            (*arg0) = arg1;
    ...
    else if ((({(gMain.newAndRepeatedKeys) & (((0x0010 | 0x0020 | 0x0040 | 0x0080)));})) == 0x0020)
    {
        (*arg0) -= 10;
        if ((*arg0) <= 0)
            (*arg0) = 1;
...
bool8 sub_8122148(u16 itemId)
{
    if (itemId != 205)
        return 1;
    else if (gSaveBlock1Ptr->location.mapGroup == ((25 | (25 << 8)) >> 8) && gSaveBlock1Ptr->location.mapNum == ((25 | (25 << 8)) & 0xFF))
        return 0;
...
bool8 itemid_80BF6D8_mail_related(u16 itemId)
{
    if (IsUpdateLinkStateCBActive() != 1 && InUnionRoom() != 1)
        return 1;
    else if (ItemIsMail(itemId) != 1)
        return 1;
    else
        return 0;
}
...
bool8 MenuHelpers_LinkSomething(void)
{
    if (IsUpdateLinkStateCBActive() == 1 || gReceivedRemoteLinkPlayers == 1)
        return 1;
    else
        return 0;
}
