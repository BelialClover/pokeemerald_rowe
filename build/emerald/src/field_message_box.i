# 0 "src/field_message_box.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/field_message_box.c"
...
# 5 "src/field_message_box.c" 2
# 1 "include/task.h" 1
# 6 "src/field_message_box.c" 2
...
# 9 "src/field_message_box.c" 2

static __attribute__((section("ewram_data"))) u8 sFieldMessageBoxMode = 0;
...
bool8 ShowFieldMessage(const u8 *str)
{
    if (sFieldMessageBoxMode != FIELD_MESSAGE_BOX_HIDDEN)
        return 0;
    ExpandStringAndStartDrawFieldMessage(str, 1);
...
bool8 ShowFieldAutoScrollMessage(const u8 *str)
{
    ...
    ExpandStringAndStartDrawFieldMessage(str, 0);
    return 1;
}
