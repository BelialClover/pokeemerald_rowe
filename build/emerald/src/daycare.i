...
__attribute__((section("ewram_data"))) static u16 sHatchedEggFatherMoves[4] = {0};
__attribute__((section("ewram_data"))) static u16 sHatchedEggFinalMoves[4] = {0};
__attribute__((section("ewram_data"))) static u16 sHatchedEggEggMoves[10] = {0};
__attribute__((section("ewram_data"))) static u16 sHatchedEggMotherMoves[4] = {0};

# 1 "src/data/pokemon/egg_moves.h" 1




const u16 gEggMoves[] = {
 (1 + 20000), 80, 92, 130, 174, 267, 275, 124, 133, 202, 203, 204, 320, 345, 437, 438, 580, 113, 219, 13
# 25 "src/data/pokemon/egg_moves.h"
                  ,

 (4 + 20000), 17, 44, 68, 187, 232, 246, 407, 525, 200, 242, 251, 264, 314, 349, 394, 406, 14, 157
# 45 "src/data/pokemon/egg_moves.h"
                  ,

 (7 + 20000), 54, 114, 175, 243, 252, 281, 323, 392, 453, 719, 193, 287, 300, 330, 362, 396, 406, 93
# 65 "src/data/pokemon/egg_moves.h"
                 ,

 (16 + 20000), 185, 193, 211, 228, 253, 314, 403, 413, 432
# 76 "src/data/pokemon/egg_moves.h"
             ,

 (19 + 20000), 44, 68, 103, 154, 172, 179, 253, 279, 382, 387, 515, 207
# 90 "src/data/pokemon/egg_moves.h"
               ,

 (21 + 20000), 13, 18, 98, 143, 161, 184, 185, 211, 253, 297, 310, 206
# 104 "src/data/pokemon/egg_moves.h"
                   ,

 (23 + 20000), 21, 50, 180, 184, 228, 231, 251, 289, 305, 342, 389, 415, 242
# 119 "src/data/pokemon/egg_moves.h"
              ,

 (27 + 20000), 68, 175, 189, 232, 400, 468, 203, 229, 306, 341, 431, 498, 563, 14, 157, 219
# 137 "src/data/pokemon/egg_moves.h"
                 ,

 (29 + 20000), 36, 48, 50, 68, 130, 305, 342, 116, 203, 204, 228, 231, 251, 498, 599
# 154 "src/data/pokemon/egg_moves.h"
                    ,

 (32 + 20000), 32, 36, 37, 48, 50, 68, 93, 342, 389, 457, 133, 203, 231, 251, 498, 599
# 172 "src/data/pokemon/egg_moves.h"
                    ,

 (35 + 20000), 217, 273, 312, 321, 505, 102, 118, 133, 150, 187, 313, 343, 500, 581, 164
# 189 "src/data/pokemon/egg_moves.h"
                  ,

 (37 + 20000), 46, 95, 175, 262, 336, 488, 608, 50, 180, 185, 257, 290, 326, 384, 394, 445, 506, 541, 244, 412
# 211 "src/data/pokemon/egg_moves.h"
                   ,

 (39 + 20000), 195, 205, 217, 273, 343, 356, 387, 505, 185, 214, 313, 386, 445, 581
# 227 "src/data/pokemon/egg_moves.h"
                     ,

 (41 + 20000), 16, 17, 18, 95, 98, 174, 432, 185, 202, 211, 228, 413, 417, 428, 599
# 244 "src/data/pokemon/egg_moves.h"
                    ,

 (43 + 20000), 73, 75, 175, 235, 267, 275, 298, 321, 495, 631, 204, 290, 14
# 259 "src/data/pokemon/egg_moves.h"
                    ,

 (46 + 20000), 60, 68, 73, 97, 103, 175, 203, 228, 230, 232, 363, 440, 450, 469, 563, 565, 580, 113, 206
# 280 "src/data/pokemon/egg_moves.h"
                   ,

 (48 + 20000), 97, 103, 202, 226, 234, 285, 290, 324, 390, 450, 476
# 293 "src/data/pokemon/egg_moves.h"
                   ,

 (50 + 20000), 29, 246, 262, 468, 515, 103, 179, 185, 203, 228, 251, 253, 310, 426, 157
# 310 "src/data/pokemon/egg_moves.h"
                  ,

 (52 + 20000), 39, 95, 175, 180, 343, 387, 133, 204, 231, 274, 289, 316, 386, 492, 244
# 327 "src/data/pokemon/egg_moves.h"
                ,

 (54 + 20000), 60, 95, 109, 238, 281, 493, 499, 193, 214, 227, 248, 287, 290, 426, 485, 94, 113, 58
# 347 "src/data/pokemon/egg_moves.h"
                ,

 (56 + 20000), 68, 96, 179, 193, 214, 227, 251, 264, 265, 279, 370, 400, 644, 157
# 363 "src/data/pokemon/egg_moves.h"
                  ,

 (58 + 20000), 24, 37, 38, 234, 343, 34, 83, 231, 242, 257, 336, 370, 394, 645, 219
# 380 "src/data/pokemon/egg_moves.h"
                 ,

 (60 + 20000), 54, 114, 150, 170, 283, 352, 61, 203, 227, 287, 301, 341, 346
# 395 "src/data/pokemon/egg_moves.h"
                   ,

 (63 + 20000), 93, 277, 470, 7, 8, 9, 112, 227, 282, 285, 375, 379, 385, 502, 641, 113
# 413 "src/data/pokemon/egg_moves.h"
                    ,

 (66 + 20000), 66, 68, 321, 418, 501, 7, 8, 9, 27, 96, 227, 265, 282, 370, 379, 484, 113, 157
# 433 "src/data/pokemon/egg_moves.h"
                  ,

 (69 + 20000), 141, 202, 227, 235, 275, 311, 321, 331, 345, 363, 388, 438, 491, 499, 562, 631, 14, 115
# 453 "src/data/pokemon/egg_moves.h"
               ,

 (72 + 20000), 62, 109, 114, 229, 243, 282, 321, 367, 392, 145, 330, 219
# 467 "src/data/pokemon/egg_moves.h"
                 ,

 (74 + 20000), 5, 174, 175, 203, 264, 335, 359, 431, 469, 475, 157
# 480 "src/data/pokemon/egg_moves.h"
                  ,

 (77 + 20000), 24, 32, 37, 38, 95, 234, 67, 172, 204, 445, 502, 630, 98
# 495 "src/data/pokemon/egg_moves.h"
                    ,

 (79 + 20000), 23, 187, 335, 562, 173, 214, 248, 300, 382, 428, 472, 219
# 509 "src/data/pokemon/egg_moves.h"
                 ,

 (83 + 20000), 16, 38, 68, 98, 143, 174, 175, 297, 343, 355, 364, 400, 493, 515, 623, 119, 189, 193, 211, 279, 348, 376
# 533 "src/data/pokemon/egg_moves.h"
                  ,

 (84 + 20000), 48, 98, 114, 119, 175, 185, 283, 363, 372, 413
# 545 "src/data/pokemon/egg_moves.h"
                  ,

 (86 + 20000), 21, 32, 50, 122, 195, 214, 227, 231, 252, 254, 255, 256, 324, 333, 352, 494, 562, 64
# 565 "src/data/pokemon/egg_moves.h"
            ,

 (88 + 20000), 114, 122, 174, 184, 212, 254, 255, 256, 286, 325, 425, 491, 612, 153
# 581 "src/data/pokemon/egg_moves.h"
                 ,

 (90 + 20000), 61, 352, 392, 719, 36, 41, 103, 112, 229, 333, 341, 350, 419
# 596 "src/data/pokemon/egg_moves.h"
                 ,

 (92 + 20000), 50, 92, 114, 123, 195, 288, 310, 499, 513, 7, 8, 9, 149, 184, 153, 261
# 614 "src/data/pokemon/egg_moves.h"
                   ,

 (95 + 20000), 111, 175, 205, 335, 457, 469, 525, 350, 431, 446, 484, 563, 153, 157
# 630 "src/data/pokemon/egg_moves.h"
                  ,

 (96 + 20000), 7, 8, 9, 112, 260, 272, 274, 285, 290, 385, 417, 427, 471, 641, 113
# 647 "src/data/pokemon/egg_moves.h"
                    ,

 (98 + 20000), 163, 246, 282, 359, 400, 21, 97, 114, 117, 133, 175, 203, 321, 498, 502, 14, 91
# 666 "src/data/pokemon/egg_moves.h"
           ,

 (102 + 20000), 77, 78, 79, 174, 236, 246, 275, 335, 202, 235, 267, 285, 363, 381, 384, 437, 580, 115, 244, 72
# 688 "src/data/pokemon/egg_moves.h"
                  ,

 (104 + 20000), 24, 43, 130, 174, 187, 195, 197, 246, 103, 203, 442, 498, 14, 157
# 704 "src/data/pokemon/egg_moves.h"
                  ,

 (108 + 20000), 37, 174, 359, 562, 34, 133, 173, 187, 214, 222, 265, 330, 428, 164
# 720 "src/data/pokemon/egg_moves.h"
                  ,

 (109 + 20000), 60, 174, 180, 220, 254, 255, 256, 288, 103, 149, 194, 390, 599, 261
# 736 "src/data/pokemon/egg_moves.h"
                   ,

 (111 + 20000), 68, 130, 174, 368, 397, 407, 470, 179, 222, 231, 242, 306, 422, 423, 424, 431, 563, 14, 157, 37, 228
# 759 "src/data/pokemon/egg_moves.h"
               ,

 (113 + 20000), 69, 217, 312, 356, 68, 118, 203, 215, 270, 363, 426, 164
# 773 "src/data/pokemon/egg_moves.h"
                  ,

 (114 + 20000), 73, 93, 175, 267, 283, 476, 72, 133, 202, 358, 363, 384, 437, 115
# 789 "src/data/pokemon/egg_moves.h"
               ,

 (115 + 20000), 38, 50, 68, 283, 359, 509, 23, 116, 193, 253, 264, 306, 376, 164, 219
# 806 "src/data/pokemon/egg_moves.h"
                 ,

 (116 + 20000), 50, 62, 150, 175, 190, 352, 499, 13, 82, 200, 225, 324, 330
# 821 "src/data/pokemon/egg_moves.h"
                   ,

 (118 + 20000), 60, 114, 189, 367, 401, 34, 56, 130, 214, 300, 324, 341
# 835 "src/data/pokemon/egg_moves.h"
                ,

 (122 + 20000), 95, 109, 252, 321, 471, 102, 196, 248, 271, 298, 358, 417, 478, 244
# 851 "src/data/pokemon/egg_moves.h"
                ,

 (123 + 20000), 68, 364, 400, 432, 501, 13, 179, 203, 211, 226, 318, 405, 113, 219
# 867 "src/data/pokemon/egg_moves.h"
                 ,

 (127 + 20000), 31, 37, 98, 175, 364, 185, 276, 370, 382, 450, 206
# 880 "src/data/pokemon/egg_moves.h"
                   ,

 (131 + 20000), 32, 90, 174, 246, 321, 573, 627, 193, 214, 248, 250, 287, 349, 406, 419, 164, 62
# 899 "src/data/pokemon/egg_moves.h"
                   ,

 (133 + 20000), 24, 174, 175, 189, 197, 273, 281, 321, 203, 204, 313, 343, 363, 445, 485, 500
# 917 "src/data/pokemon/egg_moves.h"
                    ,

 (138 + 20000), 21, 44, 48, 61, 62, 114, 282, 321, 352, 513, 117, 191, 250, 330, 378, 390, 157
# 936 "src/data/pokemon/egg_moves.h"
                  ,

 (140 + 20000), 36, 61, 62, 72, 109, 175, 229, 282, 103, 193, 196, 202, 341, 91
# 952 "src/data/pokemon/egg_moves.h"
           ,

 (142 + 20000), 18, 174, 225, 355, 366, 469, 193, 211, 228, 372
# 964 "src/data/pokemon/egg_moves.h"
                 ,

 (143 + 20000), 38, 68, 90, 174, 380, 18, 122, 204, 228, 363, 495, 562, 612, 428, 164
# 981 "src/data/pokemon/egg_moves.h"
                  ,

 (147 + 20000), 48, 54, 225, 245, 352, 453, 114, 231, 349, 406, 407, 113
# 995 "src/data/pokemon/egg_moves.h"
                    ,

 (152 + 20000), 22, 34, 68, 73, 175, 246, 267, 275, 287, 312, 320, 378, 437, 505, 580, 14
# 1013 "src/data/pokemon/egg_moves.h"
                    ,

 (155 + 20000), 24, 37, 38, 98, 154, 179, 193, 267, 306, 326, 336, 343, 394, 481, 66
# 1030 "src/data/pokemon/egg_moves.h"
                  ,

 (158 + 20000), 8, 37, 56, 232, 242, 246, 260, 300, 313, 335, 346, 349, 352, 453, 157, 337, 13
# 1049 "src/data/pokemon/egg_moves.h"
                  ,

 (161 + 20000), 38, 116, 163, 179, 204, 228, 231, 271, 274, 343, 363, 387, 445, 608, 164
# 1066 "src/data/pokemon/egg_moves.h"
                  ,

 (163 + 20000), 17, 18, 48, 101, 297, 432, 97, 119, 143, 185, 212, 542
# 1080 "src/data/pokemon/egg_moves.h"
                 ,

 (165 + 20000), 60, 68, 103, 117, 146, 203, 227, 264, 282, 318, 366, 405, 409, 450, 113
# 1097 "src/data/pokemon/egg_moves.h"
                    ,

 (167 + 20000), 41, 49, 50, 60, 224, 226, 228, 324, 390, 400, 476, 527, 642, 398
# 1113 "src/data/pokemon/egg_moves.h"
                  ,

 (170 + 20000), 54, 60, 352, 487, 97, 103, 133, 175, 250, 351, 362, 48
# 1127 "src/data/pokemon/egg_moves.h"
                  ,

 (172 + 20000), 175, 217, 252, 268, 273, 321, 574, 3, 9, 117, 179, 203, 227, 381, 516, 604
# 1145 "src/data/pokemon/egg_moves.h"
                        ,

 (173 + 20000), 217, 273, 312, 321, 505, 102, 118, 133, 150, 187, 313, 343, 500, 581, 164
# 1162 "src/data/pokemon/egg_moves.h"
                  ,

 (174 + 20000), 195, 205, 217, 273, 343, 356, 387, 505, 185, 214, 313, 386, 445, 581
# 1178 "src/data/pokemon/egg_moves.h"
                     ,

 (175 + 20000), 64, 234, 321, 326, 332, 375, 119, 193, 217, 248, 290, 381, 417, 500, 164, 244
# 1196 "src/data/pokemon/egg_moves.h"
                ,

 (177 + 20000), 65, 98, 297, 355, 389, 493, 114, 185, 211, 285, 287, 428, 485, 502, 244
# 1213 "src/data/pokemon/egg_moves.h"
                ,

 (179 + 20000), 28, 34, 36, 97, 103, 231, 260, 268, 316, 495, 598, 604, 115, 219, 85
# 1230 "src/data/pokemon/egg_moves.h"
                   ,

 (183 + 20000), 47, 48, 187, 195, 217, 321, 383, 453, 487, 34, 133, 248, 276, 287, 293, 330, 346, 113, 164, 193
# 1252 "src/data/pokemon/egg_moves.h"
                 ,

 (185 + 20000), 29, 106, 111, 174, 205, 397, 120, 203, 328, 446
# 1264 "src/data/pokemon/egg_moves.h"
                    ,

 (187 + 20000), 38, 93, 133, 203, 227, 270, 312, 388, 402, 538, 580, 631, 115, 244, 6, 45
# 1282 "src/data/pokemon/egg_moves.h"
             ,

 (190 + 20000), 3, 21, 68, 97, 103, 180, 228, 251, 252, 279, 340, 343, 415, 501, 541
# 1299 "src/data/pokemon/egg_moves.h"
                 ,

 (191 + 20000), 73, 117, 174, 203, 227, 230, 234, 267, 270, 275, 320, 363, 580
# 1314 "src/data/pokemon/egg_moves.h"
                      ,

 (193 + 20000), 18, 38, 141, 179, 185, 228, 290, 318, 324, 364
# 1326 "src/data/pokemon/egg_moves.h"
             ,

 (194 + 20000), 24, 68, 105, 174, 246, 254, 255, 256, 491, 495, 612, 34, 214, 227, 300, 385, 598, 219
# 1346 "src/data/pokemon/egg_moves.h"
                 ,

 (198 + 20000), 17, 18, 65, 103, 109, 119, 143, 185, 195, 260, 297, 355, 372, 375, 386, 413, 98
# 1365 "src/data/pokemon/egg_moves.h"
                    ,

 (200 + 20000), 103, 174, 180, 194, 262, 285, 286, 382, 389, 417, 425, 466, 472, 244
# 1381 "src/data/pokemon/egg_moves.h"
                ,

 (203 + 20000), 13, 24, 36, 133, 193, 212, 243, 248, 251, 273, 277, 285, 290, 641, 660, 244
# 1399 "src/data/pokemon/egg_moves.h"
                ,

 (204 + 20000), 38, 42, 68, 129, 175, 203, 279, 328, 379, 390, 446, 115
# 1413 "src/data/pokemon/egg_moves.h"
               ,

 (206 + 20000), 29, 44, 174, 277, 310, 387, 401, 97, 117, 173, 214, 246, 290, 376, 506, 157, 99
# 1432 "src/data/pokemon/egg_moves.h"
            ,

 (207 + 20000), 13, 17, 38, 68, 97, 226, 232, 328, 342, 364, 379, 400, 431, 440
# 1448 "src/data/pokemon/egg_moves.h"
                    ,

 (209 + 20000), 38, 102, 118, 173, 185, 215, 217, 242, 264, 265, 313, 370, 422, 423, 424, 115, 43, 122
# 1468 "src/data/pokemon/egg_moves.h"
            ,

 (211 + 20000), 48, 61, 114, 175, 310, 352, 453, 491, 324, 362, 398
# 1481 "src/data/pokemon/egg_moves.h"
                  ,

 (213 + 20000), 51, 92, 111, 230, 282, 343, 367, 515, 611, 189, 270, 328, 350
# 1496 "src/data/pokemon/egg_moves.h"
                  ,

 (214 + 20000), 36, 38, 69, 106, 175, 364, 400, 117, 224, 228, 264, 279, 350, 206
# 1512 "src/data/pokemon/egg_moves.h"
                   ,

 (215 + 20000), 44, 68, 180, 252, 364, 420, 458, 556, 8, 193, 228, 274, 306, 386, 419, 638, 115
# 1531 "src/data/pokemon/egg_moves.h"
               ,

 (216 + 20000), 36, 38, 68, 69, 187, 214, 232, 238, 242, 281, 313, 370, 400, 498, 583, 116
# 1549 "src/data/pokemon/egg_moves.h"
                    ,

 (218 + 20000), 108, 151, 174, 205, 254, 255, 256, 257, 262, 385, 414, 517
# 1563 "src/data/pokemon/egg_moves.h"
               ,

 (220 + 20000), 38, 44, 90, 174, 246, 556, 573, 34, 36, 333, 341, 419, 446, 157
# 1579 "src/data/pokemon/egg_moves.h"
                  ,

 (222 + 20000), 54, 109, 174, 267, 352, 457, 103, 112, 117, 133, 275, 293, 333, 392, 664, 157, 219
# 1598 "src/data/pokemon/egg_moves.h"
                 ,

 (223 + 20000), 48, 114, 175, 190, 323, 491, 62, 103, 129, 173, 341, 350, 352, 494, 86
# 1615 "src/data/pokemon/egg_moves.h"
                    ,

 (225 + 20000), 62, 68, 98, 150, 194, 229, 252, 262, 420, 573, 657, 8, 191, 196, 248, 301, 516
# 1634 "src/data/pokemon/egg_moves.h"
              ,

 (226 + 20000), 21, 109, 114, 150, 239, 243, 366, 56, 133, 300, 346, 469, 157
# 1649 "src/data/pokemon/egg_moves.h"
                  ,

 (227 + 20000), 18, 143, 174, 314, 355, 364, 400, 65, 203, 228, 372, 385, 413, 446
# 1665 "src/data/pokemon/egg_moves.h"
                    ,

 (228 + 20000), 68, 83, 99, 179, 180, 194, 228, 251, 364, 386, 389, 417, 422, 424, 261
# 1682 "src/data/pokemon/egg_moves.h"
                   ,

 (231 + 20000), 34, 68, 90, 116, 173, 189, 246, 283, 420, 457, 484, 583, 630, 55
# 1698 "src/data/pokemon/egg_moves.h"
                 ,

 (232 + 20000), 34, 68, 90, 116, 173, 189, 246, 283, 420, 457, 484, 583, 630, 55
# 1714 "src/data/pokemon/egg_moves.h"
                 ,

 (234 + 20000), 24, 37, 44, 50, 99, 180, 224, 300, 326, 382, 428, 207, 244, 113, 115
# 1731 "src/data/pokemon/egg_moves.h"
               ,

 (236 + 20000), 68, 136, 170, 183, 229, 364, 410, 418, 203, 228, 270, 502
# 1745 "src/data/pokemon/egg_moves.h"
                   ,

 (238 + 20000), 252, 272, 273, 8, 96, 357, 358, 417, 445, 244, 142
# 1758 "src/data/pokemon/egg_moves.h"
                   ,

 (239 + 20000), 223, 238, 264, 359, 364, 2, 7, 8, 27, 96, 112
# 1771 "src/data/pokemon/egg_moves.h"
               ,

 (240 + 20000), 183, 223, 238, 264, 562, 2, 5, 9, 103, 112, 116, 187, 231, 384, 394
# 1788 "src/data/pokemon/egg_moves.h"
                   ,

 (241 + 20000), 38, 69, 174, 217, 264, 359, 562, 146, 179, 203, 214, 270, 363, 386, 531, 244
# 1806 "src/data/pokemon/egg_moves.h"
                ,

 (246 + 20000), 23, 174, 246, 116, 200, 228, 231, 334, 349, 372, 442, 446
# 1820 "src/data/pokemon/egg_moves.h"
                    ,

 (252 + 20000), 24, 71, 73, 163, 225, 235, 388, 400, 13, 242, 283, 300, 306, 320, 331, 345, 363, 437, 580
# 1841 "src/data/pokemon/egg_moves.h"
                      ,

 (255 + 20000), 64, 68, 174, 306, 364, 387, 400, 67, 97, 179, 203, 226, 265, 297, 481, 157, 207
# 1860 "src/data/pokemon/egg_moves.h"
               ,

 (258 + 20000), 23, 38, 44, 68, 124, 174, 189, 243, 246, 281, 469, 112, 250, 253, 287, 301, 419, 426
# 1880 "src/data/pokemon/egg_moves.h"
                ,

 (261 + 20000), 43, 214, 281, 289, 305, 310, 343, 382, 389, 422, 423, 424, 583
# 1895 "src/data/pokemon/egg_moves.h"
                  ,

 (263 + 20000), 245, 321, 493, 189, 204, 214, 228, 270, 271, 431, 164
# 1908 "src/data/pokemon/egg_moves.h"
                  ,

 (270 + 20000), 68, 73, 75, 230, 235, 298, 321, 55, 175, 202
# 1920 "src/data/pokemon/egg_moves.h"
                  ,

 (273 + 20000), 36, 73, 98, 388, 400, 432, 13, 133, 251, 331, 384, 417, 492, 580, 206
# 1937 "src/data/pokemon/egg_moves.h"
                   ,

 (276 + 20000), 18, 48, 99, 119, 143, 211, 228, 287, 355, 413, 432, 542, 586
# 1952 "src/data/pokemon/egg_moves.h"
                 ,

 (278 + 20000), 16, 239, 282, 314, 332, 392, 469, 487, 54, 97, 346, 355, 362
# 1967 "src/data/pokemon/egg_moves.h"
             ,

 (280 + 20000), 50, 109, 194, 212, 262, 282, 288, 425, 227, 285, 485, 502, 581, 261
# 1983 "src/data/pokemon/egg_moves.h"
                   ,

 (283 + 20000), 56, 60, 170, 193, 203, 324, 341, 450, 453, 471, 565, 642
# 1997 "src/data/pokemon/egg_moves.h"
             ,

 (285 + 20000), 204, 264, 270, 313, 331, 358, 363, 388, 402, 409, 206, 207
# 2011 "src/data/pokemon/egg_moves.h"
               ,

 (287 + 20000), 34, 163, 173, 174, 214, 228, 306, 321, 359, 400, 495
# 2024 "src/data/pokemon/egg_moves.h"
                 ,

 (290 + 20000), 16, 175, 400, 450, 515, 185, 203, 318, 405
# 2035 "src/data/pokemon/egg_moves.h"
                ,

 (293 + 20000), 18, 36, 108, 283, 326, 359, 509, 574, 173, 265, 313, 207
# 2049 "src/data/pokemon/egg_moves.h"
               ,

 (296 + 20000), 68, 185, 193, 197, 223, 238, 264, 270, 279, 358, 364, 418, 469, 498
# 2065 "src/data/pokemon/egg_moves.h"
                 ,

 (298 + 20000), 47, 48, 187, 195, 217, 321, 383, 453, 487, 21, 34, 227, 287, 293, 313, 330, 346
# 2084 "src/data/pokemon/egg_moves.h"
                   ,

 (299 + 20000), 38, 203, 205, 222, 335, 446, 469, 153
 ...
 (300 + 20000), 226, 252, 253, 270, 273, 313, 321, 322, 387, 389, 426, 428, 445, 493, 164, 244
# 2112 "src/data/pokemon/egg_moves.h"
                ,

 (302 + 20000), 105, 259, 260, 364, 368, 389, 212, 236, 271, 286, 417, 445, 244
# 2127 "src/data/pokemon/egg_moves.h"
                ,

 (303 + 20000), 21, 69, 246, 321, 612, 305, 368, 385, 386, 389, 422, 423, 424, 445, 581, 14, 206, 244
# 2147 "src/data/pokemon/egg_moves.h"
                ,

 (304 + 20000), 23, 174, 189, 283, 407, 457, 34, 103, 179, 265, 276, 442, 446
# 2162 "src/data/pokemon/egg_moves.h"
                    ,

 (307 + 20000), 7, 8, 9, 193, 223, 226, 252, 290, 384, 385, 409, 418, 427, 501
# 2178 "src/data/pokemon/egg_moves.h"
                   ,

 (309 + 20000), 29, 174, 209, 415, 129, 242, 253, 351, 422, 423, 424, 435, 481, 486, 598
# 2195 "src/data/pokemon/egg_moves.h"
                     ,

 (311 + 20000), 47, 186, 204, 273, 313, 381, 435, 669, 164
# 2206 "src/data/pokemon/egg_moves.h"
                  ,

 (312 + 20000), 47, 186, 204, 273, 313, 381, 435, 669, 164
# 2217 "src/data/pokemon/egg_moves.h"
                  ,

 (313 + 20000), 69, 146, 226, 227, 271, 318, 405, 642
 ...
 (314 + 20000), 74, 109, 226, 227, 312, 313, 318, 405, 445
# 2238 "src/data/pokemon/egg_moves.h"
                 ,

 (315 + 20000), 75, 79, 178, 326, 719, 42, 170, 191, 202, 235, 320, 331, 363, 402, 437, 438
# 2256 "src/data/pokemon/egg_moves.h"
                  ,

 (316 + 20000), 123, 151, 174, 189, 194, 220, 441, 599, 138
# 2267 "src/data/pokemon/egg_moves.h"
                   ,

 (318 + 20000), 37, 38, 194, 246, 352, 56, 129, 362, 660
# 2278 "src/data/pokemon/egg_moves.h"
                     ,

 (320 + 20000), 37, 38, 90, 111, 174, 205, 321, 392, 487, 34, 173, 214, 428, 499, 207
# 2295 "src/data/pokemon/egg_moves.h"
               ,

 (322 + 20000), 23, 34, 74, 111, 184, 203, 205, 246, 254, 255, 256, 257, 281, 336, 426, 442, 484
# 2314 "src/data/pokemon/egg_moves.h"
                  ,

 (324 + 20000), 90, 130, 175, 246, 281, 203, 214, 276, 284, 481, 499, 89
# 2328 "src/data/pokemon/egg_moves.h"
                  ,

 (325 + 20000), 18, 133, 203, 243, 248, 271, 285, 326, 381, 428, 493, 164
# 2342 "src/data/pokemon/egg_moves.h"
                  ,

 (327 + 20000), 50, 196, 226, 227, 229, 252, 265, 271, 272, 273, 274, 313, 352, 375, 427, 470, 634, 157
# 2362 "src/data/pokemon/egg_moves.h"
                  ,

 (328 + 20000), 16, 98, 175, 210, 364, 450, 623, 116, 203, 324, 341, 414
# 2376 "src/data/pokemon/egg_moves.h"
                   ,

 (331 + 20000), 50, 51, 67, 68, 223, 265, 298, 320, 335, 345, 388, 402, 415, 417, 562, 563, 565, 612
# 2396 "src/data/pokemon/egg_moves.h"
                      ,

 (333 + 20000), 114, 297, 310, 355, 366, 407, 432, 97, 99, 211, 228, 304, 384, 583
# 2412 "src/data/pokemon/egg_moves.h"
                  ,

 (335 + 20000), 13, 24, 50, 68, 154, 174, 175, 187, 231, 232, 364, 400, 458, 501, 515, 46
# 2430 "src/data/pokemon/egg_moves.h"
            ,

 (336 + 20000), 34, 184, 231, 254, 255, 256, 372, 378, 386, 400, 415, 515
# 2444 "src/data/pokemon/egg_moves.h"
                    ,

 (339 + 20000), 36, 37, 175, 209, 56, 250, 330, 341, 349, 414
# 2456 "src/data/pokemon/egg_moves.h"
                   ,

 (341 + 20000), 38, 163, 232, 246, 415, 453, 34, 276, 282, 283, 300, 349, 376, 498
# 2472 "src/data/pokemon/egg_moves.h"
                 ,

 (345 + 20000), 20, 105, 174, 243, 321, 72, 112, 203, 378, 446, 157
# 2485 "src/data/pokemon/egg_moves.h"
                  ,

 (347 + 20000), 28, 174, 229, 282, 352, 453, 103, 334, 440, 14, 157
# 2498 "src/data/pokemon/egg_moves.h"
                  ,

 (349 + 20000), 54, 95, 109, 114, 225, 243, 321, 231, 300, 362, 406, 445, 113
# 2513 "src/data/pokemon/egg_moves.h"
                    ,

 (351 + 20000), 50, 133, 248, 322, 381, 385, 466, 499, 506, 513, 244
# 2526 "src/data/pokemon/egg_moves.h"
                ,

 (352 + 20000), 50, 105, 146, 252, 271, 277, 285, 289, 293, 417, 492, 612
# 2540 "src/data/pokemon/egg_moves.h"
                      ,

 (353 + 20000), 50, 109, 193, 194, 228, 286, 310, 425, 441, 466, 566, 371
# 2554 "src/data/pokemon/egg_moves.h"
               ,

 (355 + 20000), 114, 220, 262, 288, 185, 194, 285, 286, 399, 466
# 2566 "src/data/pokemon/egg_moves.h"
                    ,

 (357 + 20000), 13, 21, 29, 73, 174, 235, 267, 331, 348, 349, 363, 437, 655
# 2581 "src/data/pokemon/egg_moves.h"
                     ,

 (358 + 20000), 50, 95, 105, 174, 195, 248, 273, 285, 322, 500, 578, 138
# 2595 "src/data/pokemon/egg_moves.h"
                   ,

 (359 + 20000), 38, 44, 174, 212, 277, 364, 185, 195, 224, 226, 372, 382, 386, 389, 428, 506, 583, 164
# 2615 "src/data/pokemon/egg_moves.h"
                  ,

 (361 + 20000), 50, 205, 335, 415, 556, 117, 191, 311, 313, 419, 506
# 2628 "src/data/pokemon/egg_moves.h"
           ,

 (363 + 20000), 90, 174, 187, 254, 255, 256, 281, 352, 392, 205, 214, 324, 346, 157
# 2644 "src/data/pokemon/egg_moves.h"
                  ,

 (366 + 20000), 34, 48, 109, 112, 203, 287, 300, 330, 352, 362, 392
# 2657 "src/data/pokemon/egg_moves.h"
                 ,

 (369 + 20000), 130, 189, 133, 173, 214, 222, 330, 341, 346, 362, 401, 428, 157
# 2672 "src/data/pokemon/egg_moves.h"
                  ,

 (370 + 20000), 48, 150, 300, 346, 362, 392, 445, 453, 494, 505
# 2684 "src/data/pokemon/egg_moves.h"
                  ,

 (371 + 20000), 37, 111, 239, 407, 56, 82, 203, 349, 406, 424, 421
# 2697 "src/data/pokemon/egg_moves.h"
                   ,

 (387 + 20000), 34, 37, 38, 74, 133, 254, 255, 256, 276, 321, 328, 388, 402, 414, 469, 484, 580
# 2716 "src/data/pokemon/egg_moves.h"
                      ,

 (390 + 20000), 7, 9, 24, 66, 68, 116, 227, 252, 257, 264, 270, 274, 299, 501, 612
# 2733 "src/data/pokemon/egg_moves.h"
                      ,

 (393 + 20000), 48, 56, 97, 117, 173, 175, 189, 196, 281, 297, 300, 392, 458, 644
# 2749 "src/data/pokemon/egg_moves.h"
                  ,

 (396 + 20000), 28, 31, 38, 119, 193, 197, 211, 228, 253, 279, 297, 310, 355
# 2764 "src/data/pokemon/egg_moves.h"
             ,

 (399 + 20000), 38, 98, 111, 130, 154, 203, 205, 214, 300, 316, 346, 401, 431
# 2779 "src/data/pokemon/egg_moves.h"
                  ,

 (403 + 20000), 24, 36, 98, 336, 351, 400, 608, 129, 270, 313, 324, 422, 423, 424, 598
# 2796 "src/data/pokemon/egg_moves.h"
                     ,

 (406 + 20000), 75, 79, 178, 235, 326, 719, 42, 170, 191, 202, 320, 363, 402, 437, 207
# 2813 "src/data/pokemon/egg_moves.h"
               ,

 (408 + 20000), 18, 21, 23, 37, 38, 43, 174, 231, 242, 359, 442
# 2826 "src/data/pokemon/egg_moves.h"
                 ,

 (410 + 20000), 29, 34, 38, 68, 90, 103, 116, 174, 184, 350, 446, 469, 470
# 2841 "src/data/pokemon/egg_moves.h"
                   ,

 (417 + 20000), 39, 44, 111, 175, 205, 231, 260, 266, 268, 313, 343, 516, 569, 608
# 2857 "src/data/pokemon/egg_moves.h"
                      ,

 (418 + 20000), 3, 29, 154, 163, 189, 210, 226, 270, 316, 382, 392, 401, 415, 487, 541
# 2874 "src/data/pokemon/egg_moves.h"
                 ,

 (420 + 20000), 75, 111, 205, 230, 267, 312, 321, 361, 505, 579, 311, 320, 363, 402, 580
# 2891 "src/data/pokemon/egg_moves.h"
                      ,

 (422 + 20000), 54, 68, 124, 151, 174, 243, 254, 255, 256, 281, 499, 90, 133, 262, 362, 376
# 2909 "src/data/pokemon/egg_moves.h"
                  ,

 (425 + 20000), 50, 95, 114, 262, 432, 499, 34, 194, 311, 366
# 2921 "src/data/pokemon/egg_moves.h"
                ,

 (427 + 20000), 175, 186, 252, 264, 298, 383, 415, 458, 509, 7, 8, 9, 67, 227, 300, 313, 322, 327, 612, 213
# 2943 "src/data/pokemon/egg_moves.h"
               ,

 (431 + 20000), 28, 39, 44, 98, 175, 289, 313, 358, 372, 387
# 2955 "src/data/pokemon/egg_moves.h"
                   ,

 (433 + 20000), 50, 95, 105, 174, 248, 273, 285, 322, 500, 138
# 2967 "src/data/pokemon/egg_moves.h"
                   ,

 (434 + 20000), 38, 43, 114, 123, 163, 310, 184, 228, 231, 242, 386, 481, 492, 583
# 2983 "src/data/pokemon/egg_moves.h"
                  ,

 (438 + 20000), 29, 106, 111, 174, 205, 397, 120, 203, 328, 446
# 2995 "src/data/pokemon/egg_moves.h"
                    ,

 (439 + 20000), 95, 109, 252, 321, 471, 102, 196, 204, 248, 271, 298, 358, 361, 417, 478, 641, 244
# 3014 "src/data/pokemon/egg_moves.h"
                ,

 (440 + 20000), 69, 217, 312, 356, 68, 118, 203, 215, 270, 363, 387, 426, 164
# 3029 "src/data/pokemon/egg_moves.h"
                  ,

 (441 + 20000), 48, 97, 101, 211, 214, 227, 314, 417, 432, 586
# 3041 "src/data/pokemon/egg_moves.h"
                 ,

 (442 + 20000), 50, 108, 194, 220, 288, 171, 286, 425, 445, 492
# 3053 "src/data/pokemon/egg_moves.h"
                 ,

 (443 + 20000), 37, 38, 232, 239, 34, 184, 200, 225, 231, 328, 341, 431, 442
# 3068 "src/data/pokemon/egg_moves.h"
                 ,

 (446 + 20000), 38, 68, 90, 174, 562, 18, 120, 122, 204, 228, 363, 428, 495, 612, 164
# 3085 "src/data/pokemon/egg_moves.h"
                  ,

 (447 + 20000), 44, 136, 170, 197, 238, 336, 410, 418, 509, 67, 97, 242, 266, 299, 309, 327, 334
# 3104 "src/data/pokemon/egg_moves.h"
                    ,

 (449 + 20000), 18, 174, 254, 255, 256, 34, 214, 279, 303, 328
# 3116 "src/data/pokemon/egg_moves.h"
                 ,

 (451 + 20000), 18, 28, 109, 163, 41, 97, 103, 185, 228, 231, 342, 400
# 3130 "src/data/pokemon/egg_moves.h"
                   ,

 (453 + 20000), 29, 68, 223, 238, 252, 364, 410, 418, 501, 96, 265, 358, 367, 382, 409
# 3147 "src/data/pokemon/egg_moves.h"
                   ,

 (455 + 20000), 21, 73, 75, 78, 79, 202, 235, 320, 345, 388, 476, 491
# 3161 "src/data/pokemon/egg_moves.h"
                  ,

 (456 + 20000), 60, 62, 97, 109, 150, 175, 186, 204, 321, 324, 362, 401
# 3175 "src/data/pokemon/egg_moves.h"
                 ,

 (458 + 20000), 21, 109, 114, 150, 239, 243, 366, 56, 133, 300, 324, 346, 469, 157
# 3191 "src/data/pokemon/egg_moves.h"
                  ,

 (459 + 20000), 23, 38, 73, 74, 130, 54, 331, 345, 363, 402, 419
# 3204 "src/data/pokemon/egg_moves.h"
                 ,

 (495 + 20000), 137, 212, 228, 230, 231, 239, 243, 345, 363, 445, 580
# 3217 "src/data/pokemon/egg_moves.h"
                      ,

 (498 + 20000), 34, 37, 174, 214, 222, 276, 281, 283, 343, 389, 484, 645
# 3231 "src/data/pokemon/egg_moves.h"
               ,

 (501 + 20000), 103, 197, 362, 372, 376, 383, 400, 403, 533
# 3242 "src/data/pokemon/egg_moves.h"
                    ,

 (504 + 20000), 103, 175, 193, 228, 231, 279, 331, 372, 669
# 3253 "src/data/pokemon/egg_moves.h"
                    ,

 (506 + 20000), 122, 189, 281, 336, 343, 495, 28, 203, 204, 228, 422, 423, 424, 660
# 3269 "src/data/pokemon/egg_moves.h"
                     ,

 (509 + 20000), 98, 104, 163, 281, 343, 383, 6, 185, 204, 227, 313, 492
# 3283 "src/data/pokemon/egg_moves.h"
                 ,

 (511 + 20000), 67, 272, 310, 320, 321, 331, 343, 345, 417, 437, 574, 596
# 3297 "src/data/pokemon/egg_moves.h"
                    ,

 (513 + 20000), 7, 67, 83, 214, 257, 272, 310, 321, 343, 394, 417, 562, 574
# 3312 "src/data/pokemon/egg_moves.h"
                       ,

 (515 + 20000), 56, 67, 272, 300, 310, 321, 343, 392, 401, 417, 574
# 3325 "src/data/pokemon/egg_moves.h"
                       ,

 (517 + 20000), 174, 361, 49, 112, 129, 214, 226, 270, 277, 290
# 3337 "src/data/pokemon/egg_moves.h"
                    ,

 (519 + 20000), 95, 234, 273, 400, 432, 211, 253, 381, 516
# 3348 "src/data/pokemon/egg_moves.h"
              ,

 (522 + 20000), 24, 28, 36, 38, 99, 103, 203, 289, 351, 364, 382
# 3361 "src/data/pokemon/egg_moves.h"
                ,

 (524 + 20000), 36, 174, 356, 469, 475, 199, 222, 317, 484
# 3372 "src/data/pokemon/egg_moves.h"
                  ,

 (527 + 20000), 48, 260, 282, 355, 375, 204, 270, 313, 445, 485, 500, 599
# 3386 "src/data/pokemon/egg_moves.h"
                    ,

 (529 + 20000), 66, 163, 319, 130, 229, 306, 334, 414, 431
# 3397 "src/data/pokemon/egg_moves.h"
                  ,

 (531 + 20000), 186, 273, 281, 361, 133, 214, 215, 227, 381, 516, 577
# 3410 "src/data/pokemon/egg_moves.h"
                     ,

 (532 + 20000), 68, 183, 197, 432, 469, 612, 4, 179, 193, 203, 265, 395, 409
# 3425 "src/data/pokemon/egg_moves.h"
                   ,

 (535 + 20000), 54, 92, 189, 352, 173, 214, 287, 300, 414, 426, 495, 599
# 3439 "src/data/pokemon/egg_moves.h"
                    ,

 (540 + 20000), 13, 97, 103, 170, 226, 293, 318, 382, 403, 580
# 3451 "src/data/pokemon/egg_moves.h"
                      ,

 (543 + 20000), 44, 210, 36, 41, 42, 191, 390, 431
 ...
 (546 + 20000), 262, 267, 321, 388, 415, 227, 251, 313, 320, 363, 445, 581
# 3475 "src/data/pokemon/egg_moves.h"
                     ,

 (548 + 20000), 230, 275, 361, 388, 117, 203, 204, 227, 320, 363
# 3487 "src/data/pokemon/egg_moves.h"
                    ,

 (550 + 20000), 61, 283, 97, 99, 129, 250, 279, 330, 341, 362, 457
# 3500 "src/data/pokemon/egg_moves.h"
                  ,

 (551 + 20000), 38, 68, 180, 401, 116, 212, 228, 251, 253, 382, 422, 424, 431, 644
# 3516 "src/data/pokemon/egg_moves.h"
                  ,

 (554 + 20000), 36, 172, 264, 281, 326, 359, 116, 203, 214, 227, 289
# 3529 "src/data/pokemon/egg_moves.h"
              ,

 (556 + 20000), 388, 452, 73, 191, 320, 331, 340, 402, 580
# 3540 "src/data/pokemon/egg_moves.h"
                      ,

 (557 + 20000), 68, 174, 282, 335, 400, 469, 191, 203, 328, 334, 563
# 3553 "src/data/pokemon/egg_moves.h"
                  ,

 (559 + 20000), 68, 197, 252, 491, 501, 612, 7, 8, 9, 133, 185, 349, 409, 428
# 3569 "src/data/pokemon/egg_moves.h"
                    ,

 (562 + 20000), 262, 50, 171, 203, 286, 313, 377, 390, 417, 502, 578
# 3582 "src/data/pokemon/egg_moves.h"
                     ,

 (564 + 20000), 21, 88, 205, 282, 335, 352, 34, 117, 175, 250, 334, 385, 664
# 3597 "src/data/pokemon/egg_moves.h"
                   ,

 (566 + 20000), 44, 104, 282, 415, 432, 457, 211, 406, 414, 502
# 3609 "src/data/pokemon/egg_moves.h"
                   ,

 (568 + 20000), 28, 114, 174, 205, 475, 120, 191, 300, 350
# 3620 "src/data/pokemon/egg_moves.h"
                  ,

 (570 + 20000), 68, 197, 262, 326, 383, 389, 289, 399, 445
# 3631 "src/data/pokemon/egg_moves.h"
                 ,

 (572 + 20000), 39, 175, 282, 401, 189, 203, 214, 231, 313
# 3642 "src/data/pokemon/egg_moves.h"
                  ,

 (574 + 20000), 212, 243, 252, 259, 505, 253, 357, 399, 445
# 3653 "src/data/pokemon/egg_moves.h"
                 ,

 (577 + 20000), 109, 151, 310, 101, 270, 271, 286, 290
 ...
 (580 + 20000), 16, 119, 211, 300, 314, 362, 381, 382, 453
# 3674 "src/data/pokemon/egg_moves.h"
                ,

 (582 + 20000), 153, 393, 420, 475, 556, 657, 181, 286, 334, 352, 363
# 3687 "src/data/pokemon/egg_moves.h"
                    ,

 (585 + 20000), 29, 97, 214, 226, 235, 313, 316, 320, 363, 388
# 3699 "src/data/pokemon/egg_moves.h"
                  ,

 (587 + 20000), 310, 321, 343, 351, 355, 432, 204, 226, 231, 403, 569, 646
# 3713 "src/data/pokemon/egg_moves.h"
                  ,

 (588 + 20000), 68, 163, 282, 400, 450, 30, 103, 185, 224, 228, 529
# 3726 "src/data/pokemon/egg_moves.h"
                 ,

 (590 + 20000), 77, 111, 205, 388, 34, 74, 78, 203, 380
# 3737 "src/data/pokemon/egg_moves.h"
                   ,

 (592 + 20000), 54, 61, 109, 151, 220, 631, 105, 132
 ...
 (594 + 20000), 54, 203, 220, 243, 287, 321
 ...
 (595 + 20000), 40, 104, 522, 611, 642, 42, 50, 185, 228, 293, 431, 440
# 3769 "src/data/pokemon/egg_moves.h"
                    ,

 (597 + 20000), 73, 92, 282, 356, 491, 191, 331, 388, 402, 431, 446
# 3782 "src/data/pokemon/egg_moves.h"
                    ,

 (605 + 20000), 50, 194, 244, 310, 100, 112, 285, 322, 384, 385, 417, 502
# 3796 "src/data/pokemon/egg_moves.h"
                   ,

 (607 + 20000), 114, 151, 471, 499, 51, 203, 257, 445
 ...
 (610 + 20000), 68, 106, 283, 400, 623, 13, 116, 179, 203, 231, 406
# 3819 "src/data/pokemon/egg_moves.h"
                    ,

 (613 + 20000), 264, 281, 400, 8, 214, 227, 372, 419, 583
# 3830 "src/data/pokemon/egg_moves.h"
                  ,

 (616 + 20000), 38, 170, 364, 470, 189, 191, 203, 226, 227, 228, 390
# 3843 "src/data/pokemon/egg_moves.h"
                    ,

 (618 + 20000), 174, 180, 209, 220, 281, 310, 513, 214, 351, 382, 414, 598
# 3857 "src/data/pokemon/egg_moves.h"
                     ,

 (619 + 20000), 233, 264, 282, 364, 67, 203, 226, 265, 382, 502
# 3869 "src/data/pokemon/egg_moves.h"
                   ,

 (621 + 20000), 137, 342, 389, 400, 185, 228, 231, 232, 289, 306, 422, 424
# 3883 "src/data/pokemon/egg_moves.h"
                 ,

 (624 + 20000), 29, 212, 389, 501, 228, 279, 427, 446
 ...
 (626 + 20000), 23, 29, 130, 189, 283, 538, 562, 133, 341, 431, 442
# 3906 "src/data/pokemon/egg_moves.h"
                 ,

 (629 + 20000), 92, 212, 355, 184, 211, 282, 313, 492
 ...
 (631 + 20000), 174, 321, 389, 400, 562, 34, 35, 185, 214, 228, 257
# 3929 "src/data/pokemon/egg_moves.h"
                 ,

 (632 + 20000), 175, 368, 522, 611, 623, 103, 185, 203, 226, 422, 431
# 3942 "src/data/pokemon/egg_moves.h"
                  ,

 (633 + 20000), 310, 457, 458, 562, 103, 372, 399, 414, 422, 423, 424
# 3955 "src/data/pokemon/egg_moves.h"
                 ,

 (636 + 20000), 37, 71, 106, 81, 193, 203, 234, 393, 428
# 3966 "src/data/pokemon/egg_moves.h"
                    ,

 (650 + 20000), 111, 174, 187, 191, 205, 235, 501, 612
 ...
 (656 + 20000), 170, 293, 300, 346, 390, 516, 612
 ...
 (659 + 20000), 111, 205, 191


              ,

 (661 + 20000), 432, 488, 501, 289, 366
 ...
 (669 + 20000), 293, 383, 445, 669



                    ,

 (672 + 20000), 111, 205, 208, 580



                      ,

 (674 + 20000), 69, 480, 501, 511, 644, 382, 492
 ...
 (682 + 20000), 50, 273, 495, 287, 417, 445
 ...
 (686 + 20000), 50, 194, 367, 260, 293, 385, 471, 493
 ...
 (688 + 20000), 28, 400, 415, 270, 321, 346
 ...
 (690 + 20000), 114, 151, 239, 525, 390, 583, 599
 ...
 (692 + 20000), 61, 401, 494, 152, 203, 270, 453
 ...
 (694 + 20000), 137, 407, 525, 97, 293, 604
 ...
 (696 + 20000), 88, 174, 305, 397, 349, 422, 423, 424
 ...
 (698 + 20000), 36, 88, 114, 243, 435, 657, 112, 393
 ...
 (701 + 20000), 212, 238, 364, 432, 494, 501, 97, 226, 300, 382, 502
# 4150 "src/data/pokemon/egg_moves.h"
                   ,

 (702 + 20000), 343, 393, 669, 270, 363, 598
 ...
 (704 + 20000), 68, 719, 151, 174, 203, 231, 342
 ...
 (708 + 20000), 50, 288, 389, 286, 516, 599, 612
 ...
 (710 + 20000), 50, 174, 194, 516



              ,

 (712 + 20000), 54, 243, 657, 105, 112
 ...
 (714 + 20000), 407, 432, 200, 289, 366, 415
 ...
 (722 + 20000), 104, 109, 282, 432, 114, 174, 226, 466
 ...
 (725 + 20000), 252, 575, 644, 34, 242, 257, 279, 417
 ...
 (728 + 20000), 195, 392, 719, 133, 204, 472, 597
 ...
 (739 + 20000), 133, 276, 283, 469



                  ,

 (741 + 20000), 219, 365, 366, 445



                 ,

 (742 + 20000), 564, 585, 597, 226, 285, 516, 600, 646
 ...
 (744 + 20000), 37, 283, 387, 306, 389, 422, 424
 ...
 (746 + 20000), 36, 54, 352, 250, 330, 346
 ...
 (749 + 20000), 38, 46, 90, 479, 34, 222, 370, 426
 ...
 (753 + 20000), 312, 388, 432, 202, 311, 437
 ...
 (757 + 20000), 28, 189, 252, 562, 282, 289
 ...
 (759 + 20000), 23, 111, 205, 395, 8, 9, 25, 203, 469, 661
# 4352 "src/data/pokemon/egg_moves.h"
                        ,

 (761 + 20000), 235, 283, 367, 204, 320, 364, 583
 ...
 (764 + 20000), 388, 495, 536, 133, 203, 381
 ...
 (765 + 20000), 138, 281, 326, 387, 472, 641
 ...
 (766 + 20000), 68, 69, 98, 233, 282, 364, 501, 442
 ...
 (767 + 20000), 106, 205, 232, 453, 469, 191
 ...
 (769 + 20000), 174, 194, 246, 254, 255, 256, 133
 ...
 (771 + 20000), 180, 207, 243, 321, 203, 516, 599
 ...
 (775 + 20000), 47, 204, 273, 583



                  ,

 (776 + 20000), 174, 229, 457, 469, 83, 279
 ...
 (777 + 20000), 175, 217, 252, 273, 321, 574, 41, 179, 227
# 4438 "src/data/pokemon/egg_moves.h"
              ,

 (778 + 20000), 174, 194, 288, 171



                 ,

 (779 + 20000), 99, 305, 352, 423



                ,

 (780 + 20000), 54, 321, 407, 13, 542, 583
 ...
 (782 + 20000), 68, 225, 264, 179



                ,

 (810 + 20000), 70, 73, 74, 252, 267, 359, 388
 ...
 (813 + 20000), 28, 136, 162, 389



                    ,

 (816 + 20000), 54, 104, 114, 392, 420, 453, 565
 ...
 (819 + 20000), 111, 187, 205, 387



                   ,

 (821 + 20000), 28, 143, 180, 249, 355, 366, 432
 ...
 (824 + 20000), 48, 105, 564, 611



                   ,

 (827 + 20000), 259, 282, 336, 501



                   ,

 (829 + 20000), 73, 74, 77, 78, 79, 388
 ...
 (833 + 20000), 130, 380, 525


                   ,

 (835 + 20000), 28, 38, 336, 435, 488
 ...
 (837 + 20000), 153, 189, 335


             ,

 (840 + 20000), 111, 205, 278, 389



                    ,

 (843 + 20000), 189, 342, 387, 407, 562
 ...
 (846 + 20000), 37, 163, 367, 400



                   ,

 (848 + 20000), 283, 319, 612


                      ,

 (850 + 20000), 111, 205, 282, 522



                    ,

 (852 + 20000), 69, 220, 389, 487, 509, 612
 ...
 (875 + 20000), 38, 187, 392, 457, 487, 556
 ...
 (876 + 20000), 244, 252, 326


                    ,

 (877 + 20000), 162, 207, 229, 252, 268, 321, 511, 575
 ...
 (878 + 20000), 18, 21, 38, 90, 111, 174, 207, 562
 ...
 (884 + 20000), 163, 243, 400


                   ,

 (885 + 20000), 50, 104, 109, 174, 288, 389, 525
 ...
 (898 + 51 + 20000), 68, 154, 179, 253, 254, 256, 279, 289, 382, 415, 515
# 4673 "src/data/pokemon/egg_moves.h"
                    ,

 (898 + 54 + 20000), 68, 174, 175, 306, 400, 468, 133, 203, 232, 333, 498, 556
# 4687 "src/data/pokemon/egg_moves.h"
                    ,

 (898 + 56 + 20000), 46, 95, 175, 336, 573, 585, 608, 50, 97, 180, 204, 227, 290, 326, 384, 541
# 4705 "src/data/pokemon/egg_moves.h"
                 ,

 (898 + 58 + 20000), 29, 37, 246, 262, 319, 468, 515, 179, 185, 203, 228, 251
# 4719 "src/data/pokemon/egg_moves.h"
               ,

 (898 + 60 + 20000), 95, 175, 180, 260, 343, 575, 133, 204, 274, 289, 386, 492
# 4733 "src/data/pokemon/egg_moves.h"
                 ,

 (898 + 62 + 20000), 68, 103, 174, 175, 203, 335, 393, 431, 469, 475
# 4745 "src/data/pokemon/egg_moves.h"
                  ,

 (898 + 65 + 20000), 174, 180, 184, 212, 228, 254, 255, 256, 286, 372, 425, 499, 612
# 4760 "src/data/pokemon/egg_moves.h"
                      ,
...
static const u8 sJapaneseEggNickname[] = _("Egg");
...
u8 CountPokemonInDaycare(struct DayCare *daycare)
{
    ...
    for (i = 0; i < 2; i++)
    {
        if (GetBoxMonData(&daycare->mons[i].mon, 11) != 0)
            count++;
    }
...
void InitDaycareMailRecordMixing(struct DayCare *daycare, struct RecordMixingDayCareMail *daycareMail)
{
    ...
    for (i = 0; i < 2; i++)
    {
        ...
        {
            numDaycareMons++;
            if (GetBoxMonData(&daycare->mons[i].mon, 12) == 0)
            {
                daycareMail->holdsItem[i] = 0;
            }
            else
            {
                daycareMail->holdsItem[i] = 1;
            }
        }
        else
        {
...
static void StorePokemonInDaycare(struct Pokemon *mon, struct DaycareMon *daycareMon)
{
    if (MonHasMail(mon))
    {
        ...
        daycareMon->mail.gameLanguage = 2;
        daycareMon->mail.monLanguage = GetMonData(mon, 3);
        mailId = GetMonData(mon, 64);
...
static void ShiftDaycareSlots(struct DayCare *daycare)
{
    ...
    if (GetBoxMonData(&daycare->mons[1].mon, 11) != 0
        && GetBoxMonData(&daycare->mons[0].mon, 11) == 0)
    {
...
# 268 "src/daycare.c"
    ...
    {
        GiveMailToMon2(&gPlayerParty[6 - 1], &daycareMon->mail.message);
...
static u8 GetLevelAfterDaycareSteps(struct BoxPokemon *mon, u32 steps)
{
    ...
    u32 experience = GetBoxMonData(mon, 25);
...
u8 GetNumLevelsGainedFromDaycare(void)
{
    if (GetBoxMonData(&gSaveBlock1Ptr->daycare.mons[gSpecialVar_0x8004], 11) != 0)
...
{
    u16 motherItem = GetBoxMonData(&daycare->mons[0].mon, 12);
    u16 fatherItem = GetBoxMonData(&daycare->mons[1].mon, 12);
    if(motherItem == 224 && fatherItem == 224)
    {
     if (Random() >= 65535 / 2)
            return 0;
        else
...
static void _TriggerPendingDaycareEgg(struct DayCare *daycare)
{
    ...
    {
        u8 wantedNature = GetNatureFromPersonality(GetBoxMonData(&daycare->mons[parent].mon, 0, ((void *)0)));
...
{
    u32 motherItem = GetBoxMonData(&daycare->mons[0].mon, 12);
 u8 MotherAbility = GetBoxMonData(&daycare->mons[0].mon, 46);
 u8 MotherSpecies = GetBoxMonData(&daycare->mons[0].mon, 11);
    u32 fatherItem = GetBoxMonData(&daycare->mons[1].mon, 12);
 u8 FatherAbility = GetBoxMonData(&daycare->mons[1].mon, 46);
 u8 FatherSpecies = GetBoxMonData(&daycare->mons[1].mon, 11);
 u8 Ability = 2;

    u8 inheritNum = (motherItem == 280 || fatherItem == 280) ? 5: 3;
 ...
 if(Random() % 5 >= 3){
 if(MotherSpecies != 132)
  SetMonData(egg, 46, &MotherAbility);
 else if(FatherSpecies != 132)
  SetMonData(egg, 46, &FatherAbility);
 }
  ...
  i--;
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        {
            case 0:
                iv = GetBoxMonData(&daycare->mons[whichParents[i]].mon, 39);
                SetMonData(egg, 39, &iv);
                break;
            case 1:
                iv = GetBoxMonData(&daycare->mons[whichParents[i]].mon, 40);
                SetMonData(egg, 40, &iv);
                break;
            case 2:
                iv = GetBoxMonData(&daycare->mons[whichParents[i]].mon, 41);
                SetMonData(egg, 41, &iv);
                break;
            case 3:
                iv = GetBoxMonData(&daycare->mons[whichParents[i]].mon, 42);
                SetMonData(egg, 42, &iv);
                break;
            case 4:
                iv = GetBoxMonData(&daycare->mons[whichParents[i]].mon, 43);
                SetMonData(egg, 43, &iv);
                break;
            case 5:
                iv = GetBoxMonData(&daycare->mons[whichParents[i]].mon, 44);
...
static void BuildEggMoveset(struct Pokemon *egg, struct BoxPokemon *father, struct BoxPokemon *mother)
{
 ...
 u8 formId = 0;
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        sHatchedEggMotherMoves[i] = GetBoxMonData(mother, 13 + i);
    }
    ...
    for (i = 0; i < 4; i++)
    {
        if (sHatchedEggFatherMoves[i] != 0)
        {
            for (j = 0; j < 200 + 8; j++)
            {
                if (sHatchedEggFatherMoves[i] == ItemIdToBattleMoveId(482 + j) && CanMonLearnTMHM(egg, j))
                {
                    if (GiveMoveToMon(egg, sHatchedEggFatherMoves[i]) == 0xFFFF)
                        DeleteFirstMoveAndGiveMoveToMon(egg, sHatchedEggFatherMoves[i]);
                }
...
static void AlterEggSpeciesWithIncenseItem(u16 *species, struct DayCare *daycare)
{
 u16 motherItem, fatherItem;
    ...
    if (*species == 360 && motherItem != 314 && fatherItem != 314)
        *species = 202;
    else if (*species == 298 && motherItem != 313 && fatherItem != 313)
        *species = 183;

        else if (*species == 446 && motherItem != 317 && fatherItem != 317)
            *species = 143;


        else if (*species == 440 && motherItem != 320 && fatherItem != 320)
            *species = 113;


        else if (*species == 439 && motherItem != 315 && fatherItem != 315)
            *species = 122;


        else if (*species == 433 && motherItem != 321 && fatherItem != 321)
            *species = 358;


        else if (*species == 438 && motherItem != 316 && fatherItem != 316)
            *species = 185;


        else if (*species == 406 && motherItem != 319 && fatherItem != 319)
            *species = 315;
...
static void GiveVoltTackleIfLightBall(struct Pokemon *mon, struct DayCare *daycare)
{
    ...
    if (motherItem == 364 || fatherItem == 364)
    {
...
static u16 DetermineEggSpeciesAndParentSlots(struct DayCare *daycare, u8 *parentSlots)
{
    ...
    for (i = 0; i < 2; i++)
    {
        species[i] = GetBoxMonData(&daycare->mons[i].mon, 11);
        if (species[i] == 132)
        {
            parentSlots[0] = i ^ 1;
            parentSlots[1] = i;
    ...
    if (eggSpecies == 314 && daycare->offspringPersonality & 0x8000)
    {
        eggSpecies = 313;
    }
...
void CreateEgg(struct Pokemon *mon, u16 species, bool8 setHotSpringsLocation)
{
    ...
    CreateMon(mon, species, 1, 32, 0, 0, 0, 0, 0);
    metLevel = 0;
    ball = 4;
    language = 1;
...
static bool8 TryProduceOrHatchEgg(struct DayCare *daycare)
{
    ...
    for (i = 0; i < 2; i++)
    {
        if (GetBoxMonData(&daycare->mons[i].mon, 5))
    ...
    if (daycare->offspringPersonality == 0 && validEggs == 2 && (daycare->mons[1].steps & 0xFF) == 0xFF)
    {
        ...
        if (compatability > (Random() * 100u) / 65535)
...
{
    u8 text[12];
    if (GetBoxMonData(&daycare->mons[0].mon, 11) != 0)
    {
        GetBoxMonNickname(&daycare->mons[0].mon, gStringVar1);
        GetBoxMonData(&daycare->mons[0].mon, 7, text);
...
u16 GetSelectedMonNicknameAndSpecies(void)
{
    ...
    return GetBoxMonData(&gPlayerParty[GetCursorSelectionMonId()].box, 11);
}
...
static u8 GetDaycareCompatibilityScore(struct DayCare *daycare)
{
    ...
    for (i = 0; i < 2; i++)
    {
        ...
        species[i] = GetBoxMonData(&daycare->mons[i].mon, 11);
        trainerIds[i] = GetBoxMonData(&daycare->mons[i].mon, 1);
        personality = GetBoxMonData(&daycare->mons[i].mon, 0);
...
static void DaycareAddTextPrinter(u8 windowId, const u8 *text, u32 x, u32 y)
{
    ...
    AddTextPrinter(&printer, 0xFF, ((void *)0));
}
...
static void Task_HandleDaycareLevelMenuInput(u8 taskId)
{
    ...
    if (({(gMain.newKeys) & (0x0001);}))
    {
        ...
        ClearStdWindowAndFrame(gTasks[taskId].data[1], 1);
...
void ShowDaycareLevelMenu(void)
{
    ...
    gTasks[daycareMenuTaskId].data[0] = listMenuTaskId;
    gTasks[daycareMenuTaskId].data[1] = windowId;
}
