...
# 18 "src/cable_car.c" 2

# 1 "include/task.h" 1
# 20 "src/cable_car.c" 2
# 1 "include/constants/event_objects.h" 1
# 21 "src/cable_car.c" 2
# 1 "include/constants/rgb.h" 1
# 22 "src/cable_car.c" 2
# 1 "include/constants/songs.h" 1
# 23 "src/cable_car.c" 2
# 1 "include/constants/weather.h" 1
# 24 "src/cable_car.c" 2
# 33 "src/cable_car.c"
struct CableCar
{
    u8 bgTaskId;
...
static __attribute__((section("ewram_data"))) struct CableCar *sCableCar = ((void *)0);
static __attribute__((section("ewram_data"))) u8 sGroundX_Up = 0;
static __attribute__((section("ewram_data"))) u8 sGroundY_Up = 0;
static __attribute__((section("ewram_data"))) u8 sGroundSegmentY_Up = 0;
static __attribute__((section("ewram_data"))) u8 sGroundX_Down = 0;
static __attribute__((section("ewram_data"))) u8 sGroundY_Down = 0;
static __attribute__((section("ewram_data"))) u8 sGroundSegmentY_Down = 0;
...
static void CB2_LoadCableCar(void)
{
    ...
    default:
        ...
        { void *_dest = (void *)0x7000000; u32 _size = 0x400; { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); u32 eval_src = (u32)(&tmp); u32 eval_dst = (u32)(_dest); u32 eval_ctl = (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((_size)/(32/8))); register u32 r_src asm("r0") = eval_src; register u32 r_dst asm("r1") = eval_dst; register u32 r_ctl asm("r2") = eval_ctl; asm volatile("stmia %0!, {%1, %2, %3}" : "+l" (dmaRegs) : "l" (r_src), "l" (r_dst), "l" (r_ctl) : "memory"); }; }; };
        { void *_dest = (void *)0x5000000; u32 _size = 0x400; { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); u32 eval_src = (u32)(&tmp); u32 eval_dst = (u32)(_dest); u32 eval_ctl = (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((_size)/(16/8))); register u32 r_src asm("r0") = eval_src; register u32 r_dst asm("r1") = eval_dst; register u32 r_ctl asm("r2") = eval_ctl; asm volatile("stmia %0!, {%1, %2, %3}" : "+l" (dmaRegs) : "l" (r_src), "l" (r_dst), "l" (r_ctl) : "memory"); }; }; };
    ...
    case 1:
        ...
        break;
    case 2:
        for (i = 0; i < (size_t)(sizeof(sSpriteSheets) / sizeof((sSpriteSheets)[0])) - 1; i++)
    ...
    case 7:
        ...
        break;
    case 8:
        BeginNormalPaletteFade(0xFFFFFFFF, 3, 16, 0, ((0) | ((0) << 5) | ((0) << 10)));
        FadeInNewBGM(396, 1);
        SetBgRegs(1);
        gMain.state++;
        break;
...
static void CB2_EndCableCar(void)
{
    ...
    ResetBgsAndClearDma3BusyFlags(0);
    sCableCar->pylonHookTilemapEntries = ((void *)0);
    { Free(sCableCar->pylonStemTilemap); sCableCar->pylonStemTilemap = ((void *)0); };
    { Free(sCableCar->bgMountainsTilemap); sCableCar->bgMountainsTilemap = ((void *)0); };
    { Free(sCableCar->treesTilemap); sCableCar->treesTilemap = ((void *)0); };
    { Free(sCableCar->groundTilemap); sCableCar->groundTilemap = ((void *)0); };
    { Free(sCableCar); sCableCar = ((void *)0); };
    { void *_dest = (void *)0x6000000; u32 _size = 0x18000; while (1) { { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); u32 eval_src = (u32)(&tmp); u32 eval_dst = (u32)(_dest); u32 eval_ctl = (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | (((0x1000))/(16/8))); register u32 r_src asm("r0") = eval_src; register u32 r_dst asm("r1") = eval_dst; register u32 r_ctl asm("r2") = eval_ctl; asm volatile("stmia %0!, {%1, %2, %3}" : "+l" (dmaRegs) : "l" (r_src), "l" (r_dst), "l" (r_ctl) : "memory"); }; }; _dest += (0x1000); _size -= (0x1000); if (_size <= (0x1000)) { { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); u32 eval_src = (u32)(&tmp); u32 eval_dst = (u32)(_dest); u32 eval_ctl = (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((_size)/(16/8))); register u32 r_src asm("r0") = eval_src; register u32 r_dst asm("r1") = eval_dst; register u32 r_ctl asm("r2") = eval_ctl; asm volatile("stmia %0!, {%1, %2, %3}" : "+l" (dmaRegs) : "l" (r_src), "l" (r_dst), "l" (r_ctl) : "memory"); }; }; break; } } };
    { void *_dest = (void *)0x7000000; u32 _size = 0x400; { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); u32 eval_src = (u32)(&tmp); u32 eval_dst = (u32)(_dest); u32 eval_ctl = (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((_size)/(32/8))); register u32 r_src asm("r0") = eval_src; register u32 r_dst asm("r1") = eval_dst; register u32 r_ctl asm("r2") = eval_ctl; asm volatile("stmia %0!, {%1, %2, %3}" : "+l" (dmaRegs) : "l" (r_src), "l" (r_dst), "l" (r_ctl) : "memory"); }; }; };
    { void *_dest = (void *)0x5000000; u32 _size = 0x400; { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); u32 eval_src = (u32)(&tmp); u32 eval_dst = (u32)(_dest); u32 eval_ctl = (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((_size)/(16/8))); register u32 r_src asm("r0") = eval_src; register u32 r_dst asm("r1") = eval_dst; register u32 r_ctl asm("r2") = eval_ctl; asm volatile("stmia %0!, {%1, %2, %3}" : "+l" (dmaRegs) : "l" (r_src), "l" (r_dst), "l" (r_ctl) : "memory"); }; }; };
    WarpIntoMap();
...
static void Task_CableCar(u8 taskId)
{
    ...
    case 1:
        ...
        {
        case 7:
            if (gWeatherPtr->sprites.s2.ashSprites[0] != ((void *)0) && gWeatherPtr->sprites.s2.ashSprites[0]->oam.priority != 0)
            {
                for (; i < 20; i++)
                {
                    if (gWeatherPtr->sprites.s2.ashSprites[i])
    ...
    case 2:
        ...
        {
            sCableCar->state = 3;
            BeginNormalPaletteFade(0xFFFFFFFF, 3, 0, 16, ((0) | ((0) << 5) | ((0) << 10)));
            FadeOutBGM(4);
        }
        break;
    case 3:
...
static void VBlankCB_CableCar(void)
{
    ...
    SetGpuReg(0x1c, sCableCar->bg3HorizontalOffset);
    SetGpuReg(0x1e, sCableCar->bg3VerticalOffset);
    SetGpuReg(0x14, sCableCar->bg1HorizontalOffset);
    SetGpuReg(0x16, sCableCar->bg1VerticalOffset);
    SetGpuReg(0x10, sCableCar->bg0HorizontalOffset);
    SetGpuReg(0x12, sCableCar->bg0VerticalOffset);
    LoadOam();
...
static void SpriteCB_CableCar(struct Sprite *sprite)
{
    if (sCableCar->state != 0xFF)
    {
        if (!gSpecialVar_0x8004)
        {
            sprite->pos1.x = sprite->data[0] - (u8)(0.14f * ({ s16 v = (sCableCar->timer); float f = (float)v; if(v < 0) f += 65536.0f; f; }));
            sprite->pos1.y = sprite->data[1] - (u8)(0.067f * ({ s16 v = (sCableCar->timer); float f = (float)v; if(v < 0) f += 65536.0f; f; }));
        }
        else
        {
            sprite->pos1.x = sprite->data[0] + (u8)(0.14f * ({ s16 v = (sCableCar->timer); float f = (float)v; if(v < 0) f += 65536.0f; f; }));
...
static void CreateCableCarSprites(void)
{
    ...
    if ((rval % 64) == 0)
    {
        ...
        spriteId = AddPseudoObjectEvent(hikerGraphicsIds[rval % ((size_t)(sizeof(hikerGraphicsIds) / sizeof((hikerGraphicsIds)[0])) - 1)], hikerCallbacks[gSpecialVar_0x8004], hikerCoords[gSpecialVar_0x8004][0], hikerCoords[gSpecialVar_0x8004][1], 106);
        if (spriteId != 64)
        {
            gSprites[spriteId].oam.priority = 2;
            ...
            gSprites[spriteId].data[2] = hikerMovementDelayTable[rval % (size_t)(sizeof(hikerMovementDelayTable) / sizeof((hikerMovementDelayTable)[0]))];
        }
    }
}
...
static void BufferNextGroundSegment(void)
{
    ...
    {
        for (j = 0; j < (size_t)(sizeof(sCableCar->groundTileBuffer[0]) / sizeof((sCableCar->groundTileBuffer[0])[0])); j++)
        {
...
static void DrawNextGroundSegmentGoingUp(void)
{
    ...
    for (i = 0; i < (size_t)(sizeof(sCableCar->groundTileBuffer) / sizeof((sCableCar->groundTileBuffer)[0])); i++)
    {
