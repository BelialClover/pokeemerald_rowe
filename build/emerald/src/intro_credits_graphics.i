# 0 "src/intro_credits_graphics.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/intro_credits_graphics.c"
...
# 2 "src/intro_credits_graphics.c" 2
...
# 3 "src/intro_credits_graphics.c" 2
...
# 4 "src/intro_credits_graphics.c" 2
...
# 5 "src/intro_credits_graphics.c" 2
...
# 6 "src/intro_credits_graphics.c" 2
# 1 "include/task.h" 1
# 10 "include/task.h"
...
# 7 "src/intro_credits_graphics.c" 2
# 1 "include/main.h" 1
...
# 8 "src/intro_credits_graphics.c" 2
...
__attribute__((section("ewram_data"))) u16 gUnknown_0203BD24 = 0;
__attribute__((section("ewram_data"))) s16 gUnknown_0203BD26 = 0;
__attribute__((section("ewram_data"))) s16 gUnknown_0203BD28 = 0;
...
void load_intro_part2_graphics(u8 a)
{
    LZ77UnCompVram(gUnknown_085F0740, (void *)((0x6000000 + (0x4000 * (1)))));
    LZ77UnCompVram(gUnknown_085F0BC0, (void *)((0x6000000 + (0x800 * (15)))));
    LoadPalette(&gUnknown_085F06E0, 240, 32);
    switch (a)
    {
    case 0:
    default:
        LZ77UnCompVram(gUnknown_085F0DBC, (void *)(0x6000000));
        LZ77UnCompVram(gUnknown_085F1398, (void *)((0x6000000 + (0x800 * (6)))));
        ...
        break;
    case 1:
        LZ77UnCompVram(gUnknown_085F1824, (void *)(0x6000000));
        LZ77UnCompVram(gUnknown_085F1EAC, (void *)((0x6000000 + (0x800 * (6)))));
...
void sub_817B1C8(u8 a)
{
    ...
    default:
        ...
        LoadPalette(&gUnknown_085F0CFC, 0, 96);
        LoadCompressedSpriteSheet(gUnknown_085F5064);
        LZ77UnCompVram(gUnknown_085F16A8, (void *)((0x6000000 + 0x10000)));
        LoadPalette(&gUnknown_085F1668, 256, 32);
        sub_817B76C();
        break;
    case 1:
    ...
    case 4:
        ...
        LZ77UnCompVram(gUnknown_085F235C, (void *)(0x6000000));
        LZ77UnCompVram(gUnknown_085F2568, (void *)((0x6000000 + (0x800 * (6)))));
...
static void sub_817B458(u8 taskId)
{
    ...
    if (data1 != 0)
    {
        ...
        SetGpuReg(0x14, gTasks[taskId].data[2]);
        SetGpuReg(0x16, gUnknown_0203BD24 + gUnknown_0203BD26);
    }
    ...
    if (data4 != 0)
    {
        ...
        SetGpuReg(0x18, gTasks[taskId].data[5]);
        if (gTasks[taskId].data[0] != 0)
            SetGpuReg(0x1a, gUnknown_0203BD24 + gUnknown_0203BD26);
        else
            SetGpuReg(0x1a, gUnknown_0203BD24);
    }
    ...
    if (data7 != 0)
    {
        ...
        SetGpuReg(0x1c, gTasks[taskId].data[8]);
        SetGpuReg(0x1e, gUnknown_0203BD24);
    }
}
