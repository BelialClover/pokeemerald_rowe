# 0 "src/field_camera.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/field_camera.c"
...
# 12 "src/field_camera.c" 2



__attribute__((section("ewram_data"))) bool8 gUnusedBikeCameraAheadPanback = 0;
...
void DrawWholeMapView(void)
{
    ...
    sFieldCameraOffset.copyBGToVRAM = 1;
}
...
void CameraUpdate(void)
{
    ...
    if (gFieldCamera.callback != ((void *)0))
...
void UpdateCameraPanning(void)
{
    if (sFieldCameraPanningCallback != ((void *)0))
...
static void CameraPanningCB_PanAhead(void)
{
    ...
    if (gUnusedBikeCameraAheadPanback == 0)
    {
