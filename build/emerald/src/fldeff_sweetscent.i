# 0 "src/fldeff_sweetscent.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/fldeff_sweetscent.c"
...
# 14 "src/fldeff_sweetscent.c" 2

# 1 "include/task.h" 1
# 16 "src/fldeff_sweetscent.c" 2
...
# 17 "src/fldeff_sweetscent.c" 2
# 1 "include/constants/field_effects.h" 1
# 18 "src/fldeff_sweetscent.c" 2
# 1 "include/constants/rgb.h" 1
# 19 "src/fldeff_sweetscent.c" 2
# 1 "include/constants/songs.h" 1
# 20 "src/fldeff_sweetscent.c" 2
...
static void StartSweetScentFieldEffect(void)
{
    ...
    BeginNormalPaletteFade(~(1 << (gSprites[GetPlayerAvatarObjectId()].oam.paletteNum + 16)), 4, 0, 8, ((31) | ((0) << 5) | ((0) << 10)));
...
static void TrySweetScentEncounter(u8 taskId)
{
    if (!gPaletteFade.active)
    {
        ...
        BlendPalettes(0x00000040, 8, ((31) | ((0) << 5) | ((0) << 10)));
        if (gTasks[taskId].data[0] == 64)
        {
            gTasks[taskId].data[0] = 0;
            if (SweetScentWildEncounter() == 1)
            {
                DestroyTask(taskId);
            }
            else
            {
                ...
                BeginNormalPaletteFade(~(1 << (gSprites[GetPlayerAvatarObjectId()].oam.paletteNum + 16)), 4, 8, 0, ((31) | ((0) << 5) | ((0) << 10)));
