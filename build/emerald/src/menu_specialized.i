# 0 "src/menu_specialized.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/menu_specialized.c"
...
# 13 "src/menu_specialized.c" 2
# 1 "include/move_relearner.h" 1



void TeachMoveRelearnerMove(void);
void MoveRelearnerShowHideHearts(s32);
# 14 "src/menu_specialized.c" 2
...
# 15 "src/menu_specialized.c" 2
# 1 "include/player_pc.h" 1
# 16 "src/menu_specialized.c" 2
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 25 "src/menu_specialized.c" 2

# 1 "include/constants/berry.h" 1
# 27 "src/menu_specialized.c" 2
# 1 "include/constants/songs.h" 1
# 28 "src/menu_specialized.c" 2


extern const struct CompressedSpriteSheet gMonFrontPicTable[];

__attribute__((section("ewram_data"))) static u8 sUnknown_0203CF48[3] = {0};
__attribute__((section("ewram_data"))) static struct ListMenuItem *sUnknown_0203CF4C = ((void *)0);
...
{
    .dmaDest = (void*)(0x4000000 + 0x40),
    .dmaControl = (((0x8000 | 0x2000 | 0x0200 | 0x0000 | 0x0000 | 0x0400 | 0x0060) << 16) | 1),
    .initState = 1,
};
...
bool8 sub_81D1C44(u8 count)
{
    ...
    if (sUnknown_0203CF4C == ((void *)0))
        return 0;

    for (i = 0; i < (size_t)(sizeof(sUnknown_0203CF48) / sizeof((sUnknown_0203CF48)[0])); i++)
...
void SetConditionGraphIOWindows(u8 bg)
{
    ...
    flags = (((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)) | (1 << 4)) & ~(1 << bg);

    SetGpuReg(0x40, (((0) << 8) | (240)));
    SetGpuReg(0x42, (((0) << 8) | (155)));
    SetGpuReg(0x44, (((56) << 8) | (121)));
    SetGpuReg(0x46, (((56) << 8) | (121)));
    SetGpuReg(0x48, ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)) | (1 << 4) | (1 << 5) | ((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12) | (1 << 13));
    SetGpuReg(0x4a, flags);
}
...
static void sub_81D24A4(struct ConditionGraph *graph)
{
    ...
    if (graph->unk12C[0].unk2 < graph->unk12C[1].unk2)
    {
        ...
        sub_81D2278(graph, graph->unk140[0], &graph->unk12C[0], &graph->unk12C[1], 1, ((void *)0));
    }
    else
    {
        r6 = graph->unk12C[1].unk2;
        sub_81D2278(graph, graph->unk140[0], &graph->unk12C[1], &graph->unk12C[0], 0, ((void *)0));
    }

    sub_81D2278(graph, graph->unk140[0], &graph->unk12C[1], &graph->unk12C[2], 1, ((void *)0));
    ...
    varMax = ((graph->unk350) >= (graph->unk12C[2].unk2) ? (graph->unk350) : (graph->unk12C[2].unk2));
...
static void sub_81D2634(struct ConditionGraph *graph)
{
    ...
    {
        r6 = graph->unk12C[0].unk2;
        sub_81D2278(graph, graph->unk248[0], &graph->unk12C[0], &graph->unk12C[4], 0, ((void *)0));
    }
    else
    {
        r6 = graph->unk12C[4].unk2;
        sub_81D2278(graph, graph->unk248[0], &graph->unk12C[4], &graph->unk12C[0], 1, ((void *)0));
    }

    sub_81D2278(graph, graph->unk248[0], &graph->unk12C[4], &graph->unk12C[3], 0, ((void *)0));
    ...
    varMax = ((graph->unk350) >= (graph->unk12C[3].unk2 + 1) ? (graph->unk350) : (graph->unk12C[3].unk2 + 1));
...
static void MoveRelearnerLoadBattleMoveDescription(u32 chosenMove)
{
    ...
    AddTextPrinterParameterized(0, 1, str, x, 1, 0xFF, ((void *)0));

    str = gText_MoveRelearnerPP;
    AddTextPrinterParameterized(0, 1, str, 4, 0x29, 0xFF, ((void *)0));

    str = gText_MoveRelearnerPower;
    x = GetStringRightAlignXOffset(1, str, 0x6A);
    AddTextPrinterParameterized(0, 1, str, x, 0x19, 0xFF, ((void *)0));

    str = gText_MoveRelearnerAccuracy;
    x = GetStringRightAlignXOffset(1, str, 0x6A);
    AddTextPrinterParameterized(0, 1, str, x, 0x29, 0xFF, ((void *)0));
    if (chosenMove == -2)
    {
    ...
    AddTextPrinterParameterized(0, 1, str, 0x6A, 0x19, 0xFF, ((void *)0));
    ...
    AddTextPrinterParameterized(0, 1, str, 0x6A, 0x29, 0xFF, ((void *)0));

    str = gMoveDescriptionPointers[chosenMove - 1];
    AddTextPrinterParameterized(0, 7, str, 0, 0x41, 0, ((void *)0));
}
...
static void MoveRelearnerMenuLoadContestMoveDescription(u32 chosenMove)
{
    ...
    x = GetStringCenterAlignXOffset(1, str, 0x80);
    AddTextPrinterParameterized(1, 1, str, x, 1, 0xFF, ((void *)0));

    str = gText_MoveRelearnerAppeal;
    x = GetStringRightAlignXOffset(1, str, 0x5C);
    AddTextPrinterParameterized(1, 1, str, x, 0x19, 0xFF, ((void *)0));

    str = gText_MoveRelearnerJam;
    x = GetStringRightAlignXOffset(1, str, 0x5C);
    AddTextPrinterParameterized(1, 1, str, x, 0x29, 0xFF, ((void *)0));
    ...
    AddTextPrinterParameterized(1, 1, str, 4, 0x19, 0xFF, ((void *)0));

    str = gContestEffectDescriptionPointers[move->effect];
    AddTextPrinterParameterized(1, 7, str, 0, 0x41, 0xFF, ((void *)0));
...
void MoveRelearnerPrintText(u8 *str)
{
    ...
    AddTextPrinterParameterized2(3, 1, str, speed, ((void *)0), 0x2, 0x1, 3);
}
...
static u8 *GetConditionMenuMonString(u8 *dst, u16 boxId, u16 monId)
{
    ...
    *(dst++) = 0x0;
    *(dst++) = 0x9;
    if (GetBoxOrPartyMonData(boxId, monId, 45, ((void *)0)))
    {
        return StringCopyPadded(dst, gText_EggNickname, 0, 12);
    }
    else
    {
        GetBoxOrPartyMonData(boxId, monId, 2, dst);
        StringGetEnd10(dst);
        species = GetBoxOrPartyMonData(boxId, monId, 11, ((void *)0));
        if (boxId == 14)
        {
        ...
        if ((species == 29 || species == 32) && !StringCompare(dst, gSpeciesNames[species]))
            gender = 0xFF;

        for (str = dst; *str != 0xFF; str++)
            ;
...
void GetConditionMenuMonConditions(struct ConditionGraph *graph, u8 *sheen, u16 boxId, u16 monId, u16 partyId, u16 id, u16 numMons, bool8 excludesCancel)
{
    ...
    if (partyId != numMons)
    {
        graph->stat[id][0] = GetBoxOrPartyMonData(boxId, monId, 22, ((void *)0));
        graph->stat[id][1] = GetBoxOrPartyMonData(boxId, monId, 47, ((void *)0));
        graph->stat[id][2] = GetBoxOrPartyMonData(boxId, monId, 33, ((void *)0));
        graph->stat[id][3] = GetBoxOrPartyMonData(boxId, monId, 24, ((void *)0));
        graph->stat[id][4] = GetBoxOrPartyMonData(boxId, monId, 23, ((void *)0));

        sheen[id] = (GetBoxOrPartyMonData(boxId, monId, 48, ((void *)0)) != 0xFF)
                 ? GetBoxOrPartyMonData(boxId, monId, 48, ((void *)0)) / 29u
                 : 9;
...
void GetConditionMenuMonGfx(void *tilesDst, void *palDst, u16 boxId, u16 monId, u16 partyId, u16 numMons, bool8 excludesCancel)
{
    ...
    if (partyId != numMons)
    {
        u16 species = GetBoxOrPartyMonData(boxId, monId, 65, ((void *)0));
        u32 trainerId = GetBoxOrPartyMonData(boxId, monId, 1, ((void *)0));
        u32 personality = GetBoxOrPartyMonData(boxId, monId, 0, ((void *)0));

        LoadSpecialPokePic(&gMonFrontPicTable[species], tilesDst, species, personality, 1);
...
void LoadConditionMonPicTemplate(struct SpriteSheet *sheet, struct SpriteTemplate *template, struct SpritePalette *pal)
{
    struct SpriteSheet dataSheet = {((void *)0), 0x800, 100};
    ...
    struct SpritePalette dataPal = {((void *)0), 100};
...
void LoadConditionSelectionIcons(struct SpriteSheet *sheets, struct SpriteTemplate * template, struct SpritePalette *pals)
{
    ...
    for (i = 0; i < (size_t)(sizeof(dataSheets) / sizeof((dataSheets)[0])); i++)
        *(sheets++) = dataSheets[i];

    *template = dataTemplate;

    for (i = 0; i < (size_t)(sizeof(dataPals) / sizeof((dataPals)[0])); i++)
        *(pals++) = dataPals[i];
}
# 1231 "src/menu_specialized.c"
void LoadConditionSparkle(struct SpriteSheet *sheet, struct SpritePalette *pal)
{
    struct SpriteSheet dataSheet = {sConditionSparkle_Pal, 0x380, 104};
    struct SpritePalette dataPal = {sConditionSparkle_Gfx, 104};
...
static const s16 sConditionSparkleCoords[10][2] =
{
    { 0, -35},
    { 20, -28},
    { 33, -10},
...
{
    struct Sprite *mon = &gSprites[sprite->data[4]];

    if (mon != ((void *)0))
    {
        sprite->pos1.x = mon->pos1.x + mon->pos2.x + sConditionSparkleCoords[sprite->data[0]][0];
        sprite->pos1.y = mon->pos1.y + mon->pos2.y + sConditionSparkleCoords[sprite->data[0]][1];
    }
    else
    {
        sprite->pos1.x = sConditionSparkleCoords[sprite->data[0]][0] + 40;
        sprite->pos1.y = sConditionSparkleCoords[sprite->data[0]][1] + 104;
    }
}
...
void CreateConditionSparkleSprites(struct Sprite **sprites, u8 monSpriteId, u8 _count)
{
    ...
    InitConditionSparkles(count, 1, sprites);
}
...
static void ShowAllConditionSparkles(struct Sprite *sprite)
{
    ...
    for (i = 0; i < sprite->data[2] + 1; i++)
    {
        ...
        gSprites[id].invisible = 0;
        id = gSprites[id].data[5];
    }
}
# 1490 "src/menu_specialized.c"
...
void DrawLevelUpWindowPg1(u16 windowId, u16 *statsBefore, u16 *statsAfter, u8 bgClr, u8 fgClr, u8 shadowClr)
{
    ...
    FillWindowPixelBuffer(windowId, ((bgClr) | ((bgClr) << 4)));
...
void GetMonLevelUpWindowStats(struct Pokemon *mon, u16 *currStats)
{
    currStats[0] = GetMonData(mon, 58);
    currStats[1] = GetMonData(mon, 59);
    currStats[2] = GetMonData(mon, 60);
    currStats[3] = GetMonData(mon, 61);
    currStats[4] = GetMonData(mon, 62);
    currStats[5] = GetMonData(mon, 63);
}
