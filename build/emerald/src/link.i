...
# 4 "src/link.c" 2
# 1 "include/reset_save_heap.h" 1
# 10 "include/reset_save_heap.h"
...
static bool32 sDummy1;
static bool8 sDummy2;
static u32 sPlayerDataExchangeStatus;
static bool32 sDummy3;
...
u32 gLinkDebugFlags;
u32 gLinkFiller1;
bool8 gRemoteLinkPlayersNotReceived[4];
u8 gBlockReceivedStatus[4];
u32 gLinkFiller2;
u16 gLinkHeldKeys;
u16 gRecvCmds[5][8];
u32 gLinkStatus;
bool8 gLinkDummy1;
bool8 gLinkDummy2;
bool8 gReadyToExitStandby[4];
bool8 gReadyToCloseLink[4];
...
__attribute__((section("ewram_data"))) u8 gLinkTestDebugValuesEnabled = 0;
__attribute__((section("ewram_data"))) u8 gUnknown_020223BD = 0;
__attribute__((section("ewram_data"))) u32 gBerryBlenderKeySendAttempts = 0;
__attribute__((section("ewram_data"))) u16 gBlockRecvBuffer[5][0x100 / 2] = {};
__attribute__((section("ewram_data"))) u8 gBlockSendBuffer[0x100] = {};
__attribute__((section("ewram_data"))) bool8 gLinkOpen = 0;
__attribute__((section("ewram_data"))) u16 gLinkType = 0;
__attribute__((section("ewram_data"))) u16 gLinkTimeOutCounter = 0;
__attribute__((section("ewram_data"))) struct LinkPlayer gLocalLinkPlayer = {};
__attribute__((section("ewram_data"))) struct LinkPlayer gLinkPlayers[5] = {};
__attribute__((section("ewram_data"))) struct LinkPlayer gSavedLinkPlayers[5] = {};
__attribute__((section("ewram_data"))) struct {
    u32 status;
    u8 lastRecvQueueCount;
    u8 lastSendQueueCount;
    u8 unk_06;
} sLinkErrorBuffer = {};
static __attribute__((section("ewram_data"))) u16 sReadyCloseLinkAttempts = 0;
static __attribute__((section("ewram_data"))) void *sLinkErrorBgTilemapBuffer = ((void *)0);
...
static void DequeueRecvCmds(u16 (*recvCmds)[8]);
...
static const u8 sTextColors[] = { 0x0, 0x1, 0x2 };
...
static void InitLinkTestBG(u8 paletteNum, u8 bgNum, u8 screenBaseBlock, u8 charBaseBlock, u16 a4)
{
    ...
    {
        case 1:
            SetGpuReg(0xa, ((screenBaseBlock) << 8) | (1) | ((charBaseBlock) << 2));
            break;
        case 2:
            SetGpuReg(0xc, ((screenBaseBlock) << 8) | (1) | ((charBaseBlock) << 2));
            break;
        case 3:
            SetGpuReg(0xe, ((screenBaseBlock) << 8) | (1) | ((charBaseBlock) << 2));
            break;
    }
    SetGpuReg(0x10 + bgNum * 4, 0);
    SetGpuReg(0x12 + bgNum * 4, 0);
}
...
void sub_80094EC(u8 paletteNum, u8 bgNum, u8 screenBaseBlock, u8 charBaseBlock)
{
    ...
    SetGpuReg(sBGControlRegs[bgNum], ((screenBaseBlock) << 8) | ((charBaseBlock) << 2));
}
...
void LinkTestScreen(void)
{
    ...
    SetGpuReg(0x0, 0x0000 | 0x0040 | 0x0100 | 0x0400 | 0x1000);
...
void OpenLink(void)
{
    ...
    for (i = 0; i < 4; i++)
    {
        gRemoteLinkPlayersNotReceived[i] = 1;
...
static void LinkTestProcessKeyInput(void)
{
    ...
    {
        BeginNormalPaletteFade(0xFFFFFFFF, 0, 16, 0, ((2) | ((0) << 5) | ((0) << 10)));
    }
...
static void HandleReceiveRemoteLinkPlayer(u8 who)
{
    ...
    count = 0;
    gRemoteLinkPlayersNotReceived[who] = 0;
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        switch (gRecvCmds[i][0])
        {
            ...
            case 0x8888:
            {
                ...
                {
                    if (gRemoteLinkPlayersNotReceived[i] == 1)
                    {
                        struct LinkPlayerBlock *block;
                        struct LinkPlayer *linkPlayer;
...
{
    if (GetLinkPlayerCount() != 4 || AreAnyLinkPlayersUsingVersions(2, 1) < 0)
    {
        return 0;
    }
    return 1;
...
static void LinkTest_prnthexchar(char a0, u8 a1, u8 a2)
{
    ...
    vAddr = (u16 *)(0x6000000 + (0x800 * (gLinkTestBGInfo.screenBaseBlock)));
...
static void Task_PrintTestData(u8 taskId)
{
    ...
    LinkTest_prnthex((((gLinkStatus) & 0x0000001C) >> 2), 15, 10, 2);
...
void ClearSavedLinkPlayers(void)
{
    ...
    for (i = 0; i < 4; i++)
    {
        CpuSet(&gSavedLinkPlayers[i], ((void *)0), sizeof(struct LinkPlayer));
    }
}
...
static void CheckErrorStatus(void)
{
    if (gLinkOpen && (((gLinkStatus) & 0x0007F000) >> 12))
    {
...
void CB2_LinkError(void)
{
    ...
    InitBgsFromTemplates(0, sLinkErrorBgTemplates, (size_t)(sizeof(sLinkErrorBgTemplates) / sizeof((sLinkErrorBgTemplates)[0])));
    sLinkErrorBgTilemapBuffer = tilemapBuffer = Alloc(0x800);
...
static void sub_800B080(void)
{
    ...
    DecompressAndLoadBgGfxUsingHeap(1, sWirelessLinkDisplayGfx, 0, 0, 0);
...
{
    return ((*(vu16 *)(0x4000000 + 0x128)) & 0x04) != 0;
}

static bool8 IsSioMultiMaster(void)
{
    return ((*(vu16 *)(0x4000000 + 0x128)) & 0x8) && !((*(vu16 *)(0x4000000 + 0x128)) & 0x04);
}
...
bool8 HandleLinkConnection(void)
{
    ...
    if (gWirelessCommType == 0)
    {
        ...
        if ((gLinkStatus & 0x00000100) && sub_808766C() == 1)
        {
            return 1;
        }
    }
    else
    {
        ...
        if (sub_808766C() == 1)
        {
            if (r4 == 1 || IsRfuRecvQueueEmpty() || r5)
            {
                return 1;
            }
        }
...
static void EnableSerial(void)
{
    ...
    (*(vu16 *)(0x4000000 + 0x128)) = 0x2000;
    (*(vu16 *)(0x4000000 + 0x128)) |= 0x0003 | 0x4000;
    EnableInterrupts((1 << 7));
    (*(vu16 *)(0x4000000 + 0x12a)) = 0;
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, &gLink, 0x04000000 | 0x01000000 | ((sizeof(gLink))/(32/8) & 0x1FFFFF)); };
...
static void CheckMasterOrSlave(void)
{
    ...
    terminals = *(vu32 *)(0x4000000 + 0x128) & (0x0008 | 0x0004);
    if (terminals == 0x0008 && gLink.localId == 0)
    {
        gLink.isMaster = 8;
    }
    else
...
static void InitTimer(void)
{
    if (gLink.isMaster)
    {
        (*(vu16 *)(0x4000000 + 0x10c)) = -197;
        (*(vu16 *)(0x4000000 + 0x10e)) = 0x01 | 0x40;
        EnableInterrupts((1 << 6));
    }
}
...
static bool8 DoHandshake(void)
{
    ...
    *(u64 *)gLink.tempRecvBuffer = (*(vu64 *)(0x4000000 + 0x120));
    (*(vu64 *)(0x4000000 + 0x120)) = 0;
    gLink.handshakeAsMaster = 0;
    for (i = 0; i < 4; i++)
    {
        if ((gLink.tempRecvBuffer[i] & ~0x3) == 0xB9A0 || gLink.tempRecvBuffer[i] == 0x8FFF)
        {
            playerCount++;
    ...
    if (gLink.playerCount > 1 && gLink.playerCount == sHandshakePlayerCount && gLink.tempRecvBuffer[0] == 0x8FFF)
    {
        return 1;
    }
