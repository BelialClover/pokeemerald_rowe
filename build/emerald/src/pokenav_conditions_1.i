# 0 "src/pokenav_conditions_1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/pokenav_conditions_1.c"
...
# 2 "src/pokenav_conditions_1.c" 2
# 1 "include/data.h" 1
...
# 3 "src/pokenav_conditions_1.c" 2
...
# 4 "src/pokenav_conditions_1.c" 2
# 1 "include/main.h" 1
...
# 5 "src/pokenav_conditions_1.c" 2
...
# 6 "src/pokenav_conditions_1.c" 2
...
# 7 "src/pokenav_conditions_1.c" 2
...
# 8 "src/pokenav_conditions_1.c" 2
# 1 "include/pokemon.h" 1
# 9 "src/pokenav_conditions_1.c" 2
# 1 "include/pokemon_storage_system.h" 1
# 10 "src/pokenav_conditions_1.c" 2
# 1 "include/sound.h" 1
...
# 11 "src/pokenav_conditions_1.c" 2
...
# 12 "src/pokenav_conditions_1.c" 2
...
# 13 "src/pokenav_conditions_1.c" 2

# 1 "include/constants/songs.h" 1
# 15 "src/pokenav_conditions_1.c" 2
...
u32 ConditionMenu_OpenMarkingsMenu(struct PokenavSub11 *structPtr)
{
    ...
    if (!MonMarkingsMenuHandleInput())
    {
        ...
        if (boxId == 14)
            SetMonData(&gPlayerParty[monId], 8, &markings);
        else
            SetBoxMonDataAt(boxId, monId, 8, &markings);
...
u8 *CopyMonConditionNameGender(u8 *str, u16 id, bool8 arg3)
{
    ...
    *(str++) = 0x9;
    ...
    if (GetBoxOrPartyMonData(boxId, monId, 45, ((void *)0)))
        return StringCopyPadded(str, gText_EggNickname, 0x00, 12);

    GetBoxOrPartyMonData(boxId, monId, 2, str);
    StringGetEnd10(str);
    ...
    if ((species == 29 || species == 32) && !StringCompare(str, gSpeciesNames[species]))
        gender = 0xFF;
...
void CopyMonNameGenderLocation(s16 id, u8 arg1)
{
    ...
    {
        CopyMonConditionNameGender(structPtr->nameBuffer[arg1], id, 0);
        boxId = monListPtr->monData[id].boxId;
        structPtr->searchLocBuffer[arg1][0] = 0xFC;
        structPtr->searchLocBuffer[arg1][1] = 0x04;
        structPtr->searchLocBuffer[arg1][2] = 0x8;
        structPtr->searchLocBuffer[arg1][3] = 0x0;
        structPtr->searchLocBuffer[arg1][4] = 0x9;
        if (boxId == 14)
    ...
    {
        for (i = 0; i < 12; i++)
            structPtr->nameBuffer[arg1][i] = 0x00;
        structPtr->nameBuffer[arg1][i] = 0xFF;

        for (i = 0; i < 8; i++)
            structPtr->searchLocBuffer[arg1][i] = 0x00;
        structPtr->searchLocBuffer[arg1][i] = 0xFF;
    }
}
...
void GetMonConditionGraphData(s16 id, u8 arg1)
{
    ...
    if (id != (IsConditionMenuSearchMode() != 0 ? monListPtr->listCount : monListPtr->listCount - 1))
    {
        boxId = monListPtr->monData[id].boxId;
        monId = monListPtr->monData[id].monId;
        structPtr->conditionData.stat[arg1][0] = GetBoxOrPartyMonData(boxId, monId, 22, ((void *)0));
        structPtr->conditionData.stat[arg1][1] = GetBoxOrPartyMonData(boxId, monId, 47, ((void *)0));
        structPtr->conditionData.stat[arg1][2] = GetBoxOrPartyMonData(boxId, monId, 33, ((void *)0));
        structPtr->conditionData.stat[arg1][3] = GetBoxOrPartyMonData(boxId, monId, 24, ((void *)0));
        structPtr->conditionData.stat[arg1][4] = GetBoxOrPartyMonData(boxId, monId, 23, ((void *)0));
        structPtr->sheen[arg1] = (GetBoxOrPartyMonData(boxId, monId, 48, ((void *)0)) != 255)
                                 ? GetBoxOrPartyMonData(boxId, monId, 48, ((void *)0)) / 29u
                                 : 9;
        structPtr->monMarks[arg1] = GetBoxOrPartyMonData(boxId, monId, 8, ((void *)0));
...
void ConditionGraphDrawMonPic(s16 index, u8 arg1)
{
    ...
    species = GetBoxOrPartyMonData(boxId, monId, 65, ((void *)0));
    tid = GetBoxOrPartyMonData(boxId, monId, 1, ((void *)0));
    personality = GetBoxOrPartyMonData(boxId, monId, 0, ((void *)0));
    LoadSpecialPokePic(&gMonFrontPicTable[species], structPtr->monPicGfx[arg1], species, personality, 1);
