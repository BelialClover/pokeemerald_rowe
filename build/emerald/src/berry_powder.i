# 0 "src/berry_powder.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/berry_powder.c"
...
# 11 "src/berry_powder.c" 2




static __attribute__((section("ewram_data"))) u8 sBerryPowderVendorWindowId = 0;
...
static void PrintBerryPowderAmount(u8 windowId, int amount, u8 x, u8 y, u8 speed)
{
    ...
    AddTextPrinterParameterized(windowId, 1, gStringVar1, x, y, speed, ((void *)0));
}

static void DrawPlayerPowderAmount(u8 windowId, u16 baseTileOffset, u8 paletteNum, u32 amount)
{
    DrawStdFrameWithCustomTileAndPalette(windowId, 0, baseTileOffset, paletteNum);
    AddTextPrinterParameterized(windowId, 1, gText_Powder, 0, 1, 0xFF, ((void *)0));
...
void DisplayBerryPowderVendorMenu(void)
{
    ...
    FillWindowPixelBuffer(sBerryPowderVendorWindowId, ((0) | ((0) << 4)));
