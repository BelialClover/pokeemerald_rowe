# 0 "src/script_movement.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/script_movement.c"
...
static __attribute__((section("ewram_data"))) const u8 *gMovementScripts[16] = {0};
...
static bool8 ScriptMovement_TryAddNewMovement(u8 taskId, u8 objEventId, const u8 *movementScript)
{
    ...
    moveScrId = GetMovementScriptIdFromObjectEventId(taskId, 0xFF);
    if (moveScrId == 16)
    {
        return 1;
    }
