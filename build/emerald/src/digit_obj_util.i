# 0 "src/digit_obj_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/digit_obj_util.c"
...
static __attribute__((section("ewram_data"))) struct DigitPrinterAlloc *sOamWork = {0};
...
static void CopyWorkToOam(struct DigitPrinter *objWork)
{
    ...
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, &gMain.oamBuffer[oamId], 0x00000000 | 0x01000000 | ((sizeof(struct OamData) * oamCount)/(16/8) & 0x1FFFFF)); };
