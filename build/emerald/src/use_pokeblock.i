...
struct UsePokeblockSession
{
    ...
    u8 unused2;
    bool8 monInTopHalf;
    u8 conditionsBeforeBlock[5];
    u8 conditionsAfterBlock[5];
    u8 enhancements[5];
    s16 pokeblockStatBoosts[5];
    u8 numSelections;
    u8 curSelection;
...
{
    u32 unused;
    u16 partyPalettes[6][0x40];
    u8 partySheets[3][0x2000];
    u8 unusedBuffer[0x1000];
    u8 tilemapBuffer[0x800 + 2];
    u8 selectionIconSpriteIds[6 + 1];
    s16 curMonXOffset;
    u8 curMonSpriteId;
    u16 curMonPalette;
    u16 curMonSheet;
    u8 *curMonTileStart;
    struct Sprite *sparkles[10];
    struct Sprite *condition[2];
    u8 toLoadSelection;
    u8 locationStrings[3][24];
    u8 monNameStrings[3][64];
    ...
    s8 prevLoadId;
    s8 toLoadId;
    struct UsePokeblockMenuPokemon party[6];
...
static __attribute__((section("ewram_data"))) struct UsePokeblockSession *sInfo = ((void *)0);
static __attribute__((section("ewram_data"))) void (*sExitCallback)(void) = ((void *)0);
static __attribute__((section("ewram_data"))) struct Pokeblock *sPokeblock = ((void *)0);
__attribute__((section("ewram_data"))) u8 gPokeblockMonId = 0;
__attribute__((section("ewram_data"))) s16 gPokeblockGain = 0;
static __attribute__((section("ewram_data"))) u8 *sGraph_Tilemap = ((void *)0);
static __attribute__((section("ewram_data"))) u8 *sGraph_Gfx = ((void *)0);
static __attribute__((section("ewram_data"))) u8 *sMonFrame_TilemapPtr = ((void *)0);
static __attribute__((section("ewram_data"))) struct UsePokeblockMenu *sMenu = ((void *)0);
...
static const u32 sMonDataConditions[5] =
{
    22,
    47,
    33,
...
static const s16 sUpDownCoordsOnGraph[5][2] =
{
    {156, 36},
    {117, 59},
    {117, 118},
...
static void CB2_ReturnAndChooseMonToGivePokeblock(void)
{
    ...
    sInfo->monInTopHalf = (gPokeblockMonId <= 6 / 2) ? 0 : 1;
    SetUsePokeblockCallback(LoadUsePokeblockMenu);
...
static void FeedPokeblockToMon(void)
{
    ...
    case 1:
        ...
        {
            SetVBlankCallback(((void *)0));
            { Free(sGraph_Tilemap); sGraph_Tilemap = ((void *)0); };
            { Free(sGraph_Gfx); sGraph_Gfx = ((void *)0); };
            { Free(sMonFrame_TilemapPtr); sMonFrame_TilemapPtr = ((void *)0); };
            { Free(sMenu); sMenu = ((void *)0); };
...
static void ShowPokeblockResults(void)
{
    ...
    case 4:
        ...
        break;
    case 5:
        if (({(gMain.newKeys) & (0x0001 | 0x0002);}) && !TryPrintNextEnhancement())
        {
...
static void CloseUsePokeblockMenu(void)
{
    ...
    case 3:
        ...
        for (i = 0; i < (size_t)(sizeof(sMenu->selectionIconSpriteIds) / sizeof((sMenu->selectionIconSpriteIds)[0])); i++)
        ...
        for (i = 0; i < (size_t)(sizeof(sMenu->condition) / sizeof((sMenu->condition)[0])); i++)
...
static void AskUsePokeblock(void)
{
    ...
    GetMonData(&gPlayerParty[GetPartyIdFromSelectionId(sMenu->info.curSelection)], 2, stringBuffer);
    ...
    AddTextPrinterParameterized(WIN_TEXT, 1, gStringVar4, 0, 1, 0, ((void *)0));
...
static void PrintFirstEnhancement(void)
{
    ...
    for (sInfo->statId = 0; sInfo->statId < 5; sInfo->statId++)
    {
...
static void PrintWontEatAnymore(void)
{
    FillWindowPixelBuffer(WIN_TEXT, 17);
    DrawTextBorderOuter(WIN_TEXT, 151, 14);
    AddTextPrinterParameterized(WIN_TEXT, 1, gText_WontEatAnymore, 0, 1, 0, ((void *)0));
    PutWindowTilemap(WIN_TEXT);
    CopyWindowToVram(WIN_TEXT, 3);
}
...
static void UpdateMonPic(u8 loadId)
{
    ...
    if (sMenu->curMonSpriteId == 0xFF)
    {
        ...
        else
        {
            ...
            sMenu->curMonTileStart = (void*)((0x6000000 + 0x10000) + (sMenu->curMonSheet * 32));
...
static bool8 LoadUsePokeblockMenuGfx(void)
{
    ...
    case 0:
        ...
        ChangeBgX(3, 0, 0);
        ChangeBgY(3, 136 << 6, 0);
        SetGpuReg(0x0, 0x0040 | 0x1000 | 0x2000 | 0x4000);
...
static void UpdateMonInfoText(u16 loadId, bool8 firstPrint)
{
    ...
    FillWindowPixelBuffer(WIN_NAME, ((0) | ((0) << 4)));
    FillWindowPixelBuffer(WIN_NATURE, ((0) | ((0) << 4)));
    if (sMenu->info.curSelection != sMenu->info.numSelections - 1)
    {
        AddTextPrinterParameterized(WIN_NAME, 1, sMenu->monNameStrings[loadId], 0, 1, 0, ((void *)0));
        partyIndex = GetPartyIdFromSelectionId(sMenu->info.curSelection);

  nature = GetNature(&gPlayerParty[partyIndex], 0);
...
static bool8 LoadNewSelection_CancelToMon(void)
{
    ...
    case 0:
        ...
        break;
    case 1:
        UpdateMonInfoText(sMenu->curLoadId, 0);
        sMenu->info.helperState++;
        break;
    case 2:
