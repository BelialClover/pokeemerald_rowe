...
static __attribute__((section("ewram_data"))) u8 sStartMenuWindowId = 0;
static __attribute__((section("ewram_data"))) u8 sMapNamePopupWindowId = 0;
static __attribute__((section("ewram_data"))) struct Menu sMenu = {0};
static __attribute__((section("ewram_data"))) u16 sTileNum = 0;
static __attribute__((section("ewram_data"))) u8 sPaletteNum = 0;
static __attribute__((section("ewram_data"))) u8 sYesNoWindowId = 0;
static __attribute__((section("ewram_data"))) u8 sWindowId = 0;
static __attribute__((section("ewram_data"))) u16 sFiller = 0;
static __attribute__((section("ewram_data"))) bool8 sScheduledBgCopiesToVram[4] = {0};
static __attribute__((section("ewram_data"))) u16 sTempTileDataBufferIdx = 0;
static __attribute__((section("ewram_data"))) void *sTempTileDataBuffer[0x20] = {((void *)0)};
...
const u8 sTextColors[] = { 0xF, 0x1, 0x2 };
...
void AddTextPrinterForMessage(bool8 allowSkippingDelayWithButtonPress)
{
    void (*callback)(struct TextPrinterTemplate *, u16) = ((void *)0);
...
{
    gTextFlags.canABSpeedUpPrint = allowSkippingDelayWithButtonPress;
    AddTextPrinterParameterized2(0, 1, gStringVar4, GetPlayerTextSpeedDelay(), ((void *)0), 2, 1, 3);
}

void AddTextPrinterWithCustomSpeedForMessage(bool8 allowSkippingDelayWithButtonPress, u8 speed)
{
    gTextFlags.canABSpeedUpPrint = allowSkippingDelayWithButtonPress;
    AddTextPrinterParameterized2(0, 1, gStringVar4, speed, ((void *)0), 2, 1, 3);
}

void LoadMessageBoxAndBorderGfx(void)
{
    LoadMessageBoxGfx(0, 0x200, 15 * 0x10);
    LoadUserWindowBorderGfx(0, 0x214, 14 * 0x10);
}
...
{
    FillBgTilemapBufferRect(bg, 0, tilemapLeft - 1, tilemapTop - 1, width + 2, height + 2, 14);
}

void WindowFunc_ClearDialogWindowAndFrame(u8 bg, u8 tilemapLeft, u8 tilemapTop, u8 width, u8 height, u8 paletteNum)
{
    FillBgTilemapBufferRect(bg, 0, tilemapLeft - 3, tilemapTop - 1, width + 6, height + 2, 14);
}
...
void sub_819786C(u8 windowId, bool8 copyToVram)
{
    LoadMessageBoxGfx(windowId, 0x200, 15 * 0x10);
    DrawDialogFrameWithCustomTileAndPalette(windowId, copyToVram, 0x200, 0xF);
}

void sub_819789C(void)
{
    LoadPalette(gUnknown_0860F074, 14 * 0x10, 0x14);
}
...
{
    LoadMessageBoxAndBorderGfx();
    DisplayMessageAndContinueTask(taskId, 0, 0x200, 15, 1, GetPlayerTextSpeedDelay(), string, callback);
    CopyWindowToVram(0, 3);
}

void DisplayYesNoMenuDefaultYes(void)
{
    CreateYesNoMenu(&sYesNo_WindowTemplates, 0x214, 14, 0);
}

void DisplayYesNoMenuWithDefault(u8 initialCursorPos)
{
    CreateYesNoMenu(&sYesNo_WindowTemplates, 0x214, 14, initialCursorPos);
}
...
void sub_8198180(const u8 *string, u8 a2, bool8 copyToVram)
{
    ...
    if (sWindowId != 0xFF)
    {
        ...
        FillWindowPixelBuffer(sWindowId, ((15) | ((15) << 4)));
...
void sub_8198314(void)
{
    if (sWindowId != 0xFF)
    {
        FillWindowPixelBuffer(sWindowId, ((0) | ((0) << 4)));
...
u8 Menu_InitCursorInternal(u8 windowId, u8 fontId, u8 left, u8 top, u8 cursorHeight, u8 numChoices, u8 initialCursorPos, u8 a7)
{
    s32 pos;
...
u8 sub_81983EC(u8 windowId, u8 fontId, u8 left, u8 top, u8 numChoices, u8 initialCursorPos)
{
    ...
    return Menu_InitCursor(windowId, fontId, left, top, cursorHeight, numChoices, initialCursorPos);
}
...
void RedrawMenuCursor(u8 oldPos, u8 newPos)
{
    ...
    FillWindowPixelRect(sMenu.windowId, ((1) | ((1) << 4)), sMenu.left, sMenu.optionHeight * oldPos + sMenu.top, width, height);
...
s8 ProcessMenuInput_other(void)
{
    ...
    else if ((({(gMain.newAndRepeatedKeys) & (((0x0010 | 0x0020 | 0x0040 | 0x0080)));})) == 0x0040)
    {
        PlaySE(5);
        Menu_MoveCursor(-1);
        return -2;
    }
    else if ((({(gMain.newAndRepeatedKeys) & (((0x0010 | 0x0020 | 0x0040 | 0x0080)));})) == 0x0080)
    {
        PlaySE(5);
        Menu_MoveCursor(1);
        return -2;
...
void PrintTextArray(u8 windowId, u8 fontId, u8 left, u8 top, u8 lineHeight, u8 itemCount, const struct MenuAction *strs)
{
    ...
    {
        AddTextPrinterParameterized(windowId, fontId, strs[i].text, left, (lineHeight * i) + top, 0xFF, ((void *)0));
    }
...
void sub_81987BC(u8 windowId, u8 fontId, u8 left, u8 top, u8 lineHeight, u8 itemCount, const struct MenuAction *strs, u8 a6, u8 a7)
{
    ...
    for (i = 0; i < itemCount; i++)
    {
        AddTextPrinterParameterized5(windowId, fontId, strs[i].text, left, (lineHeight * i) + top, 0xFF, ((void *)0), a6, a7);
    }
    CopyWindowToVram(windowId, 2);
}
...
void sub_8198AF8(const struct WindowTemplate *window, u8 fontId, u8 left, u8 top, u16 baseTileNum, u8 paletteNum, u8 initialCursorPos)
{
    ...
    Menu_InitCursor(sYesNoWindowId, fontId, left, top, GetFontAttribute(fontId, FONTATTR_MAX_LETTER_HEIGHT), 2, initialCursorPos);
}
...
void sub_8198C78(void)
{
    ClearStdWindowAndFrameToTransparent(sYesNoWindowId, 1);
...
void sub_8198C94(u8 windowId, u8 fontId, u8 left, u8 top, u8 a4, u8 a5, u8 a6, u8 a7, const struct MenuAction *strs)
{
    ...
    for (i = 0; i < a7; i++)
    {
        for (j = 0; j < a6; j++)
        {
            AddTextPrinterParameterized(windowId, fontId, strs[(i * a6) + j].text, (a4 * j) + left, (a5 * i) + top, 0xFF, ((void *)0));
        }
    }
    CopyWindowToVram(windowId, 2);
}
...
s8 sub_81993D8(void)
{
    ...
    else if ((({(gMain.newAndRepeatedKeys) & (((0x0010 | 0x0020 | 0x0040 | 0x0080)));})) == 0x0020 || GetLRKeysPressedAndHeld() == 1)
    {
        PlaySE(5);
        ChangeListMenuCursorPosition(-1, 0);
        return -2;
    }
    else if ((({(gMain.newAndRepeatedKeys) & (((0x0010 | 0x0020 | 0x0040 | 0x0080)));})) == 0x0010 || GetLRKeysPressedAndHeld() == 2)
    {
        PlaySE(5);
        ChangeListMenuCursorPosition(1, 0);
        return -2;
...
{
    return InitMenuInUpperLeftCorner(windowId, itemCount, initialCursorPos, 0);
}
...
void PrintMenuTable(u8 windowId, u8 itemCount, const struct MenuAction *strs)
{
    ...
    for (i = 0; i < itemCount; i++)
    {
        AddTextPrinterParameterized(windowId, 1, strs[i].text, 8, (i * 16) + 1, 0xFF, ((void *)0));
    }
...
void PrintMenuGridTable(u8 windowId, u8 optionWidth, u8 columns, u8 rows, const struct MenuAction *strs)
{
    ...
    {
        for (j = 0; j < columns; j++)
            AddTextPrinterParameterized(windowId, 1, strs[(i * columns) + j].text, (optionWidth * j) + 8, (i * 16) + 1, 0xFF, ((void *)0));
    }
    CopyWindowToVram(windowId, 2);
}
...
{
    sScheduledBgCopiesToVram[bgId] = 1;
}

void DoScheduledBgTilemapCopiesToVram(void)
{
    if (sScheduledBgCopiesToVram[0] == 1)
    {
        CopyBgTilemapBufferToVram(0);
    ...
    if (sScheduledBgCopiesToVram[2] == 1)
    {
        CopyBgTilemapBufferToVram(2);
        sScheduledBgCopiesToVram[2] = 0;
    }
    if (sScheduledBgCopiesToVram[3] == 1)
    {
...
{
    int i;
    for (i = 0; i < (int)(size_t)(sizeof(sTempTileDataBuffer) / sizeof((sTempTileDataBuffer)[0])); i++)
    {
        sTempTileDataBuffer[i] = ((void *)0);
    }
...
bool8 FreeTempTileDataBuffersIfPossible(void)
{
    ...
    if (!IsDma3ManagerBusyWithBgCopy())
    {
        if (sTempTileDataBufferIdx)
        {
            ...
            {
                { Free(sTempTileDataBuffer[i]); sTempTileDataBuffer[i] = ((void *)0); };
            }
            sTempTileDataBufferIdx = 0;
        }
        return 0;
...
{
    u32 sizeOut;
    if (sTempTileDataBufferIdx < (size_t)(sizeof(sTempTileDataBuffer) / sizeof((sTempTileDataBuffer)[0])))
    {
...
void sub_8199DF0(u32 bg, u8 a1, int a2, int a3)
{
    ...
    RequestDma3Fill(a1 << 24 | a1 << 16 | a1 << 8 | a1, addr + 0x6000000, a3 * temp, 1);
}
...
void AddTextPrinterParameterized3(u8 windowId, u8 fontId, u8 left, u8 top, const u8 *color, s8 speed, const u8 *str)
{
    ...
    AddTextPrinter(&printer, speed, ((void *)0));
}
...
void sub_819A25C(u8 palOffset, u16 speciesId, u8 formId)
{
    LoadPalette(GetValidMonIconPalettePtr(speciesId, formId), palOffset, 0x20);
}

void sub_819A27C(u8 windowId, u16 speciesId, u32 personality, u16 x, u16 y, u8 formId)
{
    BlitBitmapToWindow(windowId, GetMonIconPtr(speciesId, personality, 1, formId), x, y, 32, 32);
}
