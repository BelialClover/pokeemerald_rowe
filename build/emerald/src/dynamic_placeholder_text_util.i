# 0 "src/dynamic_placeholder_text_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/dynamic_placeholder_text_util.c"
...
# 2 "src/dynamic_placeholder_text_util.c" 2
# 1 "gflib/text.h" 1
# 272 "gflib/text.h"
enum
{
...
# 3 "src/dynamic_placeholder_text_util.c" 2
...
# 4 "src/dynamic_placeholder_text_util.c" 2
...
# 5 "src/dynamic_placeholder_text_util.c" 2

static __attribute__((section("ewram_data"))) const u8 *sStringPointers[8] = {};
...
void DynamicPlaceholderTextUtil_Reset(void)
{
    ...
    ptr = sStringPointers;
    fillval = ((void *)0);
    ptr2 = ptr + ((size_t)(sizeof(sStringPointers) / sizeof((sStringPointers)[0])) - 1);
    do
    {
        *ptr2-- = fillval;
...
void DynamicPlaceholderTextUtil_SetPlaceholderPtr(u8 idx, const u8 *ptr)
{
    if (idx < (size_t)(sizeof(sStringPointers) / sizeof((sStringPointers)[0])))
    {
