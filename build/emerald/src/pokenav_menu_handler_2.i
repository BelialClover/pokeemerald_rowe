# 0 "src/pokenav_menu_handler_2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/pokenav_menu_handler_2.c"
...
# 2 "src/pokenav_menu_handler_2.c" 2
# 1 "gflib/malloc.h" 1
# 15 "gflib/malloc.h"
extern u8 gHeap[];
...
# 3 "src/pokenav_menu_handler_2.c" 2
...
# 4 "src/pokenav_menu_handler_2.c" 2
# 1 "gflib/bg.h" 1
...
# 5 "src/pokenav_menu_handler_2.c" 2
...
# 6 "src/pokenav_menu_handler_2.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 7 "src/pokenav_menu_handler_2.c" 2
...
# 8 "src/pokenav_menu_handler_2.c" 2
# 1 "include/menu.h" 1
...
# 9 "src/pokenav_menu_handler_2.c" 2
...
# 11 "src/pokenav_menu_handler_2.c" 2
...
# 12 "src/pokenav_menu_handler_2.c" 2
# 1 "include/sound.h" 1
...
# 13 "src/pokenav_menu_handler_2.c" 2
...
# 14 "src/pokenav_menu_handler_2.c" 2
...
# 16 "src/pokenav_menu_handler_2.c" 2
...
# 17 "src/pokenav_menu_handler_2.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/pokenav_menu_handler_2.c" 2
# 1 "include/constants/rgb.h" 1
# 19 "src/pokenav_menu_handler_2.c" 2
...
static const u8 sOptionDescTextColors[] = {0x6, 0x8, 0x7};
static const u8 sOptionDescTextColors2[] = {0x6, 0x8, 0x7};
...
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0x10, .yScale = 0x10, .rotation = 0, .duration = 0x12}},
    {.type = 0x7FFF},
};
...
static u32 LoopedTask_OpenMenu(s32 state)
{
    ...
    {
    case 0:
        InitBgTemplates(sPokenavMainMenuBgTemplates, (size_t)(sizeof(sPokenavMainMenuBgTemplates) / sizeof((sPokenavMainMenuBgTemplates)[0])));
    ...
    case 8:
        ...
        {
        case POKENAV_MENU_TYPE_CONDITION_SEARCH:
            ShowLeftHeaderGfx(7, 0, 0);

        case POKENAV_MENU_TYPE_CONDITION:
            ShowLeftHeaderGfx(1, 0, 0);
            break;
        default:
...
static void LoadPokenavOptionPalettes(void)
{
    ...
    for (i = 0; i < (sizeof(sPokenavOptionsSpriteSheets)/sizeof(*(sPokenavOptionsSpriteSheets))); i++)
    ...
    for (i = 0; i < 6; i++)
    {
        if (*tiles != ((void *)0))
        {
            for (j = 0; j < 4; j++)
            {
                ...
                unk->iconSprites[i][j]->invisible = 1;
...
static void SetupCurrentMenuOptionsGfx(void)
{
    ...
    for (i = 0; i < 6; i++)
    {
        if (icons->iconVisible[i])
        {
            ...
            SetMenuOptionGfxInvisibility(icons->iconSprites[i], 0);
        }
        else
        {
            SetMenuOptionGfxInvisibility(icons->iconSprites[i], 1);
        }
    }
}
...
static void SetMenuOptionGfxParamsActive(struct Sprite ** sprites)
{
    ...
    for (i = 0; i < 4; i++)
    {
        (*sprites)->oam.objMode = 1;
        (*sprites)->oam.affineMode = 3;
...
static void sub_81CA580(u8 taskId)
{
    ...
    if (data[0] == 0)
    {
        ...
        case 0:
            data[2] = 16;
            data[3] = 0;
            SetGpuReg(0x50, (0 << 6) | (((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12) | (1 << 13)));
            SetGpuReg(0x52, (((0x00) << 8) | (0x10)));
            data[1]++;
            break;
        case 1:
...
static void CreateMatchCallBlueLightSprite(void)
{
    ...
    if (PlayerHasTrainerRematches())
        ...
        ptr->blueLightSpriteId->invisible = 1;
}
...
static void AddOptionDescriptionWindow(void)
{
    ...
    FillWindowPixelBuffer(ptr->optionDescWindowId, ((6) | ((6) << 4)));
...
static void SetupPokenavMenuScanlineEffects(void)
{
    SetGpuReg(0x50, (1 << 4) | (2 << 6));
    SetGpuReg(0x54, 0);
    SetGpuRegBits(0x0, 0x2000);
    SetGpuRegBits(0x48, 0x3F);
    SetGpuRegBits(0x4a, 0x1F);
    SetGpuRegBits(0x44, 0xA0);
    ScanlineEffect_Stop();
    SetMenuOptionGlow();
...
static void Task_CurrentMenuOptionGlow(u8 taskId)
{
    ...
    if (data[0] > 0)
    {
        ...
        data[1] += 3;
        data[1] &= 0x7F;
        SetGpuReg(0x54, gSineTable[data[1]] >> 5);
    }
}
...
static void SetMenuOptionGlow(void)
{
    ...
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, gScanlineEffectRegBuffers[0], 0x00000000 | 0x01000000 | ((0x140)/(16/8) & 0x1FFFFF)); };
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, gScanlineEffectRegBuffers[1], 0x00000000 | 0x01000000 | ((0x140)/(16/8) & 0x1FFFFF)); };
    { vu16 tmp = (vu16)(((16) | ((23) << 5) | ((28) << 10))); CpuSet((void *)&tmp, &gScanlineEffectRegBuffers[0][r4], 0x00000000 | 0x01000000 | ((0x20)/(16/8) & 0x1FFFFF)); };
    { vu16 tmp = (vu16)(((16) | ((23) << 5) | ((28) << 10))); CpuSet((void *)&tmp, &gScanlineEffectRegBuffers[1][r4], 0x00000000 | 0x01000000 | ((0x20)/(16/8) & 0x1FFFFF)); };
}
