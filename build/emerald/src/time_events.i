...
# 5 "src/time_events.c" 2
# 1 "include/pokemon.h" 1
# 6 "src/time_events.c" 2
...
# 11 "src/time_events.c" 2
# 1 "include/constants/species.h" 1
# 12 "src/time_events.c" 2

static u32 GetMirageRnd(void)
{
    u32 hi = VarGet(0x4024);
    u32 lo = VarGet(0x4025);
    return (hi << 16) | lo;
}
...
{
    *GetVarPointer(0x4049) = 0;
}

void UpdateBirchState(u16 days)
{
    u16 *state = GetVarPointer(0x4049);
    *state += days;
    *state %= 7;
}
