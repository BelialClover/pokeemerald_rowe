# 0 "src/save_location.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/save_location.c"
...
static const u16 sSaveLocationReloadLocList[] =
{
    (5 | (26 << 8)),
    0xFFFF,
};
