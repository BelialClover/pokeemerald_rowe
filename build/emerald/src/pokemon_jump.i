...
# 25 "src/pokemon_jump.c" 2
# 1 "include/task.h" 1
# 26 "src/pokemon_jump.c" 2
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 28 "src/pokemon_jump.c" 2
# 1 "include/pokemon.h" 1
# 29 "src/pokemon_jump.c" 2
...
# 30 "src/pokemon_jump.c" 2
# 1 "include/constants/rgb.h" 1
# 31 "src/pokemon_jump.c" 2
# 1 "include/constants/songs.h" 1
# 32 "src/pokemon_jump.c" 2
...
struct PokemonJump2
{
    ...
    u8 txtBuff[2][0x40];
    u8 strBuff[0x100];
    u16 tilemapBuffer[(0x81a8 - 0x1a6) / 2];
    struct Sprite *unk81A8[5];
    struct Sprite *unk81BC[5];
...
__attribute__((section("ewram_data"))) static struct PokemonJump1 *gUnknown_02022CFC = ((void *)0);
__attribute__((section("ewram_data"))) static struct PokemonJump2 *gUnknown_02022D00 = ((void *)0);
...
{
    u32 i;
    for (i = 0; i < (size_t)(sizeof(gPkmnJumpSpecies) / sizeof((gPkmnJumpSpecies)[0])); i++)
    {
...
static bool32 sub_802BA58(void)
{
    ...
    case 5:
        ...
        if (({(gMain.newKeys) & (0x0001 | 0x0002);}) || gUnknown_02022CFC->unk3C > 180)
        {
            sub_802DA14();
            gUnknown_02022CFC->unkA++;
        }
...
static void sub_802BF7C(void)
{
    ...
    else
    {
        if (!(gUnknown_02022CFC->unk50 & 8))
        {
            ...
            gUnknown_02022CFC->unk4E = gUnknown_082FB64C[sub_802C098() % (size_t)(sizeof(gUnknown_082FB64C) / sizeof((gUnknown_082FB64C)[0]))] + 2;
...
static int sub_802C098(void)
{
    gUnknown_02022CFC->unk24 = (1103515245 * (gUnknown_02022CFC->unk24) + 24691);
...
static const u16 gUnknown_082FB654[] = {95, 102, 228, 261};
...
static void sub_802C43C(void)
{
    if (gUnknown_02022CFC->unk14 == 8 && gUnknown_02022CFC->unk18 == 7)
    {
        ...
        else
        {
            ...
            if (gUnknown_02022CFC->unk54 > 1)
            {
                ...
                memcpy(gUnknown_02022CFC->unk86, gUnknown_02022CFC->unk81, sizeof(u8) * 5);
            }
    ...
    if (gUnknown_02022CFC->unk64 && (sub_802C618() == 1 || !gUnknown_02022CFC->unk14))
    {
    ...
    if (gUnknown_02022CFC->unk58)
    {
        ...
        if (var1 > gUnknown_02022CFC->unk54)
        {
            ...
            memcpy(gUnknown_02022CFC->unk81, gUnknown_02022CFC->unk7C, sizeof(u8) * 5);
        }
    }
}
...
static u16 sub_802C818(void)
{
    u16 index = Random() % (size_t)(sizeof(gUnknown_082FB704) / sizeof((gUnknown_082FB704)[0]));
...
static void sub_802C974(struct PokemonJump2 *arg0)
{
    ...
    for (i = 0; i < (size_t)(sizeof(gUnknown_082FBE08) / sizeof((gUnknown_082FBE08)[0])); i++)
        LoadCompressedSpriteSheet(&gUnknown_082FBE08[i]);

    for (i = 0; i < (size_t)(sizeof(gUnknown_082FBE30) / sizeof((gUnknown_082FBE30)[0])); i++)
...
static void sub_802C9D4(struct PokemonJump2 *arg0, struct PokemonJump1_MonInfo *jumpMon, s16 x, s16 y, u8 multiplayerId)
{
    ...
    arg0->unk81A8[multiplayerId] = ((void *)0);
}
...
static void sub_802D0C8(int arg0)
{
    ...
    for (i = 0; i < (size_t)(sizeof(gUnknown_082FE18C) / sizeof((gUnknown_082FE18C)[0])); i++)
    {
...
static void sub_802D150(void)
{
    ...
    case 0:
        ...
        InitBgsFromTemplates(0, gUnknown_082FE164, (size_t)(sizeof(gUnknown_082FE164) / sizeof((gUnknown_082FE164)[0])));
...
static void sub_802D448(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(gUnknown_02022D00->unk12, 1, gText_WantToPlayAgain2, 0, 1, 0xFF, ((void *)0));
...
static void sub_802D4F4(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(gUnknown_02022D00->unk12, 1, gText_SavingDontTurnOffPower, 0, 1, 0xFF, ((void *)0));
        CopyWindowToVram(gUnknown_02022D00->unk12, 2);
        gUnknown_02022D00->unk4++;
        break;
    case 1:
...
static void sub_802D5E4(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(gUnknown_02022D00->unk12, 1, gText_SomeoneDroppedOut2, 0, 1, 0xFF, ((void *)0));
        CopyWindowToVram(gUnknown_02022D00->unk12, 2);
        gUnknown_02022D00->unk4++;
        break;
    case 1:
...
static void sub_802D688(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(gUnknown_02022D00->unk12, 1, gText_CommunicationStandby4, 0, 1, 0xFF, ((void *)0));
        CopyWindowToVram(gUnknown_02022D00->unk12, 2);
        gUnknown_02022D00->unk4++;
        break;
    case 1:
...
static void sub_802DD08(void)
{
    ...
    struct DigitObjUtilTemplate *ptr = &template;

    ptr->shape = (((0 << 2) | (0)) & 0x03);
    ptr->size = ((((0 << 2) | (0)) >> 2) & 0x03);
    ptr->strConvMode = 0;
    ptr->priority = 1;
    ptr->oamCount = 5;
    ptr->xDelta = 8;
...
# 3842 "src/pokemon_jump.c"
void ResetPokeJumpResults(void)
{
# 3853 "src/pokemon_jump.c"
}
...
static void Task_ShowPokemonJumpRecords(u8 taskId)
{
    ...
    case 0:
        ...
        for (i = 0; i < (size_t)(sizeof(gUnknown_082FE278) / sizeof((gUnknown_082FE278)[0])); i++)
        {
...
static void sub_802E500(u16 windowId, int width)
{
    ...
    AddTextPrinterParameterized(windowId, 1, gText_PkmnJumpRecords, GetStringCenterAlignXOffset(1, gText_PkmnJumpRecords, width * 8), 1, 0xFF, ((void *)0));
    for (i = 0; i < (size_t)(sizeof(gUnknown_082FE278) / sizeof((gUnknown_082FE278)[0])); i++)
    {
        AddTextPrinterParameterized(windowId, 1, gUnknown_082FE278[i], 0, 25 + (i * 16), 0xFF, ((void *)0));
        ...
        AddTextPrinterParameterized(windowId, 1, gStringVar1, x, 25 + (i * 16), 0xFF, ((void *)0));
    }
