# 0 "src/fldeff_escalator.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/fldeff_escalator.c"
...
# 7 "src/fldeff_escalator.c" 2
# 1 "include/constants/metatile_labels.h" 1
# 8 "src/fldeff_escalator.c" 2

static __attribute__((section("ewram_data"))) u8 sEscalatorAnim_TaskId = 0;
...
static const u16 sEscalatorMetatiles_1F_0[3] = {
    0x284,
    0x282,
    0x280
};

static const u16 sEscalatorMetatiles_1F_1[3] = {
    0x285,
    0x283,
    0x281
};

static const u16 sEscalatorMetatiles_1F_2[3] = {
    0x28C,
    0x28A,
    0x288
};

static const u16 sEscalatorMetatiles_1F_3[3] = {
    0x28D,
    0x28B,
    0x289
};

static const u16 sEscalatorMetatiles_2F_0[3] = {
    0x2A0,
    0x2A2,
    0x2A4
};

static const u16 sEscalatorMetatiles_2F_1[3] = {
    0x2A1,
    0x2A3,
    0x2A5
};

static const u16 sEscalatorMetatiles_2F_2[3] = {
    0x2A8,
    0x2AA,
    0x2AC
};
# 68 "src/fldeff_escalator.c"
static void SetEscalatorMetatile(u8 taskId, const s16 *metatileIds, u16 metatileMasks)
{
    s16 x = gTasks[taskId].data[4] - 1;
    s16 y = gTasks[taskId].data[5] - 1;
    s16 transitionStage = gTasks[taskId].data[1];
    s16 i;
    s16 j;
...
bool8 IsEscalatorMoving(void)
{
    if (gTasks[sEscalatorAnim_TaskId].data[3] == 0
     && gTasks[sEscalatorAnim_TaskId].data[1] == (3 - 1))
        return 0;
    else
        return 1;
}
