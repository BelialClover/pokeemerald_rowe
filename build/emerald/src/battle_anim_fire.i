# 0 "src/battle_anim_fire.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_anim_fire.c"
...
# 3 "src/battle_anim_fire.c" 2
# 1 "include/constants/rgb.h" 1
# 4 "src/battle_anim_fire.c" 2
# 1 "include/constants/songs.h" 1
# 5 "src/battle_anim_fire.c" 2
# 1 "include/sound.h" 1
...
# 7 "src/battle_anim_fire.c" 2
# 1 "include/task.h" 1
# 8 "src/battle_anim_fire.c" 2
# 1 "include/trig.h" 1
...
{
    {.frame = {.xScale = 0x32, .yScale = 0x100, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0x20, .yScale = 0x0, .rotation = 0, .duration = 7}},
    {.type = 0x7FFF},
};
...
static const union AffineAnimCmd sAffineAnim_SunlightRay[] =
{
    ...
    {.frame = {.xScale = 0x2, .yScale = 0x2, .rotation = 10, .duration = 1}},
...
# 711 "src/battle_anim_fire.c"
static void AnimEmberFlare(struct Sprite *sprite)
{
    if (GetBattlerSide(gBattleAnimAttacker) == GetBattlerSide(gBattleAnimTarget)
        && (gBattleAnimAttacker == GetBattlerAtPosition(2)
            || gBattleAnimAttacker == GetBattlerAtPosition(3)))
