# 0 "src/recorded_battle.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/recorded_battle.c"
...
# 6 "src/recorded_battle.c" 2
# 1 "include/pokemon.h" 1
# 7 "src/recorded_battle.c" 2
...
# 15 "src/recorded_battle.c" 2
# 1 "include/task.h" 1
# 16 "src/recorded_battle.c" 2
# 1 "gflib/text.h" 1
# 272 "gflib/text.h"
enum
{
...
# 20 "src/recorded_battle.c" 2
# 1 "include/constants/rgb.h" 1
# 21 "src/recorded_battle.c" 2
# 29 "src/recorded_battle.c"
struct PlayerInfo
{
    u32 trainerId;
    u8 name[7 + 1];
...
{
    struct Pokemon playerParty[6];
    struct Pokemon opponentParty[6];
    u8 playersName[4][7 + 1];
    u8 playersGender[4];
    u32 playersTrainerId[4];
    u8 playersLanguage[4];
    u32 rngSeed;
    u32 battleFlags;
    u8 playersBattlers[4];
    u16 opponentA;
    u16 opponentB;
    u16 partnerId;
    u16 field_4FA;
    ...
    u8 textSpeed:3;
    u32 AI_scripts;
    u8 recordMixFriendName[7 + 1];
    u8 recordMixFriendClass;
    u8 apprenticeId;
    u16 easyChatSpeech[6];
    u8 recordMixFriendLanguage;
    u8 apprenticeLanguage;
    u8 battleRecord[4][664];
    u32 checksum;
};

__attribute__((section("ewram_data"))) u32 gRecordedBattleRngSeed = 0;
__attribute__((section("ewram_data"))) u32 gBattlePalaceMoveSelectionRngValue = 0;
__attribute__((section("ewram_data"))) static u8 sBattleRecords[4][664] = {0};
__attribute__((section("ewram_data"))) static u16 sRecordedBytesNo[4] = {0};
__attribute__((section("ewram_data"))) static u16 sUnknown_0203C79C[4] = {0};
__attribute__((section("ewram_data"))) static u16 sUnknown_0203C7A4[4] = {0};
__attribute__((section("ewram_data"))) static u8 sUnknown_0203C7AC = 0;
__attribute__((section("ewram_data"))) static u8 sLvlMode = 0;
__attribute__((section("ewram_data"))) static u8 sFrontierFacility = 0;
__attribute__((section("ewram_data"))) static u8 sFrontierBrainSymbol = 0;
__attribute__((section("ewram_data"))) static MainCallback sCallback2_AfterRecordedBattle = ((void *)0);
__attribute__((section("ewram_data"))) u8 gUnknown_0203C7B4 = 0;
__attribute__((section("ewram_data"))) static u8 sUnknown_0203C7B5 = 0;
__attribute__((section("ewram_data"))) static u8 sBattleScene = 0;
__attribute__((section("ewram_data"))) static u8 sTextSpeed = 0;
__attribute__((section("ewram_data"))) static u32 sBattleFlags = 0;
__attribute__((section("ewram_data"))) static u32 sAI_Scripts = 0;
__attribute__((section("ewram_data"))) static struct Pokemon sSavedPlayerParty[6] = {0};
__attribute__((section("ewram_data"))) static struct Pokemon sSavedOpponentParty[6] = {0};
__attribute__((section("ewram_data"))) static u16 sPlayerMonMoves[2][4] = {0};
__attribute__((section("ewram_data"))) static struct PlayerInfo sPlayers[4] = {0};
__attribute__((section("ewram_data"))) static u8 sUnknown_0203CCD0 = 0;
__attribute__((section("ewram_data"))) static u8 sRecordMixFriendName[7 + 1] = {0};
__attribute__((section("ewram_data"))) static u8 sRecordMixFriendClass = 0;
__attribute__((section("ewram_data"))) static u8 sApprenticeId = 0;
__attribute__((section("ewram_data"))) static u16 sEasyChatSpeech[6] = {0};
__attribute__((section("ewram_data"))) static u8 sBattleOutcome = 0;
...
void RecordedBattle_SetBattlerAction(u8 battlerId, u8 action)
{
    if (sRecordedBytesNo[battlerId] < 664 && sUnknown_0203C7AC != 2)
    {
...
u8 RecordedBattle_GetBattlerAction(u8 battlerId)
{
    ...
    if (sRecordedBytesNo[battlerId] >= 664 || sBattleRecords[battlerId][sRecordedBytesNo[battlerId]] == 0xFF)
    {
...
static bool32 IsRecordedBattleSaveValid(struct RecordedBattleSave *save)
{
    if (save->battleFlags == 0)
        return 0;
    if (save->battleFlags & (((1 << 1) | (1 << 7) | (1 << 4) | (1 << 9) | (1 << 10) | (1 << 11) | (1 << 12) | (1 << 13) | (1 << 14) | (1 << 24) | (1 << 26) | (1 << 27) | (1 << 28) | (1 << 29) | (1 << 30))))
        return 0;
...
static bool32 RecordedBattleToSave(struct RecordedBattleSave *battleSave, struct RecordedBattleSave *saveSection)
{
    ...
    if (TryWriteSpecialSaveSection(31, (void*)(saveSection)) != 1)
        return 0;
    else
        return 1;
}
...
{
    if (TryReadSpecialSaveSection(31, (void*)(saveBuffer)) != 1)
        return 0;
...
void PlayRecordedBattle(void (*CB2_After)(void))
{
    ...
    if (CopyRecordedBattleFromSave(battleSave) == 1)
    {
        u8 taskId;
    ...
    for (battlerId = 0; battlerId < gBattlersCount; battlerId++)
    {
        if (GetBattlerSide(battlerId) != 1)
        {
            if (arg0 == 1)
            {
                ...
                if (j != 4)
                {
                    RecordedBattle_SetBattlerAction(battlerId, 6);
                    for (j = 0; j < 4; j++)
                    {
                        for (k = 0; k < 4; k++)
                        {
            ...
            {
                if (sBattleRecords[battlerId][sRecordedBytesNo[battlerId]] == 6)
                {
                    u8 ppBonuses[4];
                    u8 array1[4];
                    u8 array2[4];
                    ...
                    if (!(gBattleMons[battlerId].status2 & (1 << 21)))
                    {
                        for (j = 0; j < 4; j++)
                        {
                            ppBonuses[j] = ((GetMonData(&gPlayerParty[gBattlerPartyIndexes[battlerId]], 21, ((void *)0)) & ((3 << (j << 1)))) >> (j << 1));
                        }
                        for (j = 0; j < 4; j++)
                        {
                            movePp.moves[j] = GetMonData(&gPlayerParty[gBattlerPartyIndexes[battlerId]], 13 + array1[j], ((void *)0));
                            movePp.pp[j] = GetMonData(&gPlayerParty[gBattlerPartyIndexes[battlerId]], 17 + array1[j], ((void *)0));
                            array3[j] = ppBonuses[array1[j]];
                        }
                        for (j = 0; j < 4; j++)
                        {
                            SetMonData(&gPlayerParty[gBattlerPartyIndexes[battlerId]], 13 + j, &movePp.moves[j]);
                            SetMonData(&gPlayerParty[gBattlerPartyIndexes[battlerId]], 17 + j, &movePp.pp[j]);
                        }
                        var = 0;
                        for (j = 0; j < 4; j++)
                        {
                        ...
                        SetMonData(&gPlayerParty[gBattlerPartyIndexes[battlerId]], 21, &var);
                    }
