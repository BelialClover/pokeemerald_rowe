# 0 "src/battle_anim_flying.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_anim_flying.c"
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 5 "src/battle_anim_flying.c" 2
# 1 "include/constants/battle_anim.h" 1
# 6 "src/battle_anim_flying.c" 2
# 1 "include/constants/rgb.h" 1
# 7 "src/battle_anim_flying.c" 2
...
void AnimFlyBallAttack(struct Sprite *sprite)
{
    ...
    sprite->data[3] = sprite->pos1.y;
    sprite->data[4] = GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_Y_PIC_OFFSET);
 sprite->data[5] = gBattleAnimArgs[1];
...
void AnimFlyBallAttack_Step(struct Sprite *sprite)
{
    ...
    {
        gSprites[GetAnimBattlerSpriteId(0)].invisible = sprite->data[5];
        DestroyAnimSprite(sprite);
    }
}
...
static void AnimWhirlwindLine(struct Sprite * sprite)
{
    ...
    if ((gBattleAnimArgs[2] == 0 && !GetBattlerSide(gBattleAnimAttacker))
