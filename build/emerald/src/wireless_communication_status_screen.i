# 0 "src/wireless_communication_status_screen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/wireless_communication_status_screen.c"
...
# 2 "src/wireless_communication_status_screen.c" 2
# 1 "include/task.h" 1
# 10 "include/task.h"
...
# 3 "src/wireless_communication_status_screen.c" 2
# 1 "gflib/bg.h" 1
...
# 4 "src/wireless_communication_status_screen.c" 2
...
# 5 "src/wireless_communication_status_screen.c" 2
...
# 6 "src/wireless_communication_status_screen.c" 2
# 1 "gflib/malloc.h" 1
# 15 "gflib/malloc.h"
extern u8 gHeap[];
...
# 7 "src/wireless_communication_status_screen.c" 2
...
# 8 "src/wireless_communication_status_screen.c" 2
# 1 "include/m4a.h" 1
...
# 9 "src/wireless_communication_status_screen.c" 2
...
# 10 "src/wireless_communication_status_screen.c" 2
...
# 11 "src/wireless_communication_status_screen.c" 2
...
# 12 "src/wireless_communication_status_screen.c" 2
...
# 13 "src/wireless_communication_status_screen.c" 2
...
# 14 "src/wireless_communication_status_screen.c" 2
# 1 "include/sound.h" 1
...
# 15 "src/wireless_communication_status_screen.c" 2
# 1 "include/menu.h" 1
# 16 "src/wireless_communication_status_screen.c" 2
...
# 17 "src/wireless_communication_status_screen.c" 2
...
void LoadWirelessStatusIndicatorSpriteGfx(void);
# 18 "src/wireless_communication_status_screen.c" 2
...
# 19 "src/wireless_communication_status_screen.c" 2
# 1 "include/constants/songs.h" 1
# 20 "src/wireless_communication_status_screen.c" 2
# 1 "include/constants/union_room.h" 1
# 21 "src/wireless_communication_status_screen.c" 2
...
# 37 "src/wireless_communication_status_screen.c"
struct WirelessCommunicationStatusScreen
{
    u32 groupCounts[4];
    u32 prevGroupCounts[4];
    u32 activities[16];
    u8 taskId;
    u8 rfuTaskId;
    u8 filler[10];
...
static const u8 *const sHeaderTexts[4 + 1] = {
    [0] = gText_WirelessCommStatus,
    [0 + 1] = gText_PeopleTrading,
    [1 + 1] = gText_PeopleBattling,
    [2 + 1] = gText_PeopleInUnionRoom,
    [3 + 1] = gText_PeopleCommunicating
};
...
static void CB2_ExitWirelessCommunicationStatusScreen(void)
{
    ...
    for (i = 0; i < (int)(size_t)(sizeof(sBgTemplates) / sizeof((sBgTemplates)[0])); i++)
    {
...
static void PrintHeaderTexts(void)
{
    ...
    for (i = 0; i < (int)(size_t)(sizeof(*sHeaderTexts) / sizeof((*sHeaderTexts)[0])) - 1; i++)
    {
...
static u32 CountPlayersInGroupAndGetActivity(struct UnkStruct_x20 * unk20, u32 * groupCounts)
{
    ...
    for (i = 0; i < (size_t)(sizeof(sActivityGroupInfo) / sizeof((sActivityGroupInfo)[0])); i++)
    {
        if (activity == (sActivityGroupInfo[(i)][0]) && unk20->groupScheduledAnim == 1)
        {
...
{
    bool32 activitiesChanged = 0;
    u32 groupCountBuffer[4] = {0, 0, 0, 0};
