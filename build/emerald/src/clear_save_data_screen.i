# 0 "src/clear_save_data_screen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/clear_save_data_screen.c"
...
# 2 "src/clear_save_data_screen.c" 2
# 1 "include/task.h" 1
# 10 "include/task.h"
...
# 3 "src/clear_save_data_screen.c" 2
# 1 "gflib/text.h" 1
# 272 "gflib/text.h"
enum
{
...
# 4 "src/clear_save_data_screen.c" 2
# 1 "include/menu.h" 1
...
# 5 "src/clear_save_data_screen.c" 2
# 1 "include/sound.h" 1
...
# 6 "src/clear_save_data_screen.c" 2
# 1 "include/main.h" 1
...
# 7 "src/clear_save_data_screen.c" 2
# 1 "include/save.h" 1
...
# 8 "src/clear_save_data_screen.c" 2
...
# 9 "src/clear_save_data_screen.c" 2
...
# 10 "src/clear_save_data_screen.c" 2
# 1 "gflib/bg.h" 1
...
# 11 "src/clear_save_data_screen.c" 2
...
# 12 "src/clear_save_data_screen.c" 2
# 1 "include/constants/songs.h" 1
# 13 "src/clear_save_data_screen.c" 2
# 1 "include/constants/rgb.h" 1
# 14 "src/clear_save_data_screen.c" 2
...
static bool8 SetupClearSaveDataScreen(void)
{
    ...
    default:
        ...
        gPlttBufferUnfaded[1] = ((5) | ((10) << 5) | ((14) << 10));
        gPlttBufferFaded[1] = ((5) | ((10) << 5) | ((14) << 10));
        for (i = 0; i < 0x10; i++)
            ((u16 *)(0x6000000 + 0x20))[i] = 0x1111;

        for (i = 0; i < 0x400; i++)
            ((u16 *)((0x6000000 + (0x800 * (30)))))[i] = 0x0001;
        ResetTasks();
        ResetSpriteData();
        ResetBgsAndClearDma3BusyFlags(0);
        InitBgsFromTemplates(0, sClearSaveBgTemplates, (size_t)(sizeof(sClearSaveBgTemplates) / sizeof((sClearSaveBgTemplates)[0])));
        SetGpuReg(0x0, 0x1000 | 0x0040);
        ShowBg(0);
        ShowBg(3);
        SetGpuReg(0x50, 0);
        InitClearSaveDataScreenWindows();
        BeginNormalPaletteFade(0x0000FFFF, 0, 0x10, 0, (((31) | ((31) << 5) | ((31) << 10)) | 0x8000));
...
static void CB2_FadeAndDoReset(void)
{
    ...
    case 0:
    default:
        BeginNormalPaletteFade(0x0000FFFF, 0, 0, 0x10, (((31) | ((31) << 5) | ((31) << 10)) | 0x8000));
        gMain.state = 1;
        break;
    case 1:
        UpdatePaletteFade();
