...
# 13 "src/egg_hatch.c" 2
# 1 "include/constants/songs.h" 1
# 14 "src/egg_hatch.c" 2
# 1 "gflib/text.h" 1
# 272 "gflib/text.h"
enum
{
...
# 38 "src/egg_hatch.c" 2
# 1 "include/constants/rgb.h" 1
# 39 "src/egg_hatch.c" 2
...
extern const u32 gUnknown_08331F60[];
...
{
    {((s16)((-1.5) * 256)), ((s16)((-3.75) * 256))},
    {((s16)((-5) * 256)), ((s16)((-3) * 256))},
    {((s16)((3.5) * 256)), ((s16)((-3) * 256))},
    {((s16)((-4) * 256)), ((s16)((-3.75) * 256))},
    {((s16)((2) * 256)), ((s16)((-1.5) * 256))},
    {((s16)((-0.5) * 256)), ((s16)((-6.75) * 256))},
    {((s16)((5) * 256)), ((s16)((-2.25) * 256))},
    {((s16)((-1.5) * 256)), ((s16)((-3.75) * 256))},
    {((s16)((4.5) * 256)), ((s16)((-1.5) * 256))},
    {((s16)((-1) * 256)), ((s16)((-6.75) * 256))},
    {((s16)((4) * 256)), ((s16)((-2.25) * 256))},
    {((s16)((-3.5) * 256)), ((s16)((-3.75) * 256))},
    {((s16)((1) * 256)), ((s16)((-1.5) * 256))},
    {((s16)((-3.515625) * 256)), ((s16)((-6.75) * 256))},
    {((s16)((4.5) * 256)), ((s16)((-2.25) * 256))},
    {((s16)((-0.5) * 256)), ((s16)((-7.5) * 256))},
    {((s16)((1) * 256)), ((s16)((-4.5) * 256))},
    {((s16)((-2.5) * 256)), ((s16)((-2.25) * 256))},
    {((s16)((2.5) * 256)), ((s16)((-7.5) * 256))},
};
...
static void CreateHatchedMon(struct Pokemon *egg, struct Pokemon *temp)
{
    ...
    species = GetMonData(egg, 11);
    formId = GetMonData(egg, 89);

    for (i = 0; i < 4; i++)
    {
        moves[i] = GetMonData(egg, 13 + i);
    }

    personality = GetMonData(egg, 0);

    for (i = 0; i < 6; i++)
    {
        ivs[i] = GetMonData(egg, 39 + i);
    }

    language = GetMonData(egg, 3);
    gameMet = GetMonData(egg, 37);
    markings = GetMonData(egg, 8);
    pokerus = GetMonData(egg, 34);
    obedience = GetMonData(egg, 80);

    CreateMon(temp, species, 1, 32, 1, personality, 0, 0, formId);

    for (i = 0; i < 4; i++)
    {
        SetMonData(temp, 13 + i, &moves[i]);
    }

    for (i = 0; i < 6; i++)
    {
        SetMonData(temp, 39 + i, &ivs[i]);
    }

    language = (2);
    SetMonData(temp, 3, &language);
    SetMonData(temp, 37, &gameMet);
    SetMonData(temp, 8, &markings);

    friendship = 120;
    SetMonData(temp, 32, &friendship);
    SetMonData(temp, 34, &pokerus);
    SetMonData(temp, 80, &obedience);
...
static void AddHatchedMonToParty(u8 id)
{
    ...
    pokeNum = GetMonData(mon, 11);
    GetSpeciesName(name, pokeNum);
    SetMonData(mon, 2, name);
    ...
    caughtLvl = 0;
    SetMonData(mon, 36, &caughtLvl);

    mapNameID = GetCurrentRegionMapSectionId();
    SetMonData(mon, 35, &mapNameID);
...
static u8 EggHatchCreateMonSprite(u8 a0, u8 switchID, u8 pokeID, u16* speciesLoc)
{
    ...
    case 1:
        formId = GetMonData(mon, 89);
        SetMultiuseSpriteTemplateToPokemon(GetMonSpritePalStruct(mon)->tag, r5, formId);
...
static void CB2_EggHatch_0(void)
{
    ...
    case 0:
        ...
        InitBgsFromTemplates(0, sBgTemplates_EggHatch, (size_t)(sizeof(sBgTemplates_EggHatch) / sizeof((sBgTemplates_EggHatch)[0])));
...
{
    SetMonData(&gPlayerParty[gSpecialVar_0x8004], 2, gStringVar3);
    FreeMonSpritesGfx();
    Free(sEggHatchData);
...
static void CB2_EggHatch_1(void)
{
    ...
    case 1:
        if (!gPaletteFade.active)
        {
            FillWindowPixelBuffer(sEggHatchData->windowId, ((0) | ((0) << 4)));
    ...
    case 3:
        ...
        {
            species = GetMonData(&gPlayerParty[sEggHatchData->eggPartyID], 11);
            DoMonFrontSpriteAnimation(&gSprites[sEggHatchData->pokeSpriteID], species, 0, 1);
            sEggHatchData->CB2_state++;
        }
        break;
    case 4:
    ...
    case 10:
        ...
        case 0:
            ...
            personality = GetMonData(&gPlayerParty[sEggHatchData->eggPartyID], 0, 0);
            formId = GetMonData(&gPlayerParty[sEggHatchData->eggPartyID], 89);
...
static void SpriteCB_Egg_4(struct Sprite* sprite)
{
    s16 i;
    if (sprite->data[0] == 0)
        BeginNormalPaletteFade(0xFFFFFFFF, -1, 0, 0x10, (((31) | ((31) << 5) | ((31) << 10)) | 0x8000));
    if (sprite->data[0] < 4u)
    {
        for (i = 0; i <= 3; i++)
            CreateRandomEggShardSprite();
...
static void SpriteCB_Egg_5(struct Sprite* sprite)
{
    ...
    if (sprite->data[0] == 8)
        BeginNormalPaletteFade(0xFFFFFFFF, -1, 0x10, 0, (((31) | ((31) << 5) | ((31) << 10)) | 0x8000));
    if (sprite->data[0] <= 9)
