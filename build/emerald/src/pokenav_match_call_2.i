# 0 "src/pokenav_match_call_2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/pokenav_match_call_2.c"
...
# 2 "src/pokenav_match_call_2.c" 2
# 1 "gflib/bg.h" 1
...
# 3 "src/pokenav_match_call_2.c" 2
# 1 "include/data.h" 1
...
# 4 "src/pokenav_match_call_2.c" 2
...
# 5 "src/pokenav_match_call_2.c" 2
# 1 "gflib/dma3.h" 1
# 49 "gflib/dma3.h"
...
# 6 "src/pokenav_match_call_2.c" 2
...
# 7 "src/pokenav_match_call_2.c" 2
# 1 "include/main.h" 1
...
# 8 "src/pokenav_match_call_2.c" 2
...
# 9 "src/pokenav_match_call_2.c" 2
# 1 "include/menu.h" 1
# 10 "src/pokenav_match_call_2.c" 2
...
# 11 "src/pokenav_match_call_2.c" 2
...
# 12 "src/pokenav_match_call_2.c" 2
...
# 13 "src/pokenav_match_call_2.c" 2
...
# 14 "src/pokenav_match_call_2.c" 2
# 1 "include/sound.h" 1
...
# 15 "src/pokenav_match_call_2.c" 2
...
# 17 "src/pokenav_match_call_2.c" 2
...
# 18 "src/pokenav_match_call_2.c" 2
# 1 "include/task.h" 1
# 19 "src/pokenav_match_call_2.c" 2
...
# 21 "src/pokenav_match_call_2.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 22 "src/pokenav_match_call_2.c" 2

# 1 "include/constants/game_stat.h" 1
# 24 "src/pokenav_match_call_2.c" 2
# 1 "include/constants/region_map_sections.h" 1
# 25 "src/pokenav_match_call_2.c" 2
# 1 "include/constants/songs.h" 1
# 26 "src/pokenav_match_call_2.c" 2
...
static u32 LoopedTask_OpenMatchCall(s32 taskState)
{
    ...
    {
    case 0:
        InitBgTemplates(sMatchCallBgTemplates, (size_t)(sizeof(sMatchCallBgTemplates) / sizeof((sMatchCallBgTemplates)[0])));
        ChangeBgX(2, 0, 0);
        ChangeBgY(2, 0, 0);
...
u32 DoMatchCallMessage(s32 taskState)
{
    ...
    {
    case 0:
        ToggleMatchCallVerticalArrows(1);
...
u32 sub_81CB888(s32 taskState)
{
    ...
    case 5:
        ...
        else
        {
            ...
            {
                ToggleMatchCallVerticalArrows(0);
                result = 4;
            }
        }
        break;
...
static void sub_81CBC64(u8 taskId)
{
    ...
    if (taskData[15])
    {
        ...
        if (!gPaletteFade.active)
            CpuSet(gPlttBufferUnfaded + 0x50, gPlttBufferFaded + 0x50, 0x04000000 | ((0x20)/(32/8) & 0x1FFFFF));
    }
}
...
static void DrawMatchCallLeftColumnWindows(struct Pokenav4Struct *state)
{
    ...
    FillWindowPixelBuffer(state->locWindowId, ((1) | ((1) << 4)));
    PutWindowTilemap(state->locWindowId);
    FillWindowPixelBuffer(state->infoBoxWindowId, ((1) | ((1) << 4)));
...
{
    u8 str[5];
    int numTrainerBattles = GetGameStat(9);
...
{
    int y = top * 16 + 1;
    AddTextPrinterParameterized(windowId, 7, str, 2, y, 0xFF, ((void *)0));
}
...
static void PrintMatchCallInfoNumber(u16 windowId, const u8 *str, int top)
{
    ...
    int y = top * 16 + 1;
    AddTextPrinterParameterized(windowId, 7, str, x, y, 0xFF, ((void *)0));
}
...
static void PrintMatchCallLocation(struct Pokenav4Struct *state, int arg1)
{
    ...
    FillWindowPixelBuffer(state->locWindowId, ((1) | ((1) << 4)));
    AddTextPrinterParameterized(state->locWindowId, 7, mapName, x, 1, 0, ((void *)0));
}
...
static void PrintMatchCallSelectionOptions(struct Pokenav4Struct *state)
{
    ...
    for (i = 0; i < MATCH_CALL_OPTION_COUNT; i++)
    {
        ...
        AddTextPrinterParameterized(state->infoBoxWindowId, 7, sMatchCallOptionTexts[optionText], 16, i * 16 + 1, 0xFF, ((void *)0));
    }
...
static void DrawMsgBoxForMatchCallMsg(struct Pokenav4Struct *state)
{
    ...
    FillWindowPixelBuffer(state->msgBoxWindowId, ((1) | ((1) << 4)));
...
{
    AddTextPrinterParameterized(state->msgBoxWindowId, 1, sText_CallingDots, 32, 1, 1, ((void *)0));
}
...
{
    AddTextPrinterParameterized(state->msgBoxWindowId, 1, gText_TrainerCloseBy, 0, 1, 1, ((void *)0));
}
...
static void PrintMatchCallMessage(struct Pokenav4Struct *state)
{
    ...
    AddTextPrinterParameterized(state->msgBoxWindowId, 1, str, 32, 1, speed, ((void *)0));
}
...
static void LoadCheckPageTrainerPic(struct Pokenav4Struct *state)
{
    ...
    if (trainerPic >= 0)
    {
        DecompressPicFromTable(&gTrainerFrontPicTable[trainerPic], state->unk1828, 0);
