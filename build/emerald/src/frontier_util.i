...
# 25 "src/frontier_util.c" 2
# 1 "include/record_mixing.h" 1
...
# 34 "src/frontier_util.c" 2
# 1 "include/constants/game_stat.h" 1
# 35 "src/frontier_util.c" 2
# 1 "include/constants/moves.h" 1
# 36 "src/frontier_util.c" 2
# 1 "include/constants/items.h" 1
# 37 "src/frontier_util.c" 2
# 1 "include/constants/event_objects.h" 1
# 38 "src/frontier_util.c" 2
    ...
    [6] =
    {
...

        {
            ...
            },
            {
                ...
                .nature = 16,
                .evs = {6, 0, 252, 252, 0, 0},
                .moves = {126, 63, 332, 219},
            },
        },
    },
};

static const u8 sBattlePointAwards[][7][4] =
{
    {
...
static const u16 sBattledBrainBitFlags[7][2] =
{
    [0] = {0x0001, 0x0002},
    [1] = {0x0004, 0x0008},
    [2] = {0x0010, 0x0020},
...
{
    [0] = GetChallengeStatus,
    [1] = GetFrontierData,
    [2] = SetFrontierData,
    [3] = SetSelectedPartyOrder,
    [4] = DoSoftReset_,
    [5] = SetFrontierTrainers,
    [6] = SaveSelectedParty,
    [7] = ShowFacilityResultsWindow,
    [8] = CheckPutFrontierTVShowOnAir,
    [9] = Script_GetFrontierBrainStatus,
    [10] = IsTrainerFrontierBrain,
    [11] = GiveBattlePoints,
    [12] = GetFacilitySymbolCount,
    [13] = GiveFacilitySymbol,
    [14] = CheckBattleTypeFlag,
    [15] = CheckPartyIneligibility,
    [16] = ValidateVisitingTrainer,
    [17] = IncrementWinStreak,
    [18] = RestoreHeldItems,
    [19] = SaveRecordBattle,
    [20] = BufferFrontierTrainerName,
    [21] = ResetSketchedMoves,
    [22] = SetFacilityBrainObjectEvent,
};
...
static const u8 sFrontierBrainObjEventGfx[7][2] =
{
    [0] = {70, 1},
    [1] = {71, 0},
    [2] = {73, 0},
...
{
    [0] = {gText_BattleTower2, gText_FacilitySingle},
    [1] = {gText_BattleTower2, gText_FacilityDouble},
    [2] = {gText_BattleTower2, gText_FacilityMulti},
    [3] = {gText_BattleDome, gText_FacilitySingle},
    [4] = {gText_BattlePalace, gText_FacilitySingle},
    [5] = {gText_BattleArena, gText_Facility},
    [6] = {gText_BattleFactory, gText_FacilitySingle},
    [7] = {gText_BattlePike, gText_Facility},
    [8] = {gText_BattlePyramid, gText_Facility},
    [9] = {gText_BattleTower2, gText_FacilityLink},
};
...
{
    [0] = gText_FrontierFacilityWinStreak,
    [1] = gText_FrontierFacilityWinStreak,
    [2] = gText_FrontierFacilityWinStreak,
    [3] = gText_FrontierFacilityClearStreak,
    [4] = gText_FrontierFacilityWinStreak,
    [5] = gText_FrontierFacilityKOsStreak,
    [6] = gText_FrontierFacilityWinStreak,
    [7] = gText_FrontierFacilityRoomsCleared,
    [8] = gText_FrontierFacilityFloorsCleared,
    [9] = gText_FrontierFacilityWinStreak,
};

static const u16 sFrontierBrainTrainerIds[7] =
{
    [0] = 805,
    [1] = 806,
    [2] = 807,
...
static const u8 *const sFrontierBrainPlayerLostSilverTexts[7] =
{
...
static const u8 *const sFrontierBrainPlayerWonSilverTexts[7] =
{
...
static const u8 *const sFrontierBrainPlayerLostGoldTexts[7] =
{
    [0] = gText_AnabelWonGold,
    [1] = gText_TuckerWonGold,
    [2] = gText_SpenserWonGold,
    [3] = gText_GretaWonGold,
    [4] = gText_NolandWonGold,
    [5] = gText_LucyWonGold,
    [6] = gText_BrandonWonGold,
};

static const u8 *const sFrontierBrainPlayerWonGoldTexts[7] =
{
    [0] = gText_AnabelDefeatGold,
    [1] = gText_TuckerDefeatGold,
    [2] = gText_SpenserDefeatGold,
    [3] = gText_GretaDefeatGold,
    [4] = gText_NolandDefeatGold,
    [5] = gText_LucyDefeatGold,
    [6] = gText_BrandonDefeatGold,
};
...
static void PrintAligned(const u8 *str, s32 y)
{
    ...
    y = (y * 8) + 1;
    AddTextPrinterParameterized(gRecordsWindowId, 1, str, x, y, 0xFF, ((void *)0));
}
...
static void PrintHyphens(s32 y)
{
    ...
    y = (y * 8) + 1;
    AddTextPrinterParameterized(gRecordsWindowId, 1, text, 4, y, 0xFF, ((void *)0));
}


static void TowerPrintStreak(const u8 *str, u16 num, u8 x1, u8 x2, u8 y)
{
    AddTextPrinterParameterized(gRecordsWindowId, 1, str, x1, y, 0xFF, ((void *)0));
    if (num > 9999)
        num = 9999;
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar4, x2, y, 0xFF, ((void *)0));
}
...
static void ShowTowerResultsWindow(u8 battleMode)
{
    ...
    FillWindowPixelBuffer(gRecordsWindowId, ((1) | ((1) << 4)));
    if (battleMode == 0)
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_Lv502, 16, 49, 0xFF, ((void *)0));
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_OpenLv, 16, 97, 0xFF, ((void *)0));
    PrintHyphens(10);
...
{
    AddTextPrinterParameterized(gRecordsWindowId, 1, str1, x1, y, 0xFF, ((void *)0));
    ConvertIntToDecimalStringN(gStringVar1, num, STR_CONV_MODE_RIGHT_ALIGN, 4);
...
static void ShowDomeResultsWindow(u8 battleMode)
{
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_Lv502, 8, 33, 0xFF, ((void *)0));
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_OpenLv, 8, 97, 0xFF, ((void *)0));
    PrintHyphens(10);
    DomePrintPrevOrCurrentStreak(battleMode, 0, 64, 121, 33);
    PrintTwoStrings(gText_Record, gText_ClearStreak, gSaveBlock2Ptr->frontier.domeRecordWinStreaks[battleMode][0], 64, 121, 49);
    PrintTwoStrings(gText_Total, gText_Championships, gSaveBlock2Ptr->frontier.domeTotalChampionships[battleMode][0], 64, 112, 65);
    DomePrintPrevOrCurrentStreak(battleMode, 1, 64, 121, 97);
    PrintTwoStrings(gText_Record, gText_ClearStreak, gSaveBlock2Ptr->frontier.domeRecordWinStreaks[battleMode][1], 64, 121, 113);
    PrintTwoStrings(gText_Total, gText_Championships, gSaveBlock2Ptr->frontier.domeTotalChampionships[battleMode][1], 64, 112, 129);
    PutWindowTilemap(gRecordsWindowId);
    CopyWindowToVram(gRecordsWindowId, 3);
}
...
static void ShowPikeResultsWindow(void)
{
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_OpenLv, 8, 97, 0xFF, ((void *)0));
    PrintHyphens(10);
    PikePrintPrevOrCurrentStreak(0, 64, 114, 33);
    PikePrintCleared(gText_Record, gText_RoomsCleared, gSaveBlock2Ptr->frontier.pikeRecordStreaks[0], 64, 114, 49);
    PikePrintCleared(gText_Total, gText_TimesCleared, gSaveBlock2Ptr->frontier.pikeTotalStreaks[0], 64, 114, 65);
    PikePrintPrevOrCurrentStreak(1, 64, 114, 97);
    PikePrintCleared(gText_Record, gText_RoomsCleared, gSaveBlock2Ptr->frontier.pikeRecordStreaks[1], 64, 114, 113);
    PikePrintCleared(gText_Total, gText_TimesCleared, gSaveBlock2Ptr->frontier.pikeTotalStreaks[1], 64, 114, 129);
    PutWindowTilemap(gRecordsWindowId);
    CopyWindowToVram(gRecordsWindowId, 3);
}
...
static void FactoryPrintStreak(const u8 *str, u16 num1, u16 num2, u8 x1, u8 x2, u8 x3, u8 y)
{
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar4, x3, y, 0xFF, ((void *)0));
}
...
static void ShowFactoryResultsWindow(u8 battleMode)
{
    ...
    PrintAligned(gStringVar4, 0);
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_Lv502, 8, 33, 0xFF, ((void *)0));
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_RentalSwap, 152, 33, 0xFF, ((void *)0));
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_OpenLv, 8, 97, 0xFF, ((void *)0));
    PrintHyphens(10);
...
static void ShowPyramidResultsWindow(void)
{
    ...
    PrintAligned(gStringVar4, 2);
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_Lv502, 8, 49, 0xFF, ((void *)0));
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_OpenLv, 8, 97, 0xFF, ((void *)0));
    PrintHyphens(10);
...
static void ShowLinkContestResultsWindow(void)
{
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar4, x, 1, 0xFF, ((void *)0));

    str = gText_1st;
    x = GetStringRightAlignXOffset(1, str, 38) + 50;
    AddTextPrinterParameterized(gRecordsWindowId, 1, str, x, 25, 0xFF, ((void *)0));
    ...
    x = 6;
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_Cool, x, 41, 0xFF, ((void *)0));
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_Beauty, x, 57, 0xFF, ((void *)0));
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_Cute, x, 73, 0xFF, ((void *)0));
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_Smart, x, 89, 0xFF, ((void *)0));
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_Tough, x, 105, 0xFF, ((void *)0));
    ...
    for (i = 0; i < 5; i++)
    {
        for (j = 0; j < 4; j++)
        {
            ...
            AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar4, (j * 38) + 64, (i * 16) + 41, 0xFF, ((void *)0));
        }
    }
...
static void CheckPutFrontierTVShowOnAir(void)
{
    ...
    s32 facility = VarGet(0x40CF);
    s32 battleMode = VarGet(0x40CE);
...
void ResetFrontierTrainerIds(void)
{
    ...
    for (i = 0; i < (int)(size_t)(sizeof(gSaveBlock2Ptr->frontier.trainerIds) / sizeof((gSaveBlock2Ptr->frontier.trainerIds)[0])); i++)
...
static void GiveBattlePoints(void)
{
    ...
    if (challengeNum != 0)
        challengeNum--;
    if (challengeNum >= (size_t)(sizeof(sBattlePointAwards) / sizeof((sBattlePointAwards)[0])))
        challengeNum = (size_t)(sizeof(sBattlePointAwards) / sizeof((sBattlePointAwards)[0])) - 1;
...
static void AppendIfValid(u16 species, u16 heldItem, u16 hp, u8 lvlMode, u8 monLevel, u16 *speciesArray, u16 *itemsArray, u8 *count)
{
    ...
    if (species == 898 + 308 + 1 || species == 0)
        return;
...
static void CheckPartyIneligibility(void)
{
    ...
    do
    {
        ...
        do
        {
            u16 species = GetMonData(&gPlayerParty[monId], 65);
            u16 heldItem = GetMonData(&gPlayerParty[monId], 12);
            u8 level = GetMonData(&gPlayerParty[monId], 56);
            u16 hp = GetMonData(&gPlayerParty[monId], 57);
            if (VarGet(0x40CF) == 6)
            {
                if (heldItem == 0)
        ...
        monIdLooper++;
    } while (monIdLooper < 6 && count < toChoose);
...
static void RestoreHeldItems(void)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        {
            u16 item = GetMonData(&gSaveBlock1Ptr->playerParty[gSaveBlock2Ptr->frontier.selectedPartyMons[i] - 1], 12, ((void *)0));
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        if (monId < 6)
        {
            for (j = 0; j < 4; j++)
            {
                for (k = 0; k < 4; k++)
                {
                    if (GetMonData(&gSaveBlock1Ptr->playerParty[gSaveBlock2Ptr->frontier.selectedPartyMons[i] - 1], 13 + k, ((void *)0))
                        == GetMonData(&gPlayerParty[i], 13 + j, ((void *)0)))
                        break;
                }
                if (k == 4)
...
static void Print1PRecord(s32 position, s32 x, s32 y, struct RankingHall1P *hallRecord, s32 hallFacilityId)
{
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_123Dot[position], x * 8, (8 * (y + 5 * position)) + 1, 0xFF, ((void *)0));
    hallRecord->name[7] = 0xFF;
    if (hallRecord->winStreak)
    {
        TVShowConvertInternationalString(text, hallRecord->name, hallRecord->language);
        AddTextPrinterParameterized(gRecordsWindowId, 1, text, (x + 2) * 8, (8 * (y + 5 * position)) + 1, 0xFF, ((void *)0));
        ...
        AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar4, GetStringRightAlignXOffset(1, sHallFacilityToRecordsText[hallFacilityId], 0xC8), (8 * (y + 5 * position)) + 1, 0xFF, ((void *)0));
    }
}
...
static void Print2PRecord(s32 position, s32 x, s32 y, struct RankingHall2P *hallRecord)
{
    ...
    if (hallRecord->winStreak)
    {
        ...
        AddTextPrinterParameterized(gRecordsWindowId, 1, text, (x + 2) * 8, (8 * (y + 5 * position - 1)) + 1, 0xFF, ((void *)0));
        ...
        AddTextPrinterParameterized(gRecordsWindowId, 1, text, (x + 4) * 8, (8 * (y + 5 * position + 1)) + 1, 0xFF, ((void *)0));
        ...
        AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar4, GetStringRightAlignXOffset(1, sHallFacilityToRecordsText[9], 0xC8), (8 * (y + 5 * position)) + 1, 0xFF, ((void *)0));
    }
}
...
static void Fill1PRecords(struct RankingHall1P *dst, s32 hallFacilityId, s32 lvlMode)
{
    ...
    struct PlayerHallRecords *playerHallRecords = AllocZeroed((1) * (sizeof(struct PlayerHallRecords)));
...
static void PrintHallRecords(s32 hallFacilityId, s32 lvlMode)
{
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar4, 0, 1, 0xFF, ((void *)0));
    x = GetStringRightAlignXOffset(1, sLevelModeText[lvlMode], 0xD0);
    AddTextPrinterParameterized(gRecordsWindowId, 1, sLevelModeText[lvlMode], x, 1, 0xFF, ((void *)0));
    if (hallFacilityId == 9)
    {
...
{
    s32 i;
    struct Pokemon *monsParty = AllocZeroed((6) * (sizeof(struct Pokemon)));
...
void CreateFrontierBrainPokemon(void)
{
    ...
    for (i = 0; i < 3; selectedMonBits >>= 1, i++)
    {
        ...
        CreateMon(&gEnemyParty[monPartyId],
                  ...
                  1, j,
                  1, 61226,
                  GetFormIdFromFormSpeciesId(sFrontierBrainsMons[facility][symbol][i].species));
        SetMonData(&gEnemyParty[monPartyId], 12, &sFrontierBrainsMons[facility][symbol][i].heldItem);
        for (j = 0; j < 6; j++)
            SetMonData(&gEnemyParty[monPartyId], 26 + j, &sFrontierBrainsMons[facility][symbol][i].evs[j]);
        friendship = 0xFF;
        for (j = 0; j < 4; j++)
        {
