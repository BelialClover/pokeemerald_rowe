# 0 "src/battle_anim_ground.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_anim_ground.c"
...
# 5 "src/battle_anim_ground.c" 2
# 1 "include/task.h" 1
# 6 "src/battle_anim_ground.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 7 "src/battle_anim_ground.c" 2
# 1 "include/constants/rgb.h" 1
# 8 "src/battle_anim_ground.c" 2
...
{
    {.frame = {.xScale = 0x0, .yScale = 0x0, .rotation = 15, .duration = 1}},
