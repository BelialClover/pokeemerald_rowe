# 0 "src/pokenav_main_menu.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/pokenav_main_menu.c"
...
# 3 "src/pokenav_main_menu.c" 2
# 1 "include/constants/songs.h" 1
# 4 "src/pokenav_main_menu.c" 2
# 1 "include/sound.h" 1
...
# 5 "src/pokenav_main_menu.c" 2
# 1 "include/constants/rgb.h" 1
# 6 "src/pokenav_main_menu.c" 2
...
{
    [POKENAV_GFX_PARTY_MENU - POKENAV_GFX_PARTY_MENU] = {
        .data = gPokenavLeftHeaderParty_Gfx,
        .tag = 1
    },
    [POKENAV_GFX_SEARCH_MENU - POKENAV_GFX_PARTY_MENU] = {
        .data = gPokenavLeftHeaderSearch_Gfx,
        .tag = 1
    },
    [POKENAV_GFX_COOL_MENU - POKENAV_GFX_PARTY_MENU] = {
        .data = gPokenavLeftHeaderCool_Gfx,
        .tag = 4
    },
    [POKENAV_GFX_BEAUTY_MENU - POKENAV_GFX_PARTY_MENU] = {
        .data = gPokenavLeftHeaderBeauty_Gfx,
        .tag = 1
    },
    [POKENAV_GFX_CUTE_MENU - POKENAV_GFX_PARTY_MENU] = {
        .data = gPokenavLeftHeaderCute_Gfx,
        .tag = 2
    },
    [POKENAV_GFX_SMART_MENU - POKENAV_GFX_PARTY_MENU] = {
        .data = gPokenavLeftHeaderSmart_Gfx,
        .tag = 0
    },
    [POKENAV_GFX_TOUGH_MENU - POKENAV_GFX_PARTY_MENU] = {
...
static u32 LoopedTask_InitPokenavMenu(s32 a0)
{
    ...
    case 0:
        ...
        InitBgsFromTemplates(0, gPokenavMainMenuBgTemplates, (size_t)(sizeof(gPokenavMainMenuBgTemplates) / sizeof((gPokenavMainMenuBgTemplates)[0])));
        ResetBgPositions();
...
void CopyPaletteIntoBufferUnfaded(const u16 *palette, u32 bufferOffset, u32 size)
{
    CpuSet(palette, gPlttBufferUnfaded + bufferOffset, 0x00000000 | ((size)/(16/8) & 0x1FFFFF));
}
...
void Pokenav_AllocAndLoadPalettes(const struct SpritePalette *palettes)
{
    ...
    for (current = palettes; current->data != ((void *)0); current++)
    {
...
void PokenavFillPalette(u32 palIndex, u16 fillValue)
{
    { vu16 tmp = (vu16)(fillValue); CpuSet((void *)&tmp, gPlttBufferFaded + 0x100 + (palIndex * 16), 0x00000000 | 0x01000000 | ((16 * sizeof(u16))/(16/8) & 0x1FFFFF)); };
}
...
void PokenavCopyPalette(const u16 *src, const u16 *dest, int size, int a3, int a4, u16 *palette)
{
    ...
    if (a4 == 0)
    {
        CpuSet(src, palette, 0x00000000 | ((size * 2)/(16/8) & 0x1FFFFF));
    }
    else if (a4 >= a3)
    {
        CpuSet(dest, palette, 0x00000000 | ((size * 2)/(16/8) & 0x1FFFFF));
    }
    else
    {
        int r, g, b;
        ...
        while (size--)
        {
            ...
            r1 = ((((((*dest) & 0x1F) << 8) - (r << 8)) / a3) * a4) >> 8;
            g1 = (((((((*dest) >> 5) & 0x1F) << 8) - (g << 8)) / a3) * a4) >> 8;
            b1 = (((((((*dest) >> 10) & 0x1F) << 8) - (b << 8)) / a3) * a4) >> 8;
...
void PokenavFadeScreen(s32 fadeType)
{
    ...
    {
    case 0:
        BeginNormalPaletteFade(structPtr->palettes, -2, 0, 16, ((0) | ((0) << 5) | ((0) << 10)));
        break;
    case 1:
        BeginNormalPaletteFade(structPtr->palettes, -2, 16, 0, ((0) | ((0) << 5) | ((0) << 10)));
        break;
    case 2:
        BeginNormalPaletteFade(0xFFFFFFFF, -2, 0, 16, ((0) | ((0) << 5) | ((0) << 10)));
        break;
    case 3:
        BeginNormalPaletteFade(0xFFFFFFFF, -2, 16, 0, ((0) | ((0) << 5) | ((0) << 10)));
        break;
    }
}
...
void sub_81C7B40(void)
{
    BlendPalettes(0xFFFEFFFE, 16, ((0) | ((0) << 5) | ((0) << 10)));
}
...
static void InitHelpBar(void)
{
    ...
    CopyWindowToVram(structPtr->helpBarWindowId, 3);
}
...
static void DrawHelpBar(u32 windowId)
{
    ...
    FillWindowPixelRect(windowId, ((5) | ((5) << 4)), 0, 0, 0x80, 1);
}
...
static void InitPokenavMainMenuResources(void)
{
    ...
    for (i = 0; i < (size_t)(sizeof(gSpinningPokenavSpriteSheet) / sizeof((gSpinningPokenavSpriteSheet)[0])); i++)
...
void ResumeSpinningPokenavSprite(void)
{
    ...
    structPtr->spinningPokenav->invisible = 0;
...
static void InitHoennMapHeaderSprites(void)
{
    ...
    for (i = 0; i < (s32)(size_t)(sizeof(structPtr->leftHeaderSprites) / sizeof((structPtr->leftHeaderSprites)[0])); i++)
    {
        spriteId = CreateSprite(&sPokenavLeftHeaderHoennMapSpriteTemplate, 0, 0, 1);
        structPtr->leftHeaderSprites[i] = &gSprites[spriteId];
        structPtr->leftHeaderSprites[i]->invisible = 1;
        ...
        structPtr->submenuLeftHeaderSprites[i]->invisible = 1;
...
static void LoadLeftHeaderGfxForMenu(u32 menuGfxId)
{
    ...
    RequestDma3Copy(gDecompressionBuffer, (void *)(0x6000000 + 0x10000) + (GetSpriteTileStartByTag(2) * 32), size, 1);
...
static void LoadLeftHeaderGfxForSubMenu(u32 menuGfxId)
{
    ...
    RequestDma3Copy(&gDecompressionBuffer[0x1000], (void *)0x6000000 + 0x10800 + (GetSpriteTileStartByTag(2) * 32), size, 1);
}
...
static void ShowLeftHeaderSubmenuSprites(u32 startY, bool32 isOnRightSide)
{
    ...
    for (i = 0; i < (s32)(size_t)(sizeof(structPtr->submenuLeftHeaderSprites) / sizeof((structPtr->submenuLeftHeaderSprites)[0])); i++)
    {
