# 0 "src/battle_anim_dragon.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_anim_dragon.c"
...
# 4 "src/battle_anim_dragon.c" 2
# 1 "include/task.h" 1
# 5 "src/battle_anim_dragon.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 6 "src/battle_anim_dragon.c" 2
# 1 "include/constants/rgb.h" 1
# 7 "src/battle_anim_dragon.c" 2
...
__attribute__((section("ewram_data"))) static u16 gUnknown_0203A100[7] = {0};
...
{
    {.frame = {.xScale = 0x50, .yScale = 0x50, .rotation = 127, .duration = 0}},
    {.frame = {.xScale = 0xD, .yScale = 0xD, .rotation = 0, .duration = 100}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 0x64, .yScale = 0x64, .rotation = 127, .duration = 1}},
    {.type = 0x7FFF},
};

static const union AffineAnimCmd sAffineAnim_DragonRageFire_1[] =
{
    {.frame = {.xScale = 0x64, .yScale = 0x64, .rotation = 0, .duration = 1}},
    {.type = 0x7FFF},
};
...
void AnimTask_DragonDanceWaver(u8 taskId)
{
    ...
    {
        sp.dmaDest = &(*(vu16 *)(0x4000000 + 0x14));
        task->data[2] = gBattle_BG1_X;
    }
    else
    {
        sp.dmaDest = &(*(vu16 *)(0x4000000 + 0x18));
