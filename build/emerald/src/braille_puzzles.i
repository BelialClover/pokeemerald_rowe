# 0 "src/braille_puzzles.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/braille_puzzles.c"
...
# 8 "src/braille_puzzles.c" 2
# 1 "include/constants/field_effects.h" 1
# 9 "src/braille_puzzles.c" 2
...
# 10 "src/braille_puzzles.c" 2
# 1 "include/constants/songs.h" 1
# 11 "src/braille_puzzles.c" 2
# 1 "include/constants/metatile_labels.h" 1
# 12 "src/braille_puzzles.c" 2
...
__attribute__((section("ewram_data"))) static u8 sBraillePuzzleCallbackFlag = 0;
...
bool8 ShouldDoBrailleDigEffect(void)
{
    if (!FlagGet((((0x500 + 864 - 1) + 1) + 0x4F))
     && (gSaveBlock1Ptr->location.mapGroup == ((71 | (24 << 8)) >> 8)
     && gSaveBlock1Ptr->location.mapNum == ((71 | (24 << 8)) & 0xFF)))
    {
...
void DoBrailleDigEffect(void)
{
    ...
    MapGridSetMetatileIdAt(16, 9, 0x232 | 0x0C00);
    MapGridSetMetatileIdAt(17, 9, 0x233);
    MapGridSetMetatileIdAt(18, 9, 0x234 | 0x0C00);
    DrawWholeMapView();
    PlaySE(20);
...
bool8 CheckRelicanthWailord(void)
{
    ...
    if (GetMonData(&gPlayerParty[0], 65, 0) == 321)
    {
        CalculatePlayerPartyCount();

        if (GetMonData(&gPlayerParty[gPlayerPartyCount - 1], 65, 0) == 369)
            return 1;
    }
    return 0;
}
...
bool8 ShouldDoBrailleRegirockEffect(void)
{
    if (!FlagGet((((0x500 + 864 - 1) + 1) + 0x50))
        && gSaveBlock1Ptr->location.mapGroup == ((6 | (24 << 8)) >> 8)
        && gSaveBlock1Ptr->location.mapNum == ((6 | (24 << 8)) & 0xFF))
    {
...
void DoBrailleRegirockEffect(void)
{
    ...
    MapGridSetMetatileIdAt(14, 27, 0x232 | 0x0C00);
    MapGridSetMetatileIdAt(15, 27, 0x233);
    MapGridSetMetatileIdAt(16, 27, 0x234 | 0x0C00);
    DrawWholeMapView();
    PlaySE(20);
...
{
    if (!FlagGet((((0x500 + 864 - 1) + 1) + 0x52)) && (gSaveBlock1Ptr->location.mapGroup == ((68 | (24 << 8)) >> 8) && gSaveBlock1Ptr->location.mapNum == ((68 | (24 << 8)) & 0xFF)))
    {
...
bool8 ShouldDoBrailleRegicePuzzle(void)
{
    ...
    if (gSaveBlock1Ptr->location.mapGroup == ((67 | (24 << 8)) >> 8)
        && gSaveBlock1Ptr->location.mapNum == ((67 | (24 << 8)) & 0xFF))
    {
        if (FlagGet((((0x500 + 864 - 1) + 1) + 0x51)))
            return 0;
        if (FlagGet((0x0 + 0x2)) == 0)
            return 0;
        if (FlagGet((0x0 + 0x3)) == 1)
            return 0;
        ...
        for (i = 0; i < 36; i++)
        {
            ...
            if (gSaveBlock1Ptr->pos.x == xPos && gSaveBlock1Ptr->pos.y == yPos)
            {
                ...
                if (varValue != 0xFFFF || VarGet(0x403C) != 0xFFFF || VarGet(0x403D) != 0xF)
                    return 0;
