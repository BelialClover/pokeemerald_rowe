# 0 "src/pokenav_match_call_ui.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/pokenav_match_call_ui.c"
...
# 2 "src/pokenav_match_call_ui.c" 2
...
# 3 "src/pokenav_match_call_ui.c" 2
# 1 "gflib/window.h" 1
...
# 4 "src/pokenav_match_call_ui.c" 2
...
# 5 "src/pokenav_match_call_ui.c" 2
# 1 "gflib/text.h" 1
# 272 "gflib/text.h"
enum
{
...
# 6 "src/pokenav_match_call_ui.c" 2
...
# 8 "src/pokenav_match_call_ui.c" 2
...
# 9 "src/pokenav_match_call_ui.c" 2
...
__attribute__((section("ewram_data"))) u32 gUnknown_0203CF44 = 0;
...
void sub_81C82E4(struct PokenavSub17 *matchCall)
{
    ...
    sub_8199DF0(matchCall->list.listWindow.bg, ((1) | ((1) << 4)), matchCall->list.listWindow.unk6, 1);
    sub_8199DF0(matchCall->list.listWindow.bg, ((4) | ((4) << 4)), matchCall->list.listWindow.unk6 + 1, 1);
...
{
    FillWindowPixelBuffer(listWindow->windowId, ((1) | ((1) << 4)));
...
u32 LoopedTask_sub_81C83F0(s32 state)
{
    ...
    case 0:
        ...
        if (structPtr->unk38 != ((void *)0))
            structPtr->unk38(structPtr->listWindow.windowId, structPtr->unk14, v1);

        AddTextPrinterParameterized(structPtr->listWindow.windowId, structPtr->listWindow.fontId, structPtr->unkTextBuffer, 8, (v1 << 4) + 1, 255, ((void *)0));
...
int MatchCall_PageUp(void)
{
    ...
    if (ShouldShowUpArrow())
    {
        ...
        MatchCall_MoveWindow(scroll * -1, 1);
        return 2;
    }
...
u32 LoopedTask_sub_81C8870(s32 state)
{
    ...
    case 3:
        if (!IsDma3ManagerBusyWithBgCopy())
        {
            if (structPtr->unk888.selectedIndexOffset != 0)
            {
                MatchCall_MoveWindow(structPtr->unk888.selectedIndexOffset, 0);
                return 0;
            }
            return 4;
        }
...
u32 LoopedTask_sub_81C8A28(s32 state)
{
    ...
    case 1:
        ...
        *ptr = 0;
        ...
        return 9;
    case 2:
        MatchCall_MoveWindow(structPtr->unk89C, 0);
        return 0;
    case 3:
        if (!IsMonListLoopedTaskActive())
        {
...
void sub_81C8B70(struct PokenavListMenuWindow *listWindow, s32 a1, s32 a2)
{
    ...
    if (a1 + a2 <= 16)
    {
        { vu32 tmp = (vu32)(((((1) | ((1) << 4))) << 24) | ((((1) | ((1) << 4))) << 16) | ((((1) | ((1) << 4))) << 8) | (((1) | ((1) << 4)))); CpuFastSet((void *)&tmp, (v1 + a1 * v2), 0x01000000 | (((a2 * v2))/(32/8) & 0x1FFFFF)); };
    ...
    else
    {
        ...
        { vu32 tmp = (vu32)(((((1) | ((1) << 4))) << 24) | ((((1) | ((1) << 4))) << 16) | ((((1) | ((1) << 4))) << 8) | (((1) | ((1) << 4)))); CpuFastSet((void *)&tmp, (v1 + a1 * v2), 0x01000000 | (((v3 * v2))/(32/8) & 0x1FFFFF)); };
        { vu32 tmp = (vu32)(((((1) | ((1) << 4))) << 24) | ((((1) | ((1) << 4))) << 16) | ((((1) | ((1) << 4))) << 8) | (((1) | ((1) << 4)))); CpuFastSet((void *)&tmp, (v1), 0x01000000 | (((v4 * v2))/(32/8) & 0x1FFFFF)); };
        CopyWindowToVram(listWindow->windowId, 2);
    }
...
void sub_81C8CB4(struct MatchCallWindowState *state, struct PokenavSub17Substruct *list)
{
    ...
    FillWindowPixelRect(list->listWindow.windowId, ((4) | ((4) << 4)), 0, list->listWindow.unkA * 16, list->listWindow.unk4 * 8, 16);
    AddTextPrinterParameterized3(list->listWindow.windowId, list->listWindow.fontId, 8, (list->listWindow.unkA * 16) + 1, colors, 0xFF, list->unkTextBuffer);
...
{
    list->unk34(state->unk10 + state->unkC * state->windowTopIndex, list->unkTextBuffer);
    FillWindowPixelRect(list->listWindow.windowId, ((1) | ((1) << 4)), 0, list->listWindow.unkA * 16, list->listWindow.unk4 * 8, 16);
    AddTextPrinterParameterized(list->listWindow.windowId, list->listWindow.fontId, list->unkTextBuffer, 8, list->listWindow.unkA * 16 + 1, 0xFF, ((void *)0));
...
void PrintMatchCallFieldNames(struct PokenavSub17Substruct *list, u32 fieldId)
{
    ...
    u8 colors[3] = {0x1, 0x4, 0x5};
    u32 top = (list->listWindow.unkA + 1 + (fieldId * 2)) & 0xF;

    FillWindowPixelRect(list->listWindow.windowId, ((1) | ((1) << 4)), 0, top << 4, list->listWindow.unk4, 16);
...
static void PrintMatchCallFlavorText(struct MatchCallWindowState *a0, struct PokenavSub17Substruct *list, u32 checkPageEntry)
{
    ...
    if (str != ((void *)0))
    {
        ...
        AddTextPrinterParameterized(list->listWindow.windowId, 7, str, 2, (r6 << 4) + 1, 0xFF, ((void *)0));
...
void sub_81C8ED0(void)
{
    ...
    for (i = 0, ptr = sMatchcallArrowSpriteSheets; i < (size_t)(sizeof(sMatchcallArrowSpriteSheets) / sizeof((sMatchcallArrowSpriteSheets)[0])); ptr++, i++)
...
bool32 CopyPokenavListMenuTemplate(struct PokenavSub17Substruct *dest, const struct BgTemplate *bgTemplate, struct PokenavListTemplate *template, s32 a3)
{
    ...
    dest->rightArrow = ((void *)0);
    dest->upArrow = ((void *)0);
    dest->downArrow = ((void *)0);
    return 1;
}
