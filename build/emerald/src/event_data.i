...
# 4 "src/event_data.c" 2
# 15 "src/event_data.c"
__attribute__((section("ewram_data"))) u16 gSpecialVar_0x8000 = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_0x8001 = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_0x8002 = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_0x8003 = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_0x8004 = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_0x8005 = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_0x8006 = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_0x8007 = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_0x8008 = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_0x8009 = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_0x800A = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_0x800B = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_Result = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_LastTalked = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_Facing = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_MonBoxId = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_MonBoxPos = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_Unused_0x8014 = 0;
__attribute__((section("ewram_data"))) static u8 gSpecialFlags[(((0x4000 + 0x7F) - 0x4000 + 1) / 8)] = {0};
...
void ClearDailyFlags(void)
{
    memset(gSaveBlock1Ptr->flags + (((((0x500 + 864 - 1) + 1) + 0xBF) + (8 - (((0x500 + 864 - 1) + 1) + 0xBF) % 8)) / 8), 0, ((((((((0x500 + 864 - 1) + 1) + 0xBF) + (8 - (((0x500 + 864 - 1) + 1) + 0xBF) % 8)) + 0x3F) + (7 - (((((0x500 + 864 - 1) + 1) + 0xBF) + (8 - (((0x500 + 864 - 1) + 1) + 0xBF) % 8)) + 0x3F) % 8)) - ((((0x500 + 864 - 1) + 1) + 0xBF) + (8 - (((0x500 + 864 - 1) + 1) + 0xBF) % 8)) + 1) / 8));
}

void DisableNationalPokedex(void)
{
    u16 *nationalDexVar = GetVarPointer(0x4046);
...
u8 *GetFlagPointer(u16 id)
{
    if (id == 0)
        ...
        return &gSpecialFlags[(id - 0x4000) / 8];
}
