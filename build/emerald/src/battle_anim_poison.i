# 0 "src/battle_anim_poison.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_anim_poison.c"
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 4 "src/battle_anim_poison.c" 2
# 1 "include/constants/rgb.h" 1
# 5 "src/battle_anim_poison.c" 2
...
{
    {.frame = {.xScale = 0x160, .yScale = 0x160, .rotation = 0, .duration = 0}},
...
{
    {.frame = {.xScale = 0xEC, .yScale = 0xEC, .rotation = 0, .duration = 0}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 0xFFF0, .yScale = 0x10, .rotation = 0, .duration = 6}},
    {.frame = {.xScale = 0x10, .yScale = 0xFFF0, .rotation = 0, .duration = 6}},
    {.jump = {.type = 0x7FFE, .target = 0}},
};
...
{
    {.frame = {.xScale = 0x9C, .yScale = 0x9C, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0x5, .yScale = 0x5, .rotation = 0, .duration = 20}},
    {.type = 0x7FFF},
};
