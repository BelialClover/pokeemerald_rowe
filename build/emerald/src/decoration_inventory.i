# 0 "src/decoration_inventory.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/decoration_inventory.c"
...
# 2 "src/decoration_inventory.c" 2
# 1 "include/constants/decorations.h" 1
# 3 "src/decoration_inventory.c" 2
...
# 4 "src/decoration_inventory.c" 2
...
# 5 "src/decoration_inventory.c" 2

__attribute__((section("ewram_data"))) struct DecorationInventory gDecorationInventories[DECORCAT_COUNT] = {};
...
void SetDecorationInventoriesPointers(void)
{
    { gDecorationInventories[DECORCAT_DESK].items = gSaveBlock1Ptr->decorationDesks; gDecorationInventories[DECORCAT_DESK].size = (size_t)(sizeof(gSaveBlock1Ptr->decorationDesks) / sizeof((gSaveBlock1Ptr->decorationDesks)[0]));};
    { gDecorationInventories[DECORCAT_CHAIR].items = gSaveBlock1Ptr->decorationChairs; gDecorationInventories[DECORCAT_CHAIR].size = (size_t)(sizeof(gSaveBlock1Ptr->decorationChairs) / sizeof((gSaveBlock1Ptr->decorationChairs)[0]));};
    { gDecorationInventories[DECORCAT_PLANT].items = gSaveBlock1Ptr->decorationPlants; gDecorationInventories[DECORCAT_PLANT].size = (size_t)(sizeof(gSaveBlock1Ptr->decorationPlants) / sizeof((gSaveBlock1Ptr->decorationPlants)[0]));};
    { gDecorationInventories[DECORCAT_ORNAMENT].items = gSaveBlock1Ptr->decorationOrnaments; gDecorationInventories[DECORCAT_ORNAMENT].size = (size_t)(sizeof(gSaveBlock1Ptr->decorationOrnaments) / sizeof((gSaveBlock1Ptr->decorationOrnaments)[0]));};
    { gDecorationInventories[DECORCAT_MAT].items = gSaveBlock1Ptr->decorationMats; gDecorationInventories[DECORCAT_MAT].size = (size_t)(sizeof(gSaveBlock1Ptr->decorationMats) / sizeof((gSaveBlock1Ptr->decorationMats)[0]));};
    { gDecorationInventories[DECORCAT_POSTER].items = gSaveBlock1Ptr->decorationPosters; gDecorationInventories[DECORCAT_POSTER].size = (size_t)(sizeof(gSaveBlock1Ptr->decorationPosters) / sizeof((gSaveBlock1Ptr->decorationPosters)[0]));};
    { gDecorationInventories[DECORCAT_DOLL].items = gSaveBlock1Ptr->decorationDolls; gDecorationInventories[DECORCAT_DOLL].size = (size_t)(sizeof(gSaveBlock1Ptr->decorationDolls) / sizeof((gSaveBlock1Ptr->decorationDolls)[0]));};
    { gDecorationInventories[DECORCAT_CUSHION].items = gSaveBlock1Ptr->decorationCushions; gDecorationInventories[DECORCAT_CUSHION].size = (size_t)(sizeof(gSaveBlock1Ptr->decorationCushions) / sizeof((gSaveBlock1Ptr->decorationCushions)[0]));};
