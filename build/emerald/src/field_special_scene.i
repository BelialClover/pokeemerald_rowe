# 0 "src/field_special_scene.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/field_special_scene.c"
...
# 8 "src/field_special_scene.c" 2
# 1 "include/main.h" 1
# 9 "src/field_special_scene.c" 2
...
# 10 "src/field_special_scene.c" 2
...
# 11 "src/field_special_scene.c" 2
...
# 12 "src/field_special_scene.c" 2
...
# 13 "src/field_special_scene.c" 2
# 1 "include/sound.h" 1
...
# 14 "src/field_special_scene.c" 2
...
# 16 "src/field_special_scene.c" 2
# 1 "include/constants/event_objects.h" 1
# 17 "src/field_special_scene.c" 2
# 1 "include/constants/event_object_movement.h" 1
# 18 "src/field_special_scene.c" 2
# 1 "include/constants/field_specials.h" 1
# 19 "src/field_special_scene.c" 2
# 1 "include/constants/songs.h" 1
# 20 "src/field_special_scene.c" 2
# 1 "include/constants/metatile_labels.h" 1
# 21 "src/field_special_scene.c" 2
...
void Task_HandleTruckSequence(u8 taskId)
{
   s16 *data = gTasks[taskId].data;
    ...
    case 5:
        ...
        if (data[1] == 120)
        {
            MapGridSetMetatileIdAt(11, 8, 0x208);
            MapGridSetMetatileIdAt(11, 9, 0x210);
            MapGridSetMetatileIdAt(11, 10, 0x218);
            DrawWholeMapView();
            PlaySE(52);
            DestroyTask(taskId);
...
{
    MapGridSetMetatileIdAt(11, 8, 0x20D);
    MapGridSetMetatileIdAt(11, 9, 0x215);
    MapGridSetMetatileIdAt(11, 10, 0x21D);
    DrawWholeMapView();
...
{
    s16 *data = gTasks[taskId].data;
    u16 *cruiseState = GetVarPointer(0x40B4);
    ...
    case EXECUTE_MOVEMENT:
        ...
        if (*cruiseState == 2)
        {
            ScriptMovement_StartObjectMovementScript(0xFF, location->mapNum, location->mapGroup, sSSTidalSailEastMovementScript);
            data[0] = IDLE_CHECK;
        }
        else
        {
            ScriptMovement_StartObjectMovementScript(0xFF, location->mapNum, location->mapGroup, sSSTidalSailWestMovementScript);
            data[0] = IDLE_CHECK;
        }
        break;
    case EXIT_PORTHOLE:
...
{
    u8 spriteId = AddPseudoObjectEvent(140, SpriteCallbackDummy, 112, 80, 0);
