# 0 "src/contest_link_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/contest_link_util.c"
...
# 8 "src/contest_link_util.c" 2
# 19 "src/contest_link_util.c"
...
void Task_LinkContest_StartCommunicationEm(u8 taskId)
{
    ...
    {
    case 0:
        gHighestRibbonRank = GetMonData(&gPlayerParty[gContestMonPartyIndex], 50);
        break;
    case 1:
        gHighestRibbonRank = GetMonData(&gPlayerParty[gContestMonPartyIndex], 51);
        break;
    case 2:
        gHighestRibbonRank = GetMonData(&gPlayerParty[gContestMonPartyIndex], 52);
        break;
    case 3:
        gHighestRibbonRank = GetMonData(&gPlayerParty[gContestMonPartyIndex], 53);
        break;
    case 4:
    default:
        gHighestRibbonRank = GetMonData(&gPlayerParty[gContestMonPartyIndex], 54);
        break;
    }
...
static void Task_LinkContest_CommunicateAIMonsEm(u8 taskId)
{
    ...
    case 0:
        if (GetMultiplayerId() == 0)
        {
            ...
            if (LinkContest_SendBlock(&gContestMons[gNumLinkContestPlayers], (4 - gNumLinkContestPlayers) * sizeof(struct ContestPokemon)) == 1)
                gTasks[taskId].data[0]++;
        }
        else
        {
