...
# 14 "src/battle_tent.c" 2
# 1 "include/constants/battle_tent.h" 1
# 15 "src/battle_tent.c" 2
# 1 "include/constants/battle_tent_trainers.h" 1
# 16 "src/battle_tent.c" 2
# 1 "include/constants/battle_tent_mons.h" 1
# 17 "src/battle_tent.c" 2
# 1 "include/constants/items.h" 1
# 18 "src/battle_tent.c" 2
# 1 "include/constants/layouts.h" 1
# 19 "src/battle_tent.c" 2
# 1 "include/constants/region_map_sections.h" 1
# 20 "src/battle_tent.c" 2
...
# 60 "src/battle_tent.c"
static u16 sRandMonSetId;


void static (*const sVerdanturfTentFuncs[])(void) =
{
    [0] = InitVerdanturfTentChallenge,
    [1] = GetVerdanturfTentPrize,
    [2] = SetVerdanturfTentPrize,
    [3] = SetVerdanturfTentTrainerGfx,
    [4] = BufferVerdanturfTentTrainerIntro,
    [5] = SaveVerdanturfTentChallenge,
    [6] = SetRandomVerdanturfTentPrize,
    [7] = GiveVerdanturfTentPrize
};

static const u16 sVerdanturfTentRewards[] = {8};

void static (*const sFallarborTentFuncs[])(void) =
{
    [0] = InitFallarborTentChallenge,
    [1] = GetFallarborTentPrize,
    [2] = SetFallarborTentPrize,
    [3] = SaveFallarborTentChallenge,
    [4] = SetRandomFallarborTentPrize,
    [5] = GiveFallarborTentPrize,
    [6] = BufferFallarborTentTrainerName
};

static const u16 sFallarborTentRewards[] = {36};

void static (*const sSlateportTentFuncs[])(void) =
{
    [0] = InitSlateportTentChallenge,
    [1] = GetSlateportTentPrize,
    [2] = SetSlateportTentPrize,
    [3] = SaveSlateportTentChallenge,
    [4] = SetRandomSlateportTentPrize,
    [5] = GiveSlateportTentPrize,
    [6] = SelectInitialRentalMons,
    [7] = SwapRentalMons,
    [8] = GenerateOpponentMons,
...
static void SetRandomVerdanturfTentPrize(void)
{
    gSaveBlock2Ptr->frontier.verdanturfTentPrize = sVerdanturfTentRewards[Random() % (size_t)(sizeof(sVerdanturfTentRewards) / sizeof((sVerdanturfTentRewards)[0]))];
}
...
static void SetRandomFallarborTentPrize(void)
{
    gSaveBlock2Ptr->frontier.fallarborTentPrize = sFallarborTentRewards[Random() % (size_t)(sizeof(sFallarborTentRewards) / sizeof((sFallarborTentRewards)[0]))];
}
...
static void SetRandomSlateportTentPrize(void)
{
    gSaveBlock2Ptr->frontier.slateportTentPrize = sSlateportTentRewards[Random() % (size_t)(sizeof(sSlateportTentRewards) / sizeof((sSlateportTentRewards)[0]))];
}
...
bool8 InSlateportBattleTent(void)
{
    return gMapHeader.regionMapSectionId == 0x08
...
static void GenerateOpponentMons(void)
{
    ...
    s32 i, j, k;
        ...
        register const u16 *monSet asm("r9");
