# 0 "src/field_weather.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/field_weather.c"
...
# 2 "src/field_weather.c" 2
# 1 "include/constants/songs.h" 1
# 3 "src/field_weather.c" 2
# 1 "include/constants/weather.h" 1
# 4 "src/field_weather.c" 2
# 1 "include/constants/rgb.h" 1
# 5 "src/field_weather.c" 2
# 1 "include/util.h" 1
...
# 16 "src/field_weather.c" 2

# 1 "include/task.h" 1
# 18 "src/field_weather.c" 2
# 1 "include/trig.h" 1
...
__attribute__((section("ewram_data"))) struct Weather gWeather = {0};
__attribute__((section("ewram_data"))) static u8 sFieldEffectPaletteGammaTypes[32] = {0};
...
{
    [0] = {None_Init, None_Main, None_Init, None_Finish},
    [1] = {Clouds_InitVars, Clouds_Main, Clouds_InitAll, Clouds_Finish},
    [2] = {Sunny_InitVars, Sunny_Main, Sunny_InitAll, Sunny_Finish},
    [3] = {Rain_InitVars, Rain_Main, Rain_InitAll, Rain_Finish},
    [4] = {Snow_InitVars, Snow_Main, Snow_InitAll, Snow_Finish},
    [5] = {Thunderstorm_InitVars, Thunderstorm_Main, Thunderstorm_InitAll, Thunderstorm_Finish},
    [6] = {FogHorizontal_InitVars, FogHorizontal_Main, FogHorizontal_InitAll, FogHorizontal_Finish},
    [7] = {Ash_InitVars, Ash_Main, Ash_InitAll, Ash_Finish},
    [8] = {Sandstorm_InitVars, Sandstorm_Main, Sandstorm_InitAll, Sandstorm_Finish},
    [9] = {FogDiagonal_InitVars, FogDiagonal_Main, FogDiagonal_InitAll, FogDiagonal_Finish},
    [10] = {FogHorizontal_InitVars, FogHorizontal_Main, FogHorizontal_InitAll, FogHorizontal_Finish},
    [11] = {Shade_InitVars, Shade_Main, Shade_InitAll, Shade_Finish},
    [12] = {Drought_InitVars, Drought_Main, Drought_InitAll, Drought_Finish},
    [13] = {Downpour_InitVars, Thunderstorm_Main, Downpour_InitAll, Thunderstorm_Finish},
    [14] = {Bubbles_InitVars, Bubbles_Main, Bubbles_InitAll, Bubbles_Finish},
};

void (*const gWeatherPalStateFuncs[])(void) =
{
    [0] = UpdateWeatherGammaShift,
    [1] = FadeInScreenWithWeather,
    [2] = DoNothing,
    [3] = DoNothing,
};
...
void StartWeather(void)
{
    if (!FuncIsActiveTask(Task_WeatherMain))
    {
        ...
        gWeatherPtr->readyForInit = 0;
        gWeatherPtr->weatherChangeComplete = 1;
...
void SetNextWeather(u8 weather)
{
    ...
    gWeatherPtr->weatherChangeComplete = 0;
...
static void FadeInScreenWithWeather(void)
{
    ...
    case 4:
    case 11:
        if (FadeInScreen_RainShowShade() == 0)
        {
    ...
    case 12:
        ...
        break;
    case 6:
        if (FadeInScreen_FogHorizontal() == 0)
        {
...
static void ApplyGammaShift(u8 startPalIndex, u8 numPalettes, s8 gammaIndex)
{
    ...
    else if (gammaIndex < 0)
    {
        ...
        while (curPalIndex < numPalettes)
        {
            ...
            else
            {
                for (i = 0; i < 16; i++)
                {
                    gPlttBufferFaded[palOffset] = sDroughtWeatherColors[gammaIndex][((((gPlttBufferUnfaded[palOffset]) >> 1) & 0xF) | (((gPlttBufferUnfaded[palOffset]) >> 2) & 0xF0) | (((gPlttBufferUnfaded[palOffset]) >> 3) & 0xF00))];
                    palOffset++;
                }
            }
    ...
    else
    {
        ...
        CpuFastSet(gPlttBufferUnfaded + startPalIndex * 16, gPlttBufferFaded + startPalIndex * 16, ((numPalettes * 16 * sizeof(u16))/(32/8) & 0x1FFFFF));
    }
}
...
void FadeScreen(u8 mode, s8 delay)
{
    ...
    {
    case 0:
        fadeColor = ((0) | ((0) << 5) | ((0) << 10));
        fadeOut = 0;
        break;
    case 2:
        fadeColor = (((31) | ((31) << 5) | ((31) << 10)) | 0x8000);
        fadeOut = 0;
        break;
    case 1:
        fadeColor = ((0) | ((0) << 5) | ((0) << 10));
...
void UpdateSpritePaletteWithWeather(u8 spritePaletteIndex)
{
    ...
    case 2:
        paletteIndex *= 16;
        CpuFastSet(gPlttBufferFaded + paletteIndex, gPlttBufferUnfaded + paletteIndex, ((32)/(32/8) & 0x1FFFFF));
    ...
    default:
        ...
        {
            paletteIndex *= 16;
            BlendPalette(paletteIndex, 16, 12, ((28) | ((31) << 5) | ((28) << 10)));
        }
        break;
    }
}
...
u8 sub_80ABF20(void)
{
    if (gWeatherPtr->palProcessingState == 1)
...
bool8 Weather_UpdateBlend(void)
{
    ...
    SetGpuReg(0x52, (((gWeatherPtr->currBlendEVB) << 8) | (gWeatherPtr->currBlendEVA)));
...
void PreservePaletteInWeather(u8 preservedPalIndex)
{
    CpuSet(sBasePaletteGammaTypes, sFieldEffectPaletteGammaTypes, 0x00000000 | ((32)/(16/8) & 0x1FFFFF));
