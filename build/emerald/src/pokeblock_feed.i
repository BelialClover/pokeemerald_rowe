# 0 "src/pokeblock_feed.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/pokeblock_feed.c"
...
# 13 "src/pokeblock_feed.c" 2
# 1 "include/menu_helpers.h" 1
# 14 "src/pokeblock_feed.c" 2
# 1 "include/m4a.h" 1
...
# 18 "src/pokeblock_feed.c" 2
# 1 "include/pokemon.h" 1
# 19 "src/pokeblock_feed.c" 2
...
# 23 "src/pokeblock_feed.c" 2
# 1 "include/task.h" 1
# 24 "src/pokeblock_feed.c" 2
...
# 27 "src/pokeblock_feed.c" 2
# 1 "include/constants/rgb.h" 1
# 28 "src/pokeblock_feed.c" 2
...
__attribute__((section("ewram_data"))) static struct PokeblockFeedStruct *sPokeblockFeed = ((void *)0);
__attribute__((section("ewram_data"))) static struct CompressedSpritePalette sPokeblockSpritePal = {0};


static const u8 sNatureToMonPokeblockAnim[25][2] =
{
    [0] = { 0, 0 },
    [1] = { 3, 0 },
    [2] = { 4, 1 },
...
{
    if (RunTextPrintersRetIsActive(0) != 1)
...
static void Task_HandleMonAtePokeblock(u8 taskId)
{
 ...
 gPokeblockGain = PokeblockGetGain(GetNature(mon, 0), pokeblock);
...
static u8 CreateMonSprite(struct Pokemon* mon)
{
 ...
 sPokeblockFeed->nature = GetNature(mon, 0);
    gSprites[spriteId].data[2] = species;
    gSprites[spriteId].callback = SpriteCallbackDummy;

    sPokeblockFeed->noMonFlip = 1;
