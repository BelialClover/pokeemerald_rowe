...
__attribute__((section("ewram_data"))) static u8 *sDiplomaTilemapPtr = ((void *)0);
...
void CB2_ShowDiploma(void)
{
    ...
    SetGpuReg(0xe, 0x0000);
    SetGpuReg(0xc, 0x0000);
    SetGpuReg(0xa, 0x0000);
    SetGpuReg(0x8, 0x0000);
    SetGpuReg(0x1c, 0x0000);
    SetGpuReg(0x1e, 0x0000);
    SetGpuReg(0x18, 0x0000);
    SetGpuReg(0x1a, 0x0000);
    SetGpuReg(0x14, 0x0000);
    SetGpuReg(0x16, 0x0000);
    SetGpuReg(0x10, 0x0000);
    SetGpuReg(0x12, 0x0000);
...
static void InitDiplomaBg(void)
{
    ...
    ShowBg(0);
    ShowBg(1);
    SetGpuReg(0x50, 0x0000);
    SetGpuReg(0x52, 0x0000);
    SetGpuReg(0x54, 0x0000);
}
