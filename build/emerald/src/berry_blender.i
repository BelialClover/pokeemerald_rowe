# 0 "src/berry_blender.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/berry_blender.c"
...
# 27 "src/berry_blender.c" 2
# 1 "include/menu.h" 1
# 28 "src/berry_blender.c" 2
...
# 37 "src/berry_blender.c" 2
# 1 "include/constants/berry.h" 1
# 38 "src/berry_blender.c" 2
# 1 "include/constants/game_stat.h" 1
# 39 "src/berry_blender.c" 2
# 1 "include/constants/items.h" 1
# 40 "src/berry_blender.c" 2
# 1 "include/constants/rgb.h" 1
# 41 "src/berry_blender.c" 2
# 1 "include/constants/songs.h" 1
# 42 "src/berry_blender.c" 2
...
struct BerryBlender
{
    ...
    s16 speed;
    u16 maxRPM;
    u8 playerArrowSpriteIds[4];
    u8 playerArrowSpriteIds2[4];
    u8 unused1[11];
    u8 gameEndState;
    u16 playerContinueResponses[4];
    ...
    u8 numPlayers;
    u8 unused2[16];
    u16 arrowIdToPlayerId[4];
    u16 playerIdToArrowId[4];
    u8 yesNoAnswer;
    u8 stringVar[100];
    u32 gameFrameTime;
    s32 framesToWait;
...
__attribute__((section("ewram_data"))) static struct BerryBlender *sBerryBlender = ((void *)0);
__attribute__((section("ewram_data"))) static s32 sDebug_PokeblockFactorFlavors[5] = {0};
__attribute__((section("ewram_data"))) static s32 sDebug_PokeblockFactorFlavorsAfterRPM[5] = {0};
__attribute__((section("ewram_data"))) static u32 sDebug_PokeblockFactorRPM = 0;

static s16 sPokeblockFlavors[5 + 1];
static s16 sPokeblockPresentFlavors[5 + 1];
...
static const s8 sPlayerArrowQuadrant[4][2] =
{
    {-1, -1},
    { 1, -1},
    {-1, 1},
...
static const u8 sPlayerArrowPos[4][2] =
{
    { 72, 32},
    {168, 32},
    { 72, 128},
...
static const u8 sPlayerIdMap[4 - 1][4] =
{
    {0xFF, 0, 1, 0xFF},
    {0xFF, 0, 1, 2},
    { 0, 1, 2, 3}
};
# 439 "src/berry_blender.c"
...
static const u8 sArrowStartPosIds[4 - 1] = {1, 1, 0};
static const u8 sArrowHitRangeStart[4] = {32, 224, 96, 160};
...
{
    {.frame = {48, 2, .vFlip = 1, .hFlip = 1}},
    {.frame = {32, 5, .vFlip = 1, .hFlip = 1}},
    {.frame = {48, 3, .vFlip = 1, .hFlip = 1}},
    {.frame = {16, 5, .vFlip = 1, .hFlip = 1}},
    {.type = -1}
};
...
{
    gBerryBlenderPlayerArrow_Gfx, 0x800, 46545
};
...
{
    gBerryBlenderScoreSymbols_Gfx, 0x200, 48888
};
...
{
    gBerryBlenderParticles_Gfx, 0xE0, 23456
};
...
{
    gBerryBlenderCountdownNumbers_Gfx, 0x600, 12345
};
...
{
    gBerryBlenderStart_Gfx, 0x400, 12346
};
...
static const u8 sOpponentBerrySets[(((148 - 144) + 1)) * 2][3] =
{

    {(((148 - 144) + 1)) - 1, (((147 - 144) + 1)) - 1, (((146 - 144) + 1)) - 1},
    {(((144 - 144) + 1)) - 1, (((148 - 144) + 1)) - 1, (((147 - 144) + 1)) - 1},
    {(((145 - 144) + 1)) - 1, (((144 - 144) + 1)) - 1, (((148 - 144) + 1)) - 1},
    {(((146 - 144) + 1)) - 1, (((145 - 144) + 1)) - 1, (((144 - 144) + 1)) - 1},
    {(((147 - 144) + 1)) - 1, (((146 - 144) + 1)) - 1, (((145 - 144) + 1)) - 1},


    {(((144 - 144) + 1)) - 1, (((146 - 144) + 1)) - 1, (((147 - 144) + 1)) - 1},
    {(((145 - 144) + 1)) - 1, (((147 - 144) + 1)) - 1, (((148 - 144) + 1)) - 1},
    {(((146 - 144) + 1)) - 1, (((148 - 144) + 1)) - 1, (((144 - 144) + 1)) - 1},
    {(((147 - 144) + 1)) - 1, (((144 - 144) + 1)) - 1, (((145 - 144) + 1)) - 1},
    {(((148 - 144) + 1)) - 1, (((145 - 144) + 1)) - 1, (((146 - 144) + 1)) - 1},
};
...
{
    m4aMPlayPitchControl(&gMPlayInfo_SE2, 0xFFFF, 2 * (sBerryBlender->speed - 0x80));
}
...
# 1192 "src/berry_blender.c"
static void CreateBerrySprite(u16 a0, u8 playerId)
{
    u8 spriteId = CreateSpinningBerrySprite(a0 + 144 - 10, 0, 80, playerId & 1);
...
{
    const struct Berry *berryInfo = GetBerryInfo((((itemId - 144) + 1)));
...
static void InitLocalPlayers(u8 opponentsNum)
{
    ...
    case 1:
        ...
        gLinkPlayers[0].language = (2);
        gLinkPlayers[1].language = (2);
        break;
    case 2:
...
static void CB2_StartBlenderLink(void)
{
    ...
    case 10:
        if (++sBerryBlender->framesToWait > 20)
        {
            ...
            ClearDialogWindowAndFrameToTransparent(4, 1);
...
static void SetOpponentsBerryData(u16 playerBerryItemId, u8 playersNum, struct BlenderBerry* playerBerry)
{
    ...
    if (playerBerryItemId == 205)
    {
        ...
        opponentSetId += (((148 - 144) + 1));
    }
    else
    {
        opponentSetId = (((playerBerryItemId - 144) + 1)) - 1;
        if (opponentSetId >= (((148 - 144) + 1)))
            opponentSetId = (opponentSetId % (((148 - 144) + 1))) + (((148 - 144) + 1));
    }
    for (i = 0; i < playersNum - 1; i++)
    {
        opponentBerryId = sOpponentBerrySets[opponentSetId][i];
        berryMasterDiff = (((playerBerryItemId - 144) + 1)) - (((174 - 144) + 1));
        if (!FlagGet(0x340) && gSpecialVar_0x8004 == 1)
        {
            opponentSetId %= (size_t)(sizeof(sBerryMasterBerries) / sizeof((sBerryMasterBerries)[0]));
            opponentBerryId = sBerryMasterBerries[opponentSetId];



            if (berryMasterDiff < (size_t)(sizeof(sBerryMasterBerries) / sizeof((sBerryMasterBerries)[0])))
                opponentBerryId -= (size_t)(sizeof(sBerryMasterBerries) / sizeof((sBerryMasterBerries)[0]));
        }
        SetPlayerBerryData(i + 1, opponentBerryId + 144);
    }
}
...
static void CB2_StartBlenderLocal(void)
{
    ...
    case 21:
        ...
        sBerryBlender->speed = 0x80;
        sBerryBlender->gameFrameTime = 0;
        sBerryBlender->perfectOpponents = 0;
        sBerryBlender->slowdownTimer = 0;
        SetMainCallback2(CB2_PlayBlender);
    ...
    for (i = 0; i < sBerryBlender->numPlayers; i++)
    {
        if (CheckRecvCmdMatches(gRecvCmds[i][0], 0x4444, 0x4400))
        {
            ...
            if (gRecvCmds[i][2] == 0x2345
             || gRecvCmds[2][i] == 0x4523
             || gRecvCmds[2][i] == 0x5432)
            {
                if (sBerryBlender->speed > 1500)
...
static void HandlePlayerInput(void)
{
    ...
    {
        if (gSaveBlock2Ptr->optionsButtonMode == 2 && ({(gMain.newKeys) & (0x0001);}))
        {
            if (({(gMain.heldKeysRaw) & (0x0001 | 0x0200);}) != (0x0001 | 0x0200))
                pressedA = 1;
        }
    ...
    if (gEnableContestDebugging && ({(gMain.newKeys) & (0x0200);}))
    ...
    for (i = 0; i < numPlayers; i++)
    {
        for (j = 0; j < numPlayers; j++)
        {
            if (berries[i].itemId == berries[j].itemId && i != j
                && (berries[i].itemId != 205 || AreBlenderBerriesSame(berries, i, j)))
                    return PBLOCK_CLR_BLACK;
        }
    }
...
static void CalculatePokeblock(struct BlenderBerry *berries, struct Pokeblock *pokeblock, u8 numPlayers, u8 *flavors, u16 maxRPM)
{
    ...
    if (pokeblock->color == PBLOCK_CLR_BLACK)
    {
        ...
        multiuseVar = Random() % (size_t)(sizeof(sBlackPokeblockFlavorFlags) / sizeof((sBlackPokeblockFlavorFlags)[0]));
        for (i = 0; i < 5; i++)
        {
    ...
    case 10:
        if (!gPaletteFade.active)
        {
            if (sBerryBlender->playerContinueResponses[0] == 0x2222)
            {
                ...
                UnsetBgTilemapBuffer(2);
                UnsetBgTilemapBuffer(1);
                { Free(sBerryBlender); sBerryBlender = ((void *)0); };
...
static void SetBgPos(void)
{
    SetGpuReg(0x14, sBerryBlender->bg_X);
    SetGpuReg(0x16, sBerryBlender->bg_Y);

    SetGpuReg(0x10, sBerryBlender->bg_X);
    SetGpuReg(0x12, sBerryBlender->bg_Y);
}
...
static void SpriteCB_CountdownNumber(struct Sprite* sprite)
{
    ...
    case 0:
        sprite->data[1] += 8;
        if (sprite->data[1] > 160 / 2 + 8)
        {
            sprite->data[1] = 160 / 2 + 8;
            sprite->data[0]++;
            PlaySE(56);
        }
        break;
...
static void UpdateRPM(u16 speed)
{
    ...
    *((u16*)((0x6000000 + (0x800 * (12))) + 0x458)) = digits[4] + 0x8072;
    *((u16*)((0x6000000 + (0x800 * (12))) + 0x45A)) = digits[3] + 0x8072;
    *((u16*)((0x6000000 + (0x800 * (12))) + 0x45C)) = digits[2] + 0x8072;
    *((u16*)((0x6000000 + (0x800 * (12))) + 0x460)) = digits[1] + 0x8072;
    *((u16*)((0x6000000 + (0x800 * (12))) + 0x462)) = digits[0] + 0x8072;
}
    ...
    case 3:
        {
            ...
            Blender_AddTextPrinter(5, sText_BlendingResults, xPos, 1, 0xFF, 0);
            ...
            for (i = 0; i < sBerryBlender->numPlayers; yPos += 16, i++)
            {
                ...
                Blender_AddTextPrinter(5, sBerryBlender->stringVar, 8, yPos, 0xFF, 3);
                ...
                Blender_AddTextPrinter(5, sBerryBlender->stringVar, 0x54, yPos, 0xFF, 3);
            }

            Blender_AddTextPrinter(5, sText_MaximumSpeed, 0, 0x51, 0xFF, 3);
            ...
            Blender_AddTextPrinter(5, sBerryBlender->stringVar, xPos, 0x51, 0xFF, 3);
            Blender_AddTextPrinter(5, sText_Time, 0, 0x61, 0xFF, 3);
            ...
            xPos = GetStringRightAlignXOffset(1, sBerryBlender->stringVar, 0xA8);
            Blender_AddTextPrinter(5, sBerryBlender->stringVar, xPos, 0x61, 0xFF, 3);
    ...
    case 5:
        ...
        for (i = 0; i < 4; i++)
        {
            if (sBerryBlender->chosenItemId[i] != 0)
                berryIds[i] = sBerryBlender->chosenItemId[i] - 144;
            if (sBerryBlender->arrowIdToPlayerId[i] != 0xFF)
            {
                PutWindowTilemap(i);
                CopyWindowToVram(i, 3);
...
static void SortBasedOnPoints(u8 *places, u8 playersNum, u32 *scores)
{
    ...
    for (i = 0; i < playersNum; i++)
    {
        for (j = 0; j < playersNum; j++)
        {
            ...
            {
                u8 temp;
                { temp = places[i]; places[i] = places[j]; places[j] = temp; };
            }
        }
    }
}
...
static bool8 PrintBlendingRanking(void)
{
    ...
    case 3:
        ...
        Blender_AddTextPrinter(5, sText_Ranking, xPos, 1, 0xFF, 0);
...
void ShowBerryBlenderRecordWindow(void)
{
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_BlenderMaxSpeedRecord, xPos, 1, 0, ((void *)0));
    AddTextPrinterParameterized(gRecordsWindowId, 1, gText_234Players, 4, 41, 0, ((void *)0));
    ...
    for (i = 0, yPos = 41; i < NUM_SCORE_TYPES; i++)
    {
        ...
        AddTextPrinterParameterized(gRecordsWindowId, 1, text, xPos, yPos + (i * 16), 0, ((void *)0));
    }
...
static bool32 Blender_PrintText(s16 *textState, const u8 *string, s32 textSpeed)
{
    ...
    {
    case 0:
        DrawDialogFrameWithCustomTileAndPalette(4, 0, 0x14, 0xF);
