# 0 "src/gym_leader_rematch.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/gym_leader_rematch.c"
...
# 5 "src/gym_leader_rematch.c" 2
# 1 "include/gym_leader_rematch.h" 1
# 6 "src/gym_leader_rematch.c" 2
...
void UpdateGymLeaderRematch(void)
{
    ...
    {
        if (FlagGet(0x5B))
            UpdateGymLeaderRematchFromArray(GymLeaderRematches_AfterNewMauville, (size_t)(sizeof(GymLeaderRematches_AfterNewMauville) / sizeof((GymLeaderRematches_AfterNewMauville)[0])), 5);
        else
            UpdateGymLeaderRematchFromArray(GymLeaderRematches_BeforeNewMauville, (size_t)(sizeof(GymLeaderRematches_BeforeNewMauville) / sizeof((GymLeaderRematches_BeforeNewMauville)[0])), 1);
    }
}
