# 0 "src/battle_controller_recorded_opponent.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_controller_recorded_opponent.c"
...
# 2 "src/battle_controller_recorded_opponent.c" 2
...
# 3 "src/battle_controller_recorded_opponent.c" 2
...
# 4 "src/battle_controller_recorded_opponent.c" 2
...
# 5 "src/battle_controller_recorded_opponent.c" 2
...
# 6 "src/battle_controller_recorded_opponent.c" 2
...
# 7 "src/battle_controller_recorded_opponent.c" 2
# 1 "include/battle_message.h" 1
# 8 "src/battle_controller_recorded_opponent.c" 2
...
# 9 "src/battle_controller_recorded_opponent.c" 2
...
# 10 "src/battle_controller_recorded_opponent.c" 2
...
# 11 "src/battle_controller_recorded_opponent.c" 2
# 1 "gflib/bg.h" 1
...
# 12 "src/battle_controller_recorded_opponent.c" 2
# 1 "include/data.h" 1
...
# 13 "src/battle_controller_recorded_opponent.c" 2
...
# 14 "src/battle_controller_recorded_opponent.c" 2
# 1 "include/link.h" 1
# 106 "include/link.h"
struct LinkStatus
{
...
# 15 "src/battle_controller_recorded_opponent.c" 2
# 1 "include/main.h" 1
...
# 16 "src/battle_controller_recorded_opponent.c" 2
# 1 "include/m4a.h" 1
...
# 17 "src/battle_controller_recorded_opponent.c" 2
...
# 18 "src/battle_controller_recorded_opponent.c" 2
# 1 "include/pokeball.h" 1
# 19 "src/battle_controller_recorded_opponent.c" 2
# 1 "include/pokemon.h" 1
# 20 "src/battle_controller_recorded_opponent.c" 2
...
# 21 "src/battle_controller_recorded_opponent.c" 2
...
# 22 "src/battle_controller_recorded_opponent.c" 2
# 1 "include/sound.h" 1
...
# 23 "src/battle_controller_recorded_opponent.c" 2
...
# 24 "src/battle_controller_recorded_opponent.c" 2
# 1 "include/task.h" 1
# 25 "src/battle_controller_recorded_opponent.c" 2
# 1 "gflib/text.h" 1
# 272 "gflib/text.h"
enum
{
...
# 26 "src/battle_controller_recorded_opponent.c" 2
# 1 "include/util.h" 1
...
# 27 "src/battle_controller_recorded_opponent.c" 2
# 1 "gflib/window.h" 1
...
# 28 "src/battle_controller_recorded_opponent.c" 2
# 1 "include/constants/battle_anim.h" 1
# 29 "src/battle_controller_recorded_opponent.c" 2
# 1 "include/constants/songs.h" 1
# 30 "src/battle_controller_recorded_opponent.c" 2
...
# 31 "src/battle_controller_recorded_opponent.c" 2
...
static void RecordedOpponentBufferRunCommand(void)
{
    ...
    {
        if (gBattleResources->bufferA[gActiveBattler][0] < (size_t)(sizeof(sRecordedOpponentBufferCommands) / sizeof((sRecordedOpponentBufferCommands)[0])))
...
static void sub_8186678(void)
{
    ...
    else
    {
        if (gSprites[gHealthboxSpriteIds[gActiveBattler]].callback == SpriteCallbackDummy
         ...
         && gSprites[gBattlerSpriteIds[gActiveBattler]].animEnded
         && gSprites[gBattlerSpriteIds[gActiveBattler ^ 2]].animEnded)
             var = 1;
    }
    ...
    if (var)
    {
        if (GetBattlerPosition(gActiveBattler) == 1)
        {
            if (!gBattleSpritesDataPtr->healthBoxesData[gActiveBattler].finishedShinyMonAnim)
                return;
            if (!gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].finishedShinyMonAnim)
                return;
...
static void RecordedOpponentHandleSwitchInAnim(void)
{
    ...
    sub_81885D8(gActiveBattler, gBattleResources->bufferA[gActiveBattler][2]);
...
static void RecordedOpponentHandleDrawTrainerPic(void)
{
    ...
    else
    {
        ...
        {
            trainerPicId = PlayerGenderToFrontTrainerPicId(gLinkPlayers[gUnknown_0203C7B4 ^ 1].gender);
        }
    }
...
static void RecordedOpponentHandleCmd55(void)
{
    if (gBattleResources->bufferA[gActiveBattler][1] == 3)
        gBattleOutcome = gBattleResources->bufferA[gActiveBattler][1];
    else
        gBattleOutcome = gBattleResources->bufferA[gActiveBattler][1] ^ 3;
