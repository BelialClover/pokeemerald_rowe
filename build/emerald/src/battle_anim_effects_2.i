# 0 "src/battle_anim_effects_2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_anim_effects_2.c"
...
# 2 "src/battle_anim_effects_2.c" 2
# 1 "gflib/malloc.h" 1
# 15 "gflib/malloc.h"
extern u8 gHeap[];
...
# 3 "src/battle_anim_effects_2.c" 2
...
# 4 "src/battle_anim_effects_2.c" 2
...
# 5 "src/battle_anim_effects_2.c" 2
...
# 6 "src/battle_anim_effects_2.c" 2
...
# 7 "src/battle_anim_effects_2.c" 2
...
# 8 "src/battle_anim_effects_2.c" 2
# 1 "include/main.h" 1
...
# 9 "src/battle_anim_effects_2.c" 2
...
# 10 "src/battle_anim_effects_2.c" 2
...
# 11 "src/battle_anim_effects_2.c" 2
...
# 12 "src/battle_anim_effects_2.c" 2
...
# 13 "src/battle_anim_effects_2.c" 2
# 1 "include/sound.h" 1
...
# 14 "src/battle_anim_effects_2.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 15 "src/battle_anim_effects_2.c" 2
# 1 "include/util.h" 1
...
# 16 "src/battle_anim_effects_2.c" 2
# 1 "include/constants/rgb.h" 1
# 17 "src/battle_anim_effects_2.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/battle_anim_effects_2.c" 2
...
{
    {.frame = {.xScale = 0x50, .yScale = 0x50, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0x9, .yScale = 0x9, .rotation = 0, .duration = 18}},
    {.type = 0x7FFF},
};
...
const union AffineAnimCmd gSwordsDanceBladeAffineAnimCmds[] =
{
    ...
    {.frame = {.xScale = 0x14, .yScale = 0x0, .rotation = 0, .duration = 12}},
...
{
    {.frame = {.xScale = 0x20, .yScale = 0x20, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0x7, .yScale = 0x7, .rotation = 0, .duration = -56}},
    {.type = 0x7FFF},
};
...
const union AffineAnimCmd gWaterPulseRingAffineAnimCmds[] =
{
    ...
    {.frame = {.xScale = 0xFFF6, .yScale = 0xFFF6, .rotation = 0, .duration = 10}},
    {.frame = {.xScale = 0xA, .yScale = 0xA, .rotation = 0, .duration = 10}},
    {.frame = {.xScale = 0xFFF6, .yScale = 0xFFF6, .rotation = 0, .duration = 10}},
    {.frame = {.xScale = 0xA, .yScale = 0xA, .rotation = 0, .duration = 10}},
    {.frame = {.xScale = 0xFFF6, .yScale = 0xFFF6, .rotation = 0, .duration = 10}},
    {.frame = {.xScale = 0xA, .yScale = 0xA, .rotation = 0, .duration = 10}},
...
{
    {.frame = {.xScale = 0x0, .yScale = 0x0, .rotation = 10, .duration = 1}},
...
{
    {.frame = {.xScale = 0x0, .yScale = 0x0, .rotation = 20, .duration = 1}},
    {.jump = {.type = 0x7FFE, .target = 0}},
};
...
{
    {.frame = {.xScale = 0x10, .yScale = 0x100, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0x4, .yScale = 0x0, .rotation = 0, .duration = 40}},
    {.type = 0x7FFF},
};
...
const union AnimCmd gViceGripAnimCmds2[] =
{
    ...
    {.frame = {16, 3, .vFlip = 1, .hFlip = 1}},
    {.frame = {32, 20, .vFlip = 1, .hFlip = 1}},
    {.type = -1},
};
...
const union AnimCmd gGuillotineAnimCmds2[] =
{
    ...
    {.frame = {16, 2, .vFlip = 1, .hFlip = 1}},
    {.frame = {32, 1, .vFlip = 1, .hFlip = 1}},
    {.type = -1},
};
...
{
    {.frame = {.xScale = -6, .yScale = 4, .rotation = 0, .duration = 8}},
    {.frame = {.xScale = 10, .yScale = -10, .rotation = 0, .duration = 8}},
    {.frame = {.xScale = -4, .yScale = 6, .rotation = 0, .duration = 8}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gGrowAndShrinkAffineAnimCmds[] =
{
    {.frame = {.xScale = -4, .yScale = -5, .rotation = 0, .duration = 12}},
...
{
    {.frame = {.xScale = 0xB, .yScale = 0xB, .rotation = 0, .duration = 8}},
    {.frame = {.xScale = 0xFFF5, .yScale = 0xFFF5, .rotation = 0, .duration = 8}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = -10, .yScale = 9, .rotation = 0, .duration = 7}},
    {.frame = {.xScale = 20, .yScale = -20, .rotation = 0, .duration = 7}},
    {.frame = {.xScale = -20, .yScale = 20, .rotation = 0, .duration = 7}},
    {.frame = {.xScale = 10, .yScale = -9, .rotation = 0, .duration = 7}},
...
{
    {.frame = {.xScale = 0x0, .yScale = 0x0, .rotation = -8, .duration = 2}},
    {.frame = {.xScale = 0x0, .yScale = 0x0, .rotation = 8, .duration = 4}},
    {.frame = {.xScale = 0x0, .yScale = 0x0, .rotation = -8, .duration = 2}},
    {.jump = {.type = 0x7FFE, .target = 0}},
};
...
{
    {.frame = {.xScale = 0xFFF8, .yScale = 0x4, .rotation = 0, .duration = 8}},
    {.loop = {.type = 0x7FFD, .count = 0}},
    {.frame = {.xScale = 0x10, .yScale = 0xFFF8, .rotation = 0, .duration = 8}},
    {.frame = {.xScale = 0xFFF0, .yScale = 0x8, .rotation = 0, .duration = 8}},
...
const union AffineAnimCmd gThinRingExpandingAffineAnimCmds1[] =
{
    ...
    {.frame = {.xScale = 0x10, .yScale = 0x10, .rotation = 0, .duration = 30}},
    {.end = {.type = 0x7FFF, .val = 1}},
};

const union AffineAnimCmd gThinRingExpandingAffineAnimCmds2[] =
{
    {.frame = {.xScale = 0x10, .yScale = 0x10, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0x20, .yScale = 0x20, .rotation = 0, .duration = 15}},
    {.end = {.type = 0x7FFF, .val = 1}},
};
...
{
    {.frame = {.xScale = 0x10, .yScale = 0x10, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0xB, .yScale = 0xB, .rotation = 0, .duration = 45}},
    {.end = {.type = 0x7FFF, .val = 1}},
};
...
const union AffineAnimCmd gThinRingShrinkingAffineAnimCmds[] =
{
    ...
    {.frame = {.xScale = 0xFFF0, .yScale = 0xFFF0, .rotation = 0, .duration = 30}},
    {.end = {.type = 0x7FFF, .val = 1}},
};
...
{
    {.frame = {.xScale = 96, .yScale = -13, .rotation = 0, .duration = 8}},
    {.type = 0x7FFF},
};
...
static const u16 sMusicNotePaletteTagsTable[3] =
{
    (10000 + 206),
    10000 - 1,
    10000 - 2,
...
{
    {.frame = {.xScale = 0x000A, .yScale = 0xFFF3, .rotation = 0x00, .duration = 0x0A}},
    {.frame = {.xScale = 0xFFF6, .yScale = 0x000D, .rotation = 0x00, .duration = 0x0A}},
    {.type = 0x7FFF},
};
...
const union AffineAnimCmd gHiddenPowerOrbAffineAnimCmds[] =
{
    ...
    {.frame = {.xScale = 0x8, .yScale = 0x8, .rotation = 0, .duration = 1}},
...
{
    {.frame = {.xScale = 0x0, .yScale = 0x0, .rotation = 0, .duration = 5}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gPerishSongMusicNoteAffineAnimCmds2[] =
{
    {.frame = {.xScale = 0x0, .yScale = 0x0, .rotation = -8, .duration = 16}},
    {.end = {.type = 0x7FFF, .val = 1}},
};
...
{
    {.frame = {.xScale = 0x200, .yScale = 0x100, .rotation = 0, .duration = 0}},
    {.type = 0x7FFF},
};
...
# 1520 "src/battle_anim_effects_2.c"
void AnimSonicBoomProjectile(struct Sprite *sprite)
{
    s16 targetXPos;
    s16 targetYPos;
...
static void AnimAirWaveProjectile(struct Sprite *sprite)
{
    ...
    if (sprite->data[0]-- <= 0)
    {
        ...
        sprite->data[6] = 0;
        sprite->data[5] = 0;
        sprite->data[3] = MathUtil_Mul16(MathUtil_Mul16(b, a), MathUtil_Inv16(((s16)((1.75) * 256))));
        sprite->data[4] = MathUtil_Mul16(MathUtil_Mul16(c, a), MathUtil_Inv16(((s16)((1.75) * 256))));
...
static void AirCutterProjectileStep1(u8 taskId)
{
    if (gTasks[taskId].data[0]-- <= 0)
    {
        ...
        gTasks[taskId].data[1]++;
        PlaySE12WithPanning(154, BattleAnimAdjustPanning(-63));
        if (gTasks[taskId].data[1] > 2)
...
void AnimTask_AirCutterProjectile(u8 taskId)
{
    ...
    if ((gBattleTypeFlags & (1 << 0))
        && IsBattlerSpriteVisible(((gBattleAnimTarget) ^ 2)))
    {
    ...
    gTasks[taskId].data[6] = MathUtil_Mul16(gTasks[taskId].data[5], ((s16)((0.5) * 256)));
...
# 1912 "src/battle_anim_effects_2.c"
...
void AnimTask_GrowAndGreyscale(u8 taskId)
{
    ...
    SetGreyscaleOrOriginalPalette(gSprites[spriteId].oam.paletteNum + 16, 0);
...
static void AnimTask_GrowAndGreyscale_Step(u8 taskId)
{
    if (--gTasks[taskId].data[0] == -1)
    {
        u8 spriteId = GetAnimBattlerSpriteId(1);
        ResetSpriteRotScale(spriteId);
        SetGreyscaleOrOriginalPalette(gSprites[spriteId].oam.paletteNum + 16, 1);
        DestroyAnimVisualTask(taskId);
    }
}
...
void AnimTask_SketchDrawMon(u8 taskId)
{
    ...
    if (GetBattlerSpriteBGPriorityRank(gBattleAnimTarget) == 1)
    {
        ...
        params.dmaDest = (u16 *)(0x4000000 + 0x14);
    }
    else
    {
        task->data[6] = gBattle_BG2_X;
        params.dmaDest = (u16 *)(0x4000000 + 0x18);
    }
...
void AnimHyperVoiceRing(struct Sprite *sprite)
{
    ...
    if (GetBattlerSide(battler1) != 0)
    {
        ...
        if (IsBattlerSpriteVisible(((battler2) ^ 2)))
    ...
    {
        r9 = GetBattlerSpriteCoord(battler1, r10) - gBattleAnimArgs[0];
        if (!IsContest() && IsBattlerSpriteVisible(((battler1) ^ 2)))
        {
            if (gSprites[gBattlerSpriteIds[battler1]].pos1.x < gSprites[gBattlerSpriteIds[((battler1) ^ 2)]].pos1.x)
    ...
    if (!IsContest() && IsBattlerSpriteVisible(((battler2) ^ 2)))
    {
...
void AnimUproarRing(struct Sprite *sprite)
{
    u8 index = IndexOfSpritePaletteTag((10000 + 203));
    if (index != 0xFF)
    {
...
static void AnimSoftBoiledEgg_Step3_Callback1(struct Sprite *sprite)
{
    ...
    if (++sprite->data[0] == 9)
    {
        ...
        SetGpuReg(0x52, (((0) << 8) | ((u16)sprite->data[0])));
...
void AnimTask_FakeOut(u8 taskId)
{
    ...
    SetGpuReg(0x48, 0x3F1F);
    SetGpuReg(0x4a, 0x3F3F);
    SetGpuReg(0x50, (1 << 3) | (3 << 6));
    SetGpuReg(0x54, 0x10);
...
static void AnimTask_FakeOut_Step2(u8 taskId)
{
    if (++gTasks[taskId].data[10] == 5)
    {
        ...
        SetGpuReg(0x50, (1 << 3) | (2 << 6));
        BlendPalettes(sub_80A75AC(1, 0, 0, 0, 0, 0, 0), 16, ((31) | ((31) << 5) | ((31) << 10)));
    }
...
void AnimTask_HeartsBackground(u8 taskId)
{
    ...
    SetGpuReg(0x50, (((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12) | (1 << 13)) | (1 << 1) | (1 << 6));
...
static void AnimTask_HeartsBackground_Step(u8 taskId)
{
    ...
    case 0:
        if (++gTasks[taskId].data[10] == 4)
        {
            ...
            SetGpuReg(0x52, (((16 - gTasks[taskId].data[11]) << 8) | (gTasks[taskId].data[11])));
...
{
    if ((gBattleTypeFlags & (1 << 0)) && IsBattlerSpriteVisible(((gBattleAnimAttacker) ^ 2)))
    {
