...
.L4168:
	...
	sub	r1, r1, #0x1
	cmp	r1, #0
	bge	.L4168	@cond_branch
	add	r2, r3, #0
	ldrb	r0, [r6]
	cmp	r2, r0
	blt	.L4164	@cond_branch
.L4162:
	mov	r1, r9
	ldr	r0, [r1]
	add	r0, r0, #0x1
...
.L4275:
	...
	ldrh	r0, [r1]
	cmp	r0, #0
	bne	.L4275	@cond_branch
.L4273:
	mov	r3, #0x0
	cmp	r3, r6
	bcs	.L4278	@cond_branch
	ldr	r0, .L4302+0x8
	mov	sl, r0
	ldr	r1, .L4302
	mov	ip, r1
...
.L4281:
	...
	ldrb	r0, [r0]
	cmp	r2, r0
	bne	.L4278	@cond_branch
.L4279:
	add	r0, r3, #0x1
	lsl	r0, r0, #0x18
	lsr	r3, r0, #0x18
	cmp	r3, r6
	bcc	.L4280	@cond_branch
.L4278:
	cmp	r3, r6
...
Cmd_setsubstitute:
	...
	add	r2, r1, #0
	cmp	r1, #0
	bne	.L4470	@cond_branch
	mov	r2, #0x1
.L4470:
	ldrh	r0, [r3, #0x2a]
	cmp	r0, r2
	bhi	.L4471	@cond_branch
	ldr	r1, .L4474+0x8
	mov	r0, #0x0
	str	r0, [r1]
	ldr	r1, .L4474+0xc
...
.L4581:
	...
	lsr	r1, r0, #0x10
	cmp	r1, #0
	beq	.L4584	@cond_branch
	mov	r0, #0x80
	lsl	r0, r0, #0x4
	cmp	r1, r0
	bne	.L4580	@cond_branch
.L4584:
	ldr	r0, [r5]
	orr	r7, r7, r0
.L4580:
...
.L4611:
	...
	ldrh	r0, [r0]
	cmp	r2, r0
	beq	.L4609	@cond_branch
.L4610:
	add	r1, r1, #0x2
	add	r7, r7, #0x1
	cmp	r7, #0x3
	ble	.L4611	@cond_branch
.L4609:
	cmp	r7, #0x4
	beq	.LCB43292
	b	.L4607	@long jump
...
.L4752:
	...
	and	r0, r0, r5
	cmp	r0, #0
	bne	.L4754	@cond_branch
	mov	r0, #0x5c
	mul	r0, r0, r3
	add	r0, r0, ip
	ldrh	r0, [r0, #0x20]
	cmp	r0, #0x2b
	bne	.L4753	@cond_branch
.L4754:
	add	r6, r6, #0x1
	b	.L4751
.L4760:
...
.L4895:
	...
	ldrsb	r0, [r2, r0]
	cmp	r0, #0xb
	bgt	.L4896	@cond_branch
	ldrh	r0, [r2, #0x2a]
	cmp	r0, r1
	bls	.L4896	@cond_branch
	mov	r0, #0xc
	strb	r0, [r2, #0x19]
	ldr	r1, .L4899+0x8
	ldrb	r0, [r4]
...
Cmd_recoverbasedonsunlight:
	...
	ldr	r0, .L4956+0x10
	cmp	r1, r0
	bne	.L4944	@cond_branch
	mov	r0, #0xd
	bl	IsAbilityOnField
	cmp	r0, #0
	bne	.L4949	@cond_branch
	mov	r0, #0x4c
	bl	IsAbilityOnField
	cmp	r0, #0
	bne	.L4949	@cond_branch
...
Cmd_setsemiinvulnerablebit:
	...
	cmp	r1, r0
	bgt	.L5029	@cond_branch
	cmp	r1, #0x13
	beq	.L5022	@cond_branch
	cmp	r1, #0x5b
	beq	.L5023	@cond_branch
	b	.L5020
.L5033:
	.align	2, 0
.L5032:
...
.L5029:
	ldr	r0, .L5034
	cmp	r1, r0
	beq	.L5026	@cond_branch
	cmp	r1, r0
	bgt	.L5030	@cond_branch
	sub	r0, r0, #0x7f
	cmp	r1, r0
	beq	.L5022	@cond_branch
	b	.L5020
...
Cmd_jumpifnodamage:
	...
	ldr	r0, [r0]
	cmp	r0, #0
	bne	.L5093	@cond_branch
	add	r0, r2, #0
	add	r0, r0, #0x8
	add	r0, r1, r0
	ldr	r0, [r0]
	cmp	r0, #0
	beq	.L5092	@cond_branch
.L5093:
	ldr	r1, .L5095+0x8
	ldr	r0, [r1]
	add	r0, r0, #0x5
...
Cmd_trycopyability:
	...
	add	r4, r2, #0
	cmp	r0, #0x19
	beq	.L5148	@cond_branch
	cmp	r0, #0x19
	bgt	.L5151	@cond_branch
	cmp	r0, #0
	beq	.L5148	@cond_branch
	b	.L5149
.L5153:
...
Cmd_setgastroacid:
	...
	ldrh	r0, [r0, #0x20]
	cmp	r0, #0xd3
	bgt	.L5197	@cond_branch
	cmp	r0, #0xd0
	bge	.L5194	@cond_branch
	cmp	r0, #0xb0
	beq	.L5194	@cond_branch
	cmp	r0, #0xb0
	bgt	.L5198	@cond_branch
	cmp	r0, #0x79
	beq	.L5194	@cond_branch
	b	.L5195
.L5200:
...
Cmd_setroom:
	...
	ldrh	r0, [r0]
	cmp	r0, #0xf4
	beq	.L5230	@cond_branch
	cmp	r0, #0xf4
	bgt	.L5234	@cond_branch
	cmp	r0, #0xf3
...
Cmd_tryswapabilities:
	...
	add	r4, r2, #0
	cmp	r0, #0x19
	beq	.L5262	@cond_branch
	cmp	r0, #0x19
	bgt	.L5252	@cond_branch
	cmp	r0, #0
	beq	.L5262	@cond_branch
	b	.L5246
.L5264:
...
.L5286:
	...
	cmp	r1, #0
	bne	.L5284	@cond_branch
.L5285:
	add	r0, r0, #0x2
	add	r2, r2, #0x1
	cmp	r2, #0x3
	ble	.L5286	@cond_branch
.L5284:
	cmp	r2, #0x4
	...
	add	r4, r4, #0x1
	cmp	r4, #0x3
	ble	.L5282	@cond_branch
.L5280:
	cmp	r4, #0x4
	bne	.L5294	@cond_branch
.L5276:
	add	r0, r6, #0x1
	lsl	r0, r0, #0x18
	lsr	r6, r0, #0x18
.L5296:
	...
	ldrb	r0, [r0]
	cmp	r6, r0
	bcc	.L5277	@cond_branch
.L5275:
	ldr	r0, .L5301+0x8
	ldrb	r0, [r0]
	cmp	r6, r0
	bne	.L5273	@cond_branch
.L5295:
	ldr	r3, .L5301+0xc
	ldr	r2, [r3]
	ldrb	r1, [r2, #0x1]
...
.L5359:
	...
	ldrb	r1, [r2]
	cmp	r0, r1
	bcc	.L5360	@cond_branch
.L5358:
	ldr	r0, .L5367+0x10
	ldrb	r0, [r0]
	ldrb	r2, [r2]
	cmp	r0, r2
	bcc	.L5364	@cond_branch
.L5366:
	ldr	r3, .L5367+0x20
	ldr	r2, [r3]
	ldrb	r1, [r2, #0x1]
...
Cmd_switchoutabilities:
	...
	bl	GetBattlerAbility
	cmp	r0, #0x1e
	beq	.L5373	@cond_branch
	cmp	r0, #0x90
	beq	.L5374	@cond_branch
	b	.L5372
.L5379:
	.align	2, 0
.L5378:
...
.L5436:
	...
	ldrh	r0, [r6]
	cmp	r0, #0x8f
	bls	.L5430	@cond_branch
	cmp	r0, #0xd2
	bhi	.L5430	@cond_branch
	bl	Random
	lsl	r0, r0, #0x10
	mov	r1, #0xf0
	lsl	r1, r1, #0xc
...
.L5462:
	cmp	r5, #0xd5
	bne	.L5465	@cond_branch
	mov	r1, r8
	ldrh	r0, [r1]
	cmp	r0, #0x8f
	bls	.L5465	@cond_branch
	cmp	r0, #0xd2
	bhi	.L5465	@cond_branch
	bl	Random
	lsl	r0, r0, #0x10
	mov	r1, #0xf0
	lsl	r1, r1, #0xc
...
Cmd_removelightscreenreflect:
	...
	ldrb	r0, [r3]
	cmp	r0, #0
	bne	.L5571	@cond_branch
	ldrb	r1, [r3, #0x2]
	cmp	r1, #0
	beq	.L5570	@cond_branch
.L5571:
	ldr	r2, .L5573+0x8
	add	r2, r4, r2
	ldr	r0, [r2]
...
.L5600:
	...
	lsr	r0, r0, #0x18
	cmp	r0, #0x5
	beq	.L5685	@cond_branch
	ldr	r0, .L5706
	ldrb	r0, [r0]
	cmp	r0, #0
	bne	.L5685	@cond_branch
	ldr	r0, .L5706+0x4
	ldrb	r0, [r0]
	b	.L5691
.L5707:
...
.L5615:
	...
	lsl	r0, r1, #0x2
	cmp	r3, r0
	bge	.L5686	@cond_branch
	lsl	r0, r1, #0x1
	cmp	r3, r0
	bgt	.L5693	@cond_branch
	cmp	r3, r1
	bhi	.LCB52693
	b	.L5594	@long jump
.LCB52693:
...
.L5658:
	...
	ldrb	r0, [r1]
	cmp	r0, #0xfe
	bhi	.L5657	@cond_branch
	add	r0, r0, #0x1
	strb	r0, [r1]
.L5657:
	cmp	r6, #0xfe
	bls	.L5661	@cond_branch
	mov	r0, #0x0
	mov	r1, #0x4
	bl	BtlController_EmitBallThrowAnim
	ldr	r0, .L5740+0x4
...
.L5669:
	cmp	r4, r5
	bcs	.L5668	@cond_branch
	bl	Random
	lsl	r0, r0, #0x10
	lsr	r0, r0, #0x10
	cmp	r0, r6
	bcc	.L5671	@cond_branch
.L5668:
	mov	r0, #0x0
	add	r1, r4, #0
	bl	BtlController_EmitBallThrowAnim
...
.L5830:
	...
	ldr	r0, [sp, #0x1c]
	cmp	r5, r0
	ble	.L5813	@cond_branch
.L5808:
	ldr	r6, [sp, #0x18]
	cmp	r6, sl
	ble	.L5809	@cond_branch
.L5807:
	add	sp, sp, #0x20
	pop	{r3, r4, r5}
	mov	r8, r3
...
Cmd_jumpifoppositegenders:
	...
	lsr	r0, r0, #0x18
	cmp	r7, #0
	bne	.L5925	@cond_branch
	cmp	r0, #0xfe
	beq	.L5924	@cond_branch
.L5925:
	cmp	r7, #0xfe
