# 0 "src/battle_controller_wally.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_controller_wally.c"
...
# 2 "src/battle_controller_wally.c" 2
...
# 3 "src/battle_controller_wally.c" 2
...
# 4 "src/battle_controller_wally.c" 2
...
# 5 "src/battle_controller_wally.c" 2
...
# 6 "src/battle_controller_wally.c" 2
# 1 "include/battle_message.h" 1
# 7 "src/battle_controller_wally.c" 2
...
# 8 "src/battle_controller_wally.c" 2
...
# 9 "src/battle_controller_wally.c" 2
# 1 "gflib/bg.h" 1
...
# 10 "src/battle_controller_wally.c" 2
# 1 "include/data.h" 1
...
# 11 "src/battle_controller_wally.c" 2
# 1 "include/item.h" 1
...
# 12 "src/battle_controller_wally.c" 2
...
# 13 "src/battle_controller_wally.c" 2
# 1 "include/link.h" 1
# 106 "include/link.h"
struct LinkStatus
{
...
# 14 "src/battle_controller_wally.c" 2
# 1 "include/main.h" 1
...
# 15 "src/battle_controller_wally.c" 2
# 1 "include/m4a.h" 1
...
# 16 "src/battle_controller_wally.c" 2
...
# 17 "src/battle_controller_wally.c" 2
...
# 1 "include/pokemon.h" 1
# 20 "src/battle_controller_wally.c" 2
...
# 21 "src/battle_controller_wally.c" 2
...
# 22 "src/battle_controller_wally.c" 2
# 1 "include/sound.h" 1
...
# 23 "src/battle_controller_wally.c" 2
...
# 24 "src/battle_controller_wally.c" 2
# 1 "include/task.h" 1
# 25 "src/battle_controller_wally.c" 2
# 1 "gflib/text.h" 1
# 272 "gflib/text.h"
enum
{
...
# 26 "src/battle_controller_wally.c" 2
# 1 "include/util.h" 1
...
# 27 "src/battle_controller_wally.c" 2

# 1 "include/constants/battle_anim.h" 1
# 29 "src/battle_controller_wally.c" 2
# 1 "include/constants/items.h" 1
# 30 "src/battle_controller_wally.c" 2
# 1 "include/constants/moves.h" 1
# 31 "src/battle_controller_wally.c" 2
# 1 "include/constants/songs.h" 1
# 32 "src/battle_controller_wally.c" 2
...
# 33 "src/battle_controller_wally.c" 2
# 1 "include/constants/rgb.h" 1
# 34 "src/battle_controller_wally.c" 2
...
static void WallyBufferRunCommand(void)
{
    ...
    {
        if (gBattleResources->bufferA[gActiveBattler][0] < (size_t)(sizeof(sWallyBufferCommands) / sizeof((sWallyBufferCommands)[0])))
...
static void WallyHandleDrawTrainerPic(void)
{
    DecompressTrainerBackPic(6, gActiveBattler);
    SetMultiuseSpriteTemplateToTrainerBack(6, GetBattlerPosition(gActiveBattler));
    gBattlerSpriteIds[gActiveBattler] = CreateSprite(&gMultiuseSpriteTemplate,
                                               80,
                                               80 + 4 * (8 - gTrainerBackPicCoords[6].size),
                                               30);
...
static void WallyHandleIntroTrainerBallThrow(void)
{
    ...
    LoadCompressedPalette(gTrainerBackPicPaletteTable[6].data, 0x100 + paletteNum * 16, 32);
...
static void WallyHandleCmd55(void)
{
    ...
    if (!(gBattleTypeFlags & (1 << 2)) && gBattleTypeFlags & (1 << 1))
