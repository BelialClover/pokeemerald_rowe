...
static __attribute__((section("ewram_data"))) bool32 gUnknown_02022C70 = 0;
...
static void sub_801B180(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, sub_801B044(), 0x04000000 | 0x01000000 | ((sizeof(struct MysteryEventStruct))/(32/8) & 0x1FFFFF)); };
    sub_801DBC0();
}
...
bool32 CheckReceivedGiftFromWonderCard(void)
{
    ...
    if (FlagGet(sMysteryGiftFlags[value - 1000]) == 1)
        return 0;
...
{
    int i;
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, data, 0x04000000 | 0x01000000 | ((sizeof(struct MEventStruct_Unk1442CC))/(32/8) & 0x1FFFFF)); };
    data->unk_00 = 0x101;
    data->unk_04 = 1;
    data->unk_08 = 1;
