# 0 "src/mystery_event_menu.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/mystery_event_menu.c"
...
# 9 "src/mystery_event_menu.c" 2
# 1 "include/constants/songs.h" 1
# 10 "src/mystery_event_menu.c" 2
# 1 "include/sound.h" 1
...
# 14 "src/mystery_event_menu.c" 2
# 1 "include/task.h" 1
# 15 "src/mystery_event_menu.c" 2
...
# 21 "src/mystery_event_menu.c" 2
# 1 "include/constants/rgb.h" 1
# 22 "src/mystery_event_menu.c" 2
...
static __attribute__((section("ewram_data"))) u8 sUnknown_0203BCF8 = 0;
...
void CB2_InitMysteryEventMenu(void)
{
    ...
    if (InitWindows(sWindowTemplates))
    {
        ...
        SetGpuReg(0x0, 0x0000 | 0x0040 | 0x0100);
        SetGpuReg(0x50, 0);
...
static void CB2_MysteryEventMenu(void)
{
    ...
    case 11:
        if (gReceivedRemoteLinkPlayers == 0)
        {
            ...
            { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, gDecompressionBuffer, 0x04000000 | 0x01000000 | ((0x7D4)/(32/8) & 0x1FFFFF)); };
