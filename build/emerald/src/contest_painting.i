...
static void CB2_QuitContestPainting(void)
{
    ...
    { Free(gContestMonPixels); gContestMonPixels = ((void *)0); };
...
static void ShowContestPainting(void)
{
    ...
    case 4:
        ...
        { vu32 *_dest = (vu32 *)(0x5000000); u32 _size = 0x400; { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); u32 eval_src = (u32)(&tmp); u32 eval_dst = (u32)(_dest); u32 eval_ctl = (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((_size)/(32/8))); register u32 r_src asm("r0") = eval_src; register u32 r_dst asm("r1") = eval_dst; register u32 r_ctl asm("r2") = eval_ctl; asm volatile("stmia %0!, {%1, %2, %3}" : "+l" (dmaRegs) : "l" (r_src), "l" (r_dst), "l" (r_ctl) : "memory"); }; }; };
...
static void InitContestPaintingWindow(void)
{
    ...
    InitBgsFromTemplates(0, sContestPaintingBgTemplates, (size_t)(sizeof(sContestPaintingBgTemplates) / sizeof((sContestPaintingBgTemplates)[0])));
    ChangeBgX(1, 0, 0);
    ChangeBgY(1, 0, 0);
...
static void LoadContestPaintingFrame(u8 contestWinnerId, bool8 arg1)
{
    ...
    if (arg1 == 1)
    {
        ...
        {
            for (x = 0; x < 18; x++)
                (((u16 *)((0x6000000 + (0x800 * (12)))))[(y + 2) * 32 + (x + 6)]) = (*gContestMonPixels)[y + 2][x + 6];
        }


        for (x = 0; x < 16; x++)
            (((u16 *)((0x6000000 + (0x800 * (12)))))[(2) * 32 + (x + 7)]) = (*gContestMonPixels)[2][7];
    }
...
static void DoContestPaintingImageProcessing(u8 imageEffect)
{
    ...
    gImageProcessingContext.dest = (void *)(0x6000000 + 0x10000);
