# 0 "src/AgbRfu_LinkManager.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/AgbRfu_LinkManager.c"
...
void LoadWirelessStatusIndicatorSpriteGfx(void);
# 4 "src/AgbRfu_LinkManager.c" 2
# 17 "src/AgbRfu_LinkManager.c"
LINK_MANAGER lman;
...
u8 rfu_LMAN_initializeManager(void (*LMAN_callback_p)(u8, u8), void (*MSC_callback_p)(u16))
{
    if (LMAN_callback_p == ((void *)0))
    {
        return 4;
    }
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, &lman, 0x00000000 | 0x01000000 | ((sizeof(struct linkManagerTag))/(16/8) & 0x1FFFFF)); };
    lman.parent_child = 0xff;
...
{
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, &lman, 0x00000000 | 0x01000000 | ((sizeof(struct linkManagerTag) - 8)/(16/8) & 0x1FFFFF)); };
    lman.parent_child = 0xff;
}
...
static void rfu_LMAN_PARENT_stopWaitLinkRecoveryAndDisconnect(u8 bm_targetSlot)
{
    ...
    lman.param[0] = i;
    rfu_LMAN_occureCallback(0x33, i);
}
...
static bool8 rfu_LMAN_linkWatcher(u16 REQ_commandID)
{
    ...
    bool8 disconnect_occure_flag = 0;
...
void rfu_LMAN_manager_entity(u32 rand)
{
    ...
    if (lman.LMAN_callback == ((void *)0) && lman.state != 0x00)
    {
        lman.state = 0x00;
        return;
    }
...
{
    if (lman.state == 0x09 || lman.state == 0x0a || lman.state == 0x0b)
    {
        lman.param[0] = 7;
        rfu_LMAN_occureCallback(0xf3, 1);
        return 7;
