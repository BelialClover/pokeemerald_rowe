...
# 10 "src/item_menu.c" 2
# 1 "include/constants/items.h" 1
# 11 "src/item_menu.c" 2
# 1 "include/constants/songs.h" 1
# 12 "src/item_menu.c" 2
# 1 "include/data.h" 1
...
# 21 "src/item_menu.c" 2
# 1 "include/item.h" 1
# 22 "src/item_menu.c" 2
...
# 23 "src/item_menu.c" 2
# 1 "include/item_use.h" 1
# 24 "src/item_menu.c" 2
...
u8 sub_818E880(void);
# 25 "src/item_menu.c" 2
# 1 "include/list_menu.h" 1
# 26 "src/item_menu.c" 2
# 1 "include/link.h" 1
# 106 "include/link.h"
struct LinkStatus
{
...
# 37 "src/item_menu.c" 2
# 1 "include/pokemon.h" 1
# 38 "src/item_menu.c" 2
...
# 47 "src/item_menu.c" 2
# 1 "include/task.h" 1
# 48 "src/item_menu.c" 2
...
# 49 "src/item_menu.c" 2
# 1 "include/menu_helpers.h" 1
# 50 "src/item_menu.c" 2
...
# 53 "src/item_menu.c" 2
# 1 "include/constants/rgb.h" 1
# 54 "src/item_menu.c" 2
...
static const struct MenuAction sItemMenuActions[] = {
    [0] = {gMenuText_Use, ItemMenu_UseOutOfBattle},
    [1] = {gMenuText_Toss, ItemMenu_Toss},
    [2] = {gMenuText_Register, ItemMenu_Register},
    [3] = {gMenuText_Give, ItemMenu_Give},
    [4] = {gText_Cancel2, ItemMenu_Cancel},
    [5] = {gMenuText_Use, ItemMenu_UseInBattle},
    [6] = {gMenuText_Check, ItemMenu_UseOutOfBattle},
    [7] = {gMenuText_Walk, ItemMenu_UseOutOfBattle},
    [8] = {gMenuText_Deselect, ItemMenu_Deselect},
    [9] = {gMenuText_CheckTag, ItemMenu_CheckTag},
    [10] = {gMenuText_Confirm, Task_FadeAndCloseBagMenu},
    [11] = {gMenuText_Show, unknown_ItemMenu_Show},
    [12] = {gMenuText_Give2, unknown_ItemMenu_Give2},
    [13] = {gMenuText_Confirm, unknown_ItemMenu_Confirm2},
    [14] = {sMenuText_ByName, ItemMenu_SortByName},
    [15] = {sMenuText_ByType, ItemMenu_SortByType},
    [16] = {sMenuText_ByAmount, ItemMenu_SortByAmount},
    [17] = {sMenuText_ByNumber, ItemMenu_SortByNumber},
    [18] = {sMenuText_ByType, ItemMenu_SortByMoveType},
    [19] ={sMenuText_Select, ItemMenu_RegisterSelect},
    [20] = {sMenuText_L, ItemMenu_RegisterL},
    [21] = {sMenuText_R, ItemMenu_RegisterR},
    [22] = {gText_EmptyString2, ((void *)0)}
};
...
static const TaskFunc gUnknown_08614054[] = {
    [0] = Task_ItemContext_FieldOrBattle,
    [1] = Task_ItemContext_FieldOrBattle,
    [2] = Task_ItemContext_FieldGive,
    [3] = Task_ItemContext_Sell,
    [4] = Task_FadeAndCloseBagMenu,
    [5] = Task_ItemContext_FieldOrBattle,
    [6] = Task_ItemContext_Deposit,
    [7] = Task_ItemContext_FieldOrBattle,
    [8] = Task_ItemContext_FieldOrBattle,
    [9] = Task_ItemContext_FieldOrBattle,
    [10] = ((void *)0),
    [11] = Task_ItemContext_ItemPC_2
};
...
struct ListBuffer1 {
    struct ListMenuItem subBuffers[(208 + 1)];
};
...
__attribute__((section("ewram_data"))) struct BagMenuStruct *gBagMenu = 0;
__attribute__((section("ewram_data"))) struct BagStruct gBagPositionStruct = {0};
static __attribute__((section("ewram_data"))) struct ListBuffer1 *sListBuffer1 = 0;
static __attribute__((section("ewram_data"))) struct ListBuffer2 *sListBuffer2 = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_ItemId = 0;
static __attribute__((section("ewram_data"))) struct TempWallyStruct *sTempWallyBag = 0;
static __attribute__((section("ewram_data"))) bool8 sRegisterSubMenu = 0;
...
void CB2_BagMenuFromStartMenu(void)
{
    GoToBagMenu(0, 10, CB2_ReturnToFieldWithOpenMenu);
}

void CB2_BagMenuFromBattle(void)
{
    if (!InBattlePyramid())
        GoToBagMenu(1, 10, CB2_SetUpReshowBattleScreenAfterMenu2);
    else
...
void CB2_ChooseBerry(void)
{
    GoToBagMenu(4, 6, CB2_ReturnToFieldContinueScript);
}


void ChooseBerryForMachine(void (*exitCallback)(void))
{
    GoToBagMenu(5, 6, exitCallback);
}

void CB2_GoToSellMenu(void)
{
    GoToBagMenu(3, 10, CB2_ExitSellMenu);
}

void CB2_GoToItemDepositMenu(void)
{
    GoToBagMenu(6, 10, sub_816B31C);
}

void ApprenticeOpenBagMenu(void)
{
    GoToBagMenu(9, 10, CB2_ApprenticeExitBagMenu);
...
void FavorLadyOpenBagMenu(void)
{
    GoToBagMenu(7, 10, CB2_FavorLadyExitBagMenu);
    gSpecialVar_Result = 0;
}

void QuizLadyOpenBagMenu(void)
{
    GoToBagMenu(8, 10, CB2_QuizLadyExitBagMenu);
    gSpecialVar_Result = 0;
}
...
void GoToBagMenu(u8 location, u8 pocket, void ( *postExitMenuMainCallback2)())
{
    ...
    else
    {
        ...
        if (gBagPositionStruct.location == 4 ||
            gBagPositionStruct.location == 5)
            gBagMenu->pocketSwitchDisabled = 1;
        gBagMenu->exitCallback = ((void *)0);
...
void CB2_Bag(void)
{
    while(MenuHelpers_CallLinkSomething() != 1 && SetupBagMenu() != 1 && MenuHelpers_LinkSomething() != 1) {};
}
...
bool8 SetupBagMenu(void)
{
    ...
    case 13:
        ...
        DrawPocketIndicatorSquare(1, 0);
        DrawPocketIndicatorSquare(7, 0);
        DrawPocketIndicatorSquare(8, 0);
        DrawPocketIndicatorSquare(9, 0);
        DrawPocketIndicatorSquare(gBagPositionStruct.pocket, 1);
        gMain.state++;
        break;
    case 14:
...
bool8 LoadBagMenu_Graphics(void)
{
    switch (gBagMenu->graphicsLoadState)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            if (!IsWallysBag() && gSaveBlock2Ptr->playerGender != 0)
            ...
            break;
        case 3:
            if (IsWallysBag() == 1 || gSaveBlock2Ptr->playerGender == 0)
...
void GetItemName(s8 *dest, u16 itemId)
{
    switch (gBagPositionStruct.pocket)
    {
        case 8:
            ...
            if (itemId >= 682)
            {
                ConvertIntToDecimalStringN(gStringVar1, itemId - 682 + 1, STR_CONV_MODE_LEADING_ZEROS, 2);
                StringExpandPlaceholders(dest, gText_ClearTo11Var1Clear5Var2);
            }
            else
            {
                ConvertIntToDecimalStringN(gStringVar1, itemId - 482 + 1, STR_CONV_MODE_LEADING_ZEROS, 3);
                StringExpandPlaceholders(dest, gText_NumberVar1Clear7Var2);
            }
            break;
        case 6:
            ConvertIntToDecimalStringN(gStringVar1, itemId - 144 + 1, STR_CONV_MODE_LEADING_ZEROS, 2);
...
void BagMenu_ItemPrintCallback(u8 windowId, s32 itemIndex, u8 y)
{
    ...
    if (itemIndex != -2)
    {
        ...
        else if (gBagPositionStruct.pocket != 9 && ItemId_GetImportance(itemId) == 0)
        {
...
{
    if (colorIndex == 0xFF)
        FillWindowPixelRect(0, ((0) | ((0) << 4)), 0, y, GetMenuCursorDimensionByFont(1, 0), GetMenuCursorDimensionByFont(1, 1));
    else
...
void CreatePocketSwitchArrowPair(void)
{
    if (gBagMenu->pocketSwitchDisabled != 1 && gBagMenu->pocketSwitchArrowsTask == 0xFF)
...
void TaskCloseBagMenu_2(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        if (gBagMenu->exitCallback != ((void *)0))
...
void DisplayItemMessage(u8 taskId, u8 fontId, const u8 *str, void (*callback)(u8 taskId))
{
    ...
    FillWindowPixelBuffer(data[10], ((1) | ((1) << 4)));
...
{
    u8 numDigits = (gBagPositionStruct.pocket == 6) ? 3 : 2;
    ...
    if (MenuHelpers_CallLinkSomething() != 1 && !gPaletteFade.active)
    {
        switch (GetSwitchBagPocketDirection())
        {
            ...
            default:
                ...
                {
                    if ((gBagMenu->numItemStacks[gBagPositionStruct.pocket] - 1) <= 1)
                    {
...
static u8 GetSwitchBagPocketDirection(void)
{
    ...
    if ((({(gMain.newKeys) & (0x0020);})) || LRKeys == 1)
    {
        PlaySE(5);
        return SWITCH_POCKET_LEFT;
    }
    if ((({(gMain.newKeys) & (0x0010);})) || LRKeys == 2)
    {
        PlaySE(5);
...
{
    if (deltaBagPocketId == 1 && *bagPocketId == 10 - 1)
        *bagPocketId = 0;
...
static void SwitchBagPocket(u8 taskId, s16 deltaBagPocketId, u16 a3)
{
    ...
    if (a3 == 0)
    {
        ...
        DestroyListMenuTask(data[0], &gBagPositionStruct.scrollPosition[gBagPositionStruct.pocket], &gBagPositionStruct.cursorPosition[gBagPositionStruct.pocket]);
        ScheduleBgCopyTilemapToVram(0);
        gSprites[gBagMenu->spriteId[2 + (gBagMenu->itemIconSlot ^ 1)]].invisible = 1;
        BagDestroyPocketScrollArrowPair();
    }
    ...
    DrawPocketIndicatorSquare(gBagPositionStruct.pocket, 0);
    DrawPocketIndicatorSquare(pocketId, 1);
...
void OpenContextMenu(u8 unused)
{
    switch (gBagPositionStruct.location)
    {
        ...
        case 10:
            if (ItemId_GetBattleUsage(gSpecialVar_ItemId))
            {
                ...
                gBagMenu->contextMenuNumItems = (size_t)(sizeof(sContextMenuItems_BattleUse) / sizeof((sContextMenuItems_BattleUse)[0]));
            }
            else
            {
                gBagMenu->contextMenuItemsPtr = sContextMenuItems_Cancel;
                gBagMenu->contextMenuNumItems = (size_t)(sizeof(sContextMenuItems_Cancel) / sizeof((sContextMenuItems_Cancel)[0]));
            }
            break;
        case 5:
            gBagMenu->contextMenuItemsPtr = sContextMenuItems_BerryBlenderCrush;
            gBagMenu->contextMenuNumItems = (size_t)(sizeof(sContextMenuItems_BerryBlenderCrush) / sizeof((sContextMenuItems_BerryBlenderCrush)[0]));
            break;
        case 9:
            if (!ItemId_GetImportance(gSpecialVar_ItemId) && gSpecialVar_ItemId != 205)
            {
                gBagMenu->contextMenuItemsPtr = sContextMenuItems_Apprentice;
                gBagMenu->contextMenuNumItems = (size_t)(sizeof(sContextMenuItems_Apprentice) / sizeof((sContextMenuItems_Apprentice)[0]));
            }
            else
            {
                gBagMenu->contextMenuItemsPtr = sContextMenuItems_Cancel;
        ...
        case 7:
            if (!ItemId_GetImportance(gSpecialVar_ItemId) && gSpecialVar_ItemId != 205)
            {
                ...
                gBagMenu->contextMenuNumItems = (size_t)(sizeof(sContextMenuItems_FavorLady) / sizeof((sContextMenuItems_FavorLady)[0]));
            }
            else
            {
                gBagMenu->contextMenuItemsPtr = sContextMenuItems_Cancel;
        ...
        case 8:
            if (!ItemId_GetImportance(gSpecialVar_ItemId) && gSpecialVar_ItemId != 205)
            {
                ...
                gBagMenu->contextMenuNumItems = (size_t)(sizeof(sContextMenuItems_QuizLady) / sizeof((sContextMenuItems_QuizLady)[0]));
            }
            else
            {
                gBagMenu->contextMenuItemsPtr = sContextMenuItems_Cancel;
        ...
        case 6:
        default:
            if (MenuHelpers_LinkSomething() == 1 || InUnionRoom() == 1)
            {
                if (gBagPositionStruct.pocket == 9 || !sub_8122148(gSpecialVar_ItemId))
                {
                    gBagMenu->contextMenuItemsPtr = sContextMenuItems_Cancel;
                    gBagMenu->contextMenuNumItems = (size_t)(sizeof(sContextMenuItems_Cancel) / sizeof((sContextMenuItems_Cancel)[0]));
                }
                else
                {
                    ...
                    gBagMenu->contextMenuNumItems = (size_t)(sizeof(sContextMenuItems_Give) / sizeof((sContextMenuItems_Give)[0]));
                }
            }
            else
            {
                switch (gBagPositionStruct.pocket)
                {
                    case 0:
                        ...
                        gBagMenu->contextMenuNumItems = (size_t)(sizeof(sContextMenuItems_ItemsPocket) / sizeof((sContextMenuItems_ItemsPocket)[0]));
                        memcpy(&gBagMenu->contextMenuItemsBuffer, &sContextMenuItems_ItemsPocket, sizeof(sContextMenuItems_ItemsPocket));
                        if (ItemIsMail(gSpecialVar_ItemId) == 1)
                            gBagMenu->contextMenuItemsBuffer[0] = 6;
                        break;
                    case 9:
                        gBagMenu->contextMenuItemsPtr = gBagMenu->contextMenuItemsBuffer;

                        if (sRegisterSubMenu == 0)
                        {
                            gBagMenu->contextMenuNumItems = (size_t)(sizeof(sContextMenuItems_KeyItemsPocket) / sizeof((sContextMenuItems_KeyItemsPocket)[0]));
                            memcpy(&gBagMenu->contextMenuItemsBuffer, &sContextMenuItems_KeyItemsPocket, sizeof(sContextMenuItems_KeyItemsPocket));


                            if (gSpecialVar_ItemId == 455 || gSpecialVar_ItemId == 467)
                            {
                                if (TestPlayerAvatarFlags((1 << 1) | (1 << 2)))
                                    gBagMenu->contextMenuItemsBuffer[0] = 7;
                            }
                        }
                        else
                        {
                            gBagMenu->contextMenuNumItems = (sizeof(sContextMenu_RegisterKeyItem)/sizeof(*(sContextMenu_RegisterKeyItem)));
                        ...
                        if (gSaveBlock1Ptr->registeredItemSelect == gSpecialVar_ItemId)
                            gBagMenu->contextMenuItemsBuffer[1] = 8;
                    ...
                    case 2:
                        ...
                        gBagMenu->contextMenuNumItems = (size_t)(sizeof(sContextMenuItems_BallsPocket) / sizeof((sContextMenuItems_BallsPocket)[0]));
                        break;
                    case 8:
                        gBagMenu->contextMenuItemsPtr = sContextMenuItems_TmHmPocket;
                        gBagMenu->contextMenuNumItems = (size_t)(sizeof(sContextMenuItems_TmHmPocket) / sizeof((sContextMenuItems_TmHmPocket)[0]));
                        break;
                    case 6:
                        gBagMenu->contextMenuItemsPtr = sContextMenuItems_BerriesPocket;
                        gBagMenu->contextMenuNumItems = (size_t)(sizeof(sContextMenuItems_BerriesPocket) / sizeof((sContextMenuItems_BerriesPocket)[0]));
                        break;
                    case 1:
                    case 3:
                    case 7:
    ...
    if (gBagPositionStruct.pocket == 8)
    {
        ClearWindowTilemap(1);
...
void Task_HandleOutOfBattleItemMenuInput(u8 taskId)
{
    if (MenuHelpers_CallLinkSomething() != 1)
    {
        ...
        if (({(gMain.newKeys) & (0x0040);}))
        {
            ...
            {
                PlaySE(5);
                ChangeListMenuCursorPosition(0, -1);
            }
        }
        ...
        else if ((({(gMain.newKeys) & (0x0020);})) || GetLRKeysPressed() == 1)
        {
            ...
            {
                PlaySE(5);
                ChangeListMenuCursorPosition(-1, 0);
            }
        }
...
bool8 sub_81ACDFC(s8 a)
{
    ...
    if (a > gBagMenu->contextMenuNumItems)
        return 0;
    if (gBagMenu->contextMenuItemsPtr[a] == 22)
        return 0;
    return 1;
}
...
void Task_ChooseHowManyToToss(u8 taskId)
{
    ...
    {
        PrintItemDepositAmount(gBagMenu->windowPointers[7], data[8]);
    }
    else if (({(gMain.newKeys) & (0x0001);}))
    {
        PlaySE(5);
...
void Task_ItemContext_FieldGive(u8 taskId)
{
    ...
    else if (gBagPositionStruct.pocket != 9 && !ItemId_GetImportance(gSpecialVar_ItemId))
    {
        Task_FadeAndCloseBagMenu(taskId);
    }
    else
...
void Task_ItemContext_Sell(u8 taskId)
{
    ...
    if (ItemId_GetPrice(gSpecialVar_ItemId) == 0 || ItemId_GetImportance(gSpecialVar_ItemId) > 0)
    {
...
static void Task_SellHowManyDialogueHandleInput(u8 taskId)
{
    ...
    if (AdjustQuantityAccordingToDPadInput(&data[8], data[2]) == 1)
    {
        PrintItemSoldAmount(gBagMenu->windowPointers[8], data[8], (ItemId_GetPrice(gSpecialVar_ItemId) / 2) * data[8]);
    }
    else if (({(gMain.newKeys) & (0x0001);}))
    {
        PlaySE(5);
...
static void BagMenu_TryDepositItem(u8 taskId)
{
    ...
    else if (AddPCItem(gSpecialVar_ItemId, data[8]) == 1)
    {
        CopyItemName(gSpecialVar_ItemId, gStringVar1);
        ConvertIntToDecimalStringN(gStringVar2, data[8], STR_CONV_MODE_LEFT_ALIGN, 3);
...
void PrepareBagForWallyTutorial(void)
{
    ...
    ClearItemSlots(gSaveBlock1Ptr->bagPocket_Medicine, 40);
    ClearItemSlots(gSaveBlock1Ptr->bagPocket_PokeBalls, 31);
...
void DoWallyTutorialBagMenu(void)
{
    ...
    AddBagItem(28, 1);
    AddBagItem(4, 1);
    GoToBagMenu(10, 1, CB2_SetUpReshowBattleScreenAfterMenu2);
}
...
void BagMenu_PrintPocketNames(const u8 *pocketName1, const u8 *pocketName2)
{
    ...
    CpuSet((u8*)GetWindowAttribute(windowId, WINDOW_TILE_DATA), gBagMenu->pocketNameBuffer, 0x04000000 | ((0x400)/(32/8) & 0x1FFFFF));
...
void BagMenu_CopyPocketNameToWindow(u32 a)
{
    ...
    CpuSet(r4[0][a], windowAttribute, 0x04000000 | ((0x100)/(32/8) & 0x1FFFFF));
    b = a + 16;
    CpuSet(r4[0][b], windowAttribute + 0x100, 0x04000000 | ((0x100)/(32/8) & 0x1FFFFF));
...
void BagMenu_RemoveBagItemMessageindow(u8 which)
{
    ...
    if (*ptr != 0xFF)
    {
        ClearDialogWindowAndFrameToTransparent(*ptr, 0);
...
void BagMenu_PrepareTMHMMoveWindow(void)
{
    ...
    BlitMenuInfoIcon(3, (19 + 1), 0, 0);
    BlitMenuInfoIcon(3, (19 + 2), 0, 12);
    BlitMenuInfoIcon(3, (19 + 3), 0, 24);
    BlitMenuInfoIcon(3, (19 + 4), 0, 36);
...
static const u16 sItemsByType[773] =
{
    [90] = ITEM_TYPE_FIELD_USE,
    [91] = ITEM_TYPE_FIELD_USE,
    [92] = ITEM_TYPE_FIELD_USE,
    [89] = ITEM_TYPE_FIELD_USE,
    [125] = ITEM_TYPE_FIELD_USE,

    [28] = ITEM_TYPE_HEALTH_RECOVERY,
    [34] = ITEM_TYPE_HEALTH_RECOVERY,
    [35] = ITEM_TYPE_HEALTH_RECOVERY,
    [36] = ITEM_TYPE_HEALTH_RECOVERY,
    [37] = ITEM_TYPE_HEALTH_RECOVERY,
    [39] = ITEM_TYPE_HEALTH_RECOVERY,
    [40] = ITEM_TYPE_HEALTH_RECOVERY,
    [41] = ITEM_TYPE_HEALTH_RECOVERY,
    [42] = ITEM_TYPE_HEALTH_RECOVERY,
    [43] = ITEM_TYPE_HEALTH_RECOVERY,
    [44] = ITEM_TYPE_HEALTH_RECOVERY,
    [45] = ITEM_TYPE_HEALTH_RECOVERY,
    [46] = ITEM_TYPE_HEALTH_RECOVERY,
    [48] = ITEM_TYPE_HEALTH_RECOVERY,
    [60] = ITEM_TYPE_HEALTH_RECOVERY,
    [59] = ITEM_TYPE_HEALTH_RECOVERY,
    [63] = ITEM_TYPE_HEALTH_RECOVERY,

    [29] = ITEM_TYPE_STATUS_RECOVERY,
    [30] = ITEM_TYPE_STATUS_RECOVERY,
    [31] = ITEM_TYPE_STATUS_RECOVERY,
    [32] = ITEM_TYPE_STATUS_RECOVERY,
    [33] = ITEM_TYPE_STATUS_RECOVERY,
    [38] = ITEM_TYPE_STATUS_RECOVERY,
    [53] = ITEM_TYPE_STATUS_RECOVERY,
    [130] = ITEM_TYPE_STATUS_RECOVERY,
    [61] = ITEM_TYPE_STATUS_RECOVERY,




    [62] = ITEM_TYPE_STATUS_RECOVERY,
    [47] = ITEM_TYPE_STATUS_RECOVERY,
    [49] = ITEM_TYPE_PP_RECOVERY,
    [50] = ITEM_TYPE_PP_RECOVERY,
    [51] = ITEM_TYPE_PP_RECOVERY,
    [52] = ITEM_TYPE_PP_RECOVERY,

    [70] = ITEM_TYPE_STAT_BOOST_DRINK,
    [71] = ITEM_TYPE_STAT_BOOST_DRINK,
    [72] = ITEM_TYPE_STAT_BOOST_DRINK,
    [73] = ITEM_TYPE_STAT_BOOST_DRINK,
    [74] = ITEM_TYPE_STAT_BOOST_DRINK,
    [75] = ITEM_TYPE_STAT_BOOST_DRINK,
    [76] = ITEM_TYPE_STAT_BOOST_DRINK,
    [77] = ITEM_TYPE_STAT_BOOST_DRINK,
 ...
 [691] = ITEM_TYPE_STAT_BOOST_DRINK,
    ...
    [96] = ITEM_TYPE_STAT_BOOST_WING,
    [97] = ITEM_TYPE_STAT_BOOST_WING,
    [98] = ITEM_TYPE_STAT_BOOST_WING,
    [99] = ITEM_TYPE_STAT_BOOST_WING,
    [100] = ITEM_TYPE_STAT_BOOST_WING,

    [259] = ITEM_TYPE_STAT_BOOST_HELD_ITEM,
    [260] = ITEM_TYPE_STAT_BOOST_HELD_ITEM,
    [261] = ITEM_TYPE_STAT_BOOST_HELD_ITEM,
    [262] = ITEM_TYPE_STAT_BOOST_HELD_ITEM,
    [263] = ITEM_TYPE_STAT_BOOST_HELD_ITEM,
    [264] = ITEM_TYPE_STAT_BOOST_HELD_ITEM,
    [213] = ITEM_TYPE_STAT_BOOST_HELD_ITEM,

    [101] = ITEM_TYPE_EVOLUTION_STONE,
    [102] = ITEM_TYPE_EVOLUTION_STONE,
    [103] = ITEM_TYPE_EVOLUTION_STONE,
    [104] = ITEM_TYPE_EVOLUTION_STONE,
    [105] = ITEM_TYPE_EVOLUTION_STONE,
    [106] = ITEM_TYPE_EVOLUTION_STONE,
    [107] = ITEM_TYPE_EVOLUTION_STONE,
    [108] = ITEM_TYPE_EVOLUTION_STONE,
    [109] = ITEM_TYPE_EVOLUTION_STONE,
    [110] = ITEM_TYPE_EVOLUTION_STONE,
    [231] = ITEM_TYPE_EVOLUTION_STONE,

    [219] = ITEM_TYPE_EVOLUTION_ITEM,
    [358] = ITEM_TYPE_EVOLUTION_ITEM,
    [359] = ITEM_TYPE_EVOLUTION_ITEM,
    [224] = ITEM_TYPE_EVOLUTION_ITEM,
    [228] = ITEM_TYPE_EVOLUTION_ITEM,
    [230] = ITEM_TYPE_EVOLUTION_ITEM,
    [257] = ITEM_TYPE_EVOLUTION_ITEM,
    [232] = ITEM_TYPE_EVOLUTION_ITEM,
    [234] = ITEM_TYPE_EVOLUTION_ITEM,
    [239] = ITEM_TYPE_EVOLUTION_ITEM,
    [241] = ITEM_TYPE_EVOLUTION_ITEM,
    [240] = ITEM_TYPE_EVOLUTION_ITEM,
    [237] = ITEM_TYPE_EVOLUTION_ITEM,
    [238] = ITEM_TYPE_EVOLUTION_ITEM,
    [236] = ITEM_TYPE_EVOLUTION_ITEM,
    [235] = ITEM_TYPE_EVOLUTION_ITEM,
    [233] = ITEM_TYPE_EVOLUTION_ITEM,

    [79] = ITEM_TYPE_BATTLE_ITEM,
    [80] = ITEM_TYPE_BATTLE_ITEM,
    [81] = ITEM_TYPE_BATTLE_ITEM,
    [82] = ITEM_TYPE_BATTLE_ITEM,
    [83] = ITEM_TYPE_BATTLE_ITEM,
    [84] = ITEM_TYPE_BATTLE_ITEM,
    [85] = ITEM_TYPE_BATTLE_ITEM,
    [86] = ITEM_TYPE_BATTLE_ITEM,
    [87] = ITEM_TYPE_BATTLE_ITEM,
    [88] = ITEM_TYPE_BATTLE_ITEM,

    [211] = ITEM_TYPE_HELD_ITEM,
    [212] = ITEM_TYPE_HELD_ITEM,
    [214] = ITEM_TYPE_HELD_ITEM,
    [215] = ITEM_TYPE_HELD_ITEM,
    [216] = ITEM_TYPE_HELD_ITEM,
    [217] = ITEM_TYPE_HELD_ITEM,
    [218] = ITEM_TYPE_HELD_ITEM,
    [220] = ITEM_TYPE_HELD_ITEM,
    [221] = ITEM_TYPE_HELD_ITEM,
    [222] = ITEM_TYPE_HELD_ITEM,
    [357] = ITEM_TYPE_HELD_ITEM,
    [223] = ITEM_TYPE_HELD_ITEM,
    [225] = ITEM_TYPE_HELD_ITEM,
    [226] = ITEM_TYPE_HELD_ITEM,
    [227] = ITEM_TYPE_HELD_ITEM,
    [229] = ITEM_TYPE_HELD_ITEM,
    [364] = ITEM_TYPE_HELD_ITEM,
    [242] = ITEM_TYPE_HELD_ITEM,
    [243] = ITEM_TYPE_HELD_ITEM,
    [244] = ITEM_TYPE_HELD_ITEM,
    [245] = ITEM_TYPE_HELD_ITEM,
    [246] = ITEM_TYPE_HELD_ITEM,
    [247] = ITEM_TYPE_HELD_ITEM,
    [248] = ITEM_TYPE_HELD_ITEM,
    [249] = ITEM_TYPE_HELD_ITEM,
    [250] = ITEM_TYPE_HELD_ITEM,
    [251] = ITEM_TYPE_HELD_ITEM,
    [252] = ITEM_TYPE_HELD_ITEM,
    [253] = ITEM_TYPE_HELD_ITEM,
    [254] = ITEM_TYPE_HELD_ITEM,
    [255] = ITEM_TYPE_HELD_ITEM,
    [256] = ITEM_TYPE_HELD_ITEM,
    [258] = ITEM_TYPE_HELD_ITEM,
    [360] = ITEM_TYPE_HELD_ITEM,
    [361] = ITEM_TYPE_HELD_ITEM,
    [362] = ITEM_TYPE_HELD_ITEM,
    [363] = ITEM_TYPE_HELD_ITEM,
    [367] = ITEM_TYPE_HELD_ITEM,
    [368] = ITEM_TYPE_HELD_ITEM,
    [369] = ITEM_TYPE_HELD_ITEM,
    [274] = ITEM_TYPE_HELD_ITEM,
    [265] = ITEM_TYPE_HELD_ITEM,
    [269] = ITEM_TYPE_HELD_ITEM,
    [270] = ITEM_TYPE_HELD_ITEM,
    [280] = ITEM_TYPE_HELD_ITEM,
    [277] = ITEM_TYPE_HELD_ITEM,
    [279] = ITEM_TYPE_HELD_ITEM,
    [278] = ITEM_TYPE_HELD_ITEM,
    [276] = ITEM_TYPE_HELD_ITEM,
    [290] = ITEM_TYPE_HELD_ITEM,
    [275] = ITEM_TYPE_HELD_ITEM,
    [305] = ITEM_TYPE_HELD_ITEM,
    [293] = ITEM_TYPE_HELD_ITEM,
    [303] = ITEM_TYPE_HELD_ITEM,
    [304] = ITEM_TYPE_HELD_ITEM,
    [291] = ITEM_TYPE_HELD_ITEM,
    [299] = ITEM_TYPE_HELD_ITEM,
    [294] = ITEM_TYPE_HELD_ITEM,
    [306] = ITEM_TYPE_HELD_ITEM,
    [297] = ITEM_TYPE_HELD_ITEM,
    [300] = ITEM_TYPE_HELD_ITEM,
    [298] = ITEM_TYPE_HELD_ITEM,
    [292] = ITEM_TYPE_HELD_ITEM,
    [268] = ITEM_TYPE_HELD_ITEM,
    [281] = ITEM_TYPE_HELD_ITEM,
    [287] = ITEM_TYPE_HELD_ITEM,
    [288] = ITEM_TYPE_HELD_ITEM,
    [301] = ITEM_TYPE_HELD_ITEM,
    [365] = ITEM_TYPE_HELD_ITEM,
    [271] = ITEM_TYPE_HELD_ITEM,
    [272] = ITEM_TYPE_HELD_ITEM,
    [308] = ITEM_TYPE_HELD_ITEM,
    [295] = ITEM_TYPE_HELD_ITEM,
    [296] = ITEM_TYPE_HELD_ITEM,
    [289] = ITEM_TYPE_HELD_ITEM,
    [302] = ITEM_TYPE_HELD_ITEM,
    [285] = ITEM_TYPE_HELD_ITEM,
    [307] = ITEM_TYPE_HELD_ITEM,
    [273] = ITEM_TYPE_HELD_ITEM,
    [309] = ITEM_TYPE_HELD_ITEM,
    [312] = ITEM_TYPE_HELD_ITEM,
    [311] = ITEM_TYPE_HELD_ITEM,
    [310] = ITEM_TYPE_HELD_ITEM,
    [282] = ITEM_TYPE_HELD_ITEM,
    [283] = ITEM_TYPE_HELD_ITEM,
    [284] = ITEM_TYPE_HELD_ITEM,
    [286] = ITEM_TYPE_HELD_ITEM,
    [267] = ITEM_TYPE_HELD_ITEM,
    [266] = ITEM_TYPE_HELD_ITEM,
    ...
    [376] = ITEM_TYPE_MEMORY,
    [378] = ITEM_TYPE_MEMORY,
    [383] = ITEM_TYPE_MEMORY,
    [381] = ITEM_TYPE_MEMORY,
    [385] = ITEM_TYPE_MEMORY,
    [371] = ITEM_TYPE_MEMORY,
    [379] = ITEM_TYPE_MEMORY,
    [386] = ITEM_TYPE_MEMORY,
    [377] = ITEM_TYPE_MEMORY,
    [387] = ITEM_TYPE_MEMORY,
    [380] = ITEM_TYPE_MEMORY,
    [374] = ITEM_TYPE_MEMORY,
    [384] = ITEM_TYPE_MEMORY,
    [382] = ITEM_TYPE_MEMORY,
    [373] = ITEM_TYPE_MEMORY,
    [372] = ITEM_TYPE_MEMORY,
    [375] = ITEM_TYPE_MEMORY,
    ...
    [313] = ITEM_TYPE_INCENSE,
    [314] = ITEM_TYPE_INCENSE,
    [320] = ITEM_TYPE_INCENSE,
    [317] = ITEM_TYPE_INCENSE,
    [315] = ITEM_TYPE_INCENSE,
    [321] = ITEM_TYPE_INCENSE,
    [316] = ITEM_TYPE_INCENSE,
    [319] = ITEM_TYPE_INCENSE,
    [318] = ITEM_TYPE_INCENSE,

    [443] = ITEM_TYPE_MEGA_STONE,
    [410] = ITEM_TYPE_MEGA_STONE,
    [411] = ITEM_TYPE_MEGA_STONE,
    [407] = ITEM_TYPE_MEGA_STONE,
    [406] = ITEM_TYPE_MEGA_STONE,
    [432] = ITEM_TYPE_MEGA_STONE,
    [401] = ITEM_TYPE_MEGA_STONE,
    [439] = ITEM_TYPE_MEGA_STONE,
    [416] = ITEM_TYPE_MEGA_STONE,
    [421] = ITEM_TYPE_MEGA_STONE,
    [433] = ITEM_TYPE_MEGA_STONE,
    [418] = ITEM_TYPE_MEGA_STONE,
    [399] = ITEM_TYPE_MEGA_STONE,
    [430] = ITEM_TYPE_MEGA_STONE,
    [431] = ITEM_TYPE_MEGA_STONE,
    [403] = ITEM_TYPE_MEGA_STONE,
    [440] = ITEM_TYPE_MEGA_STONE,
    [437] = ITEM_TYPE_MEGA_STONE,
    [419] = ITEM_TYPE_MEGA_STONE,
    [420] = ITEM_TYPE_MEGA_STONE,
    [442] = ITEM_TYPE_MEGA_STONE,
    [436] = ITEM_TYPE_MEGA_STONE,
    [408] = ITEM_TYPE_MEGA_STONE,
    [441] = ITEM_TYPE_MEGA_STONE,
    [415] = ITEM_TYPE_MEGA_STONE,
    [434] = ITEM_TYPE_MEGA_STONE,
    [427] = ITEM_TYPE_MEGA_STONE,
    [400] = ITEM_TYPE_MEGA_STONE,
    [428] = ITEM_TYPE_MEGA_STONE,
    [426] = ITEM_TYPE_MEGA_STONE,
    [438] = ITEM_TYPE_MEGA_STONE,
    [409] = ITEM_TYPE_MEGA_STONE,
    [402] = ITEM_TYPE_MEGA_STONE,
    [405] = ITEM_TYPE_MEGA_STONE,
    [398] = ITEM_TYPE_MEGA_STONE,
    [417] = ITEM_TYPE_MEGA_STONE,
    [435] = ITEM_TYPE_MEGA_STONE,
    [429] = ITEM_TYPE_MEGA_STONE,
    [422] = ITEM_TYPE_MEGA_STONE,
    [423] = ITEM_TYPE_MEGA_STONE,
    [424] = ITEM_TYPE_MEGA_STONE,
    [414] = ITEM_TYPE_MEGA_STONE,
    [425] = ITEM_TYPE_MEGA_STONE,
    [397] = ITEM_TYPE_MEGA_STONE,
    [413] = ITEM_TYPE_MEGA_STONE,
    [404] = ITEM_TYPE_MEGA_STONE,
    [412] = ITEM_TYPE_MEGA_STONE,
...
# 3029 "src/item_menu.c"
    ...
    [126] = ITEM_TYPE_NECTAR,
    [127] = ITEM_TYPE_NECTAR,
    [128] = ITEM_TYPE_NECTAR,
    [129] = ITEM_TYPE_NECTAR,

    [64] = ITEM_TYPE_SELLABLE,
    [65] = ITEM_TYPE_SELLABLE,
    [118] = ITEM_TYPE_SELLABLE,
    [119] = ITEM_TYPE_SELLABLE,
    [120] = ITEM_TYPE_SELLABLE,
    [121] = ITEM_TYPE_SELLABLE,
    [122] = ITEM_TYPE_SELLABLE,
    [123] = ITEM_TYPE_SELLABLE,
    [124] = ITEM_TYPE_SELLABLE,
    [131] = ITEM_TYPE_SELLABLE,
...
# 3067 "src/item_menu.c"
    ...
    [447] = ITEM_TYPE_FOSSIL,
    [448] = ITEM_TYPE_FOSSIL,
    [695] = ITEM_TYPE_FOSSIL,
    [453] = ITEM_TYPE_FOSSIL,
    [454] = ITEM_TYPE_FOSSIL,
    [446] = ITEM_TYPE_FOSSIL,
    [445] = ITEM_TYPE_FOSSIL,
    [449] = ITEM_TYPE_FOSSIL,
    [450] = ITEM_TYPE_FOSSIL,
    [451] = ITEM_TYPE_FOSSIL,
    [452] = ITEM_TYPE_FOSSIL,
...
static void AddBagSortSubMenu(void)
{
    switch (gBagPositionStruct.pocket + 1)
    {
        case 10:
            ...
            memcpy(&gBagMenu->contextMenuItemsBuffer, &sBagMenuSortKeyItems, (sizeof(sBagMenuSortKeyItems)/sizeof(*(sBagMenuSortKeyItems))));
            gBagMenu->contextMenuNumItems = (sizeof(sBagMenuSortKeyItems)/sizeof(*(sBagMenuSortKeyItems)));
            break;
        case 9:
            gBagMenu->contextMenuItemsPtr = sBagMenuSortTMHMs;
            memcpy(&gBagMenu->contextMenuItemsBuffer, &sBagMenuSortTMHMs, (sizeof(sBagMenuSortTMHMs)/sizeof(*(sBagMenuSortTMHMs))));
            gBagMenu->contextMenuNumItems = (sizeof(sBagMenuSortTMHMs)/sizeof(*(sBagMenuSortTMHMs)));
            break;
        case 7:
            gBagMenu->contextMenuItemsPtr = sBagMenuSortBerries;
            memcpy(&gBagMenu->contextMenuItemsBuffer, &sBagMenuSortBerries, (sizeof(sBagMenuSortBerries)/sizeof(*(sBagMenuSortBerries))));
            gBagMenu->contextMenuNumItems = (sizeof(sBagMenuSortBerries)/sizeof(*(sBagMenuSortBerries)));
            break;
        case 3:
            gBagMenu->contextMenuItemsPtr = sBagMenuSortPokeBalls;
            memcpy(&gBagMenu->contextMenuItemsBuffer, &sBagMenuSortPokeBalls, (sizeof(sBagMenuSortPokeBalls)/sizeof(*(sBagMenuSortPokeBalls))));
            gBagMenu->contextMenuNumItems = (sizeof(sBagMenuSortPokeBalls)/sizeof(*(sBagMenuSortPokeBalls)));
            break;
        default:
            gBagMenu->contextMenuItemsPtr = sBagMenuSortItems;
            memcpy(&gBagMenu->contextMenuItemsBuffer, &sBagMenuSortItems, (sizeof(sBagMenuSortItems)/sizeof(*(sBagMenuSortItems))));
            gBagMenu->contextMenuNumItems = (sizeof(sBagMenuSortItems)/sizeof(*(sBagMenuSortItems)));
            break;
    }
...
static void ItemMenu_SortByAmount(u8 taskId)
{
    gTasks[taskId].data[2] = SORT_BY_AMOUNT;
    StringCopy(gStringVar1, sSortTypeStrings[SORT_BY_AMOUNT]);
    gTasks[taskId].func = SortBagItems;
}
static void ItemMenu_SortByNumber(u8 taskId)
{
    gTasks[taskId].data[2] = SORT_BY_NUMBER;
    StringCopy(gStringVar1, sSortTypeStrings[SORT_BY_NUMBER]);
    gTasks[taskId].func = SortBagItems;
}
static void ItemMenu_SortByMoveType(u8 taskId)
{
    gTasks[taskId].data[2] = SORT_BY_MOVE_TYPE;
    StringCopy(gStringVar1, sSortTypeStrings[SORT_BY_MOVE_TYPE]);
    gTasks[taskId].func = SortBagItems;
}
...
void SortItemsInBag(u8 pocket, u8 type)
{
    ...
    case 3:
        ...
        break;
    case 4:
        itemMem = gSaveBlock1Ptr->bagPocket_TypeItems;
        itemAmount = 80;
        break;
    case 5:
...
static s8 CompareItemsAlphabetically(struct ItemSlot* itemSlot1, struct ItemSlot* itemSlot2)
{
    ...
    for (i = 0; ; ++i)
    {
        if (name1[i] == 0xFF && name2[i] != 0xFF)
            return -1;
        else if (name1[i] != 0xFF && name2[i] == 0xFF)
            return 1;
        else if (name1[i] == 0xFF && name2[i] == 0xFF)
            return 0;
...
static s8 CompareItemsByMost(struct ItemSlot* itemSlot1, struct ItemSlot* itemSlot2)
{
    ...
    if (itemSlot1->itemId == 0)
        return 1;
    else if (itemSlot2->itemId == 0)
        return -1;
    ...
    return CompareItemsAlphabetically(itemSlot1, itemSlot2);
}
...
static s8 CompareItemsById(struct ItemSlot* itemSlot1, struct ItemSlot* itemSlot2)
{
    ...
    return CompareItemsByMost(itemSlot1, itemSlot2);
}

static s8 CompareItemsByMoveType(struct ItemSlot* itemSlot1, struct ItemSlot* itemSlot2)
{
    u16 moveId1 = ItemIdToBattleMoveId(itemSlot1->itemId);
    u16 moveId2 = ItemIdToBattleMoveId(itemSlot2->itemId);
    ...
    if (gBattleMoves[moveId2].type < gBattleMoves[moveId1].type)
        return 1;
    else if (gBattleMoves[moveId2].type > gBattleMoves[moveId1].type)
        return -1;
...
static s8 CompareItemsByType(struct ItemSlot* itemSlot1, struct ItemSlot* itemSlot2)
{
    ...
    u8 type1 = (itemSlot1->itemId == 0) ? 0xFF : sItemsByType[itemSlot1->itemId];
    u8 type2 = (itemSlot2->itemId == 0) ? 0xFF : sItemsByType[itemSlot2->itemId];
...
bool8 UseRegisteredKeyItemOnField(u8 button)
{
    ...
    if (InUnionRoom() == 1 || InBattlePyramid() || InBattlePike() || InMultiPartnerRoom() == 1)
        return 0;
    ...
    if (registeredItem != 0)
    {
        if (CheckBagHasItem(registeredItem, 1) == 1)
        {
