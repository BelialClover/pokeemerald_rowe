# 0 "src/battle_records.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_records.c"
...
# 20 "src/battle_records.c" 2
# 1 "include/constants/songs.h" 1
# 21 "src/battle_records.c" 2
# 1 "gflib/malloc.h" 1
# 15 "gflib/malloc.h"
extern u8 gHeap[];
...
# 23 "src/battle_records.c" 2
# 1 "include/constants/game_stat.h" 1
# 24 "src/battle_records.c" 2
...
# 25 "src/battle_records.c" 2
# 1 "include/constants/rgb.h" 1
# 26 "src/battle_records.c" 2
...
__attribute__((section("ewram_data"))) u8 gRecordsWindowId = 0;
__attribute__((section("ewram_data"))) static u8 *sTilemapBuffer = ((void *)0);
...
{
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, record, 0x00000000 | 0x01000000 | ((sizeof(struct LinkBattleRecord))/(16/8) & 0x1FFFFF)); };
    record->name[0] = 0xFF;
    record->trainerId = 0;
    record->wins = 0;
    record->losses = 0;
...
static void UpdateTrainerCardWinsLosses(s32 battlerId)
{
    ...
    {
    case 1:
        IncTrainerCardWins(((battlerId) ^ 1));
        IncTrainerCardLosses(battlerId);
        break;
    case 2:
        IncTrainerCardLosses(((battlerId) ^ 1));
...
static void PrintLinkBattleWinsLossesDraws(struct LinkBattleRecord *records)
{
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar4, x, 0x11, 0, ((void *)0));
}
...
static void PrintLinkBattleRecord(struct LinkBattleRecord *record, u8 y, s32 language)
{
    if (record->wins == 0 && record->losses == 0 && record->draws == 0)
    {
        ...
        AddTextPrinterParameterized(gRecordsWindowId, 1, sText_DashesNoPlayer, 8, (y * 8) + 1, 0, ((void *)0));
        AddTextPrinterParameterized(gRecordsWindowId, 1, sText_DashesNoScore, 80, (y * 8) + 1, 0, ((void *)0));
        AddTextPrinterParameterized(gRecordsWindowId, 1, sText_DashesNoScore, 128, (y * 8) + 1, 0, ((void *)0));
        AddTextPrinterParameterized(gRecordsWindowId, 1, sText_DashesNoScore, 176, (y * 8) + 1, 0, ((void *)0));
    }
    else
    {
        ...
        AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar1, 8, (y * 8) + 1, 0, ((void *)0));

        ConvertIntToDecimalStringN(gStringVar1, record->wins, STR_CONV_MODE_RIGHT_ALIGN, 4);
        AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar1, 80, (y * 8) + 1, 0, ((void *)0));

        ConvertIntToDecimalStringN(gStringVar1, record->losses, STR_CONV_MODE_RIGHT_ALIGN, 4);
        AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar1, 128, (y * 8) + 1, 0, ((void *)0));

        ConvertIntToDecimalStringN(gStringVar1, record->draws, STR_CONV_MODE_RIGHT_ALIGN, 4);
        AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar1, 176, (y * 8) + 1, 0, ((void *)0));
    }
}
...
void ShowLinkBattleRecords(void)
{
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar4, x, 1, 0, ((void *)0));
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar4, 0, 41, 0, ((void *)0));
...
void RemoveRecordsWindow(void)
{
    ClearStdWindowAndFrame(gRecordsWindowId, 0);
...
static void ClearVramOamPlttRegs(void)
{
    ...
    { vu32 *_dest = (vu32 *)(0x7000000); u32 _size = 0x400; { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); u32 eval_src = (u32)(&tmp); u32 eval_dst = (u32)(_dest); u32 eval_ctl = (u32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((_size)/(32/8))); register u32 r_src asm("r0") = eval_src; register u32 r_dst asm("r1") = eval_dst; register u32 r_ctl asm("r2") = eval_ctl; asm volatile("stmia %0!, {%1, %2, %3}" : "+l" (dmaRegs) : "l" (r_src), "l" (r_dst), "l" (r_ctl) : "memory"); }; }; };
    { vu16 *_dest = (vu16 *)(0x5000000); u32 _size = 0x400; { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); u32 eval_src = (u32)(&tmp); u32 eval_dst = (u32)(_dest); u32 eval_ctl = (u32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((_size)/(16/8))); register u32 r_src asm("r0") = eval_src; register u32 r_dst asm("r1") = eval_dst; register u32 r_ctl asm("r2") = eval_ctl; asm volatile("stmia %0!, {%1, %2, %3}" : "+l" (dmaRegs) : "l" (r_src), "l" (r_dst), "l" (r_ctl) : "memory"); }; }; };
...
{
    SetGpuReg(0x0, 0x0100 | 0x0800 | 0x0040);
}
...
static void CB2_ShowTrainerHillRecords(void)
{
    ...
    case 2:
        ...
        InitBgsFromTemplates(0, sTrainerHillRecordsBgTemplates, (size_t)(sizeof(sTrainerHillRecordsBgTemplates) / sizeof((sTrainerHillRecordsBgTemplates)[0])));
    ...
    case 3:
        ...
        break;
    case 4:
        if (IsDma3ManagerBusyWithBgCopy() != 1)
        {
            ShowBg(0);
            ShowBg(3);
