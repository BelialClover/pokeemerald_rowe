# 0 "src/fldeff_flash.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/fldeff_flash.c"
...
# 2 "src/fldeff_flash.c" 2
# 1 "include/braille_puzzles.h" 1
...
# 14 "src/fldeff_flash.c" 2

# 1 "include/task.h" 1
# 16 "src/fldeff_flash.c" 2
# 1 "include/constants/songs.h" 1
# 17 "src/fldeff_flash.c" 2
# 1 "include/constants/map_types.h" 1
# 18 "src/fldeff_flash.c" 2
...
{
    {1, 4, 1, 0, DoEnterCaveTransition},
    {2, 4, 1, 0, DoEnterCaveTransition},
    {3, 4, 1, 0, DoEnterCaveTransition},
    {5, 4, 1, 0, DoEnterCaveTransition},
    {6, 4, 1, 0, DoEnterCaveTransition},
    {7, 4, 1, 0, DoEnterCaveTransition},
    {8, 4, 1, 0, DoEnterCaveTransition},
    {9, 4, 1, 0, DoEnterCaveTransition},
    {4, 1, 0, 1, DoExitCaveTransition},
    {4, 2, 0, 1, DoExitCaveTransition},
    {4, 3, 0, 1, DoExitCaveTransition},
    {4, 5, 0, 1, DoExitCaveTransition},
    {4, 6, 0, 1, DoExitCaveTransition},
    {4, 7, 0, 1, DoExitCaveTransition},
    {4, 8, 0, 1, DoExitCaveTransition},
    {4, 9, 0, 1, DoExitCaveTransition},
    {},
};
...
bool8 SetUpFieldMove_Flash(void)
{
    ...
    else if (gMapHeader.cave == 1 && !FlagGet((((0x500 + 864 - 1) + 1) + 0x28)))
    {
        gFieldCallback2 = FieldCallback_PrepareFadeInFromMenu;
...
{
    SetGpuReg(0x0, 0);
    LZ77UnCompVram(gCaveTransitionTiles, (void *)(0x6000000 + 0xC000));
    LZ77UnCompVram(gCaveTransitionTilemap, (void *)(0x6000000 + 0xF800));
