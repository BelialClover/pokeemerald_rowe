...
# 16 "src/main_menu.c" 2
# 1 "include/menu.h" 1
# 17 "src/main_menu.c" 2
# 1 "include/list_menu.h" 1
# 18 "src/main_menu.c" 2
# 1 "include/mystery_event_menu.h" 1



void CB2_InitMysteryEventMenu(void);
# 19 "src/main_menu.c" 2
...
# 20 "src/main_menu.c" 2
# 1 "include/option_menu.h" 1



void CB2_InitOptionMenu(void);
# 21 "src/main_menu.c" 2
...
# 25 "src/main_menu.c" 2
# 1 "include/pokemon.h" 1
# 26 "src/main_menu.c" 2
...
# 35 "src/main_menu.c" 2
# 1 "include/task.h" 1
# 36 "src/main_menu.c" 2
...
# 41 "src/main_menu.c" 2
# 175 "src/main_menu.c"
static __attribute__((section("ewram_data"))) u8 gUnknown_02022D04 = 0;
static __attribute__((section("ewram_data"))) u16 sCurrItemAndOptionMenuCheck = 0;
...
static const u8 sTextColor_Headers[] = {0xA, 0xB, 0xC};
static const u8 sTextColor_MenuInfo[] = {0xA, 0x1, 0xC};
...
static const union AffineAnimCmd sSpriteAffineAnim_PlayerShrink[] = {
    {.frame = {.xScale = -2, .yScale = -2, .rotation = 0, .duration = 0x30}},
    {.type = 0x7FFF}
};
...
static const struct MenuAction sMenuActions_Gender[] = {
    {gText_BirchBoy, ((void *)0)},
    {gText_BirchGirl, ((void *)0)}
};
...
static u32 InitMainMenu(bool8 returningFromOptionsMenu)
{
    ...
    InitBgsFromTemplates(0, sMainMenuBgTemplates, (size_t)(sizeof(sMainMenuBgTemplates) / sizeof((sMainMenuBgTemplates)[0])));
    ChangeBgX(0, 0, 0);
    ChangeBgY(0, 0, 0);
    ChangeBgX(1, 0, 0);
    ChangeBgY(1, 0, 0);
...
static void Task_MainMenuCheckSaveFile(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        SetGpuReg(0x40, 0);
        SetGpuReg(0x44, 0);
        SetGpuReg(0x48, (1 << 0) | (1 << 4));
        SetGpuReg(0x4a, (1 << 0) | (1 << 4) | (1 << 5));
        SetGpuReg(0x50, (3 << 6) | (1 << 0));
        SetGpuReg(0x52, 0);
        SetGpuReg(0x54, 7);
        ...
        if (sCurrItemAndOptionMenuCheck & 0x8000)
        {
            switch (data[0])
            {
                case HAS_NO_SAVED_GAME:
                case HAS_SAVED_GAME:
                    sCurrItemAndOptionMenuCheck = data[0] + 1;
                    break;
        ...
        sCurrItemAndOptionMenuCheck &= 0x7FFF;
        data[1] = sCurrItemAndOptionMenuCheck;
        data[12] = data[0] + 2;
    }
}
...
{
    RunTextPrinters();
    if (!IsTextPrinterActive(7) && (({(gMain.newKeys) & (0x0001);})))
    {
...
static void Task_DisplayMainMenu(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        palette = ((31) | ((31) << 5) | ((31) << 10));
        LoadPalette(&palette, 250, 2);

        palette = ((12) | ((12) << 5) | ((12) << 10));
        LoadPalette(&palette, 251, 2);

        palette = ((26) | ((26) << 5) | ((25) << 10));
        ...
        {
            palette = ((4) | ((16) << 5) | ((31) << 10));
            LoadPalette(&palette, 241, 2);
        }
        else
        {
            palette = ((31) | ((3) << 5) | ((21) << 10));
            LoadPalette(&palette, 241, 2);
        }
        ...
        switch (gTasks[taskId].data[0])
        {
            case HAS_NO_SAVED_GAME:
            default:
                FillWindowPixelBuffer(0, ((0xA) | ((0xA) << 4)));
                FillWindowPixelBuffer(1, ((0xA) | ((0xA) << 4)));
                ...
                break;
            case HAS_SAVED_GAME:
                FillWindowPixelBuffer(2, ((0xA) | ((0xA) << 4)));
                FillWindowPixelBuffer(3, ((0xA) | ((0xA) << 4)));
                FillWindowPixelBuffer(4, ((0xA) | ((0xA) << 4)));
            ...
            case HAS_MYSTERY_GIFT:
                ...
                FillWindowPixelBuffer(3, ((0xA) | ((0xA) << 4)));
                FillWindowPixelBuffer(4, ((0xA) | ((0xA) << 4)));
                FillWindowPixelBuffer(5, ((0xA) | ((0xA) << 4)));
                AddTextPrinterParameterized3(2, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuContinue);
                AddTextPrinterParameterized3(3, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuNewGame);
            ...
            case HAS_MYSTERY_EVENTS:
                ...
                FillWindowPixelBuffer(4, ((0xA) | ((0xA) << 4)));
                FillWindowPixelBuffer(5, ((0xA) | ((0xA) << 4)));
                FillWindowPixelBuffer(6, ((0xA) | ((0xA) << 4)));
                AddTextPrinterParameterized3(2, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuContinue);
                AddTextPrinterParameterized3(3, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuNewGame);
                ...
                data[13] = AddScrollIndicatorArrowPair(&sScrollArrowsTemplate_MainMenu, &sCurrItemAndOptionMenuCheck);
...
static bool8 HandleMainMenuInput(u8 taskId)
{
    ...
    else if (({(gMain.newKeys) & (0x0002);}))
    {
        ...
        SetGpuReg(0x44, (((0) << 8) | (160)));
        gTasks[taskId].func = Task_HandleMainMenuBPressed;
    }
    else if ((({(gMain.newKeys) & (0x0040);})) && data[1] > 0)
    {
    ...
    else if ((({(gMain.newKeys) & (0x0080);})) && data[1] < data[12] - 1)
    {
...
static void Task_HandleMainMenuAPressed(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        ClearStdWindowAndFrame(2, 1);
        ClearStdWindowAndFrame(3, 1);
        ClearStdWindowAndFrame(4, 1);
        ClearStdWindowAndFrame(5, 1);
        ClearStdWindowAndFrame(6, 1);
        ClearStdWindowAndFrame(7, 1);
        ...
        switch (action)
        {
            ...
            case ACTION_INVALID:
                ...
                gPlttBufferUnfaded[0xF1] = ((31) | ((31) << 5) | ((31) << 10));
                gPlttBufferFaded[0xF1] = ((31) | ((31) << 5) | ((31) << 10));
                SetGpuReg(0x18, 0);
                SetGpuReg(0x1a, 0);
                SetGpuReg(0x14, 0);
                SetGpuReg(0x16, 0);
        ...
        if (action != ACTION_OPTION)
            ...
            sCurrItemAndOptionMenuCheck |= 0x8000;
    }
}
    ...
    switch (menuType)
    {
        ...
        default:
            switch (selectedMenuItem)
            {
                case 0:
                default:
                    SetGpuReg(0x44, (((((1 - 1) * 8) + 1) << 8) | ((1 + 2 + 1) * 8 - 1)));
                    break;
                case 1:
                    SetGpuReg(0x44, (((((5 - 1) * 8) + 1) << 8) | ((5 + 2 + 1) * 8 - 1)));
                    break;
            }
            break;
        case HAS_SAVED_GAME:
            switch (selectedMenuItem)
            {
                case 0:
                default:
                    SetGpuReg(0x44, (((((1 - 1) * 8) + 1) << 8) | ((1 + 6 + 1) * 8 - 1)));
                    break;
                case 1:
                    SetGpuReg(0x44, (((((9 - 1) * 8) + 1) << 8) | ((9 + 2 + 1) * 8 - 1)));
                    break;
                case 2:
                    SetGpuReg(0x44, (((((13 - 1) * 8) + 1) << 8) | ((13 + 2 + 1) * 8 - 1)));
                    break;
            }
            break;
        case HAS_MYSTERY_GIFT:
            switch (selectedMenuItem)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    SetGpuReg(0x44, (((((17 - 1) * 8) + 1) << 8) | ((17 + 2 + 1) * 8 - 1)));
                    break;
            }
            break;
        case HAS_MYSTERY_EVENTS:
            switch (selectedMenuItem)
            {
                ...
                case 1:
                    if (isScrolled)
                        SetGpuReg(0x44, (((((9 - 1) * 8) + 1) << 8) | ((9 + 2 + 1) * 8 - 1)) - (((32) << 8) | (32)));
                    else
                        SetGpuReg(0x44, (((((9 - 1) * 8) + 1) << 8) | ((9 + 2 + 1) * 8 - 1)));
                    break;
                case 2:
                    if (isScrolled)
                        SetGpuReg(0x44, (((((13 - 1) * 8) + 1) << 8) | ((13 + 2 + 1) * 8 - 1)) - (((32) << 8) | (32)));
                    else
                        SetGpuReg(0x44, (((((13 - 1) * 8) + 1) << 8) | ((13 + 2 + 1) * 8 - 1)));
                    break;
                case 3:
                    if (isScrolled)
                        SetGpuReg(0x44, (((((17 - 1) * 8) + 1) << 8) | ((17 + 2 + 1) * 8 - 1)) - (((32) << 8) | (32)));
                    else
                        SetGpuReg(0x44, (((((17 - 1) * 8) + 1) << 8) | ((17 + 2 + 1) * 8 - 1)));
                    break;
                case 4:
                    SetGpuReg(0x44, (((((21 - 1) * 8) + 1) << 8) | ((21 + 2 + 1) * 8 - 1)) - (((32) << 8) | (32)));
                    break;
            }
            break;
    }
...
static void Task_NewGameBirchSpeech_Init(u8 taskId)
{
    ...
    LZ77UnCompVram(sBirchSpeechShadowGfx, (void*)0x6000000);
    LZ77UnCompVram(sBirchSpeechBgMap, (void*)((0x6000000 + (0x800 * (7)))));
...
{
    u8 spriteId = gTasks[sBirchSpeechMainTaskId].data[9];
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, 0x0000FFFF, 1);
...
{
    s16 *data = gTasks[taskId].data;
    struct Sprite *sprite = &gSprites[gTasks[sBirchSpeechMainTaskId].data[9]];
        ...
        case 1:
            if (gTasks[sBirchSpeechMainTaskId].data[7] >= 96)
            {
                ...
                if (gTasks[sBirchSpeechMainTaskId].data[7] < 0x4000)
                    gTasks[sBirchSpeechMainTaskId].data[7]++;
            }
            break;
...
static void Task_NewGameBirchSpeech_SlidePlatformAway(u8 taskId)
{
    if (gTasks[taskId].data[4] != -60)
    {
        ...
        SetGpuReg(0x14, gTasks[taskId].data[4]);
    }
    else
    {
...
static void Task_NewGameBirchSpeech_ChooseGender(u8 taskId)
{
    ...
    if (gender2 != gTasks[taskId].data[6])
    {
        gTasks[taskId].data[6] = gender2;
        gSprites[gTasks[taskId].data[2]].oam.objMode = 1;
...
static void Task_NewGameBirchSpeech_StartNamingScreen(u8 taskId)
{
    if (!gPaletteFade.active)
    {
        ...
        DestroyTask(taskId);
        DoNamingScreen(NAMING_SCREEN_PLAYER, gSaveBlock2Ptr->playerName, gSaveBlock2Ptr->playerGender, 0, 0, CB2_NewGameBirchSpeech_ReturnFromNamingScreen, 0);
    }
}
...
static void Task_NewGameBirchSpeech_FadePlayerToWhite(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        SetGpuReg(0x0, 0x1000 | 0x0040);
        BeginNormalPaletteFade(0xFFFF0000, 0, 0, 16, (((31) | ((31) << 5) | ((31) << 10)) | 0x8000));
...
static void CB2_NewGameBirchSpeech_ReturnFromNamingScreen(void)
{
    ...
    ResetPaletteFade();
    LZ77UnCompVram(sBirchSpeechShadowGfx, (u8*)0x6000000);
    LZ77UnCompVram(sBirchSpeechBgMap, (u8*)((0x6000000 + (0x800 * (7)))));
    LoadPalette(sBirchSpeechBgPals, 0, 64);
...
{
    return CreatePicSprite2(1, 8, 0, 1, a, b, 14, -1, 0);
}
...
static void AddBirchSpeechObjects(u8 taskId)
{
    ...
    gSprites[birchSpriteId].invisible = 1;
    gTasks[taskId].data[8] = birchSpriteId;
    lotadSpriteId = NewGameBirchSpeech_CreateLotadSprite(100, 0x4B);
    gSprites[lotadSpriteId].callback = SpriteCB_Null;
    gSprites[lotadSpriteId].oam.priority = 0;
    gSprites[lotadSpriteId].invisible = 1;
    gTasks[taskId].data[9] = lotadSpriteId;
    ...
    gSprites[brendanSpriteId].invisible = 1;
    gSprites[brendanSpriteId].oam.priority = 0;
    gTasks[taskId].data[10] = brendanSpriteId;
    maySpriteId = CreateTrainerSprite(FacilityClassToPicIndex(0x3f), 120, 60, 0, &gDecompressionBuffer[0x800]);
    gSprites[maySpriteId].callback = SpriteCB_Null;
    gSprites[maySpriteId].invisible = 1;
...
static void Task_NewGameBirchSpeech_FadeOutTarget1InTarget2(u8 taskId)
{
    ...
    else
    {
        ...
        alphaCoeff2 = gTasks[taskId].data[2] << 8;
        SetGpuReg(0x52, gTasks[taskId].data[1] + alphaCoeff2);
    }
}
...
static void Task_NewGameBirchSpeech_FadePlatformIn(u8 taskId)
{
    ...
    else
    {
        gTasks[taskId].data[4] = gTasks[taskId].data[3];
        gTasks[taskId].data[1]++;
        LoadPalette(&sBirchSpeechBgGradientPal[gTasks[taskId].data[1]], 1, 16);
    }
}
...
static void NewGameBirchSpeech_CreateDialogueWindowBorder(u8 a, u8 b, u8 c, u8 d, u8 e, u8 f)
{
    ...
    FillBgTilemapBufferRect(a, (0x800 + (0xFD)), b-2, c+e, 1, 1, f);
    FillBgTilemapBufferRect(a, (0x800 + (0xFF)), b-1, c+e, 1, 1, f);
    FillBgTilemapBufferRect(a, (0x800 + (0x100)), b, c+e, d-1, 1, f);
    FillBgTilemapBufferRect(a, (0x800 + (0x101)), b+d-1, c+e, 1, 1, f);
    FillBgTilemapBufferRect(a, (0x800 + (0x102)), b+d, c+e, 1, 1, f);
}
