...
# 14 "src/level_scaling.c" 2
# 1 "include/battle_util.h" 1
# 15 "src/level_scaling.c" 2
# 1 "include/berry.h" 1
...
# 31 "src/level_scaling.c" 2
# 1 "include/main.h" 1
# 32 "src/level_scaling.c" 2
# 1 "gflib/malloc.h" 1
# 15 "gflib/malloc.h"
extern u8 gHeap[];
...
# 38 "src/level_scaling.c" 2
# 1 "include/pokemon.h" 1
# 39 "src/level_scaling.c" 2
...
# 56 "src/level_scaling.c" 2
# 1 "include/constants/battle_config.h" 1
# 57 "src/level_scaling.c" 2
# 1 "include/constants/battle_move_effects.h" 1
# 58 "src/level_scaling.c" 2
# 1 "include/constants/battle_string_ids.h" 1
# 59 "src/level_scaling.c" 2
# 1 "include/constants/hold_effects.h" 1
# 60 "src/level_scaling.c" 2
# 1 "include/constants/items.h" 1
# 61 "src/level_scaling.c" 2
# 1 "include/constants/moves.h" 1
# 62 "src/level_scaling.c" 2
# 1 "include/constants/party_menu.h" 1
# 63 "src/level_scaling.c" 2
# 1 "include/constants/rgb.h" 1
# 64 "src/level_scaling.c" 2
# 1 "include/constants/songs.h" 1
# 65 "src/level_scaling.c" 2
...
u8 GetNumBadges()
{
 ...
 if (FlagGet((((0x500 + 864 - 1) + 1) + 0x4)))
  ...
  return 8;
 else if (FlagGet(0xAB))
  return 7;
 else if (FlagGet(0xAA))
  return 6;
 else if (FlagGet(0xA9))
  return 5;
 else if (FlagGet(0xA8))
  return 4;
 else if (FlagGet(0xA7))
  return 3;
 else if (FlagGet(0xA6))
  return 2;
 else if (FlagGet(0xA5))
  return 1;
...
u16 SplitEvolutions(u16 basespecies, u8 level){
 ...
 if(basespecies == 840 && 4 <= numbadges)
 {
