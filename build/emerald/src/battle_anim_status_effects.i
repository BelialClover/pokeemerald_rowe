# 0 "src/battle_anim_status_effects.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_anim_status_effects.c"
...
# 2 "src/battle_anim_status_effects.c" 2
...
# 3 "src/battle_anim_status_effects.c" 2
...
# 4 "src/battle_anim_status_effects.c" 2
...
# 5 "src/battle_anim_status_effects.c" 2
...
# 6 "src/battle_anim_status_effects.c" 2
...
# 7 "src/battle_anim_status_effects.c" 2

# 1 "include/task.h" 1
# 9 "src/battle_anim_status_effects.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 10 "src/battle_anim_status_effects.c" 2
# 1 "include/util.h" 1
...
# 11 "src/battle_anim_status_effects.c" 2
# 1 "include/constants/battle_anim.h" 1
# 12 "src/battle_anim_status_effects.c" 2
# 1 "include/constants/rgb.h" 1
# 13 "src/battle_anim_status_effects.c" 2
...
{
    {.frame = {.xScale = 96, .yScale = 96, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 2, .yScale = 2, .rotation = 0, .duration = 1}},
...
{
    {(size_t)(sizeof(sFrozenIceCubeSubsprites) / sizeof((sFrozenIceCubeSubsprites)[0])), sFrozenIceCubeSubsprites},
};
...
u8 sub_80A9C70(u8 battlerId, bool8 b)
{
    ...
    LoadCompressedSpriteSheetUsingHeap(&gBattleAnimPicTable[(((10000 + 136) - 10000))]);
    LoadCompressedSpritePaletteUsingHeap(&gBattleAnimPaletteTable[(((10000 + 136) - 10000))]);
    gTasks[taskId].data[0] = battlerId;
    if (b)
    {
        gTasks[taskId].data[1] = ((31) | ((0) << 5) | ((0) << 10));
        for (i = 0; i < 10; i++)
        {
    ...
    {
        gTasks[taskId].data[1] = ((0) | ((0) << 5) | ((31) << 10));
        for (i = 0; i < 10; i++)
        {
            spriteId2 = CreateSprite(&gUnknown_0853EF60, gSprites[battlerSpriteId].pos1.x, gSprites[battlerSpriteId].pos1.y - 32, 0);
            gSprites[spriteId2].data[0] = i * 51;
...
static void AnimTask_FrozenIceCube_Step1(u8 taskId)
{
    ...
    else
    {
        ...
        SetGpuReg(0x52, (((16 - var) << 8) | (var)));
    }
}

static void AnimTask_FrozenIceCube_Step2(u8 taskId)
{
    u8 palIndex = IndexOfSpritePaletteTag((10000 + 10));
...
void AnimTask_StatsChange(u8 taskId)
{
    ...
    {
    case (15 + 1 - 1): goesDown = 0; animStatId = 0; break;
    case (15 + 2 - 1): goesDown = 0; animStatId = 1; break;
    case (15 + 3 - 1): goesDown = 0; animStatId = 3; break;
    case (15 + 4 - 1): goesDown = 0; animStatId = 5; break;
    case (15 + 5 - 1): goesDown = 0; animStatId = 6; break;
    case (15 + 6 - 1): goesDown = 0; animStatId = 2; break;
    case (15 + 7 - 1): goesDown = 0; animStatId = 4; break;

    case (22 + 1 - 1): goesDown = 1; animStatId = 0; break;
    case (22 + 2 - 1): goesDown = 1; animStatId = 1; break;
    case (22 + 3 - 1): goesDown = 1; animStatId = 3; break;
    case (22 + 4 - 1): goesDown = 1; animStatId = 5; break;
    case (22 + 5 - 1): goesDown = 1; animStatId = 6; break;
    case (22 + 6 - 1): goesDown = 1; animStatId = 2; break;
    case (22 + 7 - 1): goesDown = 1; animStatId = 4; break;

    case (39 + 1 - 1): goesDown = 0; animStatId = 0; sharply = 1; break;
    case (39 + 2 - 1): goesDown = 0; animStatId = 1; sharply = 1; break;
    case (39 + 3 - 1): goesDown = 0; animStatId = 3; sharply = 1; break;
    case (39 + 4 - 1): goesDown = 0; animStatId = 5; sharply = 1; break;
    case (39 + 5 - 1): goesDown = 0; animStatId = 6; sharply = 1; break;
    case (39 + 6 - 1): goesDown = 0; animStatId = 2; sharply = 1; break;
    case (39 + 7 - 1): goesDown = 0; animStatId = 4; sharply = 1; break;

    case (46 + 1 - 1): goesDown = 1; animStatId = 0; sharply = 1; break;
    case (46 + 2 - 1): goesDown = 1; animStatId = 1; sharply = 1; break;
    case (46 + 3 - 1): goesDown = 1; animStatId = 3; sharply = 1; break;
    case (46 + 4 - 1): goesDown = 1; animStatId = 5; sharply = 1; break;
    case (46 + 5 - 1): goesDown = 1; animStatId = 6; sharply = 1; break;
    case (46 + 6 - 1): goesDown = 1; animStatId = 2; sharply = 1; break;
    case (46 + 7 - 1): goesDown = 1; animStatId = 4; sharply = 1; break;

    case 55: goesDown = 0; animStatId = 0xFF; sharply = 0; break;
    case 56: goesDown = 0; animStatId = 0xFF; sharply = 1; break;
    case 57: goesDown = 1; animStatId = 0xFF; sharply = 0; break;
    case 58: goesDown = 1; animStatId = 0xFF; sharply = 1; break;
...
static void Task_DoStatusAnimation(u8 taskId)
{
    ...
    {
        gBattleSpritesDataPtr->healthBoxesData[gTasks[taskId].data[0]].statusAnimActive = 0;
        DestroyTask(taskId);
    }
}
