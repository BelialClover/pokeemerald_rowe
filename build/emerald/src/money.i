...
__attribute__((section("ewram_data"))) static u8 sMoneyLabelSpriteId = 0;
...
void PrintMoneyAmount(u8 windowId, u8 x, u8 y, int amount, u8 speed)
{
    ...
    AddTextPrinterParameterized(windowId, 1, gStringVar4, x, y, speed, ((void *)0));
}

void PrintMoneyAmountInMoneyBoxWithBorder(u8 windowId, u16 tileStart, u8 pallete, int amount)
{
    DrawStdFrameWithCustomTileAndPalette(windowId, 0, tileStart, pallete);
...
void DrawMoneyBox(int amount, u8 x, u8 y)
{
    ...
    FillWindowPixelBuffer(sMoneyBoxWindowId, ((0) | ((0) << 4)));
