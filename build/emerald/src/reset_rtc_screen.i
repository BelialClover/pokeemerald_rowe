# 0 "src/reset_rtc_screen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/reset_rtc_screen.c"
...
# 9 "src/reset_rtc_screen.c" 2

# 1 "include/constants/songs.h" 1
# 11 "src/reset_rtc_screen.c" 2
# 1 "include/sound.h" 1
...
# 14 "src/reset_rtc_screen.c" 2
# 1 "include/task.h" 1
# 15 "src/reset_rtc_screen.c" 2
...
# 20 "src/reset_rtc_screen.c" 2
# 1 "include/constants/rgb.h" 1
# 21 "src/reset_rtc_screen.c" 2
...
{
    {.data = (u8 *)sResetRtcScreen_DownArrowGfx, .size = sizeof sResetRtcScreen_DownArrowGfx},
    {.data = (u8 *)sResetRtcScreen_RightArrowGfx, .size = sizeof sResetRtcScreen_RightArrowGfx}
};
...
static void PrintTime(u8 windowId, u8 x, u8 y, u16 days, u8 hours, u8 minutes, u8 seconds)
{
    ...
    AddTextPrinterParameterized(windowId, 1, gStringVar4, x, y, 0xFF, ((void *)0));
}

static void ShowChooseTimeWindow(u8 windowId, u16 days, u8 hours, u8 minutes, u8 seconds)
{
    DrawStdFrameWithCustomTileAndPalette(windowId, 0, 0x214, 0xE);
    PrintTime(windowId, 0, 1, days, hours, minutes, seconds);
    AddTextPrinterParameterized(windowId, 1, gText_Confirm2, 126, 1, 0, ((void *)0));
    ScheduleBgCopyTilemapToVram(0);
}
...
static void Task_ResetRtc_1(u8 taskId)
{
    ...
    else if (MoveTimeUpDown(&data[selectionInfo->dataIndex], selectionInfo->minVal, selectionInfo->maxVal, ({(gMain.newAndRepeatedKeys) & (0x0040 | 0x0080);})))
    {
        PlaySE(5);
...
{
    DrawDialogFrameWithCustomTileAndPalette(1, 0, 0x200, 0xF);
    AddTextPrinterParameterized(1, 1, str, 0, 1, 0, ((void *)0));
    ScheduleBgCopyTilemapToVram(0);
}
...
static void Task_ShowResetRtcPrompt(u8 taskId)
{
    ...
    {
    case 0:
        DrawStdFrameWithCustomTileAndPalette(0, 0, 0x214, 0xE);
        AddTextPrinterParameterized(0, 1, gText_PresentTime, 0, 1, 0xFF, 0);
        PrintTime(
            0,
            0,
            17,
            ...
            gLocalTime.minutes,
            gLocalTime.seconds);
        AddTextPrinterParameterized(0, 1, gText_PreviousTime, 0, 33, 0xFF, 0);
        PrintTime(
            0,
            0,
            49,
