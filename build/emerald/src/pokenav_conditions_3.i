# 0 "src/pokenav_conditions_3.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/pokenav_conditions_3.c"
...
# 2 "src/pokenav_conditions_3.c" 2
...
# 3 "src/pokenav_conditions_3.c" 2
...
# 5 "src/pokenav_conditions_3.c" 2
...
# 7 "src/pokenav_conditions_3.c" 2
...
# 8 "src/pokenav_conditions_3.c" 2
...
# 9 "src/pokenav_conditions_3.c" 2
...
# 10 "src/pokenav_conditions_3.c" 2
...
# 11 "src/pokenav_conditions_3.c" 2
# 1 "include/constants/songs.h" 1
# 12 "src/pokenav_conditions_3.c" 2
...
static const u32 sSearchMonDataIds[] = {22, 23, 24, 33, 47};
...
{
    [CONDITION_SEARCH_FUNC_NONE] = ((void *)0),
...
static u32 BuildPartyMonSearchResults(s32 state)
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        if (!GetMonData(pokemon, 5))
            return 1;
        if (!GetMonData(pokemon, 6))
        {
            item.monId = i;
...
static u32 LoopedTask_OpenConditionSearchResults(s32 state)
{
    ...
    {
    case 0:
        InitBgTemplates(sConditionSearchResultBgTemplates, (sizeof(sConditionSearchResultBgTemplates)/sizeof(*(sConditionSearchResultBgTemplates))));
...
static void PrintSearchResultListMenuItems(struct PokenavSub8 *searchList)
{
    ...
    *gStringVar1 = 0xFF;
    ...
    AddTextPrinterParameterized(searchList->winid, 1, gStringVar2, 4, 1, 0xFF, ((void *)0));
    ConvertIntToDecimalStringN(gStringVar1, r7, STR_CONV_MODE_RIGHT_ALIGN, 3);
    AddTextPrinterParameterized(searchList->winid, 1, gStringVar1, 34, 1, 0xFF, ((void *)0));
...
static void PrintSearchMonListItem(struct PokenavMonList * item, u8 * dest)
{
    ...
    else
    {
        ...
        GetBoxMonData(mon, 2, gStringVar3);
    }
