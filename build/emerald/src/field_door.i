...
# 9 "src/field_door.c" 2
# 1 "include/constants/songs.h" 1
# 10 "src/field_door.c" 2
# 1 "include/constants/metatile_labels.h" 1
# 11 "src/field_door.c" 2
...
{
    {0x021, 0, 1, sDoorAnimTiles_General, sDoorAnimPalettes_General},
    {0x061, 1, 1, sDoorAnimTiles_PokeCenter, sDoorAnimPalettes_PokeCenter},
    {0x1CD, 1, 1, sDoorAnimTiles_Gym, sDoorAnimPalettes_Gym},
    {0x041, 1, 1, sDoorAnimTiles_PokeMart, sDoorAnimPalettes_PokeMart},
    {0x248, 0, 1, sDoorAnimTiles_Littleroot, sDoorAnimPalettes_Littleroot},
    {0x249, 0, 1, sDoorAnimTiles_BirchsLab, sDoorAnimPalettes_BirchsLab},
    {0x22F, 0, 1, sDoorAnimTiles_RustboroTan, sDoorAnimPalettes_RustboroTan},
    {0x21F, 0, 1, sDoorAnimTiles_RustboroGray, sDoorAnimPalettes_RustboroGray},
    {0x2A5, 0, 1, sDoorAnimTiles_FallarborLightRoof, sDoorAnimPalettes_FallarborLightRoof},
    {0x287, 0, 1, sDoorAnimTiles_Oldale, sDoorAnimPalettes_Oldale},
    {0x2AC, 0, 1, sDoorAnimTiles_Mauville, sDoorAnimPalettes_Mauville},
    {0x3A1, 0, 1, sDoorAnimTiles_Verdanturf, sDoorAnimPalettes_Verdanturf},
    {0x2DC, 0, 1, sDoorAnimTiles_Slateport, sDoorAnimPalettes_Slateport},
    {0x225, 0, 1, sDoorAnimTiles_Dewford, sDoorAnimPalettes_Dewford},
    {0x1DB, 1, 1, sDoorAnimTiles_Contest, sDoorAnimPalettes_Contest},
    {0x246, 0, 1, sDoorAnimTiles_Lilycove, sDoorAnimPalettes_Lilycove},
    {0x28E, 0, 1, sDoorAnimTiles_LilycoveWooden, sDoorAnimPalettes_LilycoveWooden},
    {0x2A1, 0, 1, sDoorAnimTiles_Mossdeep, sDoorAnimPalettes_Mossdeep},
    {0x21C, 0, 1, sDoorAnimTiles_SootopolisPeakedRoof, sDoorAnimPalettes_SootopolisPeakedRoof},
    {0x21E, 0, 1, sDoorAnimTiles_Sootopolis, sDoorAnimPalettes_Sootopolis},
    {0x21D, 1, 1, sDoorAnimTiles_PokemonLeague, sDoorAnimPalettes_PokemonLeague},
    {0x21A, 0, 1, sDoorAnimTiles_Pacifidlog, sDoorAnimPalettes_Pacifidlog},
    {0x224, 0, 1, sDoorAnimTiles_BattleTowerCorridor, sDoorAnimPalettes_BattleTowerCorridor},
    {0x289, 0, 1, sDoorAnimTiles_CyclingRoad, sDoorAnimPalettes_CyclingRoad},
    {0x30C, 1, 1, sDoorAnimTiles_LilycoveDeptStore, sDoorAnimPalettes_LilycoveDeptStore},
    {0x32D, 1, 1, sDoorAnimTiles_SafariZone, sDoorAnimPalettes_SafariZone},
    {0x2ED, 1, 1, sDoorAnimTiles_MossdeepSpaceCenter, sDoorAnimPalettes_MossdeepSpaceCenter},
    {0x264, 1, 1, sDoorAnimTiles_CableClub, sDoorAnimPalettes_CableClub},
    {0x22B, 0, 1, sDoorAnimTiles_AbandonedShip, sDoorAnimPalettes_AbandonedShip},
    {0x2F7, 0, 1, sDoorAnimTiles_FallarborDarkRoof, sDoorAnimPalettes_FallarborDarkRoof},
    {0x297, 0, 1, sDoorAnimTiles_AbandonedShipRoom, sDoorAnimPalettes_AbandonedShipRoom},
    {0x285, 1, 1, sDoorAnimTiles_LilycoveDeptStoreElevator, sDoorAnimPalettes_LilycoveDeptStoreElevator},
    {0x25D, 1, 1, sDoorAnimTiles_BattleTowerOld, sDoorAnimPalettes_BattleTowerOld},
    {0x20E, 1, 1, sDoorAnimTiles_BattleTowerElevator, sDoorAnimPalettes_BattleTowerElevator},
    {0x3B0, 1, 1, sDoorAnimTiles_34, sDoorAnimPalettes_34},
    {0x28A, 1, 1, sDoorAnimTiles_BattleDome, sDoorAnimPalettes_BattleDome},
    {0x263, 1, 1, sDoorAnimTiles_BattleFactory, sDoorAnimPalettes_BattleFactory},
    {0x329, 1, 1, sDoorAnimTiles_BattleTower, sDoorAnimPalettes_BattleTower},
    {0x291, 0, 1, sDoorAnimTiles_BattleArena, sDoorAnimPalettes_BattleArena},
    {0x21B, 2, 1, sDoorAnimTiles_BattleArenaLobby, sDoorAnimPalettes_BattleArenaLobby},
    {0x209, 1, 1, sDoorAnimTiles_BattleDomeLobby, sDoorAnimPalettes_BattleDomeLobby},
    {0x219, 0, 1, sDoorAnimTiles_BattlePalaceLobby, sDoorAnimPalettes_BattlePalaceLobby},
    {0x393, 1, 1, sDoorAnimTiles_BattleTent, sDoorAnimPalettes_BattleTent},
    {0x3D4, 1, 1, sDoorAnimTiles_BattleTent, sDoorAnimPalettes_BattleTent},
    {0x36C, 1, 1, sDoorAnimTiles_BattleTent, sDoorAnimPalettes_BattleTent},
    {0x25E, 1, 1, sDoorAnimTiles_BattleDomeCorridor, sDoorAnimPalettes_BattleDomeCorridor},
    {0x2AD, 1, 2, sDoorAnimTiles_BattleTowerMultiCorridor, sDoorAnimPalettes_BattleTowerMultiCorridor},
    {0x3FC, 0, 1, sDoorAnimTiles_BattleFrontier, sDoorAnimPalettes_BattleFrontier},
    {0x396, 1, 1, sDoorAnimTiles_BattleFrontierSliding, sDoorAnimPalettes_BattleFrontier},
    {0x20A, 1, 1, sDoorAnimTiles_BattleDomePreBattleRoom, sDoorAnimPalettes_BattleDomePreBattleRoom},
    {0x26B, 1, 1, sDoorAnimTiles_BattleTentInterior, sDoorAnimPalettes_BattleTentInterior},
    {0x32C, 1, 1, sDoorAnimTiles_TrainerHillLobbyElevator, sDoorAnimPalettes_TrainerHillLobbyElevator},
    {0x383, 1, 1, sDoorAnimTiles_TrainerHillRoofElevator, sDoorAnimPalettes_TrainerHillRoofElevator},
    {},
};
...
{
    if (gfx->size == 2)
        CpuFastSet(gfx->tiles + frame->offset, (void *)(0x6000000 + 0x7E00), 0x80);
    else
        CpuFastSet(gfx->tiles + frame->offset, (void *)(0x6000000 + 0x7F00), 0x40);
}
...
static void Task_AnimateDoor(u8 taskId)
{
    ...
    if (sub_808A5F0(gfx, frames, taskData) == 0)
        DestroyTask(taskId);
}
...
static bool8 ShouldUseMultiCorridorDoor(void)
{
    ...
    {
        if (gSaveBlock1Ptr->location.mapGroup == ((16 | (26 << 8)) >> 8)
            && gSaveBlock1Ptr->location.mapNum == ((16 | (26 << 8)) & 0xFF))
        {
            return 1;
        }
    }
