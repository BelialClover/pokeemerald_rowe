# 0 "src/battle_anim_throw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_anim_throw.c"
...
# 13 "src/battle_anim_throw.c" 2
# 1 "include/pokeball.h" 1
# 14 "src/battle_anim_throw.c" 2
# 1 "include/sound.h" 1
...
# 15 "src/battle_anim_throw.c" 2

# 1 "include/task.h" 1
# 17 "src/battle_anim_throw.c" 2
# 1 "include/trig.h" 1
...
# 19 "src/battle_anim_throw.c" 2
# 1 "include/constants/items.h" 1
# 20 "src/battle_anim_throw.c" 2
# 1 "include/constants/moves.h" 1
# 21 "src/battle_anim_throw.c" 2
# 1 "include/constants/songs.h" 1
# 22 "src/battle_anim_throw.c" 2
# 1 "include/constants/rgb.h" 1
# 23 "src/battle_anim_throw.c" 2
...
{
    [BALL_POKE] = {gBattleAnimSpriteGfx_Particles, 0x100, 65030},
    [BALL_GREAT] = {gBattleAnimSpriteGfx_Particles, 0x100, 65031},
    [BALL_SAFARI] = {gBattleAnimSpriteGfx_Particles, 0x100, 65032},
    [BALL_ULTRA] = {gBattleAnimSpriteGfx_Particles, 0x100, 65033},
    [BALL_MASTER] = {gBattleAnimSpriteGfx_Particles, 0x100, 65034},
    [BALL_NET] = {gBattleAnimSpriteGfx_Particles, 0x100, 65035},
    [BALL_DIVE] = {gBattleAnimSpriteGfx_Particles, 0x100, 65036},
    [BALL_NEST] = {gBattleAnimSpriteGfx_Particles, 0x100, 65037},
    [BALL_REPEAT] = {gBattleAnimSpriteGfx_Particles, 0x100, 65038},
    [BALL_TIMER] = {gBattleAnimSpriteGfx_Particles, 0x100, 65039},
    [BALL_LUXURY] = {gBattleAnimSpriteGfx_Particles, 0x100, 65040},
    [BALL_PREMIER] = {gBattleAnimSpriteGfx_Particles, 0x100, 65041},
    [BALL_LEVEL] = {sNewParticlesGfx, 0x100, 65042},
    [BALL_LURE] = {gBattleAnimSpriteGfx_Particles, 0x100, 65043},
    [BALL_MOON] = {sNewParticlesGfx, 0x100, 65044},
    [BALL_FRIEND] = {gBattleAnimSpriteGfx_Particles, 0x100, 65045},
    [BALL_LOVE] = {gBattleAnimSpriteGfx_Particles, 0x100, 65046},
    [BALL_HEAVY] = {sNewParticlesGfx, 0x100, 65047},
    [BALL_FAST] = {sNewParticlesGfx, 0x100, 65048},
    [BALL_SPORT] = {gBattleAnimSpriteGfx_Particles, 0x100, 65049},
    [BALL_DUSK] = {sNewParticlesGfx, 0x100, 65050},
    [BALL_QUICK] = {sNewParticlesGfx, 0x100, 65051},
    [BALL_HEAL] = {sNewParticlesGfx, 0x100, 65052},
    [BALL_CHERISH] = {sNewParticlesGfx, 0x100, 65053},
    [BALL_PARK] = {gBattleAnimSpriteGfx_Particles, 0x100, 65054},
    [BALL_DREAM] = {gBattleAnimSpriteGfx_Particles, 0x100, 65065},
    [BALL_BEAST] = {gBattleAnimSpriteGfx_Particles, 0x100, 65056},
};

static const struct CompressedSpritePalette sBallParticlePalettes[POKEBALL_COUNT] =
{
    [BALL_POKE] = {gBattleAnimSpritePal_CircleImpact, 65030},
    [BALL_GREAT] = {gBattleAnimSpritePal_CircleImpact, 65031},
    [BALL_SAFARI] = {gBattleAnimSpritePal_CircleImpact, 65032},
    [BALL_ULTRA] = {gBattleAnimSpritePal_CircleImpact, 65033},
    [BALL_MASTER] = {gBattleAnimSpritePal_CircleImpact, 65034},
    [BALL_NET] = {gBattleAnimSpritePal_CircleImpact, 65035},
    [BALL_DIVE] = {gBattleAnimSpritePal_CircleImpact, 65036},
    [BALL_NEST] = {gBattleAnimSpritePal_CircleImpact, 65037},
    [BALL_REPEAT] = {gBattleAnimSpritePal_CircleImpact, 65038},
    [BALL_TIMER] = {gBattleAnimSpritePal_CircleImpact, 65039},
    [BALL_LUXURY] = {gBattleAnimSpritePal_CircleImpact, 65040},
    [BALL_PREMIER] = {gBattleAnimSpritePal_CircleImpact, 65041},
    [BALL_LEVEL] = {sNewParticlesPal, 65042},
    [BALL_LURE] = {gBattleAnimSpritePal_CircleImpact, 65043},
    [BALL_MOON] = {sNewParticlesPal, 65044},
    [BALL_FRIEND] = {gBattleAnimSpritePal_CircleImpact, 65045},
    [BALL_LOVE] = {gBattleAnimSpritePal_CircleImpact, 65046},
    [BALL_HEAVY] = {sNewParticlesPal, 65047},
    [BALL_FAST] = {sNewParticlesPal, 65048},
    [BALL_SPORT] = {gBattleAnimSpritePal_CircleImpact, 65049},
    [BALL_DUSK] = {sNewParticlesPal, 65050},
    [BALL_QUICK] = {sNewParticlesPal, 65051},
    [BALL_HEAL] = {sNewParticlesPal, 65052},
    [BALL_CHERISH] = {sNewParticlesPal, 65053},
    [BALL_PARK] = {gBattleAnimSpritePal_CircleImpact, 65054},
    [BALL_DREAM] = {gBattleAnimSpritePal_CircleImpact, 65065},
    [BALL_BEAST] = {gBattleAnimSpritePal_CircleImpact, 65056},
};
...
{
    [BALL_POKE] = ((31) | ((22) << 5) | ((30) << 10)),
    [BALL_GREAT] = ((16) | ((23) << 5) | ((30) << 10)),
    [BALL_SAFARI] = ((23) | ((30) << 5) | ((20) << 10)),
    [BALL_ULTRA] = ((31) | ((31) << 5) | ((15) << 10)),
    [BALL_MASTER] = ((23) | ((20) << 5) | ((28) << 10)),
    [BALL_NET] = ((21) | ((31) << 5) | ((25) << 10)),
    [BALL_DIVE] = ((12) | ((25) << 5) | ((30) << 10)),
    [BALL_NEST] = ((30) | ((27) << 5) | ((10) << 10)),
    [BALL_REPEAT] = ((31) | ((24) << 5) | ((16) << 10)),
    [BALL_TIMER] = ((29) | ((30) << 5) | ((30) << 10)),
    [BALL_LUXURY] = ((31) | ((17) << 5) | ((10) << 10)),
    [BALL_PREMIER] = ((31) | ((9) << 5) | ((10) << 10)),


    [BALL_LEVEL] = ((24) | ((4) << 5) | ((4) << 10)),
    [BALL_LURE] = ((9) | ((22) << 5) | ((27) << 10)),
    [BALL_MOON] = ((30) | ((25) << 5) | ((8) << 10)),
    [BALL_FRIEND] = ((17) | ((24) << 5) | ((7) << 10)),
    [BALL_LOVE] = ((31) | ((19) << 5) | ((26) << 10)),
    [BALL_HEAVY] = ((7) | ((11) << 5) | ((20) << 10)),
    [BALL_FAST] = ((29) | ((17) << 5) | ((8) << 10)),
    [BALL_SPORT] = ((31) | ((31) << 5) | ((15) << 10)),
    [BALL_DUSK] = ((7) | ((1) << 5) | ((13) << 10)),
    [BALL_QUICK] = ((16) | ((25) << 5) | ((30) << 10)),
    [BALL_HEAL] = ((31) | ((23) << 5) | ((27) << 10)),
    [BALL_CHERISH] = ((25) | ((4) << 5) | ((3) << 10)),
    [BALL_PARK] = ((31) | ((31) << 5) | ((15) << 10)),
    [BALL_DREAM] = ((31) | ((31) << 5) | ((15) << 10)),
    [BALL_BEAST] = ((31) | ((31) << 5) | ((15) << 10)),
};

const struct SpriteTemplate gPokeblockSpriteTemplate =
{
    .tileTag = (10000 + 269),
    .paletteTag = (10000 + 269),
...
void unref_sub_8170478(u8 taskId)
{
    ...
    SetGpuReg(0x4a, (1 << 0) | (1 << 2) | (1 << 3) | (1 << 4) | (1 << 5) | ((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12) | (1 << 13));
    ...
    gSprites[spriteId3].oam.objMode = 2;
    gSprites[spriteId4].oam.objMode = 2;
...
static void AnimTask_FlashHealthboxOnLevelUp_Step(u8 taskId)
{
    ...
    if (gTasks[taskId].data[0]++ >= gTasks[taskId].data[11])
    {
        ...
        case 0:
            ...
            BlendPalette(paletteOffset + colorOffset, 1, gTasks[taskId].data[2], ((20) | ((27) << 5) | ((31) << 10)));
            if (gTasks[taskId].data[2] == 16)
...
void AnimTask_SwitchOutBallEffect(u8 taskId)
{
    ...
    if (GetBattlerSide(gBattleAnimAttacker) == 0)
        ball = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gBattleAnimAttacker]], 38);
    else
        ball = GetMonData(&gEnemyParty[gBattlerPartyIndexes[gBattleAnimAttacker]], 38);
...
{
    if (gBattleSpritesDataPtr->animationData->ballThrowCaseId == 5)
        gBattleAnimArgs[7] = -1;
    else
        gBattleAnimArgs[7] = 0;
...
void AnimTask_ThrowBall_StandingTrainer(u8 taskId)
{
    ...
    ballId = ItemIdToBallId(gLastUsedItem);
    subpriority = GetBattlerSpriteSubpriority(GetBattlerAtPosition(1)) + 1;
    spriteId = CreateSprite(&gBallSpriteTemplates[ballId], x + 32, y | 80, subpriority);
    gSprites[spriteId].data[0] = 34;
    gSprites[spriteId].data[1] = GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_X);
    gSprites[spriteId].data[2] = GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_Y) - 16;
    gSprites[spriteId].callback = SpriteCallbackDummy;
    gSprites[gBattlerSpriteIds[GetBattlerAtPosition(0)]].callback = SpriteCB_TrainerThrowObject;
    gTasks[taskId].data[0] = spriteId;
...
{
    if (gSprites[gBattlerSpriteIds[GetBattlerAtPosition(0)]].animCmdIndex == 1)
    {
        PlaySE12WithPanning(61, 0);
...
{
    if (gSprites[gBattlerSpriteIds[GetBattlerAtPosition(0)]].animEnded)
    {
        StartSpriteAnim(&gSprites[gBattlerSpriteIds[GetBattlerAtPosition(0)]], 0);
        DestroyTask(taskId);
    }
}
# 1106 "src/battle_anim_throw.c"
static void SpriteCB_Ball_Throw(struct Sprite *sprite)
{
    u16 targetX = sprite->data[1];
    u16 targetY = sprite->data[2];
...
static void SpriteCB_Ball_Bounce_Step(struct Sprite *sprite)
{
    ...
    if (lastBounce)
    {
        ...
        sprite->pos2.y = 0;
        if (gBattleSpritesDataPtr->animationData->ballThrowCaseId == 0)
        {
            sprite->data[5] = 0;
...
static void SpriteCB_Ball_Wobble_Step(struct Sprite *sprite)
{
    ...
    case BALL_NEXT_MOVE:
        ...
        else
        {
            ...
            {
                if (gBattleSpritesDataPtr->animationData->ballThrowCaseId == 4 && shakes == 3)
                {
                    sprite->callback = SpriteCB_Ball_Capture;
                    sprite->affineAnimPaused = 1;
                }
...
static void SpriteCB_Ball_Capture_Step(struct Sprite *sprite)
{
    ...
    {
        PlaySE(254);
        BlendPalettes(0x10000 << sprite->oam.paletteNum, 6, ((0) | ((0) << 5) | ((0) << 10)));
        MakeCaptureStars(sprite);
    }
    else if (sprite->data[4] == 60)
    {
        BeginNormalPaletteFade(0x10000 << sprite->oam.paletteNum, 2, 6, 0, ((0) | ((0) << 5) | ((0) << 10)));
    }
...
static void SpriteCB_Ball_FadeOut(struct Sprite *sprite)
{
    ...
    case 0:
        ...
        BeginNormalPaletteFade(1 << (paletteIndex + 0x10), 0, 0, 16, ((31) | ((31) << 5) | ((31) << 10)));
        sprite->data[0]++;
        break;
    case 1:
        if (sprite->data[1]++ > 0)
        {
            sprite->data[1] = 0;
            sprite->data[2]++;
            SetGpuReg(0x52, (((sprite->data[2]) << 8) | (16 - sprite->data[2])));
            if (sprite->data[2] == 16)
                sprite->data[0]++;
        }
        break;
...
static void MakeCaptureStars(struct Sprite *sprite)
{
    ...
    for (i = 0; i < (size_t)(sizeof(sCaptureStars) / sizeof((sCaptureStars)[0])); i++)
    {
        ...
        if (spriteId != 64)
        {
            ...
            gSprites[spriteId].data[2] = sprite->pos1.x + sCaptureStars[i].xOffset;
            gSprites[spriteId].data[4] = sprite->pos1.y + sCaptureStars[i].yOffset;
            gSprites[spriteId].data[5] = sCaptureStars[i].amplitude;
...
{
    s16 dy = sprite->data[0] + 0x800;
    s16 dx = sprite->data[1] + 0x680;
    sprite->pos2.x -= dx >> 8;
    sprite->pos2.y += dy >> 8;
...
static void DestroyBallOpenAnimationParticle(struct Sprite *sprite)
{
    ...
    else
    {
        ...
        if (gBattleSpritesDataPtr->animationData->numBallParticles == 0)
        {
            for (i = 0; i < POKEBALL_COUNT; i++)
            {
                if (FuncIsActiveTask(sBallParticleAnimationFuncs[i]) == 1)
                    break;
            }
...
u8 LaunchBallFadeMonTask(bool8 unfadeLater, u8 battler, u32 selectedPalettes, u8 ballId)
{
    ...
    BeginNormalPaletteFade(selectedPalettes, 0, 0, 16, ((31) | ((31) << 5) | ((31) << 10)));
    return taskId;
}
...
static void Task_FadeMon_ToBallColor(u8 taskId)
{
    ...
    else if (!gPaletteFade.active)
    {
        ...
        BeginNormalPaletteFade(selectedPalettes, 0, 16, 0, ((31) | ((31) << 5) | ((31) << 10)));
        DestroyTask(taskId);
    }
}
...
void AnimTask_SubstituteFadeToInvisible(u8 taskId)
{
    ...
    case 1:
        if (gTasks[taskId].data[1]++ > 1)
        {
            ...
            gTasks[taskId].data[0]++;
            SetGpuReg(0x52, (((gTasks[taskId].data[0]) << 8) | (16 - gTasks[taskId].data[0])));
            if (gTasks[taskId].data[0] == 16)
                gTasks[taskId].data[15]++;
        }
        break;
    case 2:
        spriteId = gBattlerSpriteIds[gBattleAnimAttacker];
        RequestDma3Fill(0, (void *)(0x6000000 + 0x10000) + gSprites[spriteId].oam.tileNum * 32, 0x800, 1);
...
void TryShinyAnimation(u8 battler, struct Pokemon *mon)
{
    ...
    otId = GetMonData(mon, 1);
    personality = GetMonData(mon, 0);

    if (IsBattlerSpriteVisible(battler))
    {
        shinyValue = (((otId) & 0xFFFF0000) >> 16) ^ ((otId) & 0xFFFF) ^ (((personality) & 0xFFFF0000) >> 16) ^ ((personality) & 0xFFFF);
        if (shinyValue < 8)
            isShiny = 1;

        if (isShiny)
        {
            if (GetSpriteTileStartByTag((10000 + 233)) == 0xFFFF)
            {
                LoadCompressedSpriteSheetUsingHeap(&gBattleAnimPicTable[(10000 + 233) - 10000]);
                LoadCompressedSpritePaletteUsingHeap(&gBattleAnimPaletteTable[(10000 + 233) - 10000]);
            }

            taskCirc = CreateTask(Task_ShinyStars, 10);
            taskDgnl = CreateTask(Task_ShinyStars, 10);
            gTasks[taskCirc].data[0] = battler;
            gTasks[taskDgnl].data[0] = battler;
...
# 2656 "src/battle_anim_throw.c"
void AnimTask_LoadPokeblockGfx(u8 taskId)
{
    u8 paletteIndex;

    LoadCompressedSpriteSheetUsingHeap(&gBattleAnimPicTable[(10000 + 269) - 10000]);
    LoadCompressedSpritePaletteUsingHeap(&gBattleAnimPaletteTable[(10000 + 269) - 10000]);
    paletteIndex = IndexOfSpritePaletteTag((10000 + 269));
    DestroyAnimVisualTask(taskId);
}

void AnimTask_FreePokeblockGfx(u8 taskId)
{
    FreeSpriteTilesByTag((10000 + 269));
    FreeSpritePaletteByTag((10000 + 269));
    DestroyAnimVisualTask(taskId);
}
...
static void SpriteCB_PokeBlock_Throw(struct Sprite *sprite)
{
    ...
    sprite->data[0] = 30;
    sprite->data[2] = GetBattlerSpriteCoord(GetBattlerAtPosition(1), BATTLER_COORD_X) + gBattleAnimArgs[2];
    sprite->data[4] = GetBattlerSpriteCoord(GetBattlerAtPosition(1), BATTLER_COORD_Y) + gBattleAnimArgs[3];
    sprite->data[5] = -32;
    InitAnimArcTranslation(sprite);
...
void AnimTask_SetAttackerTargetLeftPos(u8 taskId)
{
    ...
    {
    case 0:
        gBattleAnimAttacker = GetBattlerAtPosition(0);
        gBattleAnimTarget = GetBattlerAtPosition(1);
        break;
    case 1:
        gBattleAnimAttacker = GetBattlerAtPosition(1);
        gBattleAnimTarget = GetBattlerAtPosition(0);
        break;
    }
