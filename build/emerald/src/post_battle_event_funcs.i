# 0 "src/post_battle_event_funcs.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/post_battle_event_funcs.c"
...
# 2 "src/post_battle_event_funcs.c" 2
# 1 "include/main.h" 1
...
# 3 "src/post_battle_event_funcs.c" 2
...
# 4 "src/post_battle_event_funcs.c" 2
...
# 5 "src/post_battle_event_funcs.c" 2
...
# 6 "src/post_battle_event_funcs.c" 2
...
# 7 "src/post_battle_event_funcs.c" 2
...
# 8 "src/post_battle_event_funcs.c" 2
...
# 9 "src/post_battle_event_funcs.c" 2
# 1 "include/tv.h" 1
...
# 10 "src/post_battle_event_funcs.c" 2
# 1 "include/constants/heal_locations.h" 1
# 11 "src/post_battle_event_funcs.c" 2
# 1 "include/constants/tv.h" 1
# 12 "src/post_battle_event_funcs.c" 2
...
int GameClear(void)
{
    ...
    if (gSaveBlock2Ptr->playerGender == 0)
        SetContinueGameWarpToHealLocation(1);
    else
        SetContinueGameWarpToHealLocation(2);
    ...
    if (ribbonGet == 1)
    {
        ...
        {
            TryPutSpotTheCutiesOnAir(&gPlayerParty[ribbonCounts[0].partyIndex], 67);
        }
    }
