...
const u8 gText_FiveMarks[] = _("(?)"); // Bad egg related
...
const u8 gText_SoldOut[] = _("Perdón, pero ya no nos queda\nde este objeto.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Var1CertainlyHowMany2[] = _("¿{STR_VAR_1}? Buena elección.\n¿Cuántas unidades quieres?");
...
const u8 gText_ThrowInPremierBalls[] = _("Además te voy a dar unas\nHonor Ball de regalo.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_EggFromTraveler[] = _("Extraño Huevo regalo\ndel viajante.");
...
const u8 gText_ItemStorageNotAvailable[] = _("Almacenamiento de objetos\nno se encuentra disponible.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NoTrainersRegistered[] = _("Sin Entrenadores registrados."); // Unused
...
const u8 gText_OptionMenuCancel[] = _("Guardar");
const u8 gText_ButtonMode[] = _("Controles");
const u8 gText_TextSpeedSlow[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Lenta");
const u8 gText_TextSpeedMid[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Media");
const u8 gText_TextSpeedFast[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Rápida");
...
const u8 gText_MayBrendanMatchCallDesc[] = _("Vecina Guay");
...
//const u8 gText_Game_Modes_Cancel[]     = _("Cancel");
