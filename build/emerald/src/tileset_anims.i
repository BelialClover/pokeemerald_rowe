# 0 "src/tileset_anims.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/tileset_anims.c"
...
u16 *const gTilesetAnims_Mauville_Flower1_VDests[] = {
    (u16 *)(0x6000000 + ((512 + 96) * 32)),
    (u16 *)(0x6000000 + ((512 + 100) * 32)),
    (u16 *)(0x6000000 + ((512 + 104) * 32)),
    (u16 *)(0x6000000 + ((512 + 108) * 32)),
    (u16 *)(0x6000000 + ((512 + 112) * 32)),
    (u16 *)(0x6000000 + ((512 + 116) * 32)),
    (u16 *)(0x6000000 + ((512 + 120) * 32)),
    (u16 *)(0x6000000 + ((512 + 124) * 32))
};

u16 *const gTilesetAnims_Mauville_Flower2_VDests[] = {
    (u16 *)(0x6000000 + ((512 + 128) * 32)),
    (u16 *)(0x6000000 + ((512 + 132) * 32)),
    (u16 *)(0x6000000 + ((512 + 136) * 32)),
    (u16 *)(0x6000000 + ((512 + 140) * 32)),
    (u16 *)(0x6000000 + ((512 + 144) * 32)),
    (u16 *)(0x6000000 + ((512 + 148) * 32)),
    (u16 *)(0x6000000 + ((512 + 152) * 32)),
    (u16 *)(0x6000000 + ((512 + 156) * 32))
};
...
u16 *const gTilesetAnims_EverGrande_VDests[] = {
    (u16 *)(0x6000000 + ((512 + 224) * 32)),
    (u16 *)(0x6000000 + ((512 + 228) * 32)),
    (u16 *)(0x6000000 + ((512 + 232) * 32)),
    (u16 *)(0x6000000 + ((512 + 236) * 32)),
    (u16 *)(0x6000000 + ((512 + 240) * 32)),
    (u16 *)(0x6000000 + ((512 + 244) * 32)),
    (u16 *)(0x6000000 + ((512 + 248) * 32)),
    (u16 *)(0x6000000 + ((512 + 252) * 32))
};
...
static void ResetTilesetAnimBuffer(void)
{
    ...
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, sTilesetDMA3TransferBuffer, 0x04000000 | 0x01000000 | ((sizeof sTilesetDMA3TransferBuffer)/(32/8) & 0x1FFFFF)); };
}
...
static void _InitPrimaryTilesetAnimation(void)
{
    ...
    sPrimaryTilesetAnimCallback = ((void *)0);
...
static void _InitSecondaryTilesetAnimation(void)
{
    ...
    sSecondaryTilesetAnimCallback = ((void *)0);
...
{
    u16 i = timer % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_General_Flower[i], (u16 *)(0x6000000 + ((508) * 32)), 0x80);
}

static void QueueAnimTiles_General_Water(u16 timer)
{
    u8 i = timer % 8;
    AppendTilesetAnimToBuffer(gTilesetAnims_General_Water[i], (u16 *)(0x6000000 + ((432) * 32)), 0x3C0);
}

static void QueueAnimTiles_General_SandWaterEdge(u16 timer)
{
    u16 i = timer % 8;
    AppendTilesetAnimToBuffer(gTilesetAnims_General_SandWaterEdge[i], (u16 *)(0x6000000 + ((464) * 32)), 0x140);
}

static void QueueAnimTiles_General_Waterfall(u16 timer)
{
    u16 i = timer % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_General_Waterfall[i], (u16 *)(0x6000000 + ((496) * 32)), 0xc0);
}
...
{
    u16 i = timer % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_General_LandWaterEdge[i], (u16 *)(0x6000000 + ((480) * 32)), 0x140);
}

static void QueueAnimTiles_Lavaridge_Steam(u8 timer)
{
    u8 i = timer % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Steam[i], (u16 *)(0x6000000 + ((512 + 288) * 32)), 0x80);

    i = (timer + 2) % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Steam[i], (u16 *)(0x6000000 + ((512 + 292) * 32)), 0x80);
}

static void QueueAnimTiles_Pacifidlog_LogBridges(u8 timer)
{
    u8 i = timer % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_Pacifidlog_LogBridges[i], (u16 *)(0x6000000 + ((512 + 464) * 32)), 0x3C0);
}

static void QueueAnimTiles_Underwater_Seaweed(u8 timer)
{
    u8 i = timer % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_Underwater_Seaweed[i], (u16 *)(0x6000000 + ((512 + 496) * 32)), 0x80);
}

static void QueueAnimTiles_Pacifidlog_WaterCurrents(u8 timer)
{
    u8 i = timer % 8;
    AppendTilesetAnimToBuffer(gTilesetAnims_Pacifidlog_WaterCurrents[i], (u16 *)(0x6000000 + ((512 + 496) * 32)), 0x100);
}
...
{
    u16 i = timer % 2;
    AppendTilesetAnimToBuffer(gTilesetAnims_Rustboro_Fountain[i], (u16 *)(0x6000000 + ((512 + 448) * 32)), 0x80);
}

static void QueueAnimTiles_Lavaridge_Lava(u16 timer)
{
    u16 i = timer % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Cave_Lava[i], (u16 *)(0x6000000 + ((512 + 160) * 32)), 0x80);
}
...
{
    u16 i = timer % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Cave_Lava[i], (u16 *)(0x6000000 + ((512 + 416) * 32)), 0x80);
}

static void QueueAnimTiles_Dewford_Flag(u16 timer)
{
    u16 id = timer % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_Dewford_Flag[id], (u16 *)(0x6000000 + ((512 + 170) * 32)), 0xC0);
}

static void QueueAnimTiles_BattleFrontierOutsideWest_Flag(u16 timer)
{
    u16 i = timer % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_BattleFrontierOutsideWest_Flag[i], (u16 *)(0x6000000 + ((512 + 218) * 32)), 0xC0);
}

static void QueueAnimTiles_BattleFrontierOutsideEast_Flag(u16 timer)
{
    u16 i = timer % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_BattleFrontierOutsideEast_Flag[i], (u16 *)(0x6000000 + ((512 + 218) * 32)), 0xC0);
}

static void QueueAnimTiles_Slateport_Balloons(u16 timer)
{
    u16 i = timer % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_Slateport_Balloons[i], (u16 *)(0x6000000 + ((512 + 224) * 32)), 0x80);
}
...
{
    u16 i = timer % 2;
    AppendTilesetAnimToBuffer(gTilesetAnims_Building_TvTurnedOn[i], (u16 *)(0x6000000 + ((496) * 32)), 0x80);
}

static void QueueAnimTiles_SootopolisGym_Waterfalls(u16 timer)
{
    u16 i = timer % 3;
    AppendTilesetAnimToBuffer(gTilesetAnims_SootopolisGym_SideWaterfall[i], (u16 *)(0x6000000 + ((512 + 496) * 32)), 0x180);
    AppendTilesetAnimToBuffer(gTilesetAnims_SootopolisGym_FrontWaterfall[i], (u16 *)(0x6000000 + ((512 + 464) * 32)), 0x280);
}

static void QueueAnimTiles_EliteFour_WallLights(u16 timer)
{
    u16 i = timer % 4;
    AppendTilesetAnimToBuffer(gTilesetAnims_EliteFour_WallLights[i], (u16 *)(0x6000000 + ((512 + 504) * 32)), 0x20);
}

static void QueueAnimTiles_EliteFour_GroundLights(u16 timer)
{
    u16 i = timer % 2;
    AppendTilesetAnimToBuffer(gTilesetAnims_EliteFour_FloorLight[i], (u16 *)(0x6000000 + ((512 + 480) * 32)), 0x80);
}

static void QueueAnimTiles_MauvilleGym_ElectricGates(u16 timer)
{
    u16 i = timer % 2;
    AppendTilesetAnimToBuffer(gTilesetAnims_MauvilleGym_ElectricGates[i], (u16 *)(0x6000000 + ((512 + 144) * 32)), 0x200);
}

static void QueueAnimTiles_BikeShop_BlinkingLights(u16 timer)
{
    u16 i = timer % 2;
    AppendTilesetAnimToBuffer(gTilesetAnims_BikeShop_BlinkingLights[i], (u16 *)(0x6000000 + ((512 + 496) * 32)), 0x120);
}

static void QueueAnimTiles_Sootopolis_StormyWater(u16 timer)
{
    u16 i = timer % 8;
    AppendTilesetAnimToBuffer(gTilesetAnims_Sootopolis_StormyWater[i], (u16 *)(0x6000000 + ((512 + 240) * 32)), 0xc00);
}

static void QueueAnimTiles_BattlePyramid_Torch(u16 timer)
{
    u16 i = timer % 3;
    AppendTilesetAnimToBuffer(gTilesetAnims_BattlePyramid_Torch[i], (u16 *)(0x6000000 + ((512 + 151) * 32)), 0x100);
}

static void QueueAnimTiles_BattlePyramid_StatueShadow(u16 timer)
{
    u16 i = timer % 3;
    AppendTilesetAnimToBuffer(gTilesetAnims_BattlePyramid_StatueShadow[i], (u16 *)(0x6000000 + ((512 + 135) * 32)), 0x100);
}

static void BlendAnimPalette_BattleDome_FloorLights(u16 timer)
{
    CpuSet(gTilesetAnims_BattleDomeFloorLightPals[timer % 4], gPlttBufferUnfaded + 0x80, 0x00000000 | ((32)/(16/8) & 0x1FFFFF));
