# 0 "src/librfu_sio32id.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/librfu_sio32id.c"
...
static const u16 Sio32ConnectionData[] = { 0x494e, 0x544e, 0x4e45, 0x4f44 };
...
static void Sio32IDIntr(void)
{
    ...
    if (gRfuSIO32Id.MS_mode != 1)
        (*(vu16 *)(0x4000000 + 0x128)) |= 0x0080;
    rfuSIO32IdUnk0_times_16 = 16 * gRfuSIO32Id.MS_mode;
