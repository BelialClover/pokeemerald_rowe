# 0 "src/battle_pyramid_bag.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_pyramid_bag.c"
...
# 16 "src/battle_pyramid_bag.c" 2
# 1 "include/item_use.h" 1
# 17 "src/battle_pyramid_bag.c" 2
# 1 "include/list_menu.h" 1
# 18 "src/battle_pyramid_bag.c" 2
# 1 "include/mail.h" 1
# 18 "include/mail.h"
...
# 21 "src/battle_pyramid_bag.c" 2
# 1 "include/menu.h" 1
# 22 "src/battle_pyramid_bag.c" 2
# 1 "include/menu_helpers.h" 1
# 23 "src/battle_pyramid_bag.c" 2
...
# 26 "src/battle_pyramid_bag.c" 2
# 1 "include/task.h" 1
# 27 "src/battle_pyramid_bag.c" 2
...
# 33 "src/battle_pyramid_bag.c" 2
# 1 "include/constants/items.h" 1
# 34 "src/battle_pyramid_bag.c" 2
# 1 "include/constants/rgb.h" 1
# 35 "src/battle_pyramid_bag.c" 2
# 1 "include/constants/songs.h" 1
# 36 "src/battle_pyramid_bag.c" 2

__attribute__((section("ewram_data"))) struct PyramidBagResources *gPyramidBagResources = ((void *)0);
__attribute__((section("ewram_data"))) struct PyramidBagCursorData gPyramidBagCursorData = {0};
...
# 161 "src/battle_pyramid_bag.c"
static const struct MenuAction sMenuActions[] =
{
    [0] = { gMenuText_Use, BagAction_UseOnField },
    [1] = { gMenuText_Toss, BagAction_Toss },
    [2] = { gMenuText_Give, BagAction_Give },
    [3] = { gText_Cancel2, BagAction_Cancel },
    [4] = { gMenuText_Use, BagAction_UseInBattle },
    [5] = { gText_EmptyString2, ((void *)0) },
};

static const u8 sFieldMenuActionIds[] = {0, 2, 1, 3};
static const u8 gUnknown_0861F30C[] = {1, 3};
static const u8 sBattleMenuActionIds[] = {4, 3};
static const u8 gUnknown_0861F310[] = {3};
...
{
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 254, .duration = 2}},
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 2, .duration = 4}},
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 254, .duration = 4}},
...
void GoToBattlePyramidBagMenu(u8 a0, void (*callback)(void))
{
    ...
    gPyramidBagResources->callback2 = ((void *)0);
...
static void sub_81C504C(void)
{
    while (MenuHelpers_CallLinkSomething() != 1 && sub_81C5078() != 1 && MenuHelpers_LinkSomething() != 1);
}
...
static void sub_81C51DC(void)
{
    ...
    InitBgsFromTemplates(0, gUnknown_0861F2B4, (size_t)(sizeof(gUnknown_0861F2B4) / sizeof((gUnknown_0861F2B4)[0])));
...
static void SetBagItemsListTemplate(void)
{
    ...
    gPyramidBagResources->bagListItems[i].name = gPyramidBagResources->itemStrings[i];
    gPyramidBagResources->bagListItems[i].id = -2;
...
static void PrintItemQuantity(u8 windowId, s32 itemIndex, u8 y)
{
    ...
    PrintOnWindow_Font7(windowId, gStringVar4, xAlign, y, 0, 0, 0xFF, 0);
}
...
static void SwapItems(u8 id1, u8 id2)
{
    ...
    { temp = itemIds[id1]; itemIds[id1] = itemIds[id2]; itemIds[id2] = temp; };
    { temp = quantities[id1]; quantities[id1] = quantities[id2]; quantities[id2] = temp; };
}
...
static void sub_81C5B4C(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        if (gPyramidBagResources->callback2 != ((void *)0))
...
static void sub_81C5D20(u8 taskId)
{
    ...
    default:
        ...
        gPyramidBagResources->menuActionsCount = (size_t)(sizeof(sFieldMenuActionIds) / sizeof((sFieldMenuActionIds)[0]));
        break;
    case 1:
        if (ItemId_GetBattleUsage(gSpecialVar_ItemId))
        {
            gPyramidBagResources->menuActionIds = sBattleMenuActionIds;
            gPyramidBagResources->menuActionsCount = (size_t)(sizeof(sBattleMenuActionIds) / sizeof((sBattleMenuActionIds)[0]));
        }
        else
        {
            gPyramidBagResources->menuActionIds = gUnknown_0861F310;
            gPyramidBagResources->menuActionsCount = (size_t)(sizeof(gUnknown_0861F310) / sizeof((gUnknown_0861F310)[0]));
        }
        break;
    case 3:
        gPyramidBagResources->menuActionIds = gUnknown_0861F30C;
        gPyramidBagResources->menuActionsCount = (size_t)(sizeof(gUnknown_0861F30C) / sizeof((gUnknown_0861F30C)[0]));
        break;
    }
...
static void HandleFewMenuActionsInput(u8 taskId)
{
    if (MenuHelpers_CallLinkSomething() != 1)
    {
        ...
        case -1:
            PlaySE(5);
            sMenuActions[3].func.void_u8(taskId);
            break;
        default:
            PlaySE(5);
            if (sMenuActions[gPyramidBagResources->menuActionIds[id]].func.void_u8 != ((void *)0))
...
static bool8 IsValidMenuAction(s8 actionTableId)
{
    if (actionTableId < 0)
        ...
        return 0;
    else if (gPyramidBagResources->menuActionIds[actionTableId] == 5)
        return 0;
    else
        return 1;
}
...
static void BagAction_UseOnField(u8 taskId)
{
    ...
    if (pocketId == 10
        || pocketId == 3
        || pocketId == 9
        || ItemIsMail(gSpecialVar_ItemId) == 1)
    {
        sub_81C61A8();
        DisplayItemMessageInBattlePyramid(taskId, gText_DadsAdvice, Task_CloseBattlePyramidBagMessage);
    }
    else if (ItemId_GetFieldFunc(gSpecialVar_ItemId) != ((void *)0))
    {
        sub_81C61A8();
        FillWindowPixelBuffer(1, ((0) | ((0) << 4)));
...
static void sub_81C6404(void)
{
    ...
    AddTextPrinterParameterized(3, 1, gStringVar4, x, 2, 0, ((void *)0));
}
...
static void BagAction_UseInBattle(u8 taskId)
{
    if (ItemId_GetBattleFunc(gSpecialVar_ItemId) != ((void *)0))
    {
        sub_81C61A8();
...
void TryStoreHeldItemsInPyramidBag(void)
{
    ...
    memcpy(newItems, gSaveBlock2Ptr->frontier.pyramidBag.itemId[gSaveBlock2Ptr->frontier.lvlMode], 10 * sizeof(u16));
    memcpy(newQuantities, gSaveBlock2Ptr->frontier.pyramidBag.quantity[gSaveBlock2Ptr->frontier.lvlMode], 10 * sizeof(u8));
    for (i = 0; i < 3; i++)
    {
        heldItem = GetMonData(&party[i], 12);
        if (heldItem != 0 && !AddBagItem(heldItem, 1))
        {

            memcpy(gSaveBlock2Ptr->frontier.pyramidBag.itemId[gSaveBlock2Ptr->frontier.lvlMode], newItems, 10 * sizeof(u16));
            memcpy(gSaveBlock2Ptr->frontier.pyramidBag.quantity[gSaveBlock2Ptr->frontier.lvlMode], newQuantities, 10 * sizeof(u8));
            Free(newItems);
            Free(newQuantities);
    ...
    for (i = 0; i < 3; i++)
    {
        SetMonData(&party[i], 12, &heldItem);
    }
...
static void sub_81C6E38(u8 itemSpriteArrayId)
{
    ...
    if (*spriteId != 0xFF)
    {
        FreeSpriteTilesByTag(0x1024 + itemSpriteArrayId);
        FreeSpritePaletteByTag(0x1024 + itemSpriteArrayId);
...
static void ShowItemImage(u16 itemId, u8 itemSpriteArrayId)
{
    ...
    if (*spriteId == 0xFF)
    {
        FreeSpriteTilesByTag(0x1024 + 1 + itemSpriteArrayId);
        FreeSpritePaletteByTag(0x1024 + 1 + itemSpriteArrayId);
        itemSpriteId = AddItemIconSprite(0x1024 + 1 + itemSpriteArrayId, 0x1024 + 1 + itemSpriteArrayId, itemId);
        if (itemSpriteId != 64)
        {
