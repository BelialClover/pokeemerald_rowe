# 0 "src/international_string_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/international_string_util.c"
...
# 2 "src/international_string_util.c" 2
...
# 3 "src/international_string_util.c" 2
# 1 "include/list_menu.h" 1
# 4 "src/international_string_util.c" 2
...
# 5 "src/international_string_util.c" 2
...
# 6 "src/international_string_util.c" 2
...
# 7 "src/international_string_util.c" 2
...
# 8 "src/international_string_util.c" 2
...
void sub_81DB620(int windowId, int columnStart, int rowStart, int numFillTiles, int numRows)
{
    ...
    fillSize = numFillTiles * 32;
    windowRowSize = window->window.width * 32;
    windowTileData = window->tileData + (rowStart * windowRowSize) + (columnStart * 32);
    if (numRows > 0)
    {
        rowsToFill = numRows;
        while (rowsToFill)
        {
            { vu32 tmp = (vu32)(((0x11) << 24) | ((0x11) << 16) | ((0x11) << 8) | (0x11)); CpuFastSet((void *)&tmp, (windowTileData), 0x01000000 | (((fillSize))/(32/8) & 0x1FFFFF)); };
