# 0 "src/rotating_tile_puzzle.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/rotating_tile_puzzle.c"
...
# 2 "src/rotating_tile_puzzle.c" 2
...
# 3 "src/rotating_tile_puzzle.c" 2
...
# 4 "src/rotating_tile_puzzle.c" 2
# 1 "gflib/malloc.h" 1
# 15 "gflib/malloc.h"
extern u8 gHeap[];
...
# 5 "src/rotating_tile_puzzle.c" 2
...
# 6 "src/rotating_tile_puzzle.c" 2
...
# 7 "src/rotating_tile_puzzle.c" 2
# 1 "include/constants/event_object_movement.h" 1
# 8 "src/rotating_tile_puzzle.c" 2
# 1 "include/constants/event_objects.h" 1
# 9 "src/rotating_tile_puzzle.c" 2
# 1 "include/constants/metatile_labels.h" 1
# 10 "src/rotating_tile_puzzle.c" 2
...
{
    struct RotatingTileObject objects[16];
    u8 numObjects;
    bool8 isTrickHouse;
};
...
__attribute__((section("ewram_data"))) static struct RotatingTilePuzzle *sRotatingTilePuzzle = ((void *)0);


void InitRotatingTilePuzzle(bool8 isTrickHouse)
{
    if (sRotatingTilePuzzle == ((void *)0))
...
void FreeRotatingTilePuzzle(void)
{
    ...
    if (sRotatingTilePuzzle != ((void *)0))
        { Free(sRotatingTilePuzzle); sRotatingTilePuzzle = ((void *)0); };

    id = GetObjectEventIdByLocalIdAndMap(0xFF, 0, 0);
