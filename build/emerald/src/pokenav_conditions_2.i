# 0 "src/pokenav_conditions_2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/pokenav_conditions_2.c"
...
# 2 "src/pokenav_conditions_2.c" 2
# 1 "gflib/bg.h" 1
...
# 3 "src/pokenav_conditions_2.c" 2
# 1 "gflib/window.h" 1
...
# 4 "src/pokenav_conditions_2.c" 2
...
# 5 "src/pokenav_conditions_2.c" 2
...
# 6 "src/pokenav_conditions_2.c" 2
...
# 7 "src/pokenav_conditions_2.c" 2
...
# 8 "src/pokenav_conditions_2.c" 2
# 1 "include/menu.h" 1
...
# 9 "src/pokenav_conditions_2.c" 2
...
# 10 "src/pokenav_conditions_2.c" 2
...
# 11 "src/pokenav_conditions_2.c" 2
...
# 12 "src/pokenav_conditions_2.c" 2
...
# 14 "src/pokenav_conditions_2.c" 2
...
# 15 "src/pokenav_conditions_2.c" 2
...
# 16 "src/pokenav_conditions_2.c" 2
...
__attribute__((section(".bss"))) u8 gUnknown_030012BC;
...
{
    [PARTY_CONDITION_FUNC_NONE] = ((void *)0),
...
struct Pokenav7Struct
{
    ...
    struct Sprite *conditionSparkleSprites[10];
    u8 windowModeState;
    u8 filler2[0x38ac - 0x2909];
};

extern s8 GetMonMarkIndex(void);
...
u32 LoopedTask_OpenPartyConditionGraph(s32 state)
{
    ...
    {
    case 0:
        if (LoadPartyConditionMenuGfx() != 1)
            return 2;
        return 0;
    case 1:
        InitBgTemplates(sPartyConditionBgTemplates, (size_t)(sizeof(sPartyConditionBgTemplates) / sizeof((sPartyConditionBgTemplates)[0])));
        ChangeBgX(1, 0, 0);
        ChangeBgY(1, 0, 0);
        ChangeBgX(2, 0, 0);
        ChangeBgY(2, 0, 0);
        ChangeBgX(3, 0, 0);
        ChangeBgY(3, 0, 0);
        SetGpuReg(0x0, 0x2000 | 0x4000 | 0x1000 | 0x0040 | 0x0100 | 0x0800);
        SetGpuReg(0x50, (1 << 2) | (1 << 6) | (1 << 11));
    ...
    case 5:
        ...
        { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, structPtr->tilemapBuffers[1], 0x04000000 | 0x01000000 | ((0x800)/(32/8) & 0x1FFFFF)); };
    ...
    case 9:
        ...
        return 0;
    case 10:
        UpdateConditionGraphWindows(0, GetMonMarkIndex(), 1);
        return 0;
    case 11:
        UpdateConditionGraphWindows(1, GetMonMarkIndex(), 1);
        return 0;
    case 12:
        UpdateConditionGraphWindows(2, GetMonMarkIndex(), 1);
        return 0;
    case 13:
        if (UpdateConditionGraphWindows(3, GetMonMarkIndex(), 1) != 1)
            return 2;
    ...
    case 15:
        ...
        if (!IsConditionMenuSearchMode())
        {
            ...
            ShowLeftHeaderGfx(POKENAV_GFX_PARTY_MENU, 1, 0);
        }
        return 0;
    case 16:
    ...
    case 20:
        if (!TryUpdateConditionMonTransitionOn(GetConditionGraphDataPtr(), &structPtr->monTransitionX))
        {
            ...
            if (IsConditionMenuSearchMode() == 1 || GetConditionGraphCurrentMonIndex() != GetMonListCount())
...
u32 LoopedTask_TransitionMons(s32 state)
{
    ...
    case 4:
        ...
        return 2;
    case 5:
        UpdateConditionGraphWindows(0, GetMonMarkIndex(), 0);
        return 1;
    case 6:
        UpdateConditionGraphWindows(1, GetMonMarkIndex(), 0);
        return 1;
    case 7:
        UpdateConditionGraphWindows(2, GetMonMarkIndex(), 0);
        return 1;
    case 8:
        if (UpdateConditionGraphWindows(3, GetMonMarkIndex(), 0) == 1)
            return 1;
        return 2;
    case 9:
...
bool32 UpdateConditionGraphWindows(u8 mode, u16 bufferIndex, bool8 winMode)
{
    ...
    case 0:
        ...
        break;
    case 1:
        if (GetConditionGraphCurrentMonIndex() != GetMonListCount() - 1 || IsConditionMenuSearchMode() == 1)
        {
            str = GetConditionMonNameBuffer(bufferIndex);
            AddTextPrinterParameterized(structPtr->nameGenderWindowId, 1, str, 0, 1, 0, ((void *)0));
        }
        break;
    case 2:
        if (IsConditionMenuSearchMode() == 1)
        {
            ...
            AddTextPrinterParameterized(structPtr->nameGenderWindowId, 1, str, 0, 17, 0, ((void *)0));
            text[0] = 0xFC;
            text[1] = 0x04;
            text[2] = 0x8;
            text[3] = 0x0;
            ...
            AddTextPrinterParameterized(structPtr->listIndexWindowId, 1, text, 4, 1, 0, ((void *)0));
            ConvertIntToDecimalStringN(text + 5, GetConditionMonDataBuffer(), STR_CONV_MODE_RIGHT_ALIGN, 4);
            AddTextPrinterParameterized(structPtr->listIndexWindowId, 1, text, 28, 1, 0, ((void *)0));
        }
        break;
    case 3:
...
void FreePartyConditionSubstruct2(void)
{
    ...
    SetGpuReg(0x0, 0x1000 | 0x0100 | 0x0040);
