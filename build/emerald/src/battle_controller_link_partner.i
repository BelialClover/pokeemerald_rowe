# 0 "src/battle_controller_link_partner.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_controller_link_partner.c"
...
# 2 "src/battle_controller_link_partner.c" 2
...
# 3 "src/battle_controller_link_partner.c" 2
...
# 4 "src/battle_controller_link_partner.c" 2
...
# 5 "src/battle_controller_link_partner.c" 2
...
# 6 "src/battle_controller_link_partner.c" 2
...
# 7 "src/battle_controller_link_partner.c" 2
# 1 "include/battle_message.h" 1
# 8 "src/battle_controller_link_partner.c" 2
...
# 9 "src/battle_controller_link_partner.c" 2
...
# 10 "src/battle_controller_link_partner.c" 2
...
# 11 "src/battle_controller_link_partner.c" 2
# 1 "gflib/bg.h" 1
...
# 12 "src/battle_controller_link_partner.c" 2
# 1 "include/data.h" 1
...
# 13 "src/battle_controller_link_partner.c" 2
# 1 "include/link.h" 1
# 106 "include/link.h"
struct LinkStatus
{
...
# 14 "src/battle_controller_link_partner.c" 2
# 1 "include/main.h" 1
...
# 15 "src/battle_controller_link_partner.c" 2
# 1 "include/m4a.h" 1
...
# 16 "src/battle_controller_link_partner.c" 2
...
# 17 "src/battle_controller_link_partner.c" 2
# 1 "include/pokeball.h" 1
# 18 "src/battle_controller_link_partner.c" 2
# 1 "include/pokemon.h" 1
# 19 "src/battle_controller_link_partner.c" 2
...
# 20 "src/battle_controller_link_partner.c" 2
...
# 21 "src/battle_controller_link_partner.c" 2
# 1 "include/sound.h" 1
...
# 22 "src/battle_controller_link_partner.c" 2
...
# 23 "src/battle_controller_link_partner.c" 2
# 1 "include/task.h" 1
# 24 "src/battle_controller_link_partner.c" 2
# 1 "gflib/text.h" 1
# 272 "gflib/text.h"
enum
{
...
# 25 "src/battle_controller_link_partner.c" 2
# 1 "include/util.h" 1
...
# 26 "src/battle_controller_link_partner.c" 2
# 1 "gflib/window.h" 1
...
# 27 "src/battle_controller_link_partner.c" 2
# 1 "include/constants/battle_anim.h" 1
# 28 "src/battle_controller_link_partner.c" 2
# 1 "include/constants/songs.h" 1
# 29 "src/battle_controller_link_partner.c" 2
...
# 30 "src/battle_controller_link_partner.c" 2
...
static void LinkPartnerBufferRunCommand(void)
{
    ...
    {
        if (gBattleResources->bufferA[gActiveBattler][0] < (size_t)(sizeof(sLinkPartnerBufferCommands) / sizeof((sLinkPartnerBufferCommands)[0])))
