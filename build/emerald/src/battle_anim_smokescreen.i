# 0 "src/battle_anim_smokescreen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_anim_smokescreen.c"
...
# 2 "src/battle_anim_smokescreen.c" 2
...
# 3 "src/battle_anim_smokescreen.c" 2
# 1 "include/data.h" 1
...
# 4 "src/battle_anim_smokescreen.c" 2
...
# 5 "src/battle_anim_smokescreen.c" 2
...
# 6 "src/battle_anim_smokescreen.c" 2
...
# 8 "src/battle_anim_smokescreen.c" 2
# 1 "include/constants/pokemon.h" 1
# 9 "src/battle_anim_smokescreen.c" 2
# 1 "include/constants/battle_palace.h" 1
# 10 "src/battle_anim_smokescreen.c" 2
...
const u8 gBattlePalaceNatureToMoveTarget[25] =
{
    [0] = 0,
    [1] = 0,
    [2] = 1,
...
{
    {.frame = {0, 4, .hFlip = 1, .vFlip = 1}},
    {.frame = {4, 4, .hFlip = 1, .vFlip = 1}},
    {.frame = {8, 4, .hFlip = 1, .vFlip = 1}},
    {.type = -1}
};
