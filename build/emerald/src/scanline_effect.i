# 0 "src/scanline_effect.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/scanline_effect.c"
...
__attribute__((section("ewram_data"))) u16 gScanlineEffectRegBuffers[2][0x3C0] = {0};

__attribute__((section("ewram_data"))) struct ScanlineEffect gScanlineEffect = {0};
__attribute__((section("ewram_data"))) static bool8 sShouldStopWaveTask = 0;
...
void ScanlineEffect_Clear(void)
{
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, gScanlineEffectRegBuffers, 0x00000000 | 0x01000000 | ((sizeof(gScanlineEffectRegBuffers))/(16/8) & 0x1FFFFF)); };
    gScanlineEffect.dmaSrcBuffers[0] = ((void *)0);
    gScanlineEffect.dmaSrcBuffers[1] = ((void *)0);
    gScanlineEffect.dmaDest = ((void *)0);
...
{
    if (params.dmaControl == (((0x8000 | 0x2000 | 0x0200 | 0x0000 | 0x0000 | 0x0000 | 0x0060) << 16) | 1))
    {
...
static void TaskFunc_UpdateWavePerFrame(u8 taskId)
{
    ...
    else
    {
        if (gTasks[taskId].data[7])
        {
            ...
            {
            case ((0x4000000 + 0x10) - (0x4000000 + 0x10)):
                value = gBattle_BG0_X;
                break;
            case ((0x4000000 + 0x12) - (0x4000000 + 0x10)):
                value = gBattle_BG0_Y;
                break;
            case ((0x4000000 + 0x14) - (0x4000000 + 0x10)):
                value = gBattle_BG1_X;
                break;
            case ((0x4000000 + 0x16) - (0x4000000 + 0x10)):
                value = gBattle_BG1_Y;
                break;
            case ((0x4000000 + 0x18) - (0x4000000 + 0x10)):
                value = gBattle_BG2_X;
                break;
            case ((0x4000000 + 0x1a) - (0x4000000 + 0x10)):
                value = gBattle_BG2_Y;
                break;
            case ((0x4000000 + 0x1c) - (0x4000000 + 0x10)):
                value = gBattle_BG3_X;
                break;
            case ((0x4000000 + 0x1e) - (0x4000000 + 0x10)):
                value = gBattle_BG3_Y;
                break;
            }
        }
...
u8 ScanlineEffect_InitWave(u8 startLine, u8 endLine, u8 frequency, u8 amplitude, u8 delayInterval, u8 regOffset, bool8 applyBattleBgOffsets)
{
    ...
    params.dmaDest = (void *)((0x4000000 + 0x10) + regOffset);
    ...
    gTasks[taskId].data[0] = startLine;
    gTasks[taskId].data[1] = endLine;
    gTasks[taskId].data[2] = 256 / frequency;
    gTasks[taskId].data[3] = 0;
    gTasks[taskId].data[4] = delayInterval;
    gTasks[taskId].data[5] = delayInterval;
    gTasks[taskId].data[6] = regOffset;
    gTasks[taskId].data[7] = applyBattleBgOffsets;

    gScanlineEffect.waveTaskId = taskId;
    sShouldStopWaveTask = 0;
