# 0 "src/battle_anim_rock.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_anim_rock.c"
...
# 7 "src/battle_anim_rock.c" 2
# 1 "include/task.h" 1
# 8 "src/battle_anim_rock.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 9 "src/battle_anim_rock.c" 2
# 1 "include/constants/rgb.h" 1
# 10 "src/battle_anim_rock.c" 2
# 1 "include/constants/songs.h" 1
# 11 "src/battle_anim_rock.c" 2
...
static const union AffineAnimCmd sAffineAnim_Whirlpool[] =
{
    ...
    {.frame = {.xScale = 0x2, .yScale = 0xFFFD, .rotation = 0, .duration = 5}},
    {.frame = {.xScale = 0xFFFE, .yScale = 0x3, .rotation = 0, .duration = 5}},
...
{
    {.x = -16, .y = 0, .shape = (((2 << 2) | (1)) & 0x03), .size = ((((2 << 2) | (1)) >> 2) & 0x03), .tileOffset = 0, .priority = 1},
    {.x = 16, .y = 0, .shape = (((2 << 2) | (1)) & 0x03), .size = ((((2 << 2) | (1)) >> 2) & 0x03), .tileOffset = 8, .priority = 1},
};

static const struct SubspriteTable sFlyingSandSubspriteTable[] =
{
    {(size_t)(sizeof(sFlyingSandSubsprites) / sizeof((sFlyingSandSubsprites)[0])), sFlyingSandSubsprites},
};
...
{
 {.frame = {.xScale = 0, .yScale = 0, .rotation = 96, .duration = 1}},
 {.type = 0x7FFF}
};
