# 0 "src/rayquaza_scene.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/rayquaza_scene.c"
...
# 16 "src/rayquaza_scene.c" 2
# 1 "include/constants/songs.h" 1
# 17 "src/rayquaza_scene.c" 2
# 1 "include/constants/rgb.h" 1
# 18 "src/rayquaza_scene.c" 2
...
# 19 "src/rayquaza_scene.c" 2
# 34 "src/rayquaza_scene.c"
enum
{
...
static __attribute__((section("ewram_data"))) struct RayquazaScene *sRayScene = ((void *)0);
...
{
    gRaySceneDuoFight_Groudon_Gfx, 0x3000, 30505
};

static const struct CompressedSpritePalette sSpritePal_DuoFight_Groudon =
{
    gRaySceneDuoFight_Groudon_Pal, 30505
};
...
{
    gRaySceneDuoFight_GroudonShoulder_Gfx, 0x200, 30506
};
...
{
    gRaySceneDuoFight_GroudonClaw_Gfx, 0x400, 30507
};
...
{
    gRaySceneDuoFight_Kyogre_Gfx, 0xF00, 30508
};

static const struct CompressedSpritePalette sSpritePal_DuoFight_Kyogre =
{
    gRaySceneDuoFight_Kyogre_Pal, 30508
};
...
{
    gRaySceneDuoFight_KyogrePectoralFin_Gfx, 0xC0, 30509
};
...
{
    gRaySceneDuoFight_KyogreDorsalFin_Gfx, 0x200, 30510
};
...
{
    {.frame = {.xScale = -64, .yScale = -64, .rotation = 0, .duration = 1}},
    {.frame = {.xScale = 32, .yScale = 32, .rotation = 0, .duration = 14}},
...
{
    gRaySceneTakesFlight_Smoke_Gfx, 0x100, 30555
};

static const struct CompressedSpritePalette sSpritePal_TakesFlight_Smoke =
{
    gRaySceneTakesFlight_Smoke_Pal, 30555
};
...
static const s8 sTakesFlight_SmokeCoords[10][2] =
{
    {-1, 5},
    {-3, -4},
    { 5, -3},
...
static void CB2_InitRayquazaScene(void)
{
    ...
    ResetSpriteData();
    ResetTasks();
    FillPalette(((0) | ((0) << 5) | ((0) << 10)), 0xF0, 32);
...
static void SetWindowsHideVertBorders(void)
{
    ...
    SetGpuReg(0x4a, 0);
    SetGpuReg(0x40, (((0) << 8) | (240)));
    SetGpuReg(0x44, (((24) << 8) | (160 - 24)));
...
static u8 DuoFightPre_CreateGroudonSprites(void)
{
    ...
    data[0] = CreateSprite(&sSpriteTemplate_DuoFightPre_Groudon, 56, 104, 3);
    data[1] = CreateSprite(&sSpriteTemplate_DuoFightPre_GroudonShoulder, 75, 101, 0);
    data[2] = CreateSprite(&sSpriteTemplate_DuoFightPre_GroudonClaw, 109, 114, 1);
...
static void InitDuoFightSceneBgs(void)
{
    ...
    InitBgsFromTemplates(0, sBgTemplates_DuoFight, (size_t)(sizeof(sBgTemplates_DuoFight) / sizeof((sBgTemplates_DuoFight)[0])));
...
static void Task_DuoFightAnim(u8 taskId)
{
    ...
    { vu32 tmp = (vu32)(((0) << 16) | (0)); CpuFastSet((void *)&tmp, (gScanlineEffectRegBuffers), 0x01000000 | (((sizeof(gScanlineEffectRegBuffers)))/(32/8) & 0x1FFFFF)); };
    ScanlineEffect_SetParams(sScanlineParams_DuoFight_Clouds);
    data[0] = 0;
    data[1] = CreateTask(Task_DuoFight_AnimateClouds, 0);
    ...
    if (!gPaletteFade.active)
    {
        ...
        else
        {
            ...
            case 412:
                ...
                return;
            case 380:
                SetGpuReg(0x50, (1 << 2) | (1 << 9) | (1 << 6));
                gTasks[data[1]].func = DuoFight_PanOffScene;
...
{
    PlaySE(87);
    BlendPalettesGradually(0x00007FFF, 0, 16, 0, (((31) | ((31) << 5) | ((31) << 10)) | 0x8000), 0, 0);
    BlendPalettesGradually(0xFFFF0000, 0, 16, 0, ((0) | ((0) << 5) | ((0) << 10)), 0, 1);
}

static void DuoFight_Lightning2(void)
{
    PlaySE(87);
    BlendPalettesGradually(0x00007FFF, 0, 16, 16, (((31) | ((31) << 5) | ((31) << 10)) | 0x8000), 0, 0);
    BlendPalettesGradually(0xFFFF0000, 0, 16, 16, ((0) | ((0) << 5) | ((0) << 10)), 0, 1);
}

static void DuoFight_LightningLong(void)
{
    BlendPalettesGradually(0x00007FFF, 4, 16, 0, (((31) | ((31) << 5) | ((31) << 10)) | 0x8000), 0, 0);
    BlendPalettesGradually(0xFFFF0000, 4, 16, 0, ((0) | ((0) << 5) | ((0) << 10)), 0, 1);
}
...
static void DuoFight_PanOffScene(u8 taskId)
{
    u16 bgY;
    s16 *data = gTasks[taskId].data;
    DuoFight_SlideGroudonDown(&gSprites[data[2]]);
    DuoFight_SlideKyogreDown(&gSprites[data[3]]);
    ...
    {
        data[0]++;
        SetGpuReg(0x52, (((data[0]) << 8) | (16 - data[0])));
    }
}
...
{
    PlaySE(84);
    BeginNormalPaletteFade(0xFFFFFFFF, palDelay, 0, 0x10, ((0) | ((0) << 5) | ((0) << 10)));
...
static u8 DuoFight_CreateGroudonSprites(void)
{
    ...
    data = gSprites[spriteId].data;
    data[0] = CreateSprite(&sSpriteTemplate_DuoFight_Groudon, 66, 104, 3);
    data[1] = CreateSprite(&sSpriteTemplate_DuoFight_GroudonShoulder, 85, 101, 0);
    data[2] = CreateSprite(&sSpriteTemplate_DuoFight_GroudonClaw, 119, 114, 1);
    StartSpriteAnim(&gSprites[data[0]], 1);
    return spriteId;
}
...
# 2005 "src/rayquaza_scene.c"
static void InitTakesFlightSceneBgs(void)
{
    ResetVramOamAndBgCntRegs();
    ResetBgsAndClearDma3BusyFlags(0);
    InitBgsFromTemplates(1, sBgTemplates_TakesFlight, (size_t)(sizeof(sBgTemplates_TakesFlight) / sizeof((sBgTemplates_TakesFlight)[0])));
    SetBgTilemapBuffer(0, sRayScene->tilemapBuffers[0]);
    SetBgTilemapBuffer(1, sRayScene->tilemapBuffers[1]);
    SetBgTilemapBuffer(2, sRayScene->tilemapBuffers[2]);
    ResetAllBgsCoordinates();
...
static void Task_HandleRayTakesFlight(u8 taskId)
{
    ...
    case 1:
        ...
        SetBgAffine(2, 0x7800, 0x1800, 120, data[4] + 32, data[2], data[2], 0);
        break;
    case 2:

        data[1]++;
        SetBgAffine(2, 0x7800, 0x1800, 120, data[4] + 32 + (data[6] >> 2), data[2], data[2], 0);
        data[6] += data[7];
        if (data[6] == 12 || data[6] == -12)
        {
            ...
            {
                data[0]++;
                BeginNormalPaletteFade(0xFFFFFFFF, 6, 0, 0x10, ((0) | ((0) << 5) | ((0) << 10)));
            }
        }
        break;
    case 3:
...
static void SpriteCB_TakesFlight_Smoke(struct Sprite *sprite)
{
    ...
    {
        sprite->pos2.x += sTakesFlight_SmokeCoords[sprite->data[0]][0];
        sprite->pos2.y += sTakesFlight_SmokeCoords[sprite->data[0]][1];
    }
...
static void InitDescendsSceneBgs(void)
{
    ResetVramOamAndBgCntRegs();
    ResetBgsAndClearDma3BusyFlags(0);
    InitBgsFromTemplates(0, sBgTemplates_Descends, (size_t)(sizeof(sBgTemplates_Descends) / sizeof((sBgTemplates_Descends)[0])));
    SetBgTilemapBuffer(0, sRayScene->tilemapBuffers[0]);
    SetBgTilemapBuffer(1, sRayScene->tilemapBuffers[1]);
    SetBgTilemapBuffer(2, sRayScene->tilemapBuffers[2]);
...
static void LoadDescendsSceneGfx(void)
{
    ...
    { vu32 tmp = (vu32)(((0) << 16) | (0)); CpuFastSet((void *)&tmp, (sRayScene->tilemapBuffers[2]), 0x01000000 | (((0x800))/(32/8) & 0x1FFFFF)); };
    CpuFastSet(sRayScene->tilemapBuffers[3], sRayScene->tilemapBuffers[1], ((0x800)/(32/8) & 0x1FFFFF));
    { vu32 tmp = (vu32)(((0) << 16) | (0)); CpuFastSet((void *)&tmp, (&sRayScene->tilemapBuffers[1][0x100]), 0x01000000 | (((0x340))/(32/8) & 0x1FFFFF)); };

    LoadCompressedPalette(gRaySceneDescends_Bg_Pal, 0, 0x40);
    gPlttBufferUnfaded[0] = ((31) | ((31) << 5) | ((31) << 10));
    gPlttBufferFaded[0] = ((31) | ((31) << 5) | ((31) << 10));
...
static void Task_RayDescendsAnim(u8 taskId)
{
    ...
    SetGpuRegBits(0x50, (1 << 0) | (1 << 9) | (1 << 10) | (1 << 11) | (1 << 12) | (1 << 6));
...
# 2456 "src/rayquaza_scene.c"
static void InitChargesSceneBgs(void)
{
    ResetVramOamAndBgCntRegs();
    ResetBgsAndClearDma3BusyFlags(0);
    InitBgsFromTemplates(0, sBgTemplates_Charges, (size_t)(sizeof(sBgTemplates_Charges) / sizeof((sBgTemplates_Charges)[0])));
    SetBgTilemapBuffer(0, sRayScene->tilemapBuffers[0]);
    SetBgTilemapBuffer(1, sRayScene->tilemapBuffers[1]);
    SetBgTilemapBuffer(2, sRayScene->tilemapBuffers[2]);
    SetBgTilemapBuffer(3, sRayScene->tilemapBuffers[3]);
    ...
    ScheduleBgCopyTilemapToVram(2);
    ScheduleBgCopyTilemapToVram(3);
    SetGpuReg(0x0, 0x1000 | 0x0040 | 0x2000);
    ShowBg(0);
    ShowBg(1);
    ShowBg(2);
    ShowBg(3);
...
static void Task_RayChargesAnim(u8 taskId)
{
    ...
    data[0] = 0;
    data[1] = 0;
    data[2] = CreateTask(Task_RayCharges_ShakeRayquaza, 0);
...
static void Task_HandleRayCharges(u8 taskId)
{
    ...
    case 1:
        ...
        if (data[1] == 127)
        {
            data[1] = 0;
            data[0]++;
            gTasks[data[2]].func = Task_RayCharges_FlyOffscreen;
        }
        else
        {
            data[1]++;
...
static void InitChasesAwaySceneBgs(void)
{
    ResetVramOamAndBgCntRegs();
    ResetBgsAndClearDma3BusyFlags(0);
    InitBgsFromTemplates(1, sBgTemplates_ChasesAway, (size_t)(sizeof(sBgTemplates_ChasesAway) / sizeof((sBgTemplates_ChasesAway)[0])));
    SetBgTilemapBuffer(0, sRayScene->tilemapBuffers[0]);
    SetBgTilemapBuffer(1, sRayScene->tilemapBuffers[1]);
    SetBgTilemapBuffer(2, sRayScene->tilemapBuffers[2]);
    ResetAllBgsCoordinates();
...
static void Task_RayChasesAwayAnim(u8 taskId)
{
    ...
    SetGpuReg(0x50, (1 << 0) | (1 << 9) | (1 << 6));
    SetGpuReg(0x52, (((14) << 8) | (9)));
    BlendPalettes(-1, 0x10, 0);
    SetVBlankCallback(VBlankCB_RayquazaScene);
    data[0] = 0;
    data[1] = 0;
    gTasks[taskId].func = Task_HandleRayChasesAway;
    data[2] = CreateTask(Task_ChasesAway_AnimateBg, 0);
...
static void Task_HandleRayChasesAway(u8 taskId)
{
    ...
    case 2:
        ...
        else
        {
            ...
            if (data[1] % 144 == 0)
            {
                BlendPalettesGradually(0x0000FFFE, 0, 16, 0, (((31) | ((31) << 5) | ((31) << 10)) | 0x8000), 0, 0);
                BlendPalettesGradually(0xFFFF0000, 0, 16, 0, ((0) | ((0) << 5) | ((0) << 10)), 0, 1);
            }
        }
        break;
...
# 2786 "src/rayquaza_scene.c"
static void Task_ChasesAway_AnimateBg(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    if ((data[0] & 0xF) == 0)
    {
        SetGpuReg(0x52, ((data[1] + 14) << 8 & 0x1F00) | ((data[2] + 9) & 0xF));
        data[1] -= data[3];
        data[2] += data[4];
...
# 2937 "src/rayquaza_scene.c"
static void ChasesAway_GroudonStartLeave(u8 taskId)
{
    s16 *taskData = gTasks[taskId].data;
    gSprites[taskData[3]].callback = SpriteCB_ChasesAway_GroudonLeave;
...
static void ChasesAway_KyogreStartLeave(u8 taskId)
{
    ...
    gSprites[taskData[4]].callback = SpriteCB_ChasesAway_KyogreLeave;
...
{
    struct Sprite *tail = &gSprites[body->data[0]];
    if (!(body->data[6] & tail->data[4]))
    {
        body->pos2.y += body->data[4];
        gSprites[body->data[0]].pos2.y += body->data[4];
