# 0 "src/evolution_graphics.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/evolution_graphics.c"
...
# 9 "src/evolution_graphics.c" 2
# 1 "include/constants/songs.h" 1
# 10 "src/evolution_graphics.c" 2
...
# 11 "src/evolution_graphics.c" 2
# 1 "include/constants/rgb.h" 1
# 12 "src/evolution_graphics.c" 2
...
static void EvoTask_BeginPreSet1_FadeAndPlaySE(u8 taskID)
{
    ...
    BeginNormalPaletteFade(3 << gTasks[taskID].data[1], 0xA, 0, 0x10, ((31) | ((31) << 5) | ((31) << 10)));
...
static void EvoTask_BeginPostSparklesSet2_AndFlash(u8 taskID)
{
    ...
    BeginNormalPaletteFade(0xFFF9041C, 0, 0, 0x10, ((31) | ((31) << 5) | ((31) << 10)));
...
static void EvoTask_CreatePostEvoSparklesSet2_AndFlash(u8 taskID)
{
    if (gTasks[taskID].data[15] < 128)
    {
        ...
        case 0:
            ...
            break;
        case 32:
            BeginNormalPaletteFade(0xFFFF041C, 0x10, 0x10, 0, ((31) | ((31) << 5) | ((31) << 10)));
            break;
        }
        gTasks[taskID].data[15]++;
    }
...
static void EvoTask_BeginPostSparklesSet2_AndFlash_Trade(u8 taskID)
{
    ...
    gTasks[taskID].data[15] = 0;
    CpuSet(&gPlttBufferFaded[0x20], &gPlttBufferUnfaded[0x20], 0x30);
    BeginNormalPaletteFade(0xFFF90400, 0, 0, 0x10, ((31) | ((31) << 5) | ((31) << 10)));
...
static void EvoTask_CreatePostEvoSparklesSet2_AndFlash_Trade(u8 taskID)
{
    if (gTasks[taskID].data[15] < 128)
    {
        ...
        case 0:
            ...
            break;
        case 32:
            BeginNormalPaletteFade(0xFFFF0400, 0x10, 0x10, 0, ((31) | ((31) << 5) | ((31) << 10)));
            break;
        }
        gTasks[taskID].data[15]++;
    }
...
static void PreEvoInvisible_PostEvoVisible_KillTask(u8 taskID)
{
    gSprites[gTasks[taskID].data[1]].oam.affineMode = 0;
    gSprites[gTasks[taskID].data[1]].oam.matrixNum = 0;
    gSprites[gTasks[taskID].data[1]].invisible = 1;

    gSprites[gTasks[taskID].data[2]].oam.affineMode = 0;
    gSprites[gTasks[taskID].data[2]].oam.matrixNum = 0;
    gSprites[gTasks[taskID].data[2]].invisible = 0;
...
static void PreEvoVisible_PostEvoInvisible_KillTask(u8 taskID)
{
    gSprites[gTasks[taskID].data[1]].oam.affineMode = 0;
    gSprites[gTasks[taskID].data[1]].oam.matrixNum = 0;
    gSprites[gTasks[taskID].data[1]].invisible = 0;

    gSprites[gTasks[taskID].data[2]].oam.affineMode = 0;
    gSprites[gTasks[taskID].data[2]].oam.matrixNum = 0;
    gSprites[gTasks[taskID].data[2]].invisible = 1;
