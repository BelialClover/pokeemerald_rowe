...
const struct PokenavCallbacks PokenavMenuCallbacks[15] =
{
    ...
    [POKENAV_MAIN_MENU_CURSOR_ON_MAP - 100000] =
    {
        .init = PokenavCallback_Init_MainMenuCursorOnMap,
        .callback = GetMenuHandlerCallback,
    ...
    [POKENAV_CONDITION_SEARCH_MENU - 100000] =
    {
    ...
    [POKENAV_MAIN_MENU_CURSOR_ON_MATCH_CALL - 100000] =
    {
    ...
    [POKENAV_MAIN_MENU_CURSOR_ON_RIBBONS - 100000] =
    {
    ...
    [POKENAV_CONDITION_PARTY - 100000] =
    {
    ...
    [POKENAV_CONDITION_SEARCH_RESULTS - 100000] =
    {
    ...
    [POKENAV_CONDITION_GRAPH_FROM_SEARCH - 100000] =
    {
    ...
    [POKENAV_RETURN_CONDITION_SEARCH - 100000] =
    {
    ...
    [POKENAV_RIBBONS_MON_LIST - 100000] =
    {
    ...
    [POKENAV_RIBBONS_SUMMARY_SCREEN - 100000] =
    {
    ...
    [POKENAV_RIBBONS_RETURN_TO_MON_LIST - 100000] =
    {
...
void FreePokenavSubstruct(u32 index)
{
    if (gPokenavResources->substructPtrs[index] != ((void *)0))
        { Free(gPokenavResources->substructPtrs[index]); gPokenavResources->substructPtrs[index] = ((void *)0); };
}
