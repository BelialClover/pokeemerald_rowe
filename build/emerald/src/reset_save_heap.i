# 0 "src/reset_save_heap.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/reset_save_heap.c"
...
# 10 "src/reset_save_heap.c" 2

void sub_81700F8(void)
{
    u16 imeBackup;

    imeBackup = (*(vu16 *)(0x4000000 + 0x208));
    (*(vu16 *)(0x4000000 + 0x208)) = 0;
    RegisterRamReset(0x01);
    ClearGpuRegBits(0x0, 0x0080);
