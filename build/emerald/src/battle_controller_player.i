# 0 "src/battle_controller_player.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 2 "src/battle_controller_player.c" 2
...
# 3 "src/battle_controller_player.c" 2
...
# 4 "src/battle_controller_player.c" 2
...
# 5 "src/battle_controller_player.c" 2
...
# 6 "src/battle_controller_player.c" 2
...
# 7 "src/battle_controller_player.c" 2
...
# 8 "src/battle_controller_player.c" 2
# 1 "include/battle_message.h" 1
# 9 "src/battle_controller_player.c" 2
...
# 10 "src/battle_controller_player.c" 2
...
# 11 "src/battle_controller_player.c" 2
# 1 "gflib/bg.h" 1
...
# 12 "src/battle_controller_player.c" 2
# 1 "include/data.h" 1
...
# 13 "src/battle_controller_player.c" 2
# 1 "include/item.h" 1
...
# 14 "src/battle_controller_player.c" 2
...
# 15 "src/battle_controller_player.c" 2
# 1 "include/link.h" 1
# 106 "include/link.h"
struct LinkStatus
{
...
# 16 "src/battle_controller_player.c" 2
# 1 "include/main.h" 1
...
# 17 "src/battle_controller_player.c" 2
# 1 "include/m4a.h" 1
...
# 18 "src/battle_controller_player.c" 2
...
# 19 "src/battle_controller_player.c" 2
...
# 1 "include/pokemon.h" 1
# 22 "src/battle_controller_player.c" 2
...
# 23 "src/battle_controller_player.c" 2
...
# 24 "src/battle_controller_player.c" 2
...
# 25 "src/battle_controller_player.c" 2
# 1 "include/sound.h" 1
...
# 26 "src/battle_controller_player.c" 2
...
# 27 "src/battle_controller_player.c" 2
# 1 "include/task.h" 1
# 28 "src/battle_controller_player.c" 2
# 1 "gflib/text.h" 1
# 272 "gflib/text.h"
enum
{
...
# 29 "src/battle_controller_player.c" 2
# 1 "include/util.h" 1
...
# 30 "src/battle_controller_player.c" 2

# 1 "include/constants/battle_anim.h" 1
# 32 "src/battle_controller_player.c" 2
# 1 "include/constants/battle_config.h" 1
# 33 "src/battle_controller_player.c" 2
# 1 "include/constants/items.h" 1
# 34 "src/battle_controller_player.c" 2
# 1 "include/constants/moves.h" 1
# 35 "src/battle_controller_player.c" 2
# 1 "include/constants/party_menu.h" 1
# 36 "src/battle_controller_player.c" 2
# 1 "include/constants/songs.h" 1
# 37 "src/battle_controller_player.c" 2
...
# 38 "src/battle_controller_player.c" 2
# 1 "include/constants/rgb.h" 1
# 39 "src/battle_controller_player.c" 2
...
static void PlayerBufferRunCommand(void)
{
    ...
    {
        if (gBattleResources->bufferA[gActiveBattler][0] < (size_t)(sizeof(sPlayerBufferCommands) / sizeof((sPlayerBufferCommands)[0])))
...
static void HandleInputChooseAction(void)
{
    ...
    if (({(gMain.newAndRepeatedKeys) & (((0x0010 | 0x0020 | 0x0040 | 0x0080)));}) && gSaveBlock2Ptr->optionsButtonMode == 2)
    ...
    else if (({(gMain.newKeys) & (0x0002);}) || gPlayerDpadHoldFrames > 59)
    {
        ...
        {
            if (gBattleResources->bufferA[gActiveBattler][1] == 1)
            {
    ...
    else if (1 && gMain.newKeys & 0x0004)
    {
        BtlController_EmitTwoReturnValues(1, 20, 0);
        PlayerBufferExecCompleted();
    }

    else if (({(gMain.newKeys) & (0x0100);}) && CanThrowLastUsedBall())
    {
        PlaySE(5);
        TryHideLastUsedBall();
        BtlController_EmitTwoReturnValues(1, 21, 0);
        PlayerBufferExecCompleted();
    }

}

static void sub_80577F0(void)
{
...
{
    s32 i;
    static const u8 identities[4] = {0, 2, 3, 1};
    u16 move = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 13 + gMoveSelectionCursor[gActiveBattler]);
    ...
    if (({(gMain.heldKeys) & (((0x0010 | 0x0020 | 0x0040 | 0x0080)));}) && gSaveBlock2Ptr->optionsButtonMode == 2)
        gPlayerDpadHoldFrames++;
    else
        gPlayerDpadHoldFrames = 0;
    ...
    if (({(gMain.newKeys) & (0x0001);}))
    {
        ...
        if (gBattleStruct->mega.playerSelect)
            BtlController_EmitTwoReturnValues(1, 10, gMoveSelectionCursor[gActiveBattler] | 0x80 | (gMultiUsePlayerCursor << 8));
        else
  ...
  TryHideLastUsedBall();
    ...
    else if (({(gMain.newKeys) & (0x0020 | 0x0040);}))
    {
        PlaySE(5);
        gSprites[gBattlerSpriteIds[gMultiUsePlayerCursor]].callback = SpriteCb_HideAsMoveTarget;

        if (gBattleMoves[move].target == (0x10 | 0x80))
        {
            ...
            do
            {
                ...
                case 2:
                    if (gActiveBattler != gMultiUsePlayerCursor)
                        i++;
                    else if (gBattleMoves[move].target & 0x2)
                        i++;
                    break;
                case 1:
                case 3:
    ...
    else if (({(gMain.newKeys) & (0x0010 | 0x0080);}))
    {
        PlaySE(5);
        gSprites[gBattlerSpriteIds[gMultiUsePlayerCursor]].callback = SpriteCb_HideAsMoveTarget;
...
static void TryShowAsTarget(u32 battlerId)
{
    ...
    {
        DoBounceEffect(battlerId, 0x1, 15, 1);
...
static void HandleInputChooseMove(void)
{
    ...
    if (gMain.newKeys & 0x0001)
    {
        ...
        {
            if (moveInfo->monType1 != 7 && moveInfo->monType2 != 7 && moveInfo->monType3 != 7)
                moveTarget = 0x10;
            else
                moveTarget = 0x0;
        }
        ...
        if (moveTarget & 0x10)
            ...
            gMultiUsePlayerCursor = GetBattlerAtPosition((GetBattlerPosition(gActiveBattler) & 1) ^ 1);

        if (!gBattleResources->bufferA[gActiveBattler][1])
        {
            if (moveTarget & 0x2 && !gBattleResources->bufferA[gActiveBattler][2])
                canSelectTarget = 1;
        }
        else
        {
            if (!(moveTarget & (0x4 | 0x8 | 0x1 | 0x20 | 0x40 | 0x10 | 0x80)))
                canSelectTarget = 1;
            if (moveTarget == (0x10 | 0x80) && IsBattlerAlive(((gActiveBattler) ^ 2)))
                canSelectTarget = 1;
            ...
            else if (!(moveTarget & (0x10 | 0x2)) && CountAliveMonsInBattle(0) <= 1)
            {
            ...
            if (1 && moveTarget & (0x40 | 0x8 | 0x20))
            {
                TryShowAsTarget(gMultiUsePlayerCursor);
                TryShowAsTarget(((gMultiUsePlayerCursor) ^ 2));
                if (moveTarget & 0x20)
                    TryShowAsTarget(((gActiveBattler) ^ 2));
                canSelectTarget = 2;
            }
        }
   ...
   TryHideLastUsedBall();
        ...
        else if (canSelectTarget == 1)
        {
            ...
            if (moveTarget & (0x10 | 0x2))
                gMultiUsePlayerCursor = gActiveBattler;
            else if (gAbsentBattlerFlags & gBitTable[GetBattlerAtPosition(1)])
                gMultiUsePlayerCursor = GetBattlerAtPosition(3);
            else
                gMultiUsePlayerCursor = GetBattlerAtPosition(1);
    ...
    {
        PlaySE(5);
        gBattleStruct->mega.playerSelect = 0;
...
u32 sub_8057FBC(void)
{
    ...
    if (({(gMain.newKeys) & (0x0020);}) && gMoveSelectionCursor[gActiveBattler] & 1)
    {
        MoveSelectionDestroyCursorAt(gMoveSelectionCursor[gActiveBattler]);
        gMoveSelectionCursor[gActiveBattler] ^= 1;
        PlaySE(5);
    ...
    if (({(gMain.newKeys) & (0x0010);}) && !(gMoveSelectionCursor[gActiveBattler] & 1)
        && (gMoveSelectionCursor[gActiveBattler] ^ 1) < gNumberOfMovesToChoose)
    {
        MoveSelectionDestroyCursorAt(gMoveSelectionCursor[gActiveBattler]);
        gMoveSelectionCursor[gActiveBattler] ^= 1;
    ...
    if (({(gMain.newKeys) & (0x0040);}) && gMoveSelectionCursor[gActiveBattler] & 2)
    {
        MoveSelectionDestroyCursorAt(gMoveSelectionCursor[gActiveBattler]);
        gMoveSelectionCursor[gActiveBattler] ^= 2;
        PlaySE(5);
    ...
    if (({(gMain.newKeys) & (0x0080);}) && !(gMoveSelectionCursor[gActiveBattler] & 2)
        && (gMoveSelectionCursor[gActiveBattler] ^ 2) < gNumberOfMovesToChoose)
    {
        MoveSelectionDestroyCursorAt(gMoveSelectionCursor[gActiveBattler]);
        gMoveSelectionCursor[gActiveBattler] ^= 2;
...
static void HandleMoveSwitching(void)
{
    ...
    if (({(gMain.newKeys) & (0x0001 | 0x0004);}))
    {
        ...
        if (gMoveSelectionCursor[gActiveBattler] != gMultiUsePlayerCursor)
        {
            ...
            if (!(gBattleMons[gActiveBattler].status2 & (1 << 21)))
            {
                for (i = 0; i < 4; i++)
                {
                    moveStruct.moves[i] = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 13 + i);
                    moveStruct.currentPp[i] = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 17 + i);
                }

                totalPPBonuses = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 21);
                for (i = 0; i < 4; i++)
                ...
                for (i = 0; i < 4; i++)
                {
                    SetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 13 + i, &moveStruct.moves[i]);
                    SetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 17 + i, &moveStruct.currentPp[i]);
                }

                SetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 21, &totalPPBonuses);
            }
        }
    ...
    else if (({(gMain.newKeys) & (0x0002 | 0x0004);}))
    {
        PlaySE(5);
...
static void sub_8058B40(void)
{
    ...
    if (!gBattleSpritesDataPtr->healthBoxesData[gActiveBattler].ballAnimActive && !gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].ballAnimActive)
    {
        if (!gBattleSpritesDataPtr->healthBoxesData[gActiveBattler].field_1_x80)
        {
            if (IsDoubleBattle() && !(gBattleTypeFlags & (1 << 6)))
            {
                UpdateHealthboxAttribute(gHealthboxSpriteIds[gActiveBattler ^ 2], &gPlayerParty[gBattlerPartyIndexes[gActiveBattler ^ 2]], HEALTHBOX_ALL);
                sub_8076918(gActiveBattler ^ 2);
    ...
    if (!gBattleSpritesDataPtr->healthBoxesData[gActiveBattler].field_1_x40
        ...
        && !gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].field_1_x40
    ...
    else
    {
        if (gSprites[gUnknown_03005D7C[gActiveBattler]].callback == SpriteCallbackDummy
            && gSprites[gBattlerSpriteIds[gActiveBattler]].callback == SpriteCallbackDummy
            && gSprites[gUnknown_03005D7C[gActiveBattler ^ 2]].callback == SpriteCallbackDummy
            && gSprites[gBattlerSpriteIds[gActiveBattler ^ 2]].callback == SpriteCallbackDummy)
        {
            r8 = 1;
        }
    }
    ...
    {
        if (IsDoubleBattle() && !(gBattleTypeFlags & (1 << 6)))
            DestroySprite(&gSprites[gUnknown_03005D7C[gActiveBattler ^ 2]]);
...
static void sub_8058EDC(void)
{
     ...
     && gSprites[gBattlerSpriteIds[gActiveBattler]].callback == SpriteCallbackDummy)
    {
        ...
        if (gBattleSpritesDataPtr->battlerData[gActiveBattler].behindSubstitute)
            InitAndLaunchSpecialAnimation(gActiveBattler, gActiveBattler, gActiveBattler, 0x6);
...
static void Task_GiveExpToMon(u8 taskId)
{
    ...
    if (IsDoubleBattle() == 1 || monId != gBattlerPartyIndexes[battlerId])
    {
        struct Pokemon *mon = &gPlayerParty[monId];
        u16 species = GetMonData(mon, 11);
        u8 level = GetMonData(mon, 56);
        u32 currExp = GetMonData(mon, 25);
        ...
        if (currExp + gainedExp >= nextLvlExp)
        {
            ...
            if (IsDoubleBattle() == 1
             && ((u16)(monId) == gBattlerPartyIndexes[battlerId] || (u16)(monId) == gBattlerPartyIndexes[battlerId ^ 2]))
...
static void sub_8059400(u8 taskId)
{
    ...
    else
    {
        ...
        if (newExpPoints == -1)
        {
            ...
            m4aSongNumStop(33);
            level = GetMonData(&gPlayerParty[monId], 56);
            currExp = GetMonData(&gPlayerParty[monId], 25);
            species = GetMonData(&gPlayerParty[monId], 11);
            ...
            if (currExp + gainedExp >= expOnNextLvl)
            {
                ...
                SetMonData(&gPlayerParty[monId], 25, &expOnNextLvl);
            ...
            {
                currExp += gainedExp;
                SetMonData(&gPlayerParty[monId], 25, &currExp);
                gBattlerControllerFuncs[battlerId] = CompleteOnInactiveTextPrinter;
                DestroyTask(taskId);
            }
        }
...
static void Task_LaunchLvlUpAnim(u8 taskId)
{
    ...
    if (IsDoubleBattle() == 1 && monIndex == gBattlerPartyIndexes[battlerId ^ 2])
        battlerId ^= 2;

    InitAndLaunchSpecialAnimation(battlerId, battlerId, battlerId, 0x0);
...
static void Task_UpdateLvlInHealthbox(u8 taskId)
{
    ...
    if (!gBattleSpritesDataPtr->healthBoxesData[battlerId].specialAnimActive)
    {
        ...
        GetMonData(&gPlayerParty[monIndex], 56);

        if (IsDoubleBattle() == 1 && monIndex == gBattlerPartyIndexes[battlerId ^ 2])
            UpdateHealthboxAttribute(gHealthboxSpriteIds[battlerId ^ 2], &gPlayerParty[monIndex], HEALTHBOX_ALL);
        else
...
static void WaitForMonSelection(void)
{
    if (gMain.callback2 == BattleMainCB2 && !gPaletteFade.active)
    {
        if (gPartyMenuUseExitCallback == 1)
            ...
            BtlController_EmitChosenMonReturnValue(1, 6, ((void *)0));
...
{
    if (({(gMain.newKeys) & (0x0040);}) && gMultiUsePlayerCursor != 0)
    {
        PlaySE(5);
    ...
    if (({(gMain.newKeys) & (0x0080);}) && gMultiUsePlayerCursor == 0)
    {
        PlaySE(5);
        BattleDestroyYesNoCursorAt(gMultiUsePlayerCursor);
        gMultiUsePlayerCursor = 1;
...
static void MoveSelectionDisplayPpNumber(void)
{
    ...
    if (gBattleResources->bufferA[gActiveBattler][2] == 1)
        return;
...
u8 TypeEffectiveness(struct ChooseMoveStruct *moveInfo, u8 targetId)
{
 ...
 else
 {
  ...
  if (mod == ((u16)((0.0) * 4096)))
   return 26;
  else if (mod <= ((u16)((0.5) * 4096)))
   return 25;
  else if (mod >= ((u16)((2.0) * 4096)))
   return 24;
  else
   return 10;
 }
...
static u32 CopyPlayerMonData(u8 monId, u8 *dst)
{
    ...
    case REQUEST_ALL_BATTLE:
        battleMon.species = GetMonData(&gPlayerParty[monId], 11);
        battleMon.formId = GetMonData(&gPlayerParty[monId], 89);
        battleMon.item = GetMonData(&gPlayerParty[monId], 12);
        for (size = 0; size < 4; size++)
        {
            battleMon.moves[size] = GetMonData(&gPlayerParty[monId], 13 + size);
            battleMon.pp[size] = GetMonData(&gPlayerParty[monId], 17 + size);
        }
        battleMon.ppBonuses = GetMonData(&gPlayerParty[monId], 21);
        battleMon.friendship = GetMonData(&gPlayerParty[monId], 32);
        battleMon.experience = GetMonData(&gPlayerParty[monId], 25);
        battleMon.hpIV = GetMonData(&gPlayerParty[monId], 39);
        battleMon.attackIV = GetMonData(&gPlayerParty[monId], 40);
        battleMon.defenseIV = GetMonData(&gPlayerParty[monId], 41);
        battleMon.speedIV = GetMonData(&gPlayerParty[monId], 42);
        battleMon.spAttackIV = GetMonData(&gPlayerParty[monId], 43);
        battleMon.spDefenseIV = GetMonData(&gPlayerParty[monId], 44);
        battleMon.personality = GetMonData(&gPlayerParty[monId], 0);
        battleMon.status1 = GetMonData(&gPlayerParty[monId], 55);
        battleMon.level = GetMonData(&gPlayerParty[monId], 56);
        battleMon.hp = GetMonData(&gPlayerParty[monId], 57);
        battleMon.maxHP = GetMonData(&gPlayerParty[monId], 58);
        battleMon.attack = GetMonData(&gPlayerParty[monId], 59);
        battleMon.defense = GetMonData(&gPlayerParty[monId], 60);
        battleMon.speed = GetMonData(&gPlayerParty[monId], 61);
        battleMon.spAttack = GetMonData(&gPlayerParty[monId], 62);
        battleMon.spDefense = GetMonData(&gPlayerParty[monId], 63);
        battleMon.abilityNum = GetMonData(&gPlayerParty[monId], 46);
        battleMon.otId = GetMonData(&gPlayerParty[monId], 1);
        GetMonData(&gPlayerParty[monId], 2, nickname);
        StringCopy10(battleMon.nickname, nickname);
        GetMonData(&gPlayerParty[monId], 7, battleMon.otName);
        src = (u8 *)&battleMon;
        for (size = 0; size < sizeof(battleMon); size++)
            dst[size] = src[size];
        break;
    case REQUEST_SPECIES_BATTLE:
        data16 = GetMonData(&gPlayerParty[monId], 11);
        dst[0] = data16;
        dst[1] = data16 >> 8;
        size = 2;
        break;
    case REQUEST_HELDITEM_BATTLE:
        data16 = GetMonData(&gPlayerParty[monId], 12);
        dst[0] = data16;
        dst[1] = data16 >> 8;
        size = 2;
        break;
    case REQUEST_MOVES_PP_BATTLE:
        for (size = 0; size < 4; size++)
        {
            moveData.moves[size] = GetMonData(&gPlayerParty[monId], 13 + size);
            moveData.pp[size] = GetMonData(&gPlayerParty[monId], 17 + size);
        }
        moveData.ppBonuses = GetMonData(&gPlayerParty[monId], 21);
        src = (u8*)(&moveData);
    ...
    case REQUEST_MOVE4_BATTLE:
        data16 = GetMonData(&gPlayerParty[monId], 13 + gBattleResources->bufferA[gActiveBattler][1] - REQUEST_MOVE1_BATTLE);
        dst[0] = data16;
        dst[1] = data16 >> 8;
        size = 2;
        break;
    case REQUEST_PP_DATA_BATTLE:
        for (size = 0; size < 4; size++)
            dst[size] = GetMonData(&gPlayerParty[monId], 17 + size);
        dst[size] = GetMonData(&gPlayerParty[monId], 21);
        size++;
        break;
    ...
    case REQUEST_PPMOVE4_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 17 + gBattleResources->bufferA[gActiveBattler][1] - REQUEST_PPMOVE1_BATTLE);
        size = 1;
        break;
    case REQUEST_OTID_BATTLE:
        data32 = GetMonData(&gPlayerParty[monId], 1);
    ...
    case REQUEST_EXP_BATTLE:
        data32 = GetMonData(&gPlayerParty[monId], 25);
        dst[0] = (data32 & 0x000000FF);
        dst[1] = (data32 & 0x0000FF00) >> 8;
        dst[2] = (data32 & 0x00FF0000) >> 16;
        size = 3;
    ...
    case REQUEST_HP_EV_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 26);
        size = 1;
        break;
    case REQUEST_ATK_EV_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 27);
        size = 1;
        break;
    case REQUEST_DEF_EV_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 28);
        size = 1;
        break;
    case REQUEST_SPEED_EV_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 29);
        size = 1;
        break;
    case REQUEST_SPATK_EV_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 30);
        size = 1;
        break;
    case REQUEST_SPDEF_EV_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 31);
        size = 1;
        break;
    case REQUEST_FRIENDSHIP_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 32);
        size = 1;
        break;
    case REQUEST_POKERUS_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 34);
        size = 1;
        break;
    case REQUEST_MET_LOCATION_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 35);
        size = 1;
        break;
    case REQUEST_MET_LEVEL_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 36);
        size = 1;
        break;
    case REQUEST_MET_GAME_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 37);
        size = 1;
        break;
    case REQUEST_POKEBALL_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 38);
        size = 1;
        break;
    case REQUEST_ALL_IVS_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 39);
        dst[1] = GetMonData(&gPlayerParty[monId], 40);
        dst[2] = GetMonData(&gPlayerParty[monId], 41);
        dst[3] = GetMonData(&gPlayerParty[monId], 42);
        dst[4] = GetMonData(&gPlayerParty[monId], 43);
        dst[5] = GetMonData(&gPlayerParty[monId], 44);
        size = 6;
        break;
    ...
    case REQUEST_ATK_IV_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 40);
        size = 1;
        break;
    case REQUEST_DEF_IV_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 41);
        size = 1;
        break;
    case REQUEST_SPEED_IV_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 42);
        size = 1;
        break;
    case REQUEST_SPATK_IV_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 43);
        size = 1;
        break;
    case REQUEST_SPDEF_IV_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 44);
        size = 1;
        break;
    case REQUEST_PERSONALITY_BATTLE:
        data32 = GetMonData(&gPlayerParty[monId], 0);
        dst[0] = (data32 & 0x000000FF);
        dst[1] = (data32 & 0x0000FF00) >> 8;
        dst[2] = (data32 & 0x00FF0000) >> 16;
    ...
    case REQUEST_CHECKSUM_BATTLE:
        data16 = GetMonData(&gPlayerParty[monId], 9);
        dst[0] = data16;
        dst[1] = data16 >> 8;
        size = 2;
        break;
    case REQUEST_STATUS_BATTLE:
        data32 = GetMonData(&gPlayerParty[monId], 55);
        dst[0] = (data32 & 0x000000FF);
        dst[1] = (data32 & 0x0000FF00) >> 8;
        dst[2] = (data32 & 0x00FF0000) >> 16;
        dst[3] = (data32 & 0xFF000000) >> 24;
    ...
    case REQUEST_LEVEL_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 56);
        size = 1;
        break;
    case REQUEST_HP_BATTLE:
        data16 = GetMonData(&gPlayerParty[monId], 57);
        dst[0] = data16;
        dst[1] = data16 >> 8;
        size = 2;
        break;
    case REQUEST_MAX_HP_BATTLE:
        data16 = GetMonData(&gPlayerParty[monId], 58);
        dst[0] = data16;
        dst[1] = data16 >> 8;
        size = 2;
        break;
    case REQUEST_ATK_BATTLE:
        data16 = GetMonData(&gPlayerParty[monId], 59);
        dst[0] = data16;
        dst[1] = data16 >> 8;
        size = 2;
        break;
    case REQUEST_DEF_BATTLE:
        data16 = GetMonData(&gPlayerParty[monId], 60);
        dst[0] = data16;
        dst[1] = data16 >> 8;
        size = 2;
        break;
    case REQUEST_SPEED_BATTLE:
        data16 = GetMonData(&gPlayerParty[monId], 61);
        dst[0] = data16;
        dst[1] = data16 >> 8;
        size = 2;
        break;
    case REQUEST_SPATK_BATTLE:
        data16 = GetMonData(&gPlayerParty[monId], 62);
        dst[0] = data16;
        dst[1] = data16 >> 8;
        size = 2;
        break;
    case REQUEST_SPDEF_BATTLE:
        data16 = GetMonData(&gPlayerParty[monId], 63);
        dst[0] = data16;
        dst[1] = data16 >> 8;
        size = 2;
        break;
    case REQUEST_COOL_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 22);
        size = 1;
        break;
    case REQUEST_BEAUTY_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 23);
        size = 1;
        break;
    case REQUEST_CUTE_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 24);
        size = 1;
        break;
    case REQUEST_SMART_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 33);
        size = 1;
        break;
    case REQUEST_TOUGH_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 47);
        size = 1;
        break;
    case REQUEST_SHEEN_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 48);
        size = 1;
        break;
    case REQUEST_COOL_RIBBON_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 50);
        size = 1;
        break;
    case REQUEST_BEAUTY_RIBBON_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 51);
        size = 1;
        break;
    case REQUEST_CUTE_RIBBON_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 52);
        size = 1;
        break;
    case REQUEST_SMART_RIBBON_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 53);
        size = 1;
        break;
    case REQUEST_TOUGH_RIBBON_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 54);
        size = 1;
        break;
    }
    ...
    case REQUEST_ALL_BATTLE:
        {
            ...
            SetMonData(&gPlayerParty[monId], 11, &species);
            SetMonData(&gPlayerParty[monId], 89, &formId);
            SetMonData(&gPlayerParty[monId], 12, &battlePokemon->item);
            for (i = 0; i < 4; i++)
            {
                SetMonData(&gPlayerParty[monId], 13 + i, &battlePokemon->moves[i]);
                SetMonData(&gPlayerParty[monId], 17 + i, &battlePokemon->pp[i]);
            }
            SetMonData(&gPlayerParty[monId], 21, &battlePokemon->ppBonuses);
            SetMonData(&gPlayerParty[monId], 32, &battlePokemon->friendship);
            SetMonData(&gPlayerParty[monId], 25, &battlePokemon->experience);
            iv = battlePokemon->hpIV;
            SetMonData(&gPlayerParty[monId], 39, &iv);
            iv = battlePokemon->attackIV;
            SetMonData(&gPlayerParty[monId], 40, &iv);
            iv = battlePokemon->defenseIV;
            SetMonData(&gPlayerParty[monId], 41, &iv);
            iv = battlePokemon->speedIV;
            SetMonData(&gPlayerParty[monId], 42, &iv);
            iv = battlePokemon->spAttackIV;
            SetMonData(&gPlayerParty[monId], 43, &iv);
            iv = battlePokemon->spDefenseIV;
            SetMonData(&gPlayerParty[monId], 44, &iv);
            SetMonData(&gPlayerParty[monId], 0, &battlePokemon->personality);
            SetMonData(&gPlayerParty[monId], 55, &battlePokemon->status1);
            SetMonData(&gPlayerParty[monId], 56, &battlePokemon->level);
            SetMonData(&gPlayerParty[monId], 57, &battlePokemon->hp);
            SetMonData(&gPlayerParty[monId], 58, &battlePokemon->maxHP);
            SetMonData(&gPlayerParty[monId], 59, &battlePokemon->attack);
            SetMonData(&gPlayerParty[monId], 60, &battlePokemon->defense);
            SetMonData(&gPlayerParty[monId], 61, &battlePokemon->speed);
            SetMonData(&gPlayerParty[monId], 62, &battlePokemon->spAttack);
            SetMonData(&gPlayerParty[monId], 63, &battlePokemon->spDefense);
        }
        break;
    case REQUEST_SPECIES_BATTLE:
        SetMonData(&gPlayerParty[monId], 11, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_HELDITEM_BATTLE:
        SetMonData(&gPlayerParty[monId], 12, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_MOVES_PP_BATTLE:
        for (i = 0; i < 4; i++)
        {
            SetMonData(&gPlayerParty[monId], 13 + i, &moveData->moves[i]);
            SetMonData(&gPlayerParty[monId], 17 + i, &moveData->pp[i]);
        }
        SetMonData(&gPlayerParty[monId], 21, &moveData->ppBonuses);
        break;
    case REQUEST_MOVE1_BATTLE:
    case REQUEST_MOVE2_BATTLE:
    case REQUEST_MOVE3_BATTLE:
    case REQUEST_MOVE4_BATTLE:
        SetMonData(&gPlayerParty[monId], 13 + gBattleResources->bufferA[gActiveBattler][1] - REQUEST_MOVE1_BATTLE, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_PP_DATA_BATTLE:
        SetMonData(&gPlayerParty[monId], 17, &gBattleResources->bufferA[gActiveBattler][3]);
        SetMonData(&gPlayerParty[monId], 18, &gBattleResources->bufferA[gActiveBattler][4]);
        SetMonData(&gPlayerParty[monId], 19, &gBattleResources->bufferA[gActiveBattler][5]);
        SetMonData(&gPlayerParty[monId], 20, &gBattleResources->bufferA[gActiveBattler][6]);
        SetMonData(&gPlayerParty[monId], 21, &gBattleResources->bufferA[gActiveBattler][7]);
        break;
    case REQUEST_PPMOVE1_BATTLE:
    case REQUEST_PPMOVE2_BATTLE:
    case REQUEST_PPMOVE3_BATTLE:
    case REQUEST_PPMOVE4_BATTLE:
        SetMonData(&gPlayerParty[monId], 17 + gBattleResources->bufferA[gActiveBattler][1] - REQUEST_PPMOVE1_BATTLE, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_OTID_BATTLE:
        SetMonData(&gPlayerParty[monId], 1, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_EXP_BATTLE:
        SetMonData(&gPlayerParty[monId], 25, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_HP_EV_BATTLE:
        SetMonData(&gPlayerParty[monId], 26, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_ATK_EV_BATTLE:
        SetMonData(&gPlayerParty[monId], 27, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_DEF_EV_BATTLE:
        SetMonData(&gPlayerParty[monId], 28, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPEED_EV_BATTLE:
        SetMonData(&gPlayerParty[monId], 29, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPATK_EV_BATTLE:
        SetMonData(&gPlayerParty[monId], 30, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPDEF_EV_BATTLE:
        SetMonData(&gPlayerParty[monId], 31, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_FRIENDSHIP_BATTLE:
        SetMonData(&gPlayerParty[monId], 32, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_POKERUS_BATTLE:
        SetMonData(&gPlayerParty[monId], 34, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_MET_LOCATION_BATTLE:
        SetMonData(&gPlayerParty[monId], 35, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_MET_LEVEL_BATTLE:
        SetMonData(&gPlayerParty[monId], 36, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_MET_GAME_BATTLE:
        SetMonData(&gPlayerParty[monId], 37, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_POKEBALL_BATTLE:
        SetMonData(&gPlayerParty[monId], 38, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_ALL_IVS_BATTLE:
        SetMonData(&gPlayerParty[monId], 39, &gBattleResources->bufferA[gActiveBattler][3]);
        SetMonData(&gPlayerParty[monId], 40, &gBattleResources->bufferA[gActiveBattler][4]);
        SetMonData(&gPlayerParty[monId], 41, &gBattleResources->bufferA[gActiveBattler][5]);
        SetMonData(&gPlayerParty[monId], 42, &gBattleResources->bufferA[gActiveBattler][6]);
        SetMonData(&gPlayerParty[monId], 43, &gBattleResources->bufferA[gActiveBattler][7]);
        SetMonData(&gPlayerParty[monId], 44, &gBattleResources->bufferA[gActiveBattler][8]);
        break;
    case REQUEST_HP_IV_BATTLE:
        SetMonData(&gPlayerParty[monId], 39, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_ATK_IV_BATTLE:
        SetMonData(&gPlayerParty[monId], 40, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_DEF_IV_BATTLE:
        SetMonData(&gPlayerParty[monId], 41, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPEED_IV_BATTLE:
        SetMonData(&gPlayerParty[monId], 42, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPATK_IV_BATTLE:
        SetMonData(&gPlayerParty[monId], 43, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPDEF_IV_BATTLE:
        SetMonData(&gPlayerParty[monId], 44, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_PERSONALITY_BATTLE:
        SetMonData(&gPlayerParty[monId], 0, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_CHECKSUM_BATTLE:
        SetMonData(&gPlayerParty[monId], 9, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_STATUS_BATTLE:
        SetMonData(&gPlayerParty[monId], 55, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_LEVEL_BATTLE:
        SetMonData(&gPlayerParty[monId], 56, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_HP_BATTLE:
        SetMonData(&gPlayerParty[monId], 57, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_MAX_HP_BATTLE:
        SetMonData(&gPlayerParty[monId], 58, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_ATK_BATTLE:
        SetMonData(&gPlayerParty[monId], 59, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_DEF_BATTLE:
        SetMonData(&gPlayerParty[monId], 60, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPEED_BATTLE:
        SetMonData(&gPlayerParty[monId], 61, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPATK_BATTLE:
        SetMonData(&gPlayerParty[monId], 62, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPDEF_BATTLE:
        SetMonData(&gPlayerParty[monId], 63, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_COOL_BATTLE:
        SetMonData(&gPlayerParty[monId], 22, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_BEAUTY_BATTLE:
        SetMonData(&gPlayerParty[monId], 23, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_CUTE_BATTLE:
        SetMonData(&gPlayerParty[monId], 24, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SMART_BATTLE:
        SetMonData(&gPlayerParty[monId], 33, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_TOUGH_BATTLE:
        SetMonData(&gPlayerParty[monId], 47, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SHEEN_BATTLE:
        SetMonData(&gPlayerParty[monId], 48, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_COOL_RIBBON_BATTLE:
        SetMonData(&gPlayerParty[monId], 50, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_BEAUTY_RIBBON_BATTLE:
        SetMonData(&gPlayerParty[monId], 51, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_CUTE_RIBBON_BATTLE:
        SetMonData(&gPlayerParty[monId], 52, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SMART_RIBBON_BATTLE:
        SetMonData(&gPlayerParty[monId], 53, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_TOUGH_RIBBON_BATTLE:
        SetMonData(&gPlayerParty[monId], 54, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    }
...
static void sub_805B258(u8 battlerId, bool8 dontClearSubstituteBit)
{
    ...
    formId = GetMonData(&gPlayerParty[gBattlerPartyIndexes[battlerId]], 89);
    ...
    gSprites[gBattlerSpriteIds[battlerId]].data[2] = GetFormSpeciesId(species, formId);
    ...
    gSprites[gUnknown_03005D7C[battlerId]].data[0] = DoPokeballSendOutAnimation(0, 0xFF);
}
...
static void DoSwitchOutAnimation(void)
{
    ...
    case 0:
        if (gBattleSpritesDataPtr->battlerData[gActiveBattler].behindSubstitute)
            InitAndLaunchSpecialAnimation(gActiveBattler, gActiveBattler, gActiveBattler, 0x5);
    ...
    case 1:
        ...
        {
            gBattleSpritesDataPtr->healthBoxesData[gActiveBattler].animationState = 0;
            InitAndLaunchSpecialAnimation(gActiveBattler, gActiveBattler, gActiveBattler, 0x1);
...
static void PlayerHandleSuccessBallThrowAnim(void)
{
    ...
    if (IsCriticalCapture())
        InitAndLaunchSpecialAnimation(gActiveBattler, gActiveBattler, gBattlerTarget, 0x7);
    else
        InitAndLaunchSpecialAnimation(gActiveBattler, gActiveBattler, gBattlerTarget, 0x3);
...
static void PlayerHandleChooseItem(void)
{
    ...
    for (i = 0; i < (size_t)(sizeof(gBattlePartyCurrentOrder) / sizeof((gBattlePartyCurrentOrder)[0])); i++)
...
static void PlayerHandleChoosePokemon(void)
{
    ...
    if (gBattleTypeFlags & (1 << 18) && (gBattleResources->bufferA[gActiveBattler][1] & 0xF) != 2)
    {
...
static void PlayerHandleHealthBarUpdate(void)
{
    ...
    if (hpVal != 32767)
    {
        u32 maxHP = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 58);
        u32 curHP = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 57);
...
static void PlayerHandleExpUpdate(void)
{
    ...
    if (GetMonData(&gPlayerParty[monId], 56) >= 100)
    {
        PlayerBufferExecCompleted();
    }
    else
    {
        ...
        LoadBattleBarGfx(1);
        GetMonData(&gPlayerParty[monId], 11);
        expPointsToGive = ((&gBattleResources->bufferA[gActiveBattler][2])[0] | ((&gBattleResources->bufferA[gActiveBattler][2])[1] << 8));
...
static void PlayerHandleStatusXor(void)
{
    u8 val = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 55) ^ gBattleResources->bufferA[gActiveBattler][1];

    SetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 55, &val);
    PlayerBufferExecCompleted();
}
...
static void PlayerHandleDMA3Transfer(void)
{
    ...
    while (1)
    {
        if (size <= 0x1000)
        {
            { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); u32 eval_src = (u32)(src); u32 eval_dst = (u32)(dst); u32 eval_ctl = (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((size)/(16/8))); register u32 r_src asm("r0") = eval_src; register u32 r_dst asm("r1") = eval_dst; register u32 r_ctl asm("r2") = eval_ctl; asm volatile("stmia %0!, {%1, %2, %3}" : "+l" (dmaRegs) : "l" (r_src), "l" (r_dst), "l" (r_ctl) : "memory"); };
            break;
        }
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); u32 eval_src = (u32)(src); u32 eval_dst = (u32)(dst); u32 eval_ctl = (u32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x1000)/(16/8))); register u32 r_src asm("r0") = eval_src; register u32 r_dst asm("r1") = eval_dst; register u32 r_ctl asm("r2") = eval_ctl; asm volatile("stmia %0!, {%1, %2, %3}" : "+l" (dmaRegs) : "l" (r_src), "l" (r_dst), "l" (r_ctl) : "memory"); };
        src += 0x1000;
        dst += 0x1000;
        size -= 0x1000;
    }
...
static void PlayerHandleChosenMonReturnValue(void)
{
    BtlController_EmitChosenMonReturnValue(1, 0, ((void *)0));
    PlayerBufferExecCompleted();
}
...
{
    u16 species = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 11);
    u8 formId = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 89);
...
static void PlayerHandleDrawPartyStatusSummary(void)
{
    if (gBattleResources->bufferA[gActiveBattler][1] != 0 && GetBattlerSide(gActiveBattler) == 0)
    {
        PlayerBufferExecCompleted();
    }
    else
