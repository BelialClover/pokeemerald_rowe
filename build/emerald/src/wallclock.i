...
# 15 "src/wallclock.c" 2
# 1 "include/task.h" 1
# 16 "src/wallclock.c" 2
...
# 20 "src/wallclock.c" 2

# 1 "include/constants/rgb.h" 1
# 22 "src/wallclock.c" 2
# 1 "include/constants/songs.h" 1
# 23 "src/wallclock.c" 2
...
static const u16 sTextPrompt_Pal[] = INCBIN_U16("graphics/wallclock/text_prompt.gbapal");
...
static void LoadWallClockGraphics(void)
{
    ...
    LZ77UnCompVram(gWallClock_Gfx, (void *)0x6000000);
...
void CB2_StartWallClock(void)
{
    ...
    LZ77UnCompVram(gWallClockStart_Tilemap, (u16 *)(0x6000000 + (0x800 * (7))));
    ...
    AddTextPrinterParameterized(1, 1, gText_Confirm3, 0, 1, 0, ((void *)0));
    PutWindowTilemap(1);
...
void CB2_ViewWallClock(void)
{
    ...
    LoadWallClockGraphics();
    LZ77UnCompVram(gWallClockView_Tilemap, (u16 *)(0x6000000 + (0x800 * (7))));
    ...
    AddTextPrinterParameterized(1, 1, gText_Cancel4, 0, 1, 0, ((void *)0));
    PutWindowTilemap(1);
    ScheduleBgCopyTilemapToVram(2);
}
...
static void Task_SetClock_HandleInput(u8 taskId)
{
    ...
    {
        gTasks[taskId].data[0] = CalcNewMinHandAngle(gTasks[taskId].data[0], gTasks[taskId].data[4], gTasks[taskId].data[6]);
    }
    else
    {
        ...
        else
        {
            ...
            if (({(gMain.heldKeys) & (0x0020);}))
                gTasks[taskId].data[4] = MOVE_BACKWARD;

            if (({(gMain.heldKeys) & (0x0010);}))
                gTasks[taskId].data[4] = MOVE_FORWARD;
...
static void Task_SetClock_AskConfirm(u8 taskId)
{
    DrawStdFrameWithCustomTileAndPalette(0, 0, 0x250, 0x0d);
    AddTextPrinterParameterized(0, 1, gText_IsThisTheCorrectTime, 0, 1, 0, ((void *)0));
    PutWindowTilemap(0);
...
static void SpriteCB_MinuteHand(struct Sprite *sprite)
{
    u16 angle = gTasks[sprite->data[0]].data[0];
...
static void SpriteCB_HourHand(struct Sprite *sprite)
{
    u16 angle = gTasks[sprite->data[0]].data[1];
    s16 sin = Sin2(angle) / 16;
    s16 cos = Cos2(angle) / 16;
    u16 x, y;
