...
# 2 "src/save.c" 2
# 1 "include/agb_flash.h" 1
# 10 "include/agb_flash.h"
...
{
    { 0 * 3968, ((sizeof(gSaveblock2) - 0 * 3968) < (3968) ? (sizeof(gSaveblock2) - 0 * 3968) : (3968)) },

    { 0 * 3968, ((sizeof(gSaveblock1) - 0 * 3968) < (3968) ? (sizeof(gSaveblock1) - 0 * 3968) : (3968)) },
    { 1 * 3968, ((sizeof(gSaveblock1) - 1 * 3968) < (3968) ? (sizeof(gSaveblock1) - 1 * 3968) : (3968)) },
    { 2 * 3968, ((sizeof(gSaveblock1) - 2 * 3968) < (3968) ? (sizeof(gSaveblock1) - 2 * 3968) : (3968)) },
    { 3 * 3968, ((sizeof(gSaveblock1) - 3 * 3968) < (3968) ? (sizeof(gSaveblock1) - 3 * 3968) : (3968)) },

    { 0 * 3968, ((sizeof(gPokemonStorage) - 0 * 3968) < (3968) ? (sizeof(gPokemonStorage) - 0 * 3968) : (3968)) },
    { 1 * 3968, ((sizeof(gPokemonStorage) - 1 * 3968) < (3968) ? (sizeof(gPokemonStorage) - 1 * 3968) : (3968)) },
    { 2 * 3968, ((sizeof(gPokemonStorage) - 2 * 3968) < (3968) ? (sizeof(gPokemonStorage) - 2 * 3968) : (3968)) },
    { 3 * 3968, ((sizeof(gPokemonStorage) - 3 * 3968) < (3968) ? (sizeof(gPokemonStorage) - 3 * 3968) : (3968)) },
    { 4 * 3968, ((sizeof(gPokemonStorage) - 4 * 3968) < (3968) ? (sizeof(gPokemonStorage) - 4 * 3968) : (3968)) },
    { 5 * 3968, ((sizeof(gPokemonStorage) - 5 * 3968) < (3968) ? (sizeof(gPokemonStorage) - 5 * 3968) : (3968)) },
    { 6 * 3968, ((sizeof(gPokemonStorage) - 6 * 3968) < (3968) ? (sizeof(gPokemonStorage) - 6 * 3968) : (3968)) },
    { 7 * 3968, ((sizeof(gPokemonStorage) - 7 * 3968) < (3968) ? (sizeof(gPokemonStorage) - 7 * 3968) : (3968)) },
    { 8 * 3968, ((sizeof(gPokemonStorage) - 8 * 3968) < (3968) ? (sizeof(gPokemonStorage) - 8 * 3968) : (3968)) },
};
...
struct SaveSectionLocation gRamSaveSectionLocations[14];
u16 gSaveUnusedVar2;
u16 gSaveAttemptStatus;

__attribute__((section("ewram_data"))) struct SaveSection gSaveDataBuffer = {0};
__attribute__((section("ewram_data"))) static u8 sUnusedVar = 0;
...
static u8 HandleWriteSector(u16 sectorId, const struct SaveSectionLocation *location)
{
    ...
    gFastSaveSection->security = 0x8012025;
...
static u8 TryWriteSector(u8 sector, u8 *data)
{
    if (ProgramFlashSectorAndVerify(sector, data) != 0)
    {
...
static u8 sub_8152E10(u16 a1, const struct SaveSectionLocation *location)
{
    ...
    for (i = 0; i < 14; i++)
    {
        ...
        if (gFastSaveSection->security == 0x8012025
...
static u8 GetSaveValidStatus(const struct SaveSectionLocation *location)
{
    ...
    for (i = 0; i < 14; i++)
    {
        DoReadFlashWholeSection(i + 14, gFastSaveSection);
        if (gFastSaveSection->security == 0x8012025)
        {
            securityPassed = 1;
            checksum = CalculateChecksum(gFastSaveSection->data, location[gFastSaveSection->id].size);
...
u8 HandleSavingData(u8 saveType)
{
    ...
    gTrainerHillVBlankCounter = ((void *)0);
    UpdateSaveAddresses();
    switch (saveType)
    {
...
bool8 sub_81533AC(void)
{
    u8 status = sub_81529D4(14, gRamSaveSectionLocations);
    if (gDamagedSaveSectors)
...
bool8 sub_81533E0(void)
{
    sub_8152A34(14, gRamSaveSectionLocations);
    if (gDamagedSaveSectors)
        DoSaveFailedScreen(SAVE_NORMAL);
    return 0;
}
...
bool8 sub_8153408(void)
{
    sub_8152CAC(14, gRamSaveSectionLocations);
    if (gDamagedSaveSectors)
        DoSaveFailedScreen(SAVE_NORMAL);
    return 0;
}
...
u8 Save_LoadGameData(u8 saveType)
{
    ...
    default:
        ...
        break;
    case SAVE_HALL_OF_FAME:
        status = sub_81530DC(28, gDecompressionBuffer, 3968);
        if (status == 1)
            status = sub_81530DC(29, gDecompressionBuffer + 3968, 3968);
        break;
    }
