# 0 "src/confetti_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/confetti_util.c"
...
static void sub_81520A8(void *dest, u16 value, u8 left, u8 top, u8 width, u8 height)
{
    u8 i;
    u8 j;
    u8 x;
...
static void sub_8152134(void *dest, const u16 *src, u8 left, u8 top, u8 width, u8 height)
{
    u8 i;
    u8 j;
    u8 x;
...
bool32 ConfettiUtil_Init(u8 count)
{
    ...
    if (sWork->array == ((void *)0))
    {
        { Free(sWork); sWork = ((void *)0); };
        return 0;
    }
...
bool32 ConfettiUtil_Free(void)
{
    ...
    { Free(sWork->array); sWork->array = ((void *)0); };
...
bool32 ConfettiUtil_Update(void)
{
    ...
    if (sWork == ((void *)0) || sWork->array == ((void *)0))
        return 0;
    ...
    for (i = 0; i < sWork->count; i++)
    {
        ...
        {
            if (sWork->array[i].callback != ((void *)0))
...
u8 ConfettiUtil_SetCallback(u8 id, void (*func)(struct ConfettiUtil *))
{
    if (sWork == ((void *)0) || id >= sWork->count)
        return 0xFF;
...
u8 ConfettiUtil_SetData(u8 id, u8 dataArrayId, s16 dataValue)
{
    if (sWork == ((void *)0) || id >= sWork->count)
        return 0xFF;
    else if (!sWork->array[id].active || dataArrayId > (size_t)(sizeof(sWork->array[id].data) / sizeof((sWork->array[id].data)[0])) - 1)
        return 0xFF;
...
u8 ConfettiUtil_AddNew(const struct OamData *oam, u16 tileTag, u16 palTag, s16 x, s16 y, u8 animNum, u8 priority)
{
    struct ConfettiUtil *structPtr = ((void *)0);
    u8 i;

    if (sWork == ((void *)0) || oam == ((void *)0))
        return 0xFF;
