# 0 "src/fldeff_rocksmash.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/fldeff_rocksmash.c"
...
# 14 "src/fldeff_rocksmash.c" 2

# 1 "include/task.h" 1
# 16 "src/fldeff_rocksmash.c" 2
# 1 "include/constants/event_object_movement.h" 1
# 17 "src/fldeff_rocksmash.c" 2
# 1 "include/constants/event_objects.h" 1
# 18 "src/fldeff_rocksmash.c" 2
# 1 "include/constants/field_effects.h" 1
# 19 "src/fldeff_rocksmash.c" 2
# 1 "include/constants/map_types.h" 1
# 20 "src/fldeff_rocksmash.c" 2
# 1 "include/constants/songs.h" 1
# 21 "src/fldeff_rocksmash.c" 2
...
static void Task_DoFieldMove_ShowMonAfterPose(u8 taskId)
{
    if (ObjectEventCheckHeldMovementStatus(&gObjectEvents[gPlayerAvatar.objectEventId]) == 1)
    {
        FieldEffectStart(59);
        gTasks[taskId].func = Task_DoFieldMove_WaitForMon;
    }
...
bool8 SetUpFieldMove_RockSmash(void)
{
    ...
    else if (CheckObjectGraphicsInFrontOfPlayer(86) == 1)
    {
        gFieldCallback2 = FieldCallback_PrepareFadeInFromMenu;
