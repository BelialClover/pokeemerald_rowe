# 0 "src/battle_controller_player_partner.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_controller_player_partner.c"
...
# 2 "src/battle_controller_player_partner.c" 2
...
# 3 "src/battle_controller_player_partner.c" 2
...
# 4 "src/battle_controller_player_partner.c" 2
...
# 5 "src/battle_controller_player_partner.c" 2
...
# 6 "src/battle_controller_player_partner.c" 2
# 1 "include/battle_message.h" 1
# 7 "src/battle_controller_player_partner.c" 2
...
# 8 "src/battle_controller_player_partner.c" 2
...
# 9 "src/battle_controller_player_partner.c" 2
...
# 10 "src/battle_controller_player_partner.c" 2
# 1 "gflib/bg.h" 1
...
# 11 "src/battle_controller_player_partner.c" 2
# 1 "include/data.h" 1
...
# 12 "src/battle_controller_player_partner.c" 2
...
# 13 "src/battle_controller_player_partner.c" 2
# 1 "include/link.h" 1
# 106 "include/link.h"
struct LinkStatus
{
...
# 14 "src/battle_controller_player_partner.c" 2
# 1 "include/main.h" 1
...
# 15 "src/battle_controller_player_partner.c" 2
# 1 "include/m4a.h" 1
...
# 16 "src/battle_controller_player_partner.c" 2
...
# 17 "src/battle_controller_player_partner.c" 2
# 1 "include/pokeball.h" 1
# 18 "src/battle_controller_player_partner.c" 2
# 1 "include/pokemon.h" 1
# 19 "src/battle_controller_player_partner.c" 2
...
# 20 "src/battle_controller_player_partner.c" 2
# 1 "include/sound.h" 1
...
# 21 "src/battle_controller_player_partner.c" 2
...
# 22 "src/battle_controller_player_partner.c" 2
# 1 "include/task.h" 1
# 23 "src/battle_controller_player_partner.c" 2
# 1 "gflib/text.h" 1
# 272 "gflib/text.h"
enum
{
...
# 24 "src/battle_controller_player_partner.c" 2
# 1 "include/util.h" 1
...
# 25 "src/battle_controller_player_partner.c" 2
# 1 "gflib/window.h" 1
...
# 26 "src/battle_controller_player_partner.c" 2
# 1 "include/constants/battle_anim.h" 1
# 27 "src/battle_controller_player_partner.c" 2
# 1 "include/constants/songs.h" 1
# 28 "src/battle_controller_player_partner.c" 2
...
# 29 "src/battle_controller_player_partner.c" 2
...
static void PlayerPartnerBufferRunCommand(void)
{
    ...
    {
        if (gBattleResources->bufferA[gActiveBattler][0] < (size_t)(sizeof(sPlayerPartnerBufferCommands) / sizeof((sPlayerPartnerBufferCommands)[0])))
...
static void PlayerPartnerHandleLoadMonSprite(void)
{
    ...
    species = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 11);
    formId = GetMonData(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], 89);
    SetMultiuseSpriteTemplateToPokemon(species, GetBattlerPosition(gActiveBattler), formId);
...
static void PlayerPartnerHandleDrawTrainerPic(void)
{
    ...
    if (gPartnerTrainerId == 3075)
    {
        trainerPicId = 7;
        xPos = 90;
        yPos = (8 - gTrainerBackPicCoords[trainerPicId].size) * 4 + 80;
    }
    else if (gPartnerTrainerId >= 3076)
    {
    ...
    if (gPartnerTrainerId == 3075 || gPartnerTrainerId >= 3076)
    {
...
static void PlayerPartnerHandleChooseMove(void)
{
    ...
    if (gBattleMoves[moveInfo->moves[chosenMoveId]].target & (0x10 | 0x2))
        gBattlerTarget = gActiveBattler;
    if (gBattleMoves[moveInfo->moves[chosenMoveId]].target & 0x8)
    {
    ...
    if (CanMegaEvolve(gActiveBattler))
        BtlController_EmitTwoReturnValues(1, 10, (chosenMoveId) | (0x80) | (gBattlerTarget << 8));
    else
...
static void PlayerPartnerHandleChoosePokemon(void)
{
    ...
    if (chosenMonId == 6)
    {
        u8 playerMonIdentity = GetBattlerAtPosition(0);
        u8 selfIdentity = GetBattlerAtPosition(2);

        for (chosenMonId = 3; chosenMonId < 6; chosenMonId++)
        {
            if (GetMonData(&gPlayerParty[chosenMonId], 57) != 0
    ...
    *(gBattleStruct->monToSwitchIntoId + gActiveBattler) = chosenMonId;
    BtlController_EmitChosenMonReturnValue(1, chosenMonId, ((void *)0));
    PlayerPartnerBufferExecCompleted();
}
