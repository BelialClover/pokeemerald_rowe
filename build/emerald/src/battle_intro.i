# 0 "src/battle_intro.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_intro.c"
...
# 4 "src/battle_intro.c" 2
# 1 "include/battle_main.h" 1
# 5 "src/battle_intro.c" 2
...
# 10 "src/battle_intro.c" 2
# 1 "include/task.h" 1
# 11 "src/battle_intro.c" 2
# 1 "include/trig.h" 1
...
# 13 "src/battle_intro.c" 2

static __attribute__((section("ewram_data"))) u16 sBgCnt = 0;
...
static void Task_InstantIntro(u8 taskId)
{
    ...
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, (void *)(0x6000000 + (0x800 * (28))), 0x04000000 | 0x01000000 | ((0x800)/(32/8) & 0x1FFFFF)); };
    SetBgAttribute(1, BG_ATTR_CHARBASEINDEX, 0);
    SetBgAttribute(2, BG_ATTR_CHARBASEINDEX, 0);
    SetGpuReg(0xa, (0) | ((0) << 2) | 0x0000 | ((28) << 8) | 0x8000);
    SetGpuReg(0xc, (0) | ((0) << 2) | 0x0000 | ((30) << 8) | 0x4000);
    sub_811828C(taskId);
}
...
static void BattleIntroSlide2(u8 taskId)
{
    ...
    case 3:
        if (gTasks[taskId].data[3])
        {
            ...
            {
                SetGpuReg(0x50, (1 << 1) | (1 << 6) | (1 << 11) | (1 << 12));
                SetGpuReg(0x52, (((0) << 8) | (15)));
                SetGpuReg(0x54, 0);
            }
        }
        else
    ...
    if (gTasks[taskId].data[0] != 4)
        SetGpuReg(0x52, (((0) << 8) | (gTasks[taskId].data[4])));
}
...
static void BattleIntroSlideLink(u8 taskId)
{
    ...
    if (gTasks[taskId].data[0] > 1 && !gTasks[taskId].data[4])
    {
        ...
        {
            { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, (void *)(0x6000000 + (0x800 * (28))), 0x04000000 | 0x01000000 | ((0x800)/(32/8) & 0x1FFFFF)); };
            { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, (void *)(0x6000000 + (0x800 * (30))), 0x04000000 | 0x01000000 | ((0x800)/(32/8) & 0x1FFFFF)); };
    ...
    case 1:
        if (--gTasks[taskId].data[2] == 0)
        {
            ...
            SetGpuReg(0x48, ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)) | (1 << 4) | (1 << 5));
            SetGpuReg(0x4a, ((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12) | (1 << 13) | (1 << 1) | (1 << 2));
        }
        break;
    case 2:
        gBattle_WIN0V -= 0xFF;
...
static void BattleIntroSlidePartner(u8 taskId)
{
    ...
    case 1:
        ...
        {
            gTasks[taskId].data[0]++;
            SetGpuReg(0xa, (2) | ((2) << 2) | 0x0000 | ((28) << 8) | 0x4000);
            SetGpuReg(0xc, (2) | ((2) << 2) | 0x0000 | ((30) << 8) | 0x4000);
            SetGpuReg(0x0, GetGpuReg(0x0) | 0x0040 | 0x1000 | 0x2000 | 0x4000 | 0x8000);
            SetGpuReg(0x48, (1 << 9) | (1 << 10) | (1 << 11) | (1 << 12) | (1 << 13));
            SetGpuReg(0x4a, ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)) | (1 << 4) | (1 << 5) | ((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12) | (1 << 13));
            gBattle_BG0_Y = -48;
            gBattle_BG1_X = 240;
            gBattle_BG2_X = -240;
    ...
    case 4:
        ...
        if (!gBattle_BG0_Y)
        {
            { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, (void *)(0x6000000 + (0x800 * (28))), 0x04000000 | 0x01000000 | ((0x800 * 4)/(32/8) & 0x1FFFFF)); };
...
void sub_8118FBC(int bgId, u8 arg1, u8 arg2, u8 battlerPosition, u8 arg4, u8 *arg5, u16 *arg6, u16 tilesOffset)
{
    ...
    CpuSet(gMonSpritesGfxPtr->sprites[battlerPosition] + 0x800 * gBattleMonForms[battler], arg5, 0x00000000 | ((0x800)/(16/8) & 0x1FFFFF));
    ...
    LoadBgTilemap(bgId, arg6, 0x800, 0);
}
...
void unref_sub_8119094(u8 arg0, u8 arg1, u8 battlerPosition, u8 arg3, u8 arg4, u16 arg5, u8 arg6, u8 arg7)
{
    ...
    for (i = arg1; i < arg1 + 8; i++)
    {
        ...
        {
            *((u16 *)(0x6000000) + (i * 32) + (j + (arg6 << 10))) = offset | (arg4 << 12);
            offset++;
        }
    }
}
