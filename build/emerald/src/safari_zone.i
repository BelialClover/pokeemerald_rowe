...
# 12 "src/safari_zone.c" 2
# 1 "include/constants/game_stat.h" 1
# 13 "src/safari_zone.c" 2
...
__attribute__((section("ewram_data"))) u8 gNumSafariBalls = 0;
__attribute__((section("ewram_data"))) static u16 sSafariZoneStepCounter = 0;
__attribute__((section("ewram_data"))) static u8 sSafariZoneCaughtMons = 0;
__attribute__((section("ewram_data"))) static u8 sSafariZonePkblkUses = 0;
__attribute__((section("ewram_data"))) static struct PokeblockFeeder sPokeblockFeeders[10] = {0};
