...
# 1 "include/pokeball.h" 1
# 18 "src/battle_controller_link_opponent.c" 2
# 1 "include/pokemon.h" 1
# 19 "src/battle_controller_link_opponent.c" 2
...
# 20 "src/battle_controller_link_opponent.c" 2
...
# 21 "src/battle_controller_link_opponent.c" 2
# 1 "include/sound.h" 1
...
# 22 "src/battle_controller_link_opponent.c" 2
...
# 23 "src/battle_controller_link_opponent.c" 2
# 1 "include/task.h" 1
# 24 "src/battle_controller_link_opponent.c" 2
# 1 "gflib/text.h" 1
# 272 "gflib/text.h"
enum
{
...
# 25 "src/battle_controller_link_opponent.c" 2
# 1 "include/util.h" 1
...
# 26 "src/battle_controller_link_opponent.c" 2
# 1 "gflib/window.h" 1
...
# 27 "src/battle_controller_link_opponent.c" 2
# 1 "include/constants/battle_anim.h" 1
# 28 "src/battle_controller_link_opponent.c" 2
# 1 "include/constants/songs.h" 1
# 29 "src/battle_controller_link_opponent.c" 2
...
# 30 "src/battle_controller_link_opponent.c" 2
...
static void LinkOpponentBufferRunCommand(void)
{
    ...
    {
        if (gBattleResources->bufferA[gActiveBattler][0] < (size_t)(sizeof(sLinkOpponentBufferCommands) / sizeof((sLinkOpponentBufferCommands)[0])))
...
static void sub_8064520(void)
{
    ...
    if (r8)
    {
        if (r4 || !IsBattlerSpriteVisible(((gActiveBattler) ^ 2)))
        {
...
static void LinkOpponentHandleDrawTrainerPic(void)
{
    ...
    else
    {
        ...
        else if ((gLinkPlayers[GetMultiplayerId() ^ 1].version & 0xFF) == 4
                 || (gLinkPlayers[GetMultiplayerId() ^ 1].version & 0xFF) == 5)
        {
        ...
        {
            trainerPicId = PlayerGenderToFrontTrainerPicId(gLinkPlayers[GetMultiplayerId() ^ 1].gender);
        }
    }
