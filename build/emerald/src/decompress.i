...
# 5 "src/decompress.c" 2
# 1 "include/pokemon.h" 1
# 6 "src/decompress.c" 2
# 1 "gflib/text.h" 1
# 272 "gflib/text.h"
enum
{
...
# 7 "src/decompress.c" 2

__attribute__((section("ewram_data"))) __attribute__((aligned(4))) u8 gDecompressionBuffer[0x4000] = {0};
...
{
    if (species == 386)
        CpuSet(pointer + 0x800, pointer, 0x04000000 | ((0x800)/(32/8) & 0x1FFFFF));
}
