# 0 "src/berry_fix_graphics.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/berry_fix_graphics.c"
...
static void LoadBerryFixGraphics(u32 idx)
{
    ...
    LZ77UnCompVram(sBerryFixGraphics[idx].gfx, (void *)(0x6000000 + (0x4000 * (0))));
    LZ77UnCompVram(sBerryFixGraphics[idx].tilemap, (void *)(0x6000000 + (0x800 * (31))));
    CpuSet(sBerryFixGraphics[idx].pltt, (void *)0x5000000, 0x00000000 | ((0x200)/(16/8) & 0x1FFFFF));
    (*(vu16 *)(0x4000000 + 0x8)) = 0x1f00;
