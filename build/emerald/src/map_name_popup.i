...
static __attribute__((section("ewram_data"))) u8 sPopupTaskId = 0;
...
{
    [0x00] = MAPPOPUP_THEME_WOOD,
    [0x01] = MAPPOPUP_THEME_WOOD,
    [0x02] = MAPPOPUP_THEME_WOOD,
    [0x03] = MAPPOPUP_THEME_WOOD,
    [0x04] = MAPPOPUP_THEME_WOOD,
    [0x05] = MAPPOPUP_THEME_WOOD,
    [0x06] = MAPPOPUP_THEME_WOOD,
    [0x07] = MAPPOPUP_THEME_BRICK,
    [0x08] = MAPPOPUP_THEME_MARBLE,
    [0x09] = MAPPOPUP_THEME_MARBLE,
    [0x0A] = MAPPOPUP_THEME_MARBLE,
    [0x0B] = MAPPOPUP_THEME_BRICK,
    [0x0C] = MAPPOPUP_THEME_MARBLE,
    [0x0D] = MAPPOPUP_THEME_BRICK,
    [0x0E] = MAPPOPUP_THEME_MARBLE,
    [0x0F] = MAPPOPUP_THEME_BRICK,
    [0x10] = MAPPOPUP_THEME_WOOD,
    [0x11] = MAPPOPUP_THEME_WOOD,
    [0x12] = MAPPOPUP_THEME_WOOD,
    [0x13] = MAPPOPUP_THEME_WOOD,
    [0x14] = MAPPOPUP_THEME_UNDERWATER,
    [0x15] = MAPPOPUP_THEME_UNDERWATER,
    [0x16] = MAPPOPUP_THEME_UNDERWATER,
    [0x17] = MAPPOPUP_THEME_UNDERWATER,
    [0x18] = MAPPOPUP_THEME_UNDERWATER,
    [0x19] = MAPPOPUP_THEME_WOOD,
    [0x1A] = MAPPOPUP_THEME_WOOD,
    [0x1B] = MAPPOPUP_THEME_WOOD,
    [0x1C] = MAPPOPUP_THEME_WOOD,
    [0x1D] = MAPPOPUP_THEME_WOOD,
    [0x1E] = MAPPOPUP_THEME_WOOD,
    [0x1F] = MAPPOPUP_THEME_WOOD,
    [0x20] = MAPPOPUP_THEME_WOOD,
    [0x21] = MAPPOPUP_THEME_WOOD,
    [0x22] = MAPPOPUP_THEME_WOOD,
    [0x23] = MAPPOPUP_THEME_WOOD,
    [0x24] = MAPPOPUP_THEME_WOOD,
    [0x25] = MAPPOPUP_THEME_UNDERWATER,
    [0x26] = MAPPOPUP_THEME_WOOD,
    [0x27] = MAPPOPUP_THEME_UNDERWATER,
    [0x28] = MAPPOPUP_THEME_UNDERWATER,
    [0x29] = MAPPOPUP_THEME_UNDERWATER,
    [0x2A] = MAPPOPUP_THEME_UNDERWATER,
    [0x2B] = MAPPOPUP_THEME_UNDERWATER,
    [0x2C] = MAPPOPUP_THEME_UNDERWATER,
    [0x2D] = MAPPOPUP_THEME_UNDERWATER,
    [0x2E] = MAPPOPUP_THEME_UNDERWATER,
    [0x2F] = MAPPOPUP_THEME_UNDERWATER,
    [0x30] = MAPPOPUP_THEME_UNDERWATER,
    [0x31] = MAPPOPUP_THEME_UNDERWATER,
    [0x32] = MAPPOPUP_THEME_STONE2,
    [0x33] = MAPPOPUP_THEME_STONE2,
    [0x34] = MAPPOPUP_THEME_STONE2,
    [0x35] = MAPPOPUP_THEME_STONE2,
    [0x36] = MAPPOPUP_THEME_STONE2,
    [0x37] = MAPPOPUP_THEME_STONE,
    [0x38] = MAPPOPUP_THEME_STONE,
    [0x39] = MAPPOPUP_THEME_WOOD,
    [0x3A] = MAPPOPUP_THEME_MARBLE,
    [0x3B] = MAPPOPUP_THEME_WOOD,
    [0x3C] = MAPPOPUP_THEME_STONE,
    [0x3D] = MAPPOPUP_THEME_WOOD,
    [0x3E] = MAPPOPUP_THEME_MARBLE,
    [0x3F] = MAPPOPUP_THEME_STONE,
    [0x40] = MAPPOPUP_THEME_STONE,
    [0x41] = MAPPOPUP_THEME_STONE,
    [0x42] = MAPPOPUP_THEME_STONE,
    [0x43] = MAPPOPUP_THEME_STONE,
    [0x44] = MAPPOPUP_THEME_STONE,
    [0x45] = MAPPOPUP_THEME_STONE2,
    [0x46] = MAPPOPUP_THEME_STONE,
    [0x47] = MAPPOPUP_THEME_WOOD,
    [0x48] = MAPPOPUP_THEME_STONE,
    [0x49] = MAPPOPUP_THEME_WOOD,
    [0x4A] = MAPPOPUP_THEME_STONE,
    [0x4B] = MAPPOPUP_THEME_STONE,
    [0x4C] = MAPPOPUP_THEME_WOOD,
    [0x4D] = MAPPOPUP_THEME_WOOD,
    [0x4E] = MAPPOPUP_THEME_STONE,
    [0x4F] = MAPPOPUP_THEME_STONE2,
    [0x50] = MAPPOPUP_THEME_STONE,
    [0x51] = MAPPOPUP_THEME_STONE,
    [0x52] = MAPPOPUP_THEME_STONE,
    [0x53] = MAPPOPUP_THEME_STONE,
    [0x54] = MAPPOPUP_THEME_WOOD,
    [0x55] = MAPPOPUP_THEME_STONE,
    [0x56] = MAPPOPUP_THEME_STONE,
    [0x57] = MAPPOPUP_THEME_MARBLE,
    [0xC5 - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_STONE,
    [0xC6 - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_STONE,
    [0xC7 - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_STONE,
    [0xC8 - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_WOOD,
    [0xC9 - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_WOOD,
    [0xCA - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_STONE,
    [0xCB - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_STONE,
    [0xCC - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_STONE2,
    [0xCD - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_STONE,
    [0xCE - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_STONE2,
    [0xCF - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_STONE2,
    [0xD0 - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_STONE2,
    [0xD1 - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_STONE,
    [0xD2 - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_STONE,
    [0xD3 - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_STONE,
    [0xD4 - (0xC4 - 0x58 + 1)] = MAPPOPUP_THEME_MARBLE
};
...
static void ShowMapNamePopUpWindow(void)
{
    ...
    AddTextPrinterParameterized(GetMapNamePopUpWindowId(), 7, mapDisplayHeader, x, 3, 0xFF, ((void *)0));
...
static void LoadMapNamePopUpWindowBg(void)
{
    ...
    if (regionMapSectionId >= 0x58)
    {
        if (regionMapSectionId > 0xC4)
            regionMapSectionId -= (0xC4 - 0x58 + 1);
        else
