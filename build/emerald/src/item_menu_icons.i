# 0 "src/item_menu_icons.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/item_menu_icons.c"
...
# 9 "src/item_menu_icons.c" 2
# 1 "include/menu_helpers.h" 1
# 10 "src/item_menu_icons.c" 2


# 1 "include/constants/items.h" 1
# 13 "src/item_menu_icons.c" 2
...
static const union AnimCmd sSpriteAnim_Bag_TypeItems[] =
{
    {.frame = {64, 4}},
    {.type = -1}
};
...
{
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 8, .duration = 16}},
    {.type = 0x7FFF}
};

static const union AffineAnimCmd sSpriteAffineAnim_RotatingBallRotation2[] =
{
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 248, .duration = 16}},
    {.type = 0x7FFF}
};
...
{
    {.frame = {.xScale = -1, .yScale = -1, .rotation = 253, .duration = 96}},
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 0, .duration = 16}},
    {.frame = {.xScale = -2, .yScale = -2, .rotation = 255, .duration = 64}},
...
{
    [(((144 - 144) + 1)) - 1] = {gBerryPic_Cheri, gBerryPalette_Cheri},
    [(((145 - 144) + 1)) - 1] = {gBerryPic_Chesto, gBerryPalette_Chesto},
    [(((146 - 144) + 1)) - 1] = {gBerryPic_Pecha, gBerryPalette_Pecha},
    [(((147 - 144) + 1)) - 1] = {gBerryPic_Rawst, gBerryPalette_Rawst},
    [(((148 - 144) + 1)) - 1] = {gBerryPic_Aspear, gBerryPalette_Aspear},
    [(((149 - 144) + 1)) - 1] = {gBerryPic_Leppa, gBerryPalette_Leppa},
    [(((150 - 144) + 1)) - 1] = {gBerryPic_Oran, gBerryPalette_Oran},
    [(((151 - 144) + 1)) - 1] = {gBerryPic_Persim, gBerryPalette_Persim},
    [(((152 - 144) + 1)) - 1] = {gBerryPic_Lum, gBerryPalette_Lum},
    [(((153 - 144) + 1)) - 1] = {gBerryPic_Sitrus, gBerryPalette_Sitrus},
    [(((154 - 144) + 1)) - 1] = {gBerryPic_Figy, gBerryPalette_Figy},
    [(((155 - 144) + 1)) - 1] = {gBerryPic_Wiki, gBerryPalette_Wiki},
    [(((156 - 144) + 1)) - 1] = {gBerryPic_Mago, gBerryPalette_Mago},
    [(((157 - 144) + 1)) - 1] = {gBerryPic_Aguav, gBerryPalette_Aguav},
    [(((158 - 144) + 1)) - 1] = {gBerryPic_Iapapa, gBerryPalette_Iapapa},
    [(((159 - 144) + 1)) - 1] = {gBerryPic_Razz, gBerryPalette_Razz},
    [(((160 - 144) + 1)) - 1] = {gBerryPic_Bluk, gBerryPalette_Bluk},
    [(((161 - 144) + 1)) - 1] = {gBerryPic_Nanab, gBerryPalette_Nanab},
    [(((162 - 144) + 1)) - 1] = {gBerryPic_Wepear, gBerryPalette_Wepear},
    [(((163 - 144) + 1)) - 1] = {gBerryPic_Pinap, gBerryPalette_Pinap},
    [(((164 - 144) + 1)) - 1] = {gBerryPic_Pomeg, gBerryPalette_Pomeg},
    [(((165 - 144) + 1)) - 1] = {gBerryPic_Kelpsy, gBerryPalette_Kelpsy},
    [(((166 - 144) + 1)) - 1] = {gBerryPic_Qualot, gBerryPalette_Qualot},
    [(((167 - 144) + 1)) - 1] = {gBerryPic_Hondew, gBerryPalette_Hondew},
    [(((168 - 144) + 1)) - 1] = {gBerryPic_Grepa, gBerryPalette_Grepa},
    [(((169 - 144) + 1)) - 1] = {gBerryPic_Tamato, gBerryPalette_Tamato},
    [(((170 - 144) + 1)) - 1] = {gBerryPic_Cornn, gBerryPalette_Cornn},
    [(((171 - 144) + 1)) - 1] = {gBerryPic_Magost, gBerryPalette_Magost},
    [(((172 - 144) + 1)) - 1] = {gBerryPic_Rabuta, gBerryPalette_Rabuta},
    [(((173 - 144) + 1)) - 1] = {gBerryPic_Nomel, gBerryPalette_Nomel},
    [(((174 - 144) + 1)) - 1] = {gBerryPic_Spelon, gBerryPalette_Spelon},
    [(((175 - 144) + 1)) - 1] = {gBerryPic_Pamtre, gBerryPalette_Pamtre},
    [(((176 - 144) + 1)) - 1] = {gBerryPic_Watmel, gBerryPalette_Watmel},
    [(((177 - 144) + 1)) - 1] = {gBerryPic_Durin, gBerryPalette_Durin},
    [(((178 - 144) + 1)) - 1] = {gBerryPic_Belue, gBerryPalette_Belue},
    [(((197 - 144) + 1)) - 1] = {gBerryPic_Liechi, gBerryPalette_Liechi},
    [(((198 - 144) + 1)) - 1] = {gBerryPic_Ganlon, gBerryPalette_Ganlon},
    [(((199 - 144) + 1)) - 1] = {gBerryPic_Salac, gBerryPalette_Salac},
    [(((200 - 144) + 1)) - 1] = {gBerryPic_Petaya, gBerryPalette_Petaya},
    [(((201 - 144) + 1)) - 1] = {gBerryPic_Apicot, gBerryPalette_Apicot},
    [(((202 - 144) + 1)) - 1] = {gBerryPic_Lansat, gBerryPalette_Lansat},
    [(((203 - 144) + 1)) - 1] = {gBerryPic_Starf, gBerryPalette_Starf},
    [(((205 - 144) + 1)) - 1] = {gBerryPic_Enigma, gBerryPalette_Enigma},
    [(((179 - 144) + 1)) - 1] = {gBerryPic_Occa, gBerryPalette_Occa},
    [(((180 - 144) + 1)) - 1] = {gBerryPic_Passho, gBerryPalette_Passho},
    [(((181 - 144) + 1)) - 1] = {gBerryPic_Wacan, gBerryPalette_Wacan},
    [(((182 - 144) + 1)) - 1] = {gBerryPic_Rindo, gBerryPalette_Rindo},
    [(((183 - 144) + 1)) - 1] = {gBerryPic_Yache, gBerryPalette_Yache},
    [(((184 - 144) + 1)) - 1] = {gBerryPic_Chople, gBerryPalette_Chople},
    [(((185 - 144) + 1)) - 1] = {gBerryPic_Kebia, gBerryPalette_Kebia},
    [(((186 - 144) + 1)) - 1] = {gBerryPic_Shuca, gBerryPalette_Shuca},
    [(((187 - 144) + 1)) - 1] = {gBerryPic_Coba, gBerryPalette_Coba},
    [(((188 - 144) + 1)) - 1] = {gBerryPic_Payapa, gBerryPalette_Payapa},
    [(((189 - 144) + 1)) - 1] = {gBerryPic_Tanga, gBerryPalette_Tanga},
    [(((190 - 144) + 1)) - 1] = {gBerryPic_Charti, gBerryPalette_Charti},
    [(((191 - 144) + 1)) - 1] = {gBerryPic_Kasib, gBerryPalette_Kasib},
    [(((192 - 144) + 1)) - 1] = {gBerryPic_Haban, gBerryPalette_Haban},
    [(((193 - 144) + 1)) - 1] = {gBerryPic_Colbur, gBerryPalette_Colbur},
    [(((194 - 144) + 1)) - 1] = {gBerryPic_Babiri, gBerryPalette_Babiri},
    [(((195 - 144) + 1)) - 1] = {gBerryPic_Chilan, gBerryPalette_Chilan},
    [(((196 - 144) + 1)) - 1] = {gBerryPic_Roseli, gBerryPalette_Roseli},
    [(((204 - 144) + 1)) - 1] = {},
    [(((206 - 144) + 1)) - 1] = {},
    [(((207 - 144) + 1)) - 1] = {},
    [(((208 - 144) + 1)) - 1] = {},
...
void AddBagVisualSprite(u8 bagPocketId)
{
    ...
    *spriteId = CreateSprite(&gBagSpriteTemplate, 68, 66, 0);
    SetBagVisualPocketId(bagPocketId, 0);
...
static void LoadBerryGfx(u8 berryId)
{
    ...
    if (berryId == (((205 - 144) + 1)) - 1 && IsEnigmaBerryValid())
    {
