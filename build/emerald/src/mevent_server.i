# 0 "src/mevent_server.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/mevent_server.c"
...
# 6 "src/mevent_server.c" 2
# 1 "include/mevent_server_helpers.h" 1
# 7 "src/mevent_server.c" 2

__attribute__((section("ewram_data"))) struct mevent_srv_common * s_mevent_srv_common_ptr = ((void *)0);
...
{
    u32 result;
    if (s_mevent_srv_common_ptr == ((void *)0))
        return 3;
    ...
    if (result == 3)
    {
        *a0 = s_mevent_srv_common_ptr->param;
        ...
        s_mevent_srv_common_ptr = ((void *)0);
    }
    return result;
}
...
static u32 common_mainseq_4(struct mevent_srv_common * svr)
{
    ...
    case 6:
        ...
        ;
        ;
        svr->param = sub_801B6A0(svr->mevent_unk1442cc, 0);
        break;
    case 30:

        ;
        ;
        svr->param = sub_801B6A0(svr->mevent_unk1442cc, 1);
        break;
    case 4:
