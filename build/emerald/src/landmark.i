...
static const struct Landmark Landmark_FlowerShop = {LandmarkName_FlowerShop, (((0x500 + 864 - 1) + 1) + 0x3C)};
static const struct Landmark Landmark_PetalburgWoods = {LandmarkName_PetalburgWoods, -1};
static const struct Landmark Landmark_MrBrineysCottage = {LandmarkName_MrBrineysCottage, (((0x500 + 864 - 1) + 1) + 0x3D)};
static const struct Landmark Landmark_AbandonedShip = {LandmarkName_AbandonedShip, (((0x500 + 864 - 1) + 1) + 0x3E)};
static const struct Landmark Landmark_SeashoreHouse = {LandmarkName_SeashoreHouse, (((0x500 + 864 - 1) + 1) + 0x3F)};
...
static const struct Landmark Landmark_NewMauville = {LandmarkName_NewMauville, (((0x500 + 864 - 1) + 1) + 0x40)};
static const struct Landmark Landmark_TrickHouse = {LandmarkName_TrickHouse, (((0x500 + 864 - 1) + 1) + 0x42)};
static const struct Landmark Landmark_OldLadysRestShop = {LandmarkName_OldLadysRestShop, (((0x500 + 864 - 1) + 1) + 0x41)};
static const struct Landmark Landmark_Desert = {LandmarkName_Desert, -1};
static const struct Landmark Landmark_WinstrateFamily = {LandmarkName_WinstrateFamily, (((0x500 + 864 - 1) + 1) + 0x43)};
static const struct Landmark Landmark_CableCar = {LandmarkName_CableCar, -1};
static const struct Landmark Landmark_GlassWorkshop = {LandmarkName_GlassWorkshop, (((0x500 + 864 - 1) + 1) + 0x44)};
...
static const struct Landmark Landmark_TunnelersRestHouse = {LandmarkName_TunnelersRestHouse, (((0x500 + 864 - 1) + 1) + 0x5A)};
static const struct Landmark Landmark_RusturfTunnel = {LandmarkName_RusturfTunnel, -1};
static const struct Landmark Landmark_PokemonDayCare = {LandmarkName_PokemonDayCare, (((0x500 + 864 - 1) + 1) + 0x46)};
...
static const struct Landmark Landmark_SeafloorCavern = {LandmarkName_SeafloorCavern, (((0x500 + 864 - 1) + 1) + 0x47)};
...
static const struct Landmark Landmark_LanettesHouse = {LandmarkName_LanettesHouse, (((0x500 + 864 - 1) + 1) + 0x45)};
static const struct Landmark Landmark_FieryPath = {LandmarkName_FieryPath, (((0x500 + 864 - 1) + 1) + 0x4A)};
static const struct Landmark Landmark_JaggedPass = {LandmarkName_JaggedPass, -1};
static const struct Landmark Landmark_BerryMastersHouse = {LandmarkName_BerryMastersHouse, (((0x500 + 864 - 1) + 1) + 0x63)};
static const struct Landmark Landmark_IslandCave = {LandmarkName_IslandCave, (((0x500 + 864 - 1) + 1) + 0x55)};
static const struct Landmark Landmark_DesertRuins = {LandmarkName_DesertRuins, (((0x500 + 864 - 1) + 1) + 0x56)};
static const struct Landmark Landmark_ScorchedSlab = {LandmarkName_ScorchedSlab, (((0x500 + 864 - 1) + 1) + 0x58)};
static const struct Landmark Landmark_AncientTomb = {LandmarkName_AncientTomb, (((0x500 + 864 - 1) + 1) + 0x59)};
static const struct Landmark Landmark_SealedChamber = {LandmarkName_SealedChamber, (((0x500 + 864 - 1) + 1) + 0x5C)};
static const struct Landmark Landmark_FossilManiacsHouse = {LandmarkName_FossilManiacsHouse, (((0x500 + 864 - 1) + 1) + 0x57)};
static const struct Landmark Landmark_HuntersHouse = {LandmarkName_HuntersHouse, (((0x500 + 864 - 1) + 1) + 0x5B)};
static const struct Landmark Landmark_SkyPillar = {LandmarkName_SkyPillar, (((0x500 + 864 - 1) + 1) + 0x5E)};
static const struct Landmark Landmark_MirageTower = {LandmarkName_MirageTower, 0x78};
static const struct Landmark Landmark_AlteringCave = {LandmarkName_AlteringCave, (((0x500 + 864 - 1) + 1) + 0x7D)};
static const struct Landmark Landmark_DesertUnderpass = {LandmarkName_DesertUnderpass, (((0x500 + 864 - 1) + 1) + 0x7E)};
static const struct Landmark Landmark_TrainerHill = {LandmarkName_TrainerHill, (((0x500 + 864 - 1) + 1) + 0x82)};
...
{
    {0x12, 2, Landmarks_Route103_2},
    {0x13, 0, Landmarks_Route104_0},
    {0x13, 1, Landmarks_Route104_1},
    {0x14, 0, Landmarks_Route105_0},
    {0x15, 1, Landmarks_Route106_1},
    {0x17, 0, Landmarks_Route108_0},
    {0x18, 0, Landmarks_Route109_0},
    {0x19, 0, Landmarks_Route110_0},
    {0x19, 1, Landmarks_Route110_1},
    {0x19, 2, Landmarks_Route110_2},
    {0x1A, 0, Landmarks_Route111_0},
    {0x1A, 1, Landmarks_Route111_1},
    {0x1A, 2, Landmarks_Route111_2},
    {0x1A, 3, Landmarks_Route111_3},
    {0x1A, 4, Landmarks_Route111_4},
    {0x1B, 0, Landmarks_Route112_0},
    {0x1B, 1, Landmarks_Route112_1},
    {0x1C, 1, Landmarks_Route113_1},
    {0x1D, 1, Landmarks_Route114_1},
    {0x1D, 2, Landmarks_Route114_2},
    {0x1D, 3, Landmarks_MeteorFalls},
    {0x1E, 0, Landmarks_MeteorFalls},
    {0x1E, 1, Landmarks_MeteorFalls},
    {0x1F, 1, Landmarks_Route116_1},
    {0x1F, 2, Landmarks_Route116_2},
    {0x20, 2, Landmarks_Route117_2},
    {0x22, 1, Landmarks_Route119_1},
    {0x23, 0, Landmarks_Route120_0},
    {0x23, 2, Landmarks_Route120_2},
    {0x24, 2, Landmarks_Route121_2},
    {0x25, 0, Landmarks_Route122_0},
    {0x26, 0, Landmarks_Route123_0},
    {0x25, 1, Landmarks_Route122_0},
    {0x27, 7, Landmarks_Route124_7},
    {0x28, 2, Landmarks_Route125_2},
    {0x2B, 1, Landmarks_Route128_1},
    {0x2E, 1, Landmarks_Route131_1},
    {0x2F, 0, Landmarks_OceanCurrent},
    {0x2F, 1, Landmarks_OceanCurrent},
    {0x30, 0, Landmarks_OceanCurrent},
    {0x30, 1, Landmarks_OceanCurrent},
    {0x30, 2, Landmarks_OceanCurrent},
    {0x31, 0, Landmarks_OceanCurrent},
    {0x31, 1, Landmarks_OceanCurrent},
    {0x31, 2, Landmarks_Route134_2},
    {0x38, 2, Landmarks_MtChimney_2},
    {0xD5, 0, ((void *)0)},
};
...
const u8 *GetLandmarkName(u8 mapSection, u8 id, u8 count)
{
    ...
    while (1)
    {
        ...
        if (landmark->flag == 0xFFFF || FlagGet(landmark->flag) == 1)
        {
            if (count == 0)
                break;
            else
...
static const struct Landmark *const *GetLandmarks(u8 mapSection, u8 id)
{
    ...
    for (; gLandmarkLists[i].mapSection != 0xD5; i++)
    {
    ...
    if (gLandmarkLists[i].mapSection == 0xD5)
        return ((void *)0);
