...
void IntrSIO32(void)
{
    ...
    {
        if (gSTWIStatus->callbackID != ((void *)0))
...
static void sio32intr_clock_master(void)
{
    ...
    if (gSTWIStatus->state == 0)
    {
        if (regSIODATA32 == 0x80000000)
        {
            ...
            {
                (*(vu32 *)(0x4000000 + 0x120)) = ((u32*)gSTWIStatus->txPacket->rfuPacket8.data)[gSTWIStatus->reqNext];
                gSTWIStatus->reqNext++;
            }
            else
            {
                gSTWIStatus->state = 1;
                (*(vu32 *)(0x4000000 + 0x120)) = 0x80000000;
            }
        }
        else
        {
    ...
    (*(vu16 *)(0x4000000 + 0x128)) = 0x4000 | 0x1000 | 0x0003 | 0x0008;
    ...
    if (gSTWIStatus->state == 3)
    {
        ...
        )
        {
            ...
            (*(vu32 *)(0x4000000 + 0x120)) = 0x80000000;
            (*(vu16 *)(0x4000000 + 0x128)) = 0x4000 | 0x1000 | 0x0002;
            (*(vu16 *)(0x4000000 + 0x128)) = 0x4000 | 0x1000 | 0x0002 | 0x0080;
            gSTWIStatus->state = 5;
        }
        else
        {
    ...
    {
        (*(vu16 *)(0x4000000 + 0x128)) = 0x4000 | 0x1000 | 0x0003;
        (*(vu16 *)(0x4000000 + 0x128)) = 0x4000 | 0x1000 | 0x0003 | 0x0080;
    }
}
...
static void sio32intr_clock_slave(void)
{
    ...
    if (handshake_wait(0) == 1)
        return;
    (*(vu16 *)(0x4000000 + 0x128)) = 0x4000 | 0x1000 | 0x0002 | 0x0008;
    regSIODATA32 = (*(vu32 *)(0x4000000 + 0x120));
    if (gSTWIStatus->state == 5)
    {
        ...
        if ((regSIODATA32 >> 16) == (r0 >> 16))
        {
            ...
            if (gSTWIStatus->reqLength == 0)
            {
                ...
                (*(vu32 *)(0x4000000 + 0x120)) = ((u32*)gSTWIStatus->txPacket)[0];
    ...
    else if (gSTWIStatus->state == 7)
    {
        if (regSIODATA32 == 0x80000000)
        {
            ...
            {
                (*(vu32 *)(0x4000000 + 0x120)) = ((u32*)gSTWIStatus->txPacket)[gSTWIStatus->ackNext];
                gSTWIStatus->ackNext++;
            }
        }
        else
    ...
    else
    {
        ...
        if ((*(vu16 *)(0x4000000 + 0x102)) & 0x80)
        {
            if (((*(vu16 *)(0x4000000 + 0x102)) & 0x03) == 0x00)
            {
                while ((*(vu16 *)(0x4000000 + 0x100)) > 0xFF9B);
            }
            else
            {
                while ((*(vu16 *)(0x4000000 + 0x100)) > 0xFFFE);
            }
        }
        (*(vu16 *)(0x4000000 + 0x128)) = 0x4000 | 0x1000 | 0x0002;
        (*(vu16 *)(0x4000000 + 0x128)) = 0x4000 | 0x1000 | 0x0002 | 0x0080;
...
static u16 handshake_wait(u16 slot)
{
    ...
    } while (((*(vu16 *)(0x4000000 + 0x128)) & 0x0004) != (slot << 2));
    return 0;
}

static void STWI_set_timer_in_RAM(u8 count)
{
    vu16* regTMCNTL = (vu16*)((0x4000000 + 0x100) + gSTWIStatus->timerSelect * 4);
    vu16* regTMCNTH = (vu16*)((0x4000000 + 0x102) + gSTWIStatus->timerSelect * 4);
    (*(vu16 *)(0x4000000 + 0x208)) = 0;
    switch (count)
    {
    case 50:
