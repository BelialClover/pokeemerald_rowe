# 0 "src/frontier_pass.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/frontier_pass.c"
...
# 12 "src/frontier_pass.c" 2
# 1 "include/task.h" 1
# 13 "src/frontier_pass.c" 2
...
# 21 "src/frontier_pass.c" 2
# 1 "include/menu.h" 1
# 22 "src/frontier_pass.c" 2
# 1 "gflib/bg.h" 1
...
# 28 "src/frontier_pass.c" 2
# 1 "include/constants/battle_frontier.h" 1
# 29 "src/frontier_pass.c" 2
...
# 30 "src/frontier_pass.c" 2
# 1 "include/constants/rgb.h" 1
# 31 "src/frontier_pass.c" 2
# 1 "include/constants/region_map_sections.h" 1
# 32 "src/frontier_pass.c" 2
# 1 "include/constants/songs.h" 1
# 33 "src/frontier_pass.c" 2
...
enum
{
    ...
    CURSOR_AREA_CANCEL,
    CURSOR_AREA_POINTS,
    CURSOR_AREA_EARNED_SYMBOLS,
    CURSOR_AREA_SYMBOL,
    CURSOR_AREA_COUNT = CURSOR_AREA_SYMBOL + 7,
};
...
struct FrontierPassData
{
    ...
    u8 unkE:3;
    u8 trainerStars:4;
    u8 facilitySymbols[7];
};

struct FrontierPassGfx
{
    struct Sprite *cursorSprite;
    struct Sprite *symbolSprites[7];
    u8 *unk20;
    u8 *unk24;
    u8 *unk28;
    bool8 setAffine;
...
static __attribute__((section("ewram_data"))) struct FrontierPassData *sPassData = ((void *)0);
static __attribute__((section("ewram_data"))) struct FrontierPassGfx *sPassGfx = ((void *)0);
static __attribute__((section("ewram_data"))) struct FrontierMapData *sMapData = ((void *)0);
static __attribute__((section("ewram_data"))) struct FrontierPassSaved sSavedPassData = {0};
...
static void ResetGpuRegsAndBgs(void)
{
    ...
    SetGpuReg(0x48, 0);
    SetGpuReg(0x4a, 0);
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, (void *)0x6000000, 0x00000000 | 0x01000000 | ((0x18000)/(16/8) & 0x1FFFFF)); };
...
static u32 FreeFrontierPassData(void)
{
    ...
    memset(sPassData, 0, sizeof(*sPassData));
    { Free(sPassData); sPassData = ((void *)0); };
    return 0;
}
...
static u32 FreeFrontierPassGfx(void)
{
    ...
    if (sPassGfx->unk28 != ((void *)0))
        { Free(sPassGfx->unk28); sPassGfx->unk28 = ((void *)0); };
    if (sPassGfx->unk24 != ((void *)0))
        { Free(sPassGfx->unk24); sPassGfx->unk24 = ((void *)0); };
    if (sPassGfx->unk20 != ((void *)0))
        { Free(sPassGfx->unk20); sPassGfx->unk20 = ((void *)0); };

    memset(sPassGfx, 0, sizeof(*sPassGfx));
    { Free(sPassGfx); sPassGfx = ((void *)0); };
    return 0;
}
...
static bool32 InitFrontierPass(void)
{
    ...
    case 4:
        ...
        InitBgsFromTemplates(1, sPassBgTemplates, (size_t)(sizeof(sPassBgTemplates) / sizeof((sPassBgTemplates)[0])));
...
static void Task_HandleFrontierPassInput(u8 taskId)
{
    ...
    if (({(gMain.heldKeys) & (0x0040);}) && sPassGfx->cursorSprite->pos1.y >= 9)
    {
    ...
    if (({(gMain.heldKeys) & (0x0080);}) && sPassGfx->cursorSprite->pos1.y <= 135)
    {
        sPassGfx->cursorSprite->pos1.y += 2;
    ...
    if (({(gMain.heldKeys) & (0x0020);}) && sPassGfx->cursorSprite->pos1.x >= 6)
    {
    ...
    if (({(gMain.heldKeys) & (0x0010);}) && sPassGfx->cursorSprite->pos1.x <= 231)
    {
        sPassGfx->cursorSprite->pos1.x += 2;
    ...
    if (!var)
    {
        if (sPassData->cursorArea != CURSOR_AREA_NOTHING && ({(gMain.newKeys) & (0x0001);}))
        {
...
static void Task_DoFadeEffect(u8 taskId)
{
    ...
    case 0:
        if (!data[0])
        {
            ...
            data[3] = 0x15;
            data[4] = 0x15;
            BeginNormalPaletteFade(0xFFFFFFFF, 0, 0, 0x10, ((31) | ((31) << 5) | ((31) << 10)));
        }
        else
        {
            data[1] = ((s16)((1.984375) * 256));
            data[2] = ((s16)((1.984375) * 256));
            data[3] = -0x15;
            data[4] = -0x15;
            SetGpuReg(0x0, 0x1000 | 0x0040);
            ShowBg(0);
            ...
            BeginNormalPaletteFade(0xFFFFFFFF, 0, 0x10, 0, ((31) | ((31) << 5) | ((31) << 10)));
        }
        sPassGfx->setAffine = 1;
...
static void PrintAreaDescription(u8 cursorArea)
{
    FillWindowPixelBuffer(WINDOW_DESCRIPTION, ((0) | ((0) << 4)));
...
static void sub_80C5F58(bool8 arg0, bool8 arg1)
{
    ...
    if (arg1)
    {
        SetBgAffine(2,
                    ...
                    gUnknown_085713E0[sPassData->unkE - 1][0],
                    gUnknown_085713E0[sPassData->unkE - 1][1],
                    MathUtil_Inv16(((s16)((1.984375) * 256))),
                    MathUtil_Inv16(((s16)((1.984375) * 256))),
                    0);
    }
    else
...
static void FreeCursorAndSymbolSprites(void)
{
    ...
    sPassGfx->cursorSprite = ((void *)0);
    for (i = 0; i < 7; i++)
    {
        if (sPassGfx->symbolSprites[i] != ((void *)0))
        {
            DestroySprite(sPassGfx->symbolSprites[i]);
            sPassGfx->symbolSprites[i] = ((void *)0);
        }
    }
    FreeAllSpritePalettes();
...
static void FreeFrontierMap(void)
{
    ...
    memset(sMapData, 0, sizeof(*sMapData));
    { Free(sMapData); sMapData = ((void *)0); };
}
...
static bool32 InitFrontierMap(void)
{
    ...
    case 3:
        ResetBgsAndClearDma3BusyFlags(0);
        InitBgsFromTemplates(0, sMapBgTemplates, (size_t)(sizeof(sMapBgTemplates) / sizeof((sMapBgTemplates)[0])));
...
static bool32 ExitFrontierMap(void)
{
    ...
    case 2:
        ...
        break;
    case 3:
        if (sMapData->cursorSprite != ((void *)0))
        {
            DestroySprite(sMapData->cursorSprite);
            FreeSpriteTilesByTag(0);
        }
        if (sMapData->mapIndicatorSprite != ((void *)0))
        {
            DestroySprite(sMapData->mapIndicatorSprite);
            FreeSpriteTilesByTag(1);
        }
        if (sMapData->playerHeadSprite != ((void *)0))
        {
...
{
    if ((mapNum >= ((5 | (26 << 8)) & 0xFF) && mapNum <= ((8 | (26 << 8)) & 0xFF))
        || (mapNum >= ((15 | (26 << 8)) & 0xFF) && mapNum <= ((17 | (26 << 8)) & 0xFF)))
        return 0 + 1;
    else if (mapNum == ((18 | (26 << 8)) & 0xFF)
             || mapNum == ((19 | (26 << 8)) & 0xFF)
             || mapNum == ((20 | (26 << 8)) & 0xFF)
             || mapNum == ((21 | (26 << 8)) & 0xFF))
        return 1 + 1;
    else if (mapNum == ((22 | (26 << 8)) & 0xFF)
        || mapNum == ((23 | (26 << 8)) & 0xFF)
        || mapNum == ((24 | (26 << 8)) & 0xFF))
        return 2 + 1;
    else if (mapNum == ((28 | (26 << 8)) & 0xFF)
        || mapNum == ((29 | (26 << 8)) & 0xFF)
        || mapNum == ((30 | (26 << 8)) & 0xFF))
        return 3 + 1;
    else if (mapNum == ((31 | (26 << 8)) & 0xFF)
        || mapNum == ((32 | (26 << 8)) & 0xFF)
        || mapNum == ((33 | (26 << 8)) & 0xFF))
        return 4 + 1;
    else if (mapNum == ((34 | (26 << 8)) & 0xFF)
             || mapNum == ((35 | (26 << 8)) & 0xFF)
             || mapNum == ((36 | (26 << 8)) & 0xFF)
             || mapNum == ((37 | (26 << 8)) & 0xFF)
             || mapNum == ((38 | (26 << 8)) & 0xFF)
...
static void InitFrontierMapSprites(void)
{
    ...
    if (id == 0x3A || id == 0xCA)
    {
        ...
        if (mapNum == ((4 | (26 << 8)) & 0xFF)
            || (mapNum == ((14 | (26 << 8)) & 0xFF) && (x = 55)))
        {
        ...
        else
        {
            ...
            else
            {
                ...
                if (gSaveBlock1Ptr->escapeWarp.mapNum == ((14 | (26 << 8)) & 0xFF))
...
static void HandleFrontierMapCursorMove(u8 direction)
{
    ...
    FillWindowPixelBuffer(MAP_WINDOW_DESCRIPTION, ((0) | ((0) << 4)));
    AddTextPrinterParameterized3(MAP_WINDOW_DESCRIPTION, 1, 4, 0, sTextColors[0], 0, sMapLandmarks[sMapData->cursorPos].description);
