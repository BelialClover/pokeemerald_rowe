...
static __attribute__((section("ewram_data"))) struct BerryCrushGame *gUnknown_02022C90 = ((void *)0);
...
u32 sub_8020C0C(MainCallback callback)
{
    ...
    { Free(gUnknown_02022C90); gUnknown_02022C90 = ((void *)0); };
...
{
    if (gSpecialVar_ItemId < 144 || gSpecialVar_ItemId > 210 + 1)
        gSpecialVar_ItemId = 144;
    else
        RemoveBagItem(gSpecialVar_ItemId, 1);

    gUnknown_02022C90->unk68.as_four_players.others[gUnknown_02022C90->unk8].unk0 = gSpecialVar_ItemId - 144;
    gUnknown_02022C90->unkE = 1;
...
void sub_8020FC4(struct BerryCrushGame *arg0)
{
    ...
    for (i = 0; i < arg0->unk9; i++)
        StringCopy(((u8 *)(arg0) + ((size_t)&((struct BerryCrushGame *)0)->unk68) + ((size_t)&((struct BerryCrushGame_68_x *)0)->unk30) + sizeof(struct BerryCrushGame_Player) * (i)), gLinkPlayers[i].name);
    for (; i < 5; i++)
    {
        memset(((u8 *)(arg0) + ((size_t)&((struct BerryCrushGame *)0)->unk68) + ((size_t)&((struct BerryCrushGame_68_x *)0)->unk30) + sizeof(struct BerryCrushGame_Player) * (i)), 1, 7);
        arg0->unk68.as_five_players.unk1C[i].unk14[7] = 0xFF;
    }
...
void sub_8021A28(struct BerryCrushGame * sp0C, u8 sp10, u8 sp14, u8 sp18)
{
    ...
    for (r8 = 0; r8 < sp0C->unk9; r6 += 14, ++r8)
    {
        ...
        DynamicPlaceholderTextUtil_SetPlaceholderPtr(0, ((u8 *)(sp0C) + ((size_t)&((struct BerryCrushGame *)0)->unk68) + ((size_t)&((struct BerryCrushGame_68_x *)0)->unk30) + sizeof(struct BerryCrushGame_Player) * (sp1C)));
    ...
    for (r7 = 0; r7 < r6->unk9; ++r7)
    {
        ...
        if (r7 == r6->unk8)
        {
            AddTextPrinterParameterized4(
                r6->unk138.unk83[r7],
                2,
                36 - GetStringWidth(2, ((u8 *)(r6) + ((size_t)&((struct BerryCrushGame *)0)->unk68) + ((size_t)&((struct BerryCrushGame_68_x *)0)->unk30) + sizeof(struct BerryCrushGame_Player) * (r7)), 0) / 2u,
                1,
                0,
                0,
                sBerryCrushTextColorTable[1],
                0,
                ((u8 *)(r6) + ((size_t)&((struct BerryCrushGame *)0)->unk68) + ((size_t)&((struct BerryCrushGame_68_x *)0)->unk30) + sizeof(struct BerryCrushGame_Player) * (r7))
            );
        }
        else
        {
