# 0 "src/battle_setup.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_setup.c"
...
# 31 "src/battle_setup.c" 2
# 1 "include/gym_leader_rematch.h" 1
# 32 "src/battle_setup.c" 2
...
# 43 "src/battle_setup.c" 2
# 1 "include/constants/battle_setup.h" 1
# 44 "src/battle_setup.c" 2
# 1 "include/constants/game_stat.h" 1
# 45 "src/battle_setup.c" 2
# 1 "include/constants/items.h" 1
# 46 "src/battle_setup.c" 2
# 1 "include/constants/songs.h" 1
# 47 "src/battle_setup.c" 2
# 1 "include/constants/map_types.h" 1
# 48 "src/battle_setup.c" 2
...
# 50 "src/battle_setup.c" 2
# 1 "include/constants/trainer_hill.h" 1
# 51 "src/battle_setup.c" 2
...
__attribute__((section("ewram_data"))) u16 gTrainerBattleOpponent_A = 0;
__attribute__((section("ewram_data"))) u16 gTrainerBattleOpponent_B = 0;
__attribute__((section("ewram_data"))) u16 gPartnerTrainerId = 0;
__attribute__((section("ewram_data"))) static u16 sTrainerObjectEventLocalId = 0;
__attribute__((section("ewram_data"))) static u8 *sTrainerAIntroSpeech = ((void *)0);
__attribute__((section("ewram_data"))) static u8 *sTrainerBIntroSpeech = ((void *)0);
__attribute__((section("ewram_data"))) static u8 *sTrainerADefeatSpeech = ((void *)0);
__attribute__((section("ewram_data"))) static u8 *sTrainerBDefeatSpeech = ((void *)0);
...
__attribute__((section("ewram_data"))) static u8 *sTrainerABattleScriptRetAddr = ((void *)0);
__attribute__((section("ewram_data"))) static u8 *sTrainerBBattleScriptRetAddr = ((void *)0);
__attribute__((section("ewram_data"))) static bool8 sShouldCheckTrainerBScript = 0;
__attribute__((section("ewram_data"))) static u8 sNoOfPossibleTrainerRetScripts = 0;
...
# 256 "src/battle_setup.c"
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    [REMATCH_ROSE] = { .trainerIds = {37, 40, 41, 42, 43}, .mapGroup = ((33 | (0 << 8)) >> 8), .mapNum = ((33 | (0 << 8)) & 0xFF), },
    [REMATCH_ANDRES] = { .trainerIds = {737, 812, 813, 814, 815}, .mapGroup = ((20 | (0 << 8)) >> 8), .mapNum = ((20 | (0 << 8)) & 0xFF), },
    [REMATCH_DUSTY] = { .trainerIds = {44, 47, 48, 49, 50}, .mapGroup = ((26 | (0 << 8)) >> 8), .mapNum = ((26 | (0 << 8)) & 0xFF), },
    [REMATCH_LOLA] = { .trainerIds = {57, 60, 61, 62, 63}, .mapGroup = ((24 | (0 << 8)) >> 8), .mapNum = ((24 | (0 << 8)) & 0xFF), },
    [REMATCH_RICKY] = { .trainerIds = {64, 67, 68, 69, 70}, .mapGroup = ((24 | (0 << 8)) >> 8), .mapNum = ((24 | (0 << 8)) & 0xFF), },
    [REMATCH_LILA_AND_ROY] = { .trainerIds = {687, 688, 689, 690, 691}, .mapGroup = ((39 | (0 << 8)) >> 8), .mapNum = ((39 | (0 << 8)) & 0xFF), },
    [REMATCH_CRISTIN] = { .trainerIds = {767, 828, 829, 830, 831}, .mapGroup = ((36 | (0 << 8)) >> 8), .mapNum = ((36 | (0 << 8)) & 0xFF), },
    [REMATCH_BROOKE] = { .trainerIds = {94, 101, 102, 103, 104}, .mapGroup = ((26 | (0 << 8)) >> 8), .mapNum = ((26 | (0 << 8)) & 0xFF), },
    [REMATCH_WILTON] = { .trainerIds = {78, 84, 85, 86, 87}, .mapGroup = ((26 | (0 << 8)) >> 8), .mapNum = ((26 | (0 << 8)) & 0xFF), },
    [REMATCH_VALERIE] = { .trainerIds = {108, 110, 111, 112, 113}, .mapGroup = ((20 | (24 << 8)) >> 8), .mapNum = ((20 | (24 << 8)) & 0xFF), },
    [REMATCH_CINDY] = { .trainerIds = {114, 120, 121, 122, 123}, .mapGroup = ((19 | (0 << 8)) >> 8), .mapNum = ((19 | (0 << 8)) & 0xFF), },
    [REMATCH_THALIA] = { .trainerIds = {144, 844, 845, 846, 847}, .mapGroup = ((56 | (24 << 8)) >> 8), .mapNum = ((56 | (24 << 8)) & 0xFF), },
    [REMATCH_JESSICA] = { .trainerIds = {127, 132, 133, 134, 135}, .mapGroup = ((36 | (0 << 8)) >> 8), .mapNum = ((36 | (0 << 8)) & 0xFF), },
    [REMATCH_WINSTON] = { .trainerIds = {136, 139, 140, 141, 142}, .mapGroup = ((19 | (0 << 8)) >> 8), .mapNum = ((19 | (0 << 8)) & 0xFF), },
    [REMATCH_STEVE] = { .trainerIds = {143, 147, 148, 149, 150}, .mapGroup = ((29 | (0 << 8)) >> 8), .mapNum = ((29 | (0 << 8)) & 0xFF), },
    [REMATCH_TONY] = { .trainerIds = {155, 175, 176, 177, 178}, .mapGroup = ((22 | (0 << 8)) >> 8), .mapNum = ((22 | (0 << 8)) & 0xFF), },
    [REMATCH_NOB] = { .trainerIds = {183, 184, 185, 186, 187}, .mapGroup = ((30 | (0 << 8)) >> 8), .mapNum = ((30 | (0 << 8)) & 0xFF), },
    [REMATCH_KOJI] = { .trainerIds = {672, 824, 825, 826, 827}, .mapGroup = ((42 | (0 << 8)) >> 8), .mapNum = ((42 | (0 << 8)) & 0xFF), },
    [REMATCH_FERNANDO] = { .trainerIds = {195, 832, 833, 834, 835}, .mapGroup = ((38 | (0 << 8)) >> 8), .mapNum = ((38 | (0 << 8)) & 0xFF), },
    [REMATCH_DALTON] = { .trainerIds = {196, 197, 198, 199, 200}, .mapGroup = ((33 | (0 << 8)) >> 8), .mapNum = ((33 | (0 << 8)) & 0xFF), },
    [REMATCH_BERNIE] = { .trainerIds = {206, 207, 208, 209, 210}, .mapGroup = ((29 | (0 << 8)) >> 8), .mapNum = ((29 | (0 << 8)) & 0xFF), },
    [REMATCH_ETHAN] = { .trainerIds = {216, 219, 220, 221, 222}, .mapGroup = ((13 | (24 << 8)) >> 8), .mapNum = ((13 | (24 << 8)) & 0xFF), },
    [REMATCH_JOHN_AND_JAY] = { .trainerIds = {681, 682, 683, 684, 685}, .mapGroup = ((1 | (24 << 8)) >> 8), .mapNum = ((1 | (24 << 8)) & 0xFF), },
    [REMATCH_JEFFREY] = { .trainerIds = {226, 228, 229, 230, 231}, .mapGroup = ((35 | (0 << 8)) >> 8), .mapNum = ((35 | (0 << 8)) & 0xFF), },
    [REMATCH_CAMERON] = { .trainerIds = {238, 239, 240, 241, 242}, .mapGroup = ((38 | (0 << 8)) >> 8), .mapNum = ((38 | (0 << 8)) & 0xFF), },
    [REMATCH_JACKI] = { .trainerIds = {249, 250, 251, 252, 253}, .mapGroup = ((38 | (0 << 8)) >> 8), .mapNum = ((38 | (0 << 8)) & 0xFF), },
    [REMATCH_WALTER] = { .trainerIds = {254, 257, 258, 259, 260}, .mapGroup = ((36 | (0 << 8)) >> 8), .mapNum = ((36 | (0 << 8)) & 0xFF), },
    [REMATCH_KAREN] = { .trainerIds = {280, 282, 283, 284, 285}, .mapGroup = ((31 | (0 << 8)) >> 8), .mapNum = ((31 | (0 << 8)) & 0xFF), },
    [REMATCH_JERRY] = { .trainerIds = {273, 276, 277, 278, 279}, .mapGroup = ((31 | (0 << 8)) >> 8), .mapNum = ((31 | (0 << 8)) & 0xFF), },
    [REMATCH_ANNA_AND_MEG] = { .trainerIds = {287, 288, 289, 290, 291}, .mapGroup = ((32 | (0 << 8)) >> 8), .mapNum = ((32 | (0 << 8)) & 0xFF), },
    [REMATCH_ISABEL] = { .trainerIds = {302, 303, 304, 305, 306}, .mapGroup = ((25 | (0 << 8)) >> 8), .mapNum = ((25 | (0 << 8)) & 0xFF), },
    [REMATCH_MIGUEL] = { .trainerIds = {293, 295, 296, 297, 298}, .mapGroup = ((18 | (0 << 8)) >> 8), .mapNum = ((18 | (0 << 8)) & 0xFF), },
    [REMATCH_TIMOTHY] = { .trainerIds = {307, 308, 309, 310, 311}, .mapGroup = ((30 | (0 << 8)) >> 8), .mapNum = ((30 | (0 << 8)) & 0xFF), },
    [REMATCH_SHELBY] = { .trainerIds = {313, 314, 315, 316, 317}, .mapGroup = ((12 | (24 << 8)) >> 8), .mapNum = ((12 | (24 << 8)) & 0xFF), },
    [REMATCH_CALVIN] = { .trainerIds = {318, 328, 329, 330, 331}, .mapGroup = ((17 | (0 << 8)) >> 8), .mapNum = ((17 | (0 << 8)) & 0xFF), },
    [REMATCH_ELLIOT] = { .trainerIds = {339, 346, 347, 348, 349}, .mapGroup = ((21 | (0 << 8)) >> 8), .mapNum = ((21 | (0 << 8)) & 0xFF), },
    [REMATCH_ISAIAH] = { .trainerIds = {376, 379, 380, 381, 382}, .mapGroup = ((43 | (0 << 8)) >> 8), .mapNum = ((43 | (0 << 8)) & 0xFF), },
    [REMATCH_MARIA] = { .trainerIds = {369, 370, 371, 372, 373}, .mapGroup = ((32 | (0 << 8)) >> 8), .mapNum = ((32 | (0 << 8)) & 0xFF), },
    [REMATCH_ABIGAIL] = { .trainerIds = {358, 360, 361, 362, 363}, .mapGroup = ((25 | (0 << 8)) >> 8), .mapNum = ((25 | (0 << 8)) & 0xFF), },
    [REMATCH_DYLAN] = { .trainerIds = {364, 365, 366, 367, 368}, .mapGroup = ((32 | (0 << 8)) >> 8), .mapNum = ((32 | (0 << 8)) & 0xFF), },
    [REMATCH_KATELYN] = { .trainerIds = {386, 388, 389, 390, 391}, .mapGroup = ((43 | (0 << 8)) >> 8), .mapNum = ((43 | (0 << 8)) & 0xFF), },
    [REMATCH_BENJAMIN] = { .trainerIds = {353, 354, 355, 356, 357}, .mapGroup = ((25 | (0 << 8)) >> 8), .mapNum = ((25 | (0 << 8)) & 0xFF), },
    [REMATCH_PABLO] = { .trainerIds = {377, 820, 821, 822, 823}, .mapGroup = ((41 | (0 << 8)) >> 8), .mapNum = ((41 | (0 << 8)) & 0xFF), },
    [REMATCH_NICOLAS] = { .trainerIds = {392, 393, 394, 395, 396}, .mapGroup = ((1 | (24 << 8)) >> 8), .mapNum = ((1 | (24 << 8)) & 0xFF), },
    [REMATCH_ROBERT] = { .trainerIds = {406, 409, 410, 411, 412}, .mapGroup = ((35 | (0 << 8)) >> 8), .mapNum = ((35 | (0 << 8)) & 0xFF), },
    [REMATCH_LAO] = { .trainerIds = {419, 421, 422, 423, 424}, .mapGroup = ((28 | (0 << 8)) >> 8), .mapNum = ((28 | (0 << 8)) & 0xFF), },
    [REMATCH_CYNDY] = { .trainerIds = {427, 430, 431, 432, 433}, .mapGroup = ((30 | (0 << 8)) >> 8), .mapNum = ((30 | (0 << 8)) & 0xFF), },
    [REMATCH_MADELINE] = { .trainerIds = {434, 437, 438, 439, 440}, .mapGroup = ((28 | (0 << 8)) >> 8), .mapNum = ((28 | (0 << 8)) & 0xFF), },
    [REMATCH_JENNY] = { .trainerIds = {449, 465, 466, 467, 468}, .mapGroup = ((39 | (0 << 8)) >> 8), .mapNum = ((39 | (0 << 8)) & 0xFF), },
    [REMATCH_DIANA] = { .trainerIds = {474, 477, 478, 479, 480}, .mapGroup = ((13 | (24 << 8)) >> 8), .mapNum = ((13 | (24 << 8)) & 0xFF), },
    [REMATCH_AMY_AND_LIV] = { .trainerIds = {481, 482, 487, 488, 489}, .mapGroup = ((18 | (0 << 8)) >> 8), .mapNum = ((18 | (0 << 8)) & 0xFF), },
    [REMATCH_ERNEST] = { .trainerIds = {492, 497, 498, 499, 500}, .mapGroup = ((40 | (0 << 8)) >> 8), .mapNum = ((40 | (0 << 8)) & 0xFF), },
    [REMATCH_CORY] = { .trainerIds = {740, 816, 817, 818, 819}, .mapGroup = ((23 | (0 << 8)) >> 8), .mapNum = ((23 | (0 << 8)) & 0xFF), },
    [REMATCH_EDWIN] = { .trainerIds = {512, 515, 516, 517, 518}, .mapGroup = ((25 | (0 << 8)) >> 8), .mapNum = ((25 | (0 << 8)) & 0xFF), },
    [REMATCH_LYDIA] = { .trainerIds = {545, 548, 549, 550, 551}, .mapGroup = ((32 | (0 << 8)) >> 8), .mapNum = ((32 | (0 << 8)) & 0xFF), },
    [REMATCH_ISAAC] = { .trainerIds = {538, 541, 542, 543, 544}, .mapGroup = ((32 | (0 << 8)) >> 8), .mapNum = ((32 | (0 << 8)) & 0xFF), },
    [REMATCH_GABRIELLE] = { .trainerIds = {9, 840, 841, 842, 843}, .mapGroup = ((17 | (24 << 8)) >> 8), .mapNum = ((17 | (24 << 8)) & 0xFF), },
    [REMATCH_CATHERINE] = { .trainerIds = {559, 562, 563, 564, 565}, .mapGroup = ((34 | (0 << 8)) >> 8), .mapNum = ((34 | (0 << 8)) & 0xFF), },
    [REMATCH_JACKSON] = { .trainerIds = {552, 555, 556, 557, 558}, .mapGroup = ((34 | (0 << 8)) >> 8), .mapNum = ((34 | (0 << 8)) & 0xFF), },
    [REMATCH_HALEY] = { .trainerIds = {604, 607, 608, 609, 610}, .mapGroup = ((19 | (0 << 8)) >> 8), .mapNum = ((19 | (0 << 8)) & 0xFF), },
    [REMATCH_JAMES] = { .trainerIds = {621, 622, 623, 624, 625}, .mapGroup = ((11 | (24 << 8)) >> 8), .mapNum = ((11 | (24 << 8)) & 0xFF), },
    [REMATCH_TRENT] = { .trainerIds = {627, 636, 637, 638, 639}, .mapGroup = ((27 | (0 << 8)) >> 8), .mapNum = ((27 | (0 << 8)) & 0xFF), },
    [REMATCH_SAWYER] = { .trainerIds = {1, 836, 837, 838, 839}, .mapGroup = ((12 | (24 << 8)) >> 8), .mapNum = ((12 | (24 << 8)) & 0xFF), },
    [REMATCH_KIRA_AND_DAN] = { .trainerIds = {642, 643, 644, 645, 646}, .mapGroup = ((62 | (24 << 8)) >> 8), .mapNum = ((62 | (24 << 8)) & 0xFF), },
    [REMATCH_WALLY_3] = { .trainerIds = {657, 658, 659, 660, 660}, .mapGroup = ((43 | (24 << 8)) >> 8), .mapNum = ((43 | (24 << 8)) & 0xFF), },
    [REMATCH_ROXANNE] = { .trainerIds = {265, 770, 771, 772, 773}, .mapGroup = ((3 | (0 << 8)) >> 8), .mapNum = ((3 | (0 << 8)) & 0xFF), },
    [REMATCH_BRAWLY] = { .trainerIds = {266, 774, 775, 776, 777}, .mapGroup = ((11 | (0 << 8)) >> 8), .mapNum = ((11 | (0 << 8)) & 0xFF), },
    [REMATCH_WATTSON] = { .trainerIds = {267, 778, 779, 780, 781}, .mapGroup = ((2 | (0 << 8)) >> 8), .mapNum = ((2 | (0 << 8)) & 0xFF), },
    [REMATCH_FLANNERY] = { .trainerIds = {268, 782, 783, 784, 785}, .mapGroup = ((12 | (0 << 8)) >> 8), .mapNum = ((12 | (0 << 8)) & 0xFF), },
    [REMATCH_NORMAN] = { .trainerIds = {269, 786, 787, 788, 789}, .mapGroup = ((0 | (0 << 8)) >> 8), .mapNum = ((0 | (0 << 8)) & 0xFF), },
    [REMATCH_WINONA] = { .trainerIds = {270, 790, 791, 792, 793}, .mapGroup = ((4 | (0 << 8)) >> 8), .mapNum = ((4 | (0 << 8)) & 0xFF), },
    [REMATCH_TATE_AND_LIZA] = { .trainerIds = {271, 794, 795, 796, 797}, .mapGroup = ((6 | (0 << 8)) >> 8), .mapNum = ((6 | (0 << 8)) & 0xFF), },
    [REMATCH_JUAN] = { .trainerIds = {272, 798, 799, 800, 801}, .mapGroup = ((7 | (0 << 8)) >> 8), .mapNum = ((7 | (0 << 8)) & 0xFF), },
    [REMATCH_SIDNEY] = { .trainerIds = {261, 261, 261, 261, 261}, .mapGroup = ((8 | (0 << 8)) >> 8), .mapNum = ((8 | (0 << 8)) & 0xFF), },
    [REMATCH_PHOEBE] = { .trainerIds = {262, 262, 262, 262, 262}, .mapGroup = ((8 | (0 << 8)) >> 8), .mapNum = ((8 | (0 << 8)) & 0xFF), },
    [REMATCH_GLACIA] = { .trainerIds = {263, 263, 263, 263, 263}, .mapGroup = ((8 | (0 << 8)) >> 8), .mapNum = ((8 | (0 << 8)) & 0xFF), },
    [REMATCH_DRAKE] = { .trainerIds = {264, 264, 264, 264, 264}, .mapGroup = ((8 | (0 << 8)) >> 8), .mapNum = ((8 | (0 << 8)) & 0xFF), },
    [REMATCH_WALLACE] = { .trainerIds = {335, 335, 335, 335, 335}, .mapGroup = ((8 | (0 << 8)) >> 8), .mapNum = ((8 | (0 << 8)) & 0xFF), },
};

static const u16 sBadgeFlags[(1 + (((0x500 + 864 - 1) + 1) + 0xE) - (((0x500 + 864 - 1) + 1) + 0x7))] =
{
...
void BattleSetup_StartWildBattle(void)
{
    if (GetSafariZoneFlag())
        ...
        DoStandardWildBattle(0);
}

void BattleSetup_StartDoubleWildBattle(void)
{
    DoStandardWildBattle(1);
}
...
void StartWallyTutorialBattle(void)
{
    CreateMaleMon(&gEnemyParty[0], 280, 5, 0);
    ScriptContext2_Enable();
...
void StartRegiBattle(void)
{
    ...
    species = GetMonData(&gEnemyParty[0], 11);
    switch (species)
    {
    case 377:
        transitionId = 21;
...
static void CB2_EndWildBattle(void)
{
    ...
    if (IsPlayerDefeated(gBattleOutcome) == 1 && !InBattlePyramid() && !InBattlePike())
    {
...
u8 BattleSetup_GetTerrainId(void)
{
    ...
    if (gSaveBlock1Ptr->location.mapGroup == ((28 | (0 << 8)) >> 8) && gSaveBlock1Ptr->location.mapNum == ((28 | (0 << 8)) & 0xFF))
        return 2;
    if (GetSav1Weather() == 8)
        return 2;
...
static u16 GetSumOfPlayerPartyLevel(u8 numMons)
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        if (species != 898 + 308 + 1 && species != 0 && GetMonData(&gPlayerParty[i], 57) != 0)
        {
...
u8 GetTrainerBattleTransition(void)
{
    ...
    if (gTrainers[gTrainerBattleOpponent_A].doubleBattle == 1)
        minPartyCount = 2;
    else
        minPartyCount = 1;
...
u8 GetSpecialBattleTransition(s32 id)
{
    ...
    if (enemyLevel < playerLevel)
    {
        ...
        case 13:
            return 4;
        case 10:
            return sBattleTransitionTable_BattlePyramid[Random() % (size_t)(sizeof(sBattleTransitionTable_BattlePyramid) / sizeof((sBattleTransitionTable_BattlePyramid)[0]))];
        case 3:
            return sBattleTransitionTable_BattleDome[Random() % (size_t)(sizeof(sBattleTransitionTable_BattleDome) / sizeof((sBattleTransitionTable_BattleDome)[0]))];
        }

        if (VarGet(0x40CE) != 3)
            return sBattleTransitionTable_BattleFrontier[Random() % (size_t)(sizeof(sBattleTransitionTable_BattleFrontier) / sizeof((sBattleTransitionTable_BattleFrontier)[0]))];
    }
    else
    {
        switch (id)
    ...
    return sBattleTransitionTable_BattleFrontier[var % (size_t)(sizeof(sBattleTransitionTable_BattleFrontier) / sizeof((sBattleTransitionTable_BattleFrontier)[0]))];
}
...
static void InitTrainerBattleVariables(void)
{
    ...
    {
        sTrainerAIntroSpeech = ((void *)0);
        sTrainerADefeatSpeech = ((void *)0);
        sTrainerABattleScriptRetAddr = ((void *)0);
    }
    else
    {
        sTrainerBIntroSpeech = ((void *)0);
        sTrainerBDefeatSpeech = ((void *)0);
        sTrainerBBattleScriptRetAddr = ((void *)0);
    }
    sTrainerObjectEventLocalId = 0;
    sTrainerVictorySpeech = ((void *)0);
    sTrainerCannotBattleSpeech = ((void *)0);
    sTrainerBattleEndScript = ((void *)0);
}
...
const u8 *BattleSetup_ConfigureTrainerBattle(const u8 *data)
{
    if (TrainerBattleLoadArg8(data) != 11)
...
const u8 *BattleSetup_GetScriptAddrAfterBattle(void)
{
    if (sTrainerBattleEndScript != ((void *)0))
        return sTrainerBattleEndScript;
    else
...
const u8 *BattleSetup_GetTrainerPostBattleScript(void)
{
    ...
    {
        sShouldCheckTrainerBScript = 0;
        if (sTrainerBBattleScriptRetAddr != ((void *)0))
        {
    ...
    {
        if (sTrainerABattleScriptRetAddr != ((void *)0))
        {
            gWhichTrainerToFaceAfterBattle = 0;
...
void UpdateRematchIfDefeated(s32 rematchTableId)
{
    if (HasTrainerBeenFought(gRematchTable[rematchTableId].trainerIds[0]) == 1)
...
void TryUpdateRandomTrainerRematches(u16 mapGroup, u16 mapNum)
{
    if (IsRematchStepCounterMaxed() && UpdateRandomTrainerRematches(gRematchTable, mapGroup, mapNum) == 1)
...
u16 CountBattledRematchTeams(u16 trainerId)
{
    ...
    if (HasTrainerBeenFought(gRematchTable[trainerId].trainerIds[0]) != 1)
        return 0;
