# 0 "src/coord_event_weather.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/coord_event_weather.c"
...
{
    { 1, CoordEventWeather_Clouds },
    { 2, CoordEventWeather_Sunny },
    { 3, CoordEventWeather_Rain },
    { 4, CoordEventWeather_Snow },
    { 5, CoordEventWeather_Thunderstorm },
    { 6, CoordEventWeather_HorizontalFog },
    { 7, CoordEventWeather_DiagonalFog },
    { 8, CoordEventWeather_Ash },
    { 9, CoordEventWeather_Sandstorm },
    { 10, CoordEventWeather_Shade },
    { 11, CoordEventWeather_Drought },
    { 20, CoordEventWeather_Route119Cycle },
    { 21, CoordEventWeather_Route123Cycle },
};
...
{
    u8 i;
    for (i = 0; i < (size_t)(sizeof(sCoordEventWeatherFuncs) / sizeof((sCoordEventWeatherFuncs)[0])); i++)
    {
