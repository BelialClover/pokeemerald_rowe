...
# 18 "src/day_night.c" 2
# 1 "include/constants/day_night.h" 1
# 19 "src/day_night.c" 2
# 1 "include/constants/rgb.h" 1
# 20 "src/day_night.c" 2





__attribute__((section("ewram_data"))) u16 gPlttBufferPreDN[0x200] = {0};
static __attribute__((section("ewram_data"))) s8 sOldHour = 0;
static __attribute__((section("ewram_data"))) bool8 sRetintPhase = 0;
__attribute__((section("ewram_data"))) struct PaletteOverride *gPaletteOverrides[4] = {((void *)0)};

static const u16 sTimeOfDayTints[][3] = {
    {((s16)((0.6) * 256)), ((s16)((0.55) * 256)), ((s16)((1.0) * 256))},
    {((s16)((0.6) * 256)), ((s16)((0.55) * 256)), ((s16)((1.0) * 256))},
    {((s16)((0.6) * 256)), ((s16)((0.55) * 256)), ((s16)((1.0) * 256))},
    {((s16)((0.6) * 256)), ((s16)((0.55) * 256)), ((s16)((1.0) * 256))},
    {((s16)((0.6) * 256)), ((s16)((0.6) * 256)), ((s16)((1.0) * 256))},
    {((s16)((0.8) * 256)), ((s16)((0.7) * 256)), ((s16)((0.9) * 256))},
    {((s16)((0.8) * 256)), ((s16)((0.7) * 256)), ((s16)((0.9) * 256))},
    {((s16)((0.8) * 256)), ((s16)((0.7) * 256)), ((s16)((0.9) * 256))},
    {((s16)((0.9) * 256)), ((s16)((0.8) * 256)), ((s16)((1.0) * 256))},
    {((s16)((1.0) * 256)), ((s16)((0.9) * 256)), ((s16)((1.0) * 256))},
    {((s16)((1.0) * 256)), ((s16)((1.0) * 256)), ((s16)((1.0) * 256))},
    {((s16)((1.0) * 256)), ((s16)((1.0) * 256)), ((s16)((1.0) * 256))},
    {((s16)((1.0) * 256)), ((s16)((1.0) * 256)), ((s16)((1.0) * 256))},
    {((s16)((1.0) * 256)), ((s16)((1.0) * 256)), ((s16)((1.0) * 256))},
    {((s16)((1.0) * 256)), ((s16)((1.0) * 256)), ((s16)((1.0) * 256))},
    {((s16)((1.0) * 256)), ((s16)((1.0) * 256)), ((s16)((1.0) * 256))},
    {((s16)((1.0) * 256)), ((s16)((1.0) * 256)), ((s16)((1.0) * 256))},
    {((s16)((1.0) * 256)), ((s16)((0.9) * 256)), ((s16)((0.8) * 256))},
    {((s16)((0.9) * 256)), ((s16)((0.6) * 256)), ((s16)((0.67) * 256))},
    {((s16)((0.7) * 256)), ((s16)((0.6) * 256)), ((s16)((0.9) * 256))},
    {((s16)((0.6) * 256)), ((s16)((0.55) * 256)), ((s16)((1.0) * 256))},
    {((s16)((0.6) * 256)), ((s16)((0.55) * 256)), ((s16)((1.0) * 256))},
    {((s16)((0.6) * 256)), ((s16)((0.55) * 256)), ((s16)((1.0) * 256))},
    {((s16)((0.6) * 256)), ((s16)((0.55) * 256)), ((s16)((1.0) * 256))},
...
static void LoadPaletteOverrides(void)
{
    ...
    for (i = 0; i < (size_t)(sizeof(gPaletteOverrides) / sizeof((gPaletteOverrides)[0])); i++)
    {
        const struct PaletteOverride *curr = gPaletteOverrides[i];
        if (curr != ((void *)0))
        {
            while (curr->slot != 0xFF && curr->palette != ((void *)0))
            {
...
static void TintPaletteForDayNight(u16 offset, u16 size)
{
    if (ShouldTintOverworld())
    {
        ...
        TintPalette_CustomToneWithCopy(gPlttBufferPreDN + offset, gPlttBufferUnfaded + offset, size / 2, sTimeOfDayTints[hour][0], sTimeOfDayTints[hour][1], sTimeOfDayTints[hour][2], 0);
    }
    else
    {
        CpuSet(gPlttBufferPreDN + offset, gPlttBufferUnfaded + offset, 0x00000000 | ((size)/(16/8) & 0x1FFFFF));
    }
...
void LoadCompressedPaletteDayNight(const void *src, u16 offset, u16 size)
{
    ...
    CpuSet(gPaletteDecompressionBuffer, gPlttBufferPreDN + offset, 0x00000000 | ((size)/(16/8) & 0x1FFFFF));
    TintPaletteForDayNight(offset, size);
    CpuSet(gPlttBufferUnfaded + offset, gPlttBufferFaded + offset, 0x00000000 | ((size)/(16/8) & 0x1FFFFF));
}

void LoadPaletteDayNight(const void *src, u16 offset, u16 size)
{
    CpuSet(src, gPlttBufferPreDN + offset, 0x00000000 | ((size)/(16/8) & 0x1FFFFF));
    TintPaletteForDayNight(offset, size);
    CpuSet(gPlttBufferUnfaded + offset, gPlttBufferFaded + offset, 0x00000000 | ((size)/(16/8) & 0x1FFFFF));
}
    ...
    if (ShouldTintOverworld())
    {
        if (!sRetintPhase)
        {
            ...
            if (hour != sOldHour)
            {
                sOldHour = hour;
                sRetintPhase = 1;
                TintPalette_CustomToneWithCopy(gPlttBufferPreDN, gPlttBufferUnfaded, 0x200 / 2, sTimeOfDayTints[hour][0], sTimeOfDayTints[hour][1], sTimeOfDayTints[hour][2], 1);
            }
        }
        else
        {
            sRetintPhase = 0;
            TintPalette_CustomToneWithCopy(gPlttBufferPreDN + (0x200 / 2), gPlttBufferUnfaded + (0x200 / 2), 0x200 / 2, sTimeOfDayTints[sOldHour][0], sTimeOfDayTints[sOldHour][1], sTimeOfDayTints[sOldHour][2], 1);
            LoadPaletteOverrides();

            if (gWeatherPtr->palProcessingState != 1 &&
                gWeatherPtr->palProcessingState != 2)
                CpuSet(gPlttBufferUnfaded, gPlttBufferFaded, 0x00000000 | ((0x400)/(16/8) & 0x1FFFFF));
