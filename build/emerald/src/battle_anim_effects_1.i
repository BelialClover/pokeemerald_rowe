...
# 10 "src/battle_anim_effects_1.c" 2
...
# 11 "src/battle_anim_effects_1.c" 2
...
# 12 "src/battle_anim_effects_1.c" 2
...
# 13 "src/battle_anim_effects_1.c" 2
# 1 "include/sound.h" 1
...
# 14 "src/battle_anim_effects_1.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 15 "src/battle_anim_effects_1.c" 2
# 1 "include/util.h" 1
...
# 16 "src/battle_anim_effects_1.c" 2
# 1 "include/constants/rgb.h" 1
# 17 "src/battle_anim_effects_1.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/battle_anim_effects_1.c" 2
# 1 "include/constants/moves.h" 1
# 19 "src/battle_anim_effects_1.c" 2

__attribute__((section("ewram_data"))) s16 gUnknown_0203A0F8[4] = {0};
...
static const union AffineAnimCmd sFeintAffineSwipe[] = { {.type = 0x7FFF} };
static const union AffineAnimCmd sFeintAffineZoom[] =
{
    {.frame = {.xScale = 0x200, .yScale = 0x200, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = -30, .yScale = -30, .rotation = 0, .duration = 10}},
    {.type = 0x7FFF},
};

static const union AffineAnimCmd sTrumpCardAffine0[] =
{
    {.frame = {.xScale = 0xC0, .yScale = 0xC0, .rotation = 30, .duration = 0}},
    {.type = 0x7FFF},
};

static const union AffineAnimCmd sTrumpCardAffine1[] =
{
    {.frame = {.xScale = 0xA0, .yScale = 0xA0, .rotation = 40, .duration = 0}},
    {.type = 0x7FFF},
};

static const union AffineAnimCmd sTrumpCardAffine2[] =
{
    {.frame = {.xScale = 0xD0, .yScale = 0xD0, .rotation = -20, .duration = 0}},
    {.type = 0x7FFF},
};

static const union AffineAnimCmd sTrumpCardAffine3[] =
{
    {.frame = {.xScale = 0xE0, .yScale = 0xE0, .rotation = 40, .duration = 0}},
    {.type = 0x7FFF},
};

static const union AffineAnimCmd sTrumpCardAffine4[] =
{
    {.frame = {.xScale = 0xF0, .yScale = 0xF0, .rotation = 60, .duration = 0}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 1, .duration = 20}},
    {.frame = {.xScale = 0, .yScale = 0, .rotation = -1, .duration = 40}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = -10, .yScale = -10, .rotation = 0, .duration = 15}},
    {.type = 0x7FFF}
};
...
static const union AffineAnimCmd sSmallCloudsVariant1[] =
{
    ...
    {.frame = {.xScale = -18, .yScale = -18, .rotation = 0, .duration = 21}},
    {.type = 0x7FFF}
};
...
static const union AffineAnimCmd sSmallCloudsVariant2[] =
{
    ...
    {.frame = {.xScale = -6, .yScale = -6, .rotation = 0, .duration = 15}},
    {.type = 0x7FFF}
};
...
const union AffineAnimCmd gMetronomeFingerAffineAnimCmds2[] =
{
    ...
    {.frame = {.xScale = 0xFFE2, .yScale = 0xFFE2, .rotation = 0, .duration = 8}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0x0, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmd1[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0x10, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmd2[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0x20, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmd3[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0x30, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmd4[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0x40, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmd5[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0x50, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmd6[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0x60, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmd7[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0x70, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmd8[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0x80, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmd9[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0x90, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmdA[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0xA0, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmdB[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0xB0, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmdC[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0xC0, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmdD[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0xD0, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmdE[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0xE0, .duration = 0}},
    {.type = 0x7FFF},
};

const union AffineAnimCmd gRockPolishStreak_AffineAnimCmdF[] =
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0xF0, .duration = 0}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {0, 4, .vFlip = 1, .hFlip = 1}},
    {.frame = {16, 4, .vFlip = 1, .hFlip = 1}},
    {.frame = {32, 4, .vFlip = 1, .hFlip = 1}},
    {.frame = {48, 4, .vFlip = 1, .hFlip = 1}},
    {.type = -1},
};
...
{
    {.frame = {.xScale = 0x0, .yScale = 0x0, .rotation = -5, .duration = 5}},
    {.jump = {.type = 0x7FFE, .target = 0}},
};
...
# 2962 "src/battle_anim_effects_1.c"
void AnimMovePowderParticle(struct Sprite* sprite)
{
    sprite->pos1.x += gBattleAnimArgs[0];
    sprite->pos1.y += gBattleAnimArgs[1];
...
static void AnimSolarbeamSmallOrb(struct Sprite* sprite)
{
    ...
    if ((gBattleTypeFlags & (1 << 0)) && gAnimMoveIndex == 650)
    {
...
# 3206 "src/battle_anim_effects_1.c"
static void AnimMoveSmallCloud(struct Sprite* sprite)
{
    InitSpritePosToAnimTarget(sprite, 1);
    sprite->data[0] = gBattleAnimArgs[3];
...
# 3242 "src/battle_anim_effects_1.c"
static void AnimPluck(struct Sprite* sprite)
{
    InitSpritePosToAnimTarget(sprite, 1);
...
static void AnimMoveWringOut(struct Sprite* sprite)
{
    ...
    sprite->data[0] = 256 / gBattleAnimArgs[2];
    sprite->data[1] = gBattleAnimArgs[3];
    sprite->data[2] = gBattleAnimArgs[4];
    sprite->data[3] = 64;
    sprite->callback = AnimMoveWringOutCircle;
}
# 3469 "src/battle_anim_effects_1.c"
...
# 3511 "src/battle_anim_effects_1.c"
void AnimSporeParticle(struct Sprite* sprite)
{
    InitSpritePosToAnimTarget(sprite, 1);
...
# 3709 "src/battle_anim_effects_1.c"
void AnimTranslateLinearSingleSineWave(struct Sprite* sprite)
{
    InitSpritePosToAnimAttacker(sprite, 1);
    if (GetBattlerSide(gBattleAnimAttacker) != 0)
...
void AnimTask_ShrinkTargetCopy(u8 taskId)
{
    ...
    else
    {
        ...
        gSprites[spriteId].oam.priority = GetBattlerSpriteBGPriority(((gBattleAnimTarget) ^ 2));
...
# 3999 "src/battle_anim_effects_1.c"
...
void AnimTask_CycleMagicalLeafPal(u8 taskId)
{
    ...
    {
    case 0:
        task->data[8] = IndexOfSpritePaletteTag((10000 + 63)) * 16 + 256;
        task->data[12] = IndexOfSpritePaletteTag((10000 + 160)) * 16 + 256;
        task->data[0]++;
        break;
    case 1:
        if (++task->data[9] >= 0)
...
static void AnimProtect(struct Sprite* sprite)
{
    ...
    sprite->data[0] = gBattleAnimArgs[2];
    sprite->data[2] = (IndexOfSpritePaletteTag((10000 + 280)) << 4) + 0x100;
    sprite->data[7] = 16;
...
static void AnimLockOnTarget_Step4(struct Sprite* sprite)
{
    ...
    BlendPalettes(sub_80A75AC(1, 1, 1, 1, 1, 0, 0), sprite->data[1], ((31) | ((31) << 5) | ((31) << 10)));
    if (sprite->data[1] == 16)
    {
        int pal;
        sprite->data[2]++;
...
static void AnimMoon(struct Sprite* sprite)
{
    ...
    sprite->oam.shape = (((3 << 2) | (0)) & 0x03);
    sprite->oam.size = ((((3 << 2) | (0)) >> 2) & 0x03);
    sprite->data[0] = 0;
...
void AnimTask_MusicNotesRainbowBlend(u8 taskId)
{
    ...
    {
        index = (index << 4) + 0x100;
        for (i = 1; i < (size_t)(sizeof(gParticlesColorBlendTable[0]) / sizeof((gParticlesColorBlendTable[0])[0])); i++)
            gPlttBufferFaded[index + i] = gParticlesColorBlendTable[0][i];
    }

    for (j = 1; j < (size_t)(sizeof(gParticlesColorBlendTable) / sizeof((gParticlesColorBlendTable)[0])); j++)
    {
...
{
    u16 i;
    for (i = 1; i < (size_t)(sizeof(gParticlesColorBlendTable) / sizeof((gParticlesColorBlendTable)[0])); i++)
...
void AnimThoughtBubble(struct Sprite* sprite)
{
    ...
    a = (GetBattlerSide(battler) == 0) ? 0 : 1;
...
static void AnimRockPolishStreak(struct Sprite *sprite)
{
    int affineAnimNum = Random2() % (size_t)(sizeof(gRockPolishStreak_AffineAnimCmds) / sizeof((gRockPolishStreak_AffineAnimCmds)[0]));
    InitSpritePosToAnimAttacker(sprite, 1);
...
{
    int paletteOffset = IndexOfSpritePaletteTag((10000 + 183)) * 16 + 256;
    BlendPalette(paletteOffset, 16, 6, ((31) | ((0) << 5) | ((0) << 10)));
    DestroyAnimVisualTask(taskId);
}
...
{
 {.frame = {.xScale = 64, .yScale = 0, .rotation = 0, .duration = 16}},
 {.frame = {.xScale = 0, .yScale = 0, .rotation = 0, .duration = 64}},
 {.frame = {.xScale = -64, .yScale = 0, .rotation = 0, .duration = 16}},
 {.type = 0x7FFF},
};
