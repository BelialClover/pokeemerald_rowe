# 0 "src/pokenav_match_call_1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/pokenav_match_call_1.c"
...
# 2 "src/pokenav_match_call_1.c" 2
...
# 3 "src/pokenav_match_call_1.c" 2
# 1 "include/data.h" 1
...
# 4 "src/pokenav_match_call_1.c" 2
...
# 5 "src/pokenav_match_call_1.c" 2
# 1 "include/gym_leader_rematch.h" 1
# 6 "src/pokenav_match_call_1.c" 2
...
# 7 "src/pokenav_match_call_1.c" 2
# 1 "include/main.h" 1
...
# 8 "src/pokenav_match_call_1.c" 2
...
# 9 "src/pokenav_match_call_1.c" 2
...
# 10 "src/pokenav_match_call_1.c" 2
# 1 "include/pokemon.h" 1
# 11 "src/pokenav_match_call_1.c" 2
...
# 12 "src/pokenav_match_call_1.c" 2
# 1 "include/sound.h" 1
...
# 13 "src/pokenav_match_call_1.c" 2
...
# 14 "src/pokenav_match_call_1.c" 2
...
# 15 "src/pokenav_match_call_1.c" 2
# 1 "include/constants/songs.h" 1
# 16 "src/pokenav_match_call_1.c" 2
...
struct Pokenav3Struct
{
    ...
    struct PokenavMatchCallEntries matchCallEntries[100 - 1];
};
...
# 1 "src/data/text/match_call_messages.h" 1
# 395 "src/data/text/match_call_messages.h"
...
{
    [REMATCH_ROSE] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallAromaLady_Rose_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallAromaLady_Rose_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallAromaLady_Rose_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallAromaLady_Rose_Intro2},
    [REMATCH_ANDRES] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallRuinManiac_Andres_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallRuinManiac_Andres_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallRuinManiac_Andres_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallRuinManiac_Andres_Intro2},
    [REMATCH_DUSTY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallRuinManiac_Dusty_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallRuinManiac_Dusty_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallRuinManiac_Dusty_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallRuinManiac_Dusty_Intro2},
    [REMATCH_LOLA] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallTuber_Lola_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallTuber_Lola_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallTuber_Lola_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallTuber_Lola_Intro2},
    [REMATCH_RICKY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallTuber_Ricky_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallTuber_Ricky_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallTuber_Ricky_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallTuber_Ricky_Intro2},
    [REMATCH_LILA_AND_ROY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallSisAndBro_LilaAndRoy_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallSisAndBro_LilaAndRoy_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallSisAndBro_LilaAndRoy_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallSisAndBro_LilaAndRoy_Intro2},
    [REMATCH_CRISTIN] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallCooltrainer_Cristin_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallCooltrainer_Cristin_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallCooltrainer_Cristin_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallCooltrainer_Cristin_Intro2},
    [REMATCH_BROOKE] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallCooltrainer_Brooke_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallCooltrainer_Brooke_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallCooltrainer_Brooke_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallCooltrainer_Brooke_Intro2},
    [REMATCH_WILTON] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallCooltrainer_Wilton_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallCooltrainer_Wilton_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallCooltrainer_Wilton_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallCooltrainer_Wilton_Intro2},
    [REMATCH_VALERIE] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallHexManiac_Valerie_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallHexManiac_Valerie_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallHexManiac_Valerie_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallHexManiac_Valerie_Intro2},
    [REMATCH_CINDY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallLady_Cindy_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallLady_Cindy_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallLady_Cindy_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallLady_Cindy_Intro2},
    [REMATCH_THALIA] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallBeauty_Thalia_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallBeauty_Thalia_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallBeauty_Thalia_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallBeauty_Thalia_Intro2},
    [REMATCH_JESSICA] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallBeauty_Jessica_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallBeauty_Jessica_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallBeauty_Jessica_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallBeauty_Jessica_Intro2},
    [REMATCH_WINSTON] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallRichBoy_Winston_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallRichBoy_Winston_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallRichBoy_Winston_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallRichBoy_Winston_Intro2},
    [REMATCH_STEVE] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallPokeManiac_Steve_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallPokeManiac_Steve_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallPokeManiac_Steve_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallPokeManiac_Steve_Intro2},
    [REMATCH_TONY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallSwimmer_Tony_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallSwimmer_Tony_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallSwimmer_Tony_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallSwimmer_Tony_Intro2},
    [REMATCH_NOB] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallBlackBelt_Nob_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallBlackBelt_Nob_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallBlackBelt_Nob_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallBlackBelt_Nob_Intro2},
    [REMATCH_KOJI] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallBlackBelt_Koji_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallBlackBelt_Koji_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallBlackBelt_Koji_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallBlackBelt_Koji_Intro2},
    [REMATCH_FERNANDO] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallGuitarist_Fernando_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallGuitarist_Fernando_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallGuitarist_Fernando_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallGuitarist_Fernando_Intro2},
    [REMATCH_DALTON] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallGuitarist_Dalton_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallGuitarist_Dalton_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallGuitarist_Dalton_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallGuitarist_Dalton_Intro2},
    [REMATCH_BERNIE] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallKindler_Bernie_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallKindler_Bernie_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallKindler_Bernie_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallKindler_Bernie_Intro2},
    [REMATCH_ETHAN] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallCamper_Ethan_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallCamper_Ethan_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallCamper_Ethan_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallCamper_Ethan_Intro2},
    [REMATCH_JOHN_AND_JAY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallOldCouple_JohnAndJay_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallOldCouple_JohnAndJay_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallOldCouple_JohnAndJay_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallOldCouple_JohnAndJay_Intro2},
    [REMATCH_JEFFREY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallBugManiac_Jeffrey_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallBugManiac_Jeffrey_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallBugManiac_Jeffrey_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallBugManiac_Jeffrey_Intro2},
    [REMATCH_CAMERON] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallPsychic_Cameron_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallPsychic_Cameron_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallPsychic_Cameron_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallPsychic_Cameron_Intro2},
    [REMATCH_JACKI] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallPsychic_Jacki_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallPsychic_Jacki_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallPsychic_Jacki_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallPsychic_Jacki_Intro2},
    [REMATCH_WALTER] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallGentleman_Walter_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallGentleman_Walter_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallGentleman_Walter_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallGentleman_Walter_Intro2},
    [REMATCH_KAREN] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallSchoolKid_Karen_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallSchoolKid_Karen_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallSchoolKid_Karen_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallSchoolKid_Karen_Intro2},
    [REMATCH_JERRY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallSchoolKid_Jerry_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallSchoolKid_Jerry_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallSchoolKid_Jerry_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallSchoolKid_Jerry_Intro2},
    [REMATCH_ANNA_AND_MEG] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallSrAndJr_AnnaAndMeg_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallSrAndJr_AnnaAndMeg_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallSrAndJr_AnnaAndMeg_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallSrAndJr_AnnaAndMeg_Intro2},
    [REMATCH_ISABEL] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallPokefan_Isabel_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallPokefan_Isabel_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallPokefan_Isabel_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallPokefan_Isabel_Intro2},
    [REMATCH_MIGUEL] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallPokefan_Miguel_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallPokefan_Miguel_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallPokefan_Miguel_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallPokefan_Miguel_Intro2},
    [REMATCH_TIMOTHY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallExpert_Timothy_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallExpert_Timothy_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallExpert_Timothy_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallExpert_Timothy_Intro2},
    [REMATCH_SHELBY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallExpert_Shelby_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallExpert_Shelby_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallExpert_Shelby_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallExpert_Shelby_Intro2},
    [REMATCH_CALVIN] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallYoungster_Calvin_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallYoungster_Calvin_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallYoungster_Calvin_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallYoungster_Calvin_Intro2},
    [REMATCH_ELLIOT] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallFisherman_Elliot_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallFisherman_Elliot_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallFisherman_Elliot_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallFisherman_Elliot_Intro2},
    [REMATCH_ISAIAH] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallTriathlete_Isaiah_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallTriathlete_Isaiah_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallTriathlete_Isaiah_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallTriathlete_Isaiah_Intro2},
    [REMATCH_MARIA] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallTriathlete_Maria_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallTriathlete_Maria_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallTriathlete_Maria_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallTriathlete_Maria_Intro2},
    [REMATCH_ABIGAIL] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallTriathlete_Abigail_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallTriathlete_Abigail_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallTriathlete_Abigail_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallTriathlete_Abigail_Intro2},
    [REMATCH_DYLAN] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallTriathlete_Dylan_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallTriathlete_Dylan_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallTriathlete_Dylan_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallTriathlete_Dylan_Intro2},
    [REMATCH_KATELYN] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallTriathlete_Katelyn_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallTriathlete_Katelyn_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallTriathlete_Katelyn_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallTriathlete_Katelyn_Intro2},
    [REMATCH_BENJAMIN] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallTriathlete_Benjamin_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallTriathlete_Benjamin_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallTriathlete_Benjamin_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallTriathlete_Benjamin_Intro2},
    [REMATCH_PABLO] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallTriathlete_Pablo_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallTriathlete_Pablo_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallTriathlete_Pablo_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallTriathlete_Pablo_Intro2},
    [REMATCH_NICOLAS] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallDragonTamer_Nicolas_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallDragonTamer_Nicolas_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallDragonTamer_Nicolas_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallDragonTamer_Nicolas_Intro2},
    [REMATCH_ROBERT] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallBirdKeeper_Robert_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallBirdKeeper_Robert_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallBirdKeeper_Robert_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallBirdKeeper_Robert_Intro2},
    [REMATCH_LAO] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallNinjaBoy_Lao_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallNinjaBoy_Lao_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallNinjaBoy_Lao_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallNinjaBoy_Lao_Intro2},
    [REMATCH_CYNDY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallBattleGirl_Cyndy_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallBattleGirl_Cyndy_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallBattleGirl_Cyndy_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallBattleGirl_Cyndy_Intro2},
    [REMATCH_MADELINE] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallParasolLady_Madeline_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallParasolLady_Madeline_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallParasolLady_Madeline_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallParasolLady_Madeline_Intro2},
    [REMATCH_JENNY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallSwimmer_Jenny_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallSwimmer_Jenny_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallSwimmer_Jenny_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallSwimmer_Jenny_Intro2},
    [REMATCH_DIANA] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallPicnicker_Diana_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallPicnicker_Diana_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallPicnicker_Diana_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallPicnicker_Diana_Intro2},
    [REMATCH_AMY_AND_LIV] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallTwins_AmyAndLiv_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallTwins_AmyAndLiv_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallTwins_AmyAndLiv_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallTwins_AmyAndLiv_Intro2},
    [REMATCH_ERNEST] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallSailor_Ernest_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallSailor_Ernest_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallSailor_Ernest_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallSailor_Ernest_Intro2},
    [REMATCH_CORY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallSailor_Cory_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallSailor_Cory_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallSailor_Cory_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallSailor_Cory_Intro2},
    [REMATCH_EDWIN] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallCollector_Edwin_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallCollector_Edwin_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallCollector_Edwin_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallCollector_Edwin_Intro2},
    [REMATCH_LYDIA] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallPkmnBreeder_Lydia_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallPkmnBreeder_Lydia_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallPkmnBreeder_Lydia_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallPkmnBreeder_Lydia_Intro2},
    [REMATCH_ISAAC] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallPkmnBreeder_Isaac_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallPkmnBreeder_Isaac_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallPkmnBreeder_Isaac_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallPkmnBreeder_Isaac_Intro2},
    [REMATCH_GABRIELLE] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallPkmnBreeder_Gabrielle_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallPkmnBreeder_Gabrielle_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallPkmnBreeder_Gabrielle_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallPkmnBreeder_Gabrielle_Intro2},
    [REMATCH_CATHERINE] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallPkmnRanger_Catherine_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallPkmnRanger_Catherine_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallPkmnRanger_Catherine_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallPkmnRanger_Catherine_Intro2},
    [REMATCH_JACKSON] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallPkmnRanger_Jackson_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallPkmnRanger_Jackson_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallPkmnRanger_Jackson_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallPkmnRanger_Jackson_Intro2},
    [REMATCH_HALEY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallLass_Haley_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallLass_Haley_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallLass_Haley_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallLass_Haley_Intro2},
    [REMATCH_JAMES] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallBugCatcher_James_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallBugCatcher_James_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallBugCatcher_James_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallBugCatcher_James_Intro2},
    [REMATCH_TRENT] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallHiker_Trent_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallHiker_Trent_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallHiker_Trent_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallHiker_Trent_Intro2},
    [REMATCH_SAWYER] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallHiker_Sawyer_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallHiker_Sawyer_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallHiker_Sawyer_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallHiker_Sawyer_Intro2},
    [REMATCH_KIRA_AND_DAN] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallYoungCouple_LoisAndHal_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallYoungCouple_LoisAndHal_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallYoungCouple_LoisAndHal_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallYoungCouple_LoisAndHal_Intro2},
    [REMATCH_WALLY_3] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallPkmnTrainer_Wally_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallPkmnTrainer_Wally_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallPkmnTrainer_Wally_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallPkmnTrainer_Wally_Intro2},
    [REMATCH_ROXANNE] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallRockinWhiz_Roxanne_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallRockinWhiz_Roxanne_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallRockinWhiz_Roxanne_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallRockinWhiz_Roxanne_Intro2},
    [REMATCH_BRAWLY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallTheBigHit_Brawly_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallTheBigHit_Brawly_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallTheBigHit_Brawly_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallTheBigHit_Brawly_Intro2},
    [REMATCH_WATTSON] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallSwellShock_Wattson_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallSwellShock_Wattson_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallSwellShock_Wattson_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallSwellShock_Wattson_Intro2},
    [REMATCH_FLANNERY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallPassionBurn_Flannery_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallPassionBurn_Flannery_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallPassionBurn_Flannery_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallPassionBurn_Flannery_Intro2},
    [REMATCH_NORMAN] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallReliableOne_Dad_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallReliableOne_Dad_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallReliableOne_Dad_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallReliableOne_Dad_Intro2},
    [REMATCH_WINONA] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallSkyTamer_Winona_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallSkyTamer_Winona_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallSkyTamer_Winona_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallSkyTamer_Winona_Intro2},
    [REMATCH_TATE_AND_LIZA] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallMysticDuo_TateAndLiza_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallMysticDuo_TateAndLiza_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallMysticDuo_TateAndLiza_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallMysticDuo_TateAndLiza_Intro2},
    [REMATCH_JUAN] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallDandyCharm_Juan_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallDandyCharm_Juan_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallDandyCharm_Juan_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallDandyCharm_Juan_Intro2},
    [REMATCH_SIDNEY] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallEliteFour_Sidney_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallEliteFour_Sidney_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallEliteFour_Sidney_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallEliteFour_Sidney_Intro2},
    [REMATCH_PHOEBE] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallEliteFour_Phoebe_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallEliteFour_Phoebe_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallEliteFour_Phoebe_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallEliteFour_Phoebe_Intro2},
    [REMATCH_GLACIA] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallEliteFour_Glacia_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallEliteFour_Glacia_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallEliteFour_Glacia_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallEliteFour_Glacia_Intro2},
    [REMATCH_DRAKE] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallEliteFour_Drake_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallEliteFour_Drake_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallEliteFour_Drake_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallEliteFour_Drake_Intro2},
    [REMATCH_WALLACE] = {[CHECK_PAGE_STRATEGY] = gText_MatchCallChampion_Wallace_Strategy, [CHECK_PAGE_POKEMON] = gText_MatchCallChampion_Wallace_Pokemon, [CHECK_PAGE_INTRO_1] = gText_MatchCallChampion_Wallace_Intro1, [CHECK_PAGE_INTRO_2] = gText_MatchCallChampion_Wallace_Intro2},
};
# 40 "src/pokenav_match_call_1.c" 2
...
static u32 CB2_HandleMatchCallInput(struct Pokenav3Struct *state)
{
    ...
    if (({(gMain.newKeys) & (0x0001);}))
    {
        ...
        if (!state->matchCallEntries[selection].isSpecialTrainer || MatchCall_HasCheckPage(state->matchCallEntries[selection].headerId))
        {
            ...
            state->maxOptionId = (size_t)(sizeof(sMatchCallOptionsHasCheckPage) / sizeof((sMatchCallOptionsHasCheckPage)[0])) - 1;
        }
        else
        {
            state->matchCallOptions = sMatchCallOptionsNoCheckPage;
            state->maxOptionId = (size_t)(sizeof(sMatchCallOptionsNoCheckPage) / sizeof((sMatchCallOptionsNoCheckPage)[0])) - 1;
        }
...
{
    if ((({(gMain.newKeys) & (0x0040);})) && state->optionCursorPos)
    {
        state->optionCursorPos--;
        return POKENAV_MC_FUNC_MOVE_OPTIONS_CURSOR;
    }

    if ((({(gMain.newKeys) & (0x0080);})) && state->optionCursorPos < state->maxOptionId)
    {
        state->optionCursorPos++;
        return POKENAV_MC_FUNC_MOVE_OPTIONS_CURSOR;
    }
    ...
    case 1:
        for (i = 0, j = state->headerId; i < 30; i++, j++)
        {
            if (MatchCall_GetEnabled(j))
            {
                ...
                state->matchCallEntries[state->numRegistered].isSpecialTrainer = 1;
    ...
    case 2:
        for (i = 0, j = state->headerId; i < 30; i++, j++)
        {
            if (!MatchCall_HasRematchId(state->headerId) && IsRematchEntryRegistered(state->headerId))
            {
                ...
                state->matchCallEntries[state->numRegistered].isSpecialTrainer = 0;
