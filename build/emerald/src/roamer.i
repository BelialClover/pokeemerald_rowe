...
__attribute__((section("ewram_data"))) static u8 sLocationHistory[3][2] = {0};
__attribute__((section("ewram_data"))) static u8 sRoamerLocation[2] = {0};

static const u8 sRoamerLocations[][6] =
{
    { ((25 | (0 << 8)) & 0xFF), ((26 | (0 << 8)) & 0xFF), ((32 | (0 << 8)) & 0xFF), ((33 | (0 << 8)) & 0xFF), ((49 | (0 << 8)) & 0xFF), 0xFF },
    { ((26 | (0 << 8)) & 0xFF), ((25 | (0 << 8)) & 0xFF), ((32 | (0 << 8)) & 0xFF), ((33 | (0 << 8)) & 0xFF), 0xFF, 0xFF },
    { ((32 | (0 << 8)) & 0xFF), ((26 | (0 << 8)) & 0xFF), ((25 | (0 << 8)) & 0xFF), ((33 | (0 << 8)) & 0xFF), 0xFF, 0xFF },
    { ((33 | (0 << 8)) & 0xFF), ((32 | (0 << 8)) & 0xFF), ((25 | (0 << 8)) & 0xFF), ((26 | (0 << 8)) & 0xFF), ((34 | (0 << 8)) & 0xFF), ((38 | (0 << 8)) & 0xFF) },
    { ((34 | (0 << 8)) & 0xFF), ((33 | (0 << 8)) & 0xFF), ((35 | (0 << 8)) & 0xFF), 0xFF, 0xFF, 0xFF },
    { ((35 | (0 << 8)) & 0xFF), ((34 | (0 << 8)) & 0xFF), ((36 | (0 << 8)) & 0xFF), 0xFF, 0xFF, 0xFF },
    { ((36 | (0 << 8)) & 0xFF), ((35 | (0 << 8)) & 0xFF), ((37 | (0 << 8)) & 0xFF), ((38 | (0 << 8)) & 0xFF), 0xFF, 0xFF },
    { ((37 | (0 << 8)) & 0xFF), ((36 | (0 << 8)) & 0xFF), ((38 | (0 << 8)) & 0xFF), 0xFF, 0xFF, 0xFF },
    { ((38 | (0 << 8)) & 0xFF), ((37 | (0 << 8)) & 0xFF), ((33 | (0 << 8)) & 0xFF), 0xFF, 0xFF, 0xFF },
    { ((39 | (0 << 8)) & 0xFF), ((36 | (0 << 8)) & 0xFF), ((40 | (0 << 8)) & 0xFF), ((41 | (0 << 8)) & 0xFF), 0xFF, 0xFF },
    { ((40 | (0 << 8)) & 0xFF), ((39 | (0 << 8)) & 0xFF), ((42 | (0 << 8)) & 0xFF), 0xFF, 0xFF, 0xFF },
    { ((41 | (0 << 8)) & 0xFF), ((39 | (0 << 8)) & 0xFF), ((42 | (0 << 8)) & 0xFF), 0xFF, 0xFF, 0xFF },
    { ((42 | (0 << 8)) & 0xFF), ((40 | (0 << 8)) & 0xFF), ((41 | (0 << 8)) & 0xFF), ((43 | (0 << 8)) & 0xFF), 0xFF, 0xFF },
    { ((43 | (0 << 8)) & 0xFF), ((42 | (0 << 8)) & 0xFF), ((44 | (0 << 8)) & 0xFF), 0xFF, 0xFF, 0xFF },
    { ((44 | (0 << 8)) & 0xFF), ((43 | (0 << 8)) & 0xFF), ((45 | (0 << 8)) & 0xFF), 0xFF, 0xFF, 0xFF },
    { ((45 | (0 << 8)) & 0xFF), ((44 | (0 << 8)) & 0xFF), ((46 | (0 << 8)) & 0xFF), 0xFF, 0xFF, 0xFF },
    { ((46 | (0 << 8)) & 0xFF), ((45 | (0 << 8)) & 0xFF), ((47 | (0 << 8)) & 0xFF), 0xFF, 0xFF, 0xFF },
    { ((47 | (0 << 8)) & 0xFF), ((46 | (0 << 8)) & 0xFF), ((48 | (0 << 8)) & 0xFF), 0xFF, 0xFF, 0xFF },
    { ((48 | (0 << 8)) & 0xFF), ((47 | (0 << 8)) & 0xFF), ((49 | (0 << 8)) & 0xFF), 0xFF, 0xFF, 0xFF },
    { ((49 | (0 << 8)) & 0xFF), ((48 | (0 << 8)) & 0xFF), ((25 | (0 << 8)) & 0xFF), 0xFF, 0xFF, 0xFF },
...
void ClearRoamerData(void)
{
    ...
    (&gSaveBlock1Ptr->roamer)->species = 489;
}
...
static void CreateInitialRoamerMon(bool16 createLatios)
{
    ...
    CreateMon(&gEnemyParty[0], (&gSaveBlock1Ptr->roamer)->species, 40, 0x20, 0, 0, 0, 0, 0);
    (&gSaveBlock1Ptr->roamer)->level = 20;
    (&gSaveBlock1Ptr->roamer)->status = 0;
    (&gSaveBlock1Ptr->roamer)->active = 1;
    (&gSaveBlock1Ptr->roamer)->ivs = GetMonData(&gEnemyParty[0], 66);
    (&gSaveBlock1Ptr->roamer)->personality = GetMonData(&gEnemyParty[0], 0);
    (&gSaveBlock1Ptr->roamer)->hp = GetMonData(&gEnemyParty[0], 58);
    (&gSaveBlock1Ptr->roamer)->cool = GetMonData(&gEnemyParty[0], 22);
    (&gSaveBlock1Ptr->roamer)->beauty = GetMonData(&gEnemyParty[0], 23);
    (&gSaveBlock1Ptr->roamer)->cute = GetMonData(&gEnemyParty[0], 24);
    (&gSaveBlock1Ptr->roamer)->smart = GetMonData(&gEnemyParty[0], 33);
    (&gSaveBlock1Ptr->roamer)->tough = GetMonData(&gEnemyParty[0], 47);
    sRoamerLocation[MAP_GRP] = 0;
    sRoamerLocation[MAP_NUM] = sRoamerLocations[Random() % ((size_t)(sizeof(sRoamerLocations) / sizeof((sRoamerLocations)[0])) - 1)][0];
}
...
void RoamerMoveToOtherLocationSet(void)
{
    ...
    while (1)
    {
        mapNum = sRoamerLocations[Random() % ((size_t)(sizeof(sRoamerLocations) / sizeof((sRoamerLocations)[0])) - 1)][0];
...
void RoamerMove(void)
{
    ...
    else
    {
        ...
        while (locSet < ((size_t)(sizeof(sRoamerLocations) / sizeof((sRoamerLocations)[0])) - 1))
        {
...
void CreateRoamerMonInstance(void)
{
    ...
    SetMonData(mon, 55, &gSaveBlock1Ptr->roamer.status);
    SetMonData(mon, 57, &gSaveBlock1Ptr->roamer.hp);
    SetMonData(mon, 22, &gSaveBlock1Ptr->roamer.cool);
    SetMonData(mon, 23, &gSaveBlock1Ptr->roamer.beauty);
    SetMonData(mon, 24, &gSaveBlock1Ptr->roamer.cute);
    SetMonData(mon, 33, &gSaveBlock1Ptr->roamer.smart);
    SetMonData(mon, 47, &gSaveBlock1Ptr->roamer.tough);
}

bool8 TryStartRoamerEncounter(void)
{
    if (IsRoamerAt(gSaveBlock1Ptr->location.mapGroup, gSaveBlock1Ptr->location.mapNum) == 1 && (Random() % 4) == 0)
    {
...
void UpdateRoamerHPStatus(struct Pokemon *mon)
{
    (&gSaveBlock1Ptr->roamer)->hp = GetMonData(mon, 57);
    (&gSaveBlock1Ptr->roamer)->status = GetMonData(mon, 55);
