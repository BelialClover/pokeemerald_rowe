# 0 "src/battle_anim_fight.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_anim_fight.c"
...
# 5 "src/battle_anim_fight.c" 2
# 1 "include/task.h" 1
# 6 "src/battle_anim_fight.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 7 "src/battle_anim_fight.c" 2
# 1 "include/constants/rgb.h" 1
# 8 "src/battle_anim_fight.c" 2
...
static const union AffineAnimCmd sAffineAnim_SpinningHandOrFoot[] =
{
    ...
    {.frame = {.xScale = 0xFFF8, .yScale = 0xFFF8, .rotation = 20, .duration = 1}},
...
{
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0xFFFC, .yScale = 0xFFFC, .rotation = 20, .duration = 1}},
    {.jump = {.type = 0x7FFE, .target = 1}},
};
...
static const union AffineAnimCmd sAffineAnim_SuperpowerOrb[] =
{
    ...
    {.frame = {.xScale = 0x4, .yScale = 0x4, .rotation = 0, .duration = 64}},
    {.frame = {.xScale = 0xFFFA, .yScale = 0xFFFA, .rotation = 0, .duration = 8}},
    {.frame = {.xScale = 0x6, .yScale = 0x6, .rotation = 0, .duration = 8}},
...
{
    {.frame = {0, 6, .vFlip = 1, .hFlip = 1}},
    {.frame = {64, 6, .vFlip = 1, .hFlip = 1}},
    {.type = -1},
};
...
static const union AffineAnimCmd sAffineAnim_FocusPunchFist[] =
{
    ...
    {.frame = {.xScale = 0xFFE0, .yScale = 0xFFE0, .rotation = 0, .duration = 8}},
    {.type = 0x7FFF},
};
