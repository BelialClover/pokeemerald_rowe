# 0 "src/battle_anim_psychic.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_anim_psychic.c"
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 8 "src/battle_anim_psychic.c" 2
# 1 "include/constants/rgb.h" 1
# 9 "src/battle_anim_psychic.c" 2
# 1 "include/constants/songs.h" 1
# 10 "src/battle_anim_psychic.c" 2
...
static const union AffineAnimCmd sAffineAnim_PsychUpSpiral[] =
{
    ...
    {.frame = {.xScale = 0xFFFE, .yScale = 0xFFFE, .rotation = -10, .duration = 120}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 4, .duration = 4}},
...
static const union AffineAnimCmd sAffineAnim_MeditateStretchAttacker[] =
{
    ...
    {.frame = {.xScale = 18, .yScale = -18, .rotation = 0, .duration = 16}},
    {.frame = {.xScale = -20, .yScale = 16, .rotation = 0, .duration = 8}},
    {.type = 0x7FFF},
};

static const union AffineAnimCmd sAffineAnim_Teleport[] =
{
    {.frame = {.xScale = 64, .yScale = -4, .rotation = 0, .duration = 20}},
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 0, .duration = -56}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 0xFFF8, .yScale = 0xFFF8, .rotation = 0, .duration = 8}},
    {.frame = {.xScale = 0x8, .yScale = 0x8, .rotation = 0, .duration = 8}},
    {.jump = {.type = 0x7FFE, .target = 0}},
};

static const union AffineAnimCmd sAffineAnim_SkillSwapOrb_1[] =
{
    {.frame = {.xScale = 0xF0, .yScale = 0xF0, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0xFFF8, .yScale = 0xFFF8, .rotation = 0, .duration = 6}},
    {.frame = {.xScale = 0x8, .yScale = 0x8, .rotation = 0, .duration = 8}},
    {.frame = {.xScale = 0xFFF8, .yScale = 0xFFF8, .rotation = 0, .duration = 2}},
    {.jump = {.type = 0x7FFE, .target = 1}},
};

static const union AffineAnimCmd sAffineAnim_SkillSwapOrb_2[] =
{
    {.frame = {.xScale = 0xD0, .yScale = 0xD0, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0xFFF8, .yScale = 0xFFF8, .rotation = 0, .duration = 4}},
    {.frame = {.xScale = 0x8, .yScale = 0x8, .rotation = 0, .duration = 8}},
    {.frame = {.xScale = 0xFFF8, .yScale = 0xFFF8, .rotation = 0, .duration = 4}},
    {.jump = {.type = 0x7FFE, .target = 1}},
};
...
{
    {.frame = {.xScale = 0xB0, .yScale = 0xB0, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0xFFF8, .yScale = 0xFFF8, .rotation = 0, .duration = 2}},
    {.frame = {.xScale = 0x8, .yScale = 0x8, .rotation = 0, .duration = 8}},
    {.frame = {.xScale = 0xFFF8, .yScale = 0xFFF8, .rotation = 0, .duration = 6}},
    {.jump = {.type = 0x7FFE, .target = 1}},
...
static const union AffineAnimCmd sAffineAnim_LusterPurgeCircle[] =
{
    ...
    {.frame = {.xScale = 0x4, .yScale = 0x4, .rotation = 0, .duration = 120}},
...
{
    {.frame = {.xScale = 0x20, .yScale = 0x20, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0x10, .yScale = 0x10, .rotation = 0, .duration = 17}},
    {.loop = {.type = 0x7FFD, .count = 0}},
    {.frame = {.xScale = 0xFFF8, .yScale = 0xFFF8, .rotation = 0, .duration = 10}},
    {.frame = {.xScale = 0x8, .yScale = 0x8, .rotation = 0, .duration = 10}},
    {.loop = {.type = 0x7FFD, .count = 4}},
    {.loop = {.type = 0x7FFD, .count = 0}},
    {.frame = {.xScale = 0xFFF0, .yScale = 0xFFF0, .rotation = 0, .duration = 5}},
    {.frame = {.xScale = 0x10, .yScale = 0x10, .rotation = 0, .duration = 5}},
...
{
    {.frame = {.xScale = 0xFFEC, .yScale = 0x18, .rotation = 0, .duration = 15}},
    {.type = 0x7FFF},
};
...
const union AffineAnimCmd gZenHeadbuttAffineAnimCmd[] =
{
    ...
    {.frame = {.xScale = 0x8, .yScale = 0x8, .rotation = 0, .duration = 18}},
    {.loop = {.type = 0x7FFD, .count = 0}},
    {.frame = {.xScale = 0xFFFB, .yScale = 0xFFFB, .rotation = 0, .duration = 8}},
    {.frame = {.xScale = 0x5, .yScale = 0x5, .rotation = 0, .duration = 8}},
    {.loop = {.type = 0x7FFD, .count = 5}},
    {.type = 0x7FFF},
};
...
static void AnimPsychoCut(struct Sprite *sprite)
{
    ...
    {
        if (GetBattlerPosition(gBattleAnimTarget) == 0
         || GetBattlerPosition(gBattleAnimTarget) == 1)
        {
            s16 temp1, temp2;
...
static void AnimDefensiveWall(struct Sprite *sprite)
{
    ...
    {
        u8 battlerCopy;
        u8 battler = battlerCopy = GetBattlerAtPosition(1);
        u8 rank = GetBattlerSpriteBGPriorityRank(battler);
        int var0 = 1;
        u8 toBG_2 = (rank ^ var0) != 0;

        if (IsBattlerSpriteVisible(battler))
            MoveBattlerSpriteToBG(battler, toBG_2, 0);

        battler = ((battlerCopy) ^ 2);
        if (IsBattlerSpriteVisible(battler))
            MoveBattlerSpriteToBG(battler, toBG_2 ^ var0, 0);
    }
...
{
    u8 battler = GetBattlerAtPosition(1);
    if (!sprite->data[7])
    {
        sprite->data[7] = 1;
        return;
...
{
    SetGpuReg(0x52, (((16 - sprite->data[3]) << 8) | (sprite->data[3])));
    if (sprite->data[3] == 13)
...
static void AnimWallSparkle(struct Sprite *sprite)
{
    if (sprite->data[0] == 0)
    {
        ...
        bool8 respectMonPicOffsets = 0;
        if (arg3 == 0)
            respectMonPicOffsets = 1;
