...
# 1 "include/constants/mevent.h" 1
# 60 "src/field_specials.c" 2
# 1 "include/constants/tv.h" 1
# 61 "src/field_specials.c" 2
# 1 "include/constants/script_menu.h" 1
# 62 "src/field_specials.c" 2
# 1 "include/constants/slot_machine.h" 1
# 63 "src/field_specials.c" 2
# 1 "include/constants/songs.h" 1
# 64 "src/field_specials.c" 2
# 1 "include/constants/moves.h" 1
# 65 "src/field_specials.c" 2
# 1 "include/constants/party_menu.h" 1
# 66 "src/field_specials.c" 2

# 1 "include/constants/weather.h" 1
# 68 "src/field_specials.c" 2
...
# 71 "src/field_specials.c" 2

__attribute__((section("ewram_data"))) bool8 gBikeCyclingChallenge = 0;
__attribute__((section("ewram_data"))) u8 gBikeCollisions = 0;
static __attribute__((section("ewram_data"))) u32 sBikeCyclingTimer = 0;
static __attribute__((section("ewram_data"))) u8 sSlidingDoorNextFrameCounter = 0;
static __attribute__((section("ewram_data"))) u8 sSlidingDoorFrame = 0;
static __attribute__((section("ewram_data"))) u8 sTutorMoveAndElevatorWindowId = 0;
static __attribute__((section("ewram_data"))) u16 sLilycoveDeptStore_NeverRead = 0;
static __attribute__((section("ewram_data"))) u16 sLilycoveDeptStore_DefaultFloorChoice = 0;
static __attribute__((section("ewram_data"))) struct ListMenuItem *sScrollableMultichoice_ListMenuItem = ((void *)0);
static __attribute__((section("ewram_data"))) u16 sScrollableMultichoice_ScrollOffset = 0;
static __attribute__((section("ewram_data"))) u16 sFrontierExchangeCorner_NeverRead = 0;
static __attribute__((section("ewram_data"))) u8 sScrollableMultichoice_ItemSpriteId = 0;
static __attribute__((section("ewram_data"))) u8 sBattlePointsWindowId = 0;
static __attribute__((section("ewram_data"))) u8 sFrontierExchangeCorner_ItemIconWindowId = 0;
static __attribute__((section("ewram_data"))) u8 sPCBoxToSendMon = 0;
static __attribute__((section("ewram_data"))) u32 sBattleTowerMultiBattleTypeFlags = 0;
...
bool32 CountSSTidalStep(u16 delta)
{
    if (!FlagGet((((0x500 + 864 - 1) + 1) + 0x2D)) || (*GetVarPointer(0x404A) += delta) < 205)
    {
        return 0;
    }
    return 1;
...
static void Task_PetalburgGymSlideOpenRoomDoors(u8 taskId)
{
    if (sSlidingDoorNextFrameDelay[sSlidingDoorFrame] == sSlidingDoorNextFrameCounter)
    {
        ...
        sSlidingDoorNextFrameCounter = 0;
        if ((++sSlidingDoorFrame) == (size_t)(sizeof(sPetalburgGymSlidingDoorMetatiles) / sizeof((sPetalburgGymSlidingDoorMetatiles)[0])))
        {
            DestroyTask(taskId);
...
void IsGrassTypeInParty(void)
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        if (GetMonData(pokemon, 5) && !GetMonData(pokemon, 45))
        {
            ...
            if (gBaseStats[species].type1 == 12 || gBaseStats[species].type2 == 12)
            {
...
{
    u8 obj = SpawnSpecialObjectEventParameterized(7, 0x8, 0x7F, gSaveBlock1Ptr->pos.x + 7, gSaveBlock1Ptr->pos.y + 7, 3);
    gObjectEvents[obj].invisible = 1;
...
void RemoveCameraObject(void)
{
    ...
    RemoveObjectEventByLocalIdAndMap(0x7F, gSaveBlock1Ptr->location.mapNum, gSaveBlock1Ptr->location.mapGroup);
}
...
{
    if (!FlagGet(0xC7)
        && gSaveBlock1Ptr->location.mapGroup == ((4 | (24 << 8)) >> 8)
        && gSaveBlock1Ptr->location.mapNum == ((4 | (24 << 8)) & 0xFF))
    {
        if (FlagGet(0x3A3))
        {
            VarSet(0x409A, 4);
...
{
    u16 monData;
    CreateMon(&gPlayerParty[0], 263, 7, 32, 0, 0, 0, 0, 0);
    monData = 1;
...
u8 GetLeadMonIndex(void)
{
    ...
    for (i = 0; i < partyCount; i++)
    {
        if (GetMonData(&gPlayerParty[i], 65, ((void *)0)) != 898 + 308 + 1 && GetMonData(&gPlayerParty[i], 65, ((void *)0)) != 0)
        {
            return i;
        }
    }
...
{
    if (gSpecialVar_0x8004 >= 482 && gSpecialVar_0x8004 <= 689)
    {
...
void ShowDeptStoreElevatorFloorSelect(void)
{
    ...
    AddTextPrinterParameterized(sTutorMoveAndElevatorWindowId, 1, gText_ElevatorNowOn, xPos, 1, 0xFF, ((void *)0));

    xPos = GetStringCenterAlignXOffset(1, gDeptStoreFloorNames[gSpecialVar_0x8005], 64);
    AddTextPrinterParameterized(sTutorMoveAndElevatorWindowId, 1, gDeptStoreFloorNames[gSpecialVar_0x8005], xPos, 17, 0xFF, ((void *)0));
...
{
    ClearStdWindowAndFrameToTransparent(sTutorMoveAndElevatorWindowId, 1);
...
static void MoveElevatorWindowLights(u16 floorDelta, bool8 descending)
{
    ...
    if (FuncIsActiveTask(Task_MoveElevatorWindowLights) != 1)
    {
...
{
    static const u8 *const sFrontierManiacMessages[][3] =
    {
        [0] =
        {
    ...
    static const u8 sFrontierManiacStreakThresholds[][3 - 1] =
    {
        [0] = { 21, 56 },
        [1] = { 21, 35 },
        [2] = { 255, 255 },
...
void BufferBattleTowerElevatorFloors(void)
{
    ...
    for (i = 0; i < (size_t)(sizeof(sBattleTowerStreakThresholds) / sizeof((sBattleTowerStreakThresholds)[0])) - 1; i++)
    {
...
static const u8 *const sScrollableMultichoiceOptions[][16] =
{
    [0] =
    {
        gText_Exit
...
static void Task_ShowScrollableMultichoice(u8 taskId)
{
    ...
    if (task->data[2] + task->data[4] > 28 + 1)
    {
        int adjustedLeft = 28 + 1 - task->data[4];
        if (adjustedLeft < 0)
        {
            task->data[2] = 0;
        }
...
static void InitScrollableMultichoice(void)
{
    ...
    gScrollableMultichoice_ListMenuTemplate.itemPrintFunc = ((void *)0);
...
static void ScrollableMultichoice_MoveCursor(s32 itemIndex, bool8 onInit, struct ListMenu *list)
{
    ...
    if (taskId != 0xFF)
    {
        u16 selection;
        struct Task *task = &gTasks[taskId];
        ListMenuGetScrollAndRow(task->data[14], &selection, ((void *)0));
...
{
    static const u8 *const sNatureGirlMessages[25] = {
        [0] = BattleFrontier_Lounge5_Text_NatureGirlHardy,
        [1] = BattleFrontier_Lounge5_Text_NatureGirlLonely,
        [2] = BattleFrontier_Lounge5_Text_NatureGirlBrave,
        [3] = BattleFrontier_Lounge5_Text_NatureGirlAdamant,
        [4] = BattleFrontier_Lounge5_Text_NatureGirlNaughty,
        [5] = BattleFrontier_Lounge5_Text_NatureGirlBold,
        [6] = BattleFrontier_Lounge5_Text_NatureGirlDocileNaiveQuietQuirky,
        [7] = BattleFrontier_Lounge5_Text_NatureGirlRelaxed,
        [8] = BattleFrontier_Lounge5_Text_NatureGirlImpish,
        [9] = BattleFrontier_Lounge5_Text_NatureGirlLax,
        [10] = BattleFrontier_Lounge5_Text_NatureGirlTimid,
        [11] = BattleFrontier_Lounge5_Text_NatureGirlHasty,
        [12] = BattleFrontier_Lounge5_Text_NatureGirlSerious,
        [13] = BattleFrontier_Lounge5_Text_NatureGirlJolly,
        [14] = BattleFrontier_Lounge5_Text_NatureGirlDocileNaiveQuietQuirky,
        [15] = BattleFrontier_Lounge5_Text_NatureGirlModest,
        [16] = BattleFrontier_Lounge5_Text_NatureGirlMild,
        [17] = BattleFrontier_Lounge5_Text_NatureGirlDocileNaiveQuietQuirky,
        [18] = BattleFrontier_Lounge5_Text_NatureGirlBashful,
        [19] = BattleFrontier_Lounge5_Text_NatureGirlRash,
        [20] = BattleFrontier_Lounge5_Text_NatureGirlCalm,
        [21] = BattleFrontier_Lounge5_Text_NatureGirlGentle,
        [22] = BattleFrontier_Lounge5_Text_NatureGirlSassy,
        [23] = BattleFrontier_Lounge5_Text_NatureGirlCareful,
        [24] = BattleFrontier_Lounge5_Text_NatureGirlDocileNaiveQuietQuirky,
    };
...
void FrontierGamblerSetWonOrLost(bool8 won)
{
    ...
    u16 battleMode = VarGet(0x40CE);
    u16 challenge = VarGet(0x4031);
    u16 frontierFacilityId = VarGet(0x40CF);

    if (VarGet(0x4033) == 1)
    {
        if (sFrontierChallenges[challenge] == ((frontierFacilityId << 8) + battleMode))
        {
            if (won)
            {
                VarSet(0x4033, 2);
...
void UpdateBattlePointsWindow(void)
{
    ...
    AddTextPrinterParameterized(sBattlePointsWindowId, 1, string, x, 1, 0, ((void *)0));
}
...
{
    ClearStdWindowAndFrameToTransparent(sBattlePointsWindowId, 1);
...
{
    ClearStdWindowAndFrameToTransparent(sFrontierExchangeCorner_ItemIconWindowId, 1);
    RemoveWindow(sFrontierExchangeCorner_ItemIconWindowId);
}

static void FillFrontierExchangeCornerWindowAndItemIcon(u16 menu, u16 selection)
{
# 1 "src/data/battle_frontier/battle_frontier_exchange_corner.h" 1
...
# 3101 "src/field_specials.c" 2
    ...
    if (menu >= 3 && menu <= 6)
    {
        ...
        {
            case 3:
                AddTextPrinterParameterized2(0, 1, sFrontierExchangeCorner_Decor1Descriptions[selection], 0, ((void *)0), 2, 1, 3);
            ...
            case 5:
                ...
                break;
            case 6:
                AddTextPrinterParameterized2(0, 1, sFrontierExchangeCorner_HoldItemsDescriptions[selection], 0, ((void *)0), 2, 1, 3);
...
static void ShowBattleFrontierTutorMoveDescription(u8 menu, u16 selection)
{
    ...
    if (menu == 9 || menu == 10)
    {
        FillWindowPixelRect(sTutorMoveAndElevatorWindowId, ((1) | ((1) << 4)), 0, 0, 96, 48);
        if (menu == 10)
        {
            AddTextPrinterParameterized(sTutorMoveAndElevatorWindowId, 1, sBattleFrontier_TutorMoveDescriptions2[selection], 0, 1, 0, ((void *)0));
        }
        else
        {
            AddTextPrinterParameterized(sTutorMoveAndElevatorWindowId, 1, sBattleFrontier_TutorMoveDescriptions1[selection], 0, 1, 0, ((void *)0));
        }
    }
}
...
void sub_813ADD4(void)
{
    ...
    if (taskId != 0xFF)
    {
        ...
        for (i = 0; i < 6; i++)
        {
            AddTextPrinterParameterized5(task->data[13], 1, sScrollableMultichoiceOptions[gSpecialVar_0x8004][scrollOffset + i], 10, i * 16, 0xFF, ((void *)0), 0, 0);
        }
...
static void Task_DeoxysRockInteraction(u8 taskId)
{
    ...
    if (FlagGet((((0x500 + 864 - 1) + 1) + 0x74)) == 1)
    {
...
bool32 GetAbnormalWeatherMapNameAndType(void)
{
    ...
    u16 abnormalWeather = VarGet(0x4037);
...
u32 GetMartEmployeeObjectEventId(void)
{
    ...
    {
        { ((4 | (2 << 8)) >> 8), ((4 | (2 << 8)) & 0xFF), 1 },
        { ((4 | (4 << 8)) >> 8), ((4 | (4 << 8)) & 0xFF), 1 },
        { ((0 | (5 << 8)) >> 8), ((0 | (5 << 8)) & 0xFF), 1 },
        { ((3 | (6 << 8)) >> 8), ((3 | (6 << 8)) & 0xFF), 1 },
        { ((6 | (8 << 8)) >> 8), ((6 | (8 << 8)) & 0xFF), 1 },
        { ((13 | (9 << 8)) >> 8), ((13 | (9 << 8)) & 0xFF), 1 },
        { ((7 | (10 << 8)) >> 8), ((7 | (10 << 8)) & 0xFF), 1 },
        { ((7 | (11 << 8)) >> 8), ((7 | (11 << 8)) & 0xFF), 1 },
        { ((4 | (12 << 8)) >> 8), ((4 | (12 << 8)) & 0xFF), 1 },
        { ((5 | (14 << 8)) >> 8), ((5 | (14 << 8)) & 0xFF), 1 },
        { ((4 | (15 << 8)) >> 8), ((4 | (15 << 8)) & 0xFF), 1 },
        { ((55 | (26 << 8)) >> 8), ((55 | (26 << 8)) & 0xFF), 1 }
    };

    u8 i;
    for (i = 0; i < (size_t)(sizeof(sPokeMarts) / sizeof((sPokeMarts)[0])); i++)
    {
...
u8 TryGainNewFanFromCounter(u8 incrementId)
{
    ...
    if (VarGet(0x4095) == 2)
    {
        if (((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) & 0x007F) + sCounterIncrements[incrementId] > 19)
        {
            if (GetNumFansOfPlayerInTrainerFanClub() < 3)
            {
                PlayerGainRandomTrainerFan();
                ((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) &= ~(0x007F));
            }
            else
            {
                ((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) = ((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) & 0xFF80) | (20));
            }
        }
        else
        {
            ((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) += (sCounterIncrements[incrementId]));
        }
    }

    return ((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) & 0x007F);
}
...
static u16 PlayerGainRandomTrainerFan(void)
{
    static const u8 sFanClubMemberIds[8] =
    {
        8,
        9,
        10,
    ...
    for (i = 0; i < (size_t)(sizeof(sFanClubMemberIds) / sizeof((sFanClubMemberIds)[0])); i++)
    {
        if (!((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) >> (sFanClubMemberIds[i]) & 1))
        {
            idx = i;
            if (Random() & 1)
            {
                ((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) |= 1 << (sFanClubMemberIds[idx]));
                return idx;
            }
        }
    }
...
static u16 PlayerLoseRandomTrainerFan(void)
{
    ...
    if (((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) >> (sFanClubMemberIds[idx]) & 1))
    {
        ((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) ^= 1 << (sFanClubMemberIds[idx]));
    }
...
u16 GetNumFansOfPlayerInTrainerFanClub(void)
{
    ...
    for (i = 0; i < 8; i++)
    {
        if (((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) >> (i + 8) & 1))
            numFans++;
    }
...
static void SetInitialFansOfPlayer(void)
{
    ((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) |= 1 << (13));
    ((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) |= 1 << (8));
    ((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) |= 1 << (10));
}
...
void SetPlayerGotFirstFans(void)
{
    ((gSaveBlock1Ptr->vars[0x4041 - 0x4000]) |= 1 << (7));
}
...
u8 CountRotomInParty (void)
{
    ...
    for (i = 0; i < partyCount; i++)
    {
        species = GetMonData(&gPlayerParty[i], 11, ((void *)0));
        if (species == 479)
        {
...
{
    gSpecialVar_0x8007 = GetFormSpeciesId(479, GetMonData(&gPlayerParty[gSpecialVar_0x8004], 89, ((void *)0)));
...
void RotomForgetSpecialMove (void)
{
    ...
    for (i = 0; i < 4; i++)
    {
        if (GetMonData(&gPlayerParty[gSpecialVar_0x8004], 13 + i, ((void *)0)) == currentMove)
        {
            RemoveMonPPBonus (&gPlayerParty[gSpecialVar_0x8004], i);
            SetMonData(&gPlayerParty[gSpecialVar_0x8004], 13 + i, &moveNone);
            forgotSpecialMove = 1;
            break;
        }
    }
...
void ChangeRotomForm (void)
{
    ...
    currentForm = GetMonData(&gPlayerParty[gSpecialVar_0x8004], 89, ((void *)0));
    newForm = GetFormIdFromFormSpeciesId(gSpecialVar_0x8005);

    SetMonData(&gPlayerParty[gSpecialVar_0x8004], 89, &newForm);
...
bool8 IsSelectedMonRotom (void)
{
    ...
    species = GetMonData(&gPlayerParty[gSpecialVar_0x8004], 65, ((void *)0));
    if (species == 479)
    {
        return 1;
    }
