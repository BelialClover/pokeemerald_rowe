# 0 "src/battle_controller_opponent.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_controller_opponent.c"
...
# 2 "src/battle_controller_opponent.c" 2
...
# 3 "src/battle_controller_opponent.c" 2
...
# 4 "src/battle_controller_opponent.c" 2
...
# 5 "src/battle_controller_opponent.c" 2
...
# 6 "src/battle_controller_opponent.c" 2
...
# 7 "src/battle_controller_opponent.c" 2
# 1 "include/battle_message.h" 1
# 8 "src/battle_controller_opponent.c" 2
...
# 9 "src/battle_controller_opponent.c" 2
...
# 10 "src/battle_controller_opponent.c" 2
...
# 11 "src/battle_controller_opponent.c" 2
...
# 12 "src/battle_controller_opponent.c" 2
# 1 "gflib/bg.h" 1
...
# 13 "src/battle_controller_opponent.c" 2
# 1 "include/data.h" 1
...
# 14 "src/battle_controller_opponent.c" 2
...
# 15 "src/battle_controller_opponent.c" 2
# 1 "include/item.h" 1
...
# 16 "src/battle_controller_opponent.c" 2
# 1 "include/link.h" 1
# 106 "include/link.h"
struct LinkStatus
{
...
# 17 "src/battle_controller_opponent.c" 2
# 1 "include/main.h" 1
...
# 18 "src/battle_controller_opponent.c" 2
# 1 "include/m4a.h" 1
...
# 19 "src/battle_controller_opponent.c" 2
...
# 20 "src/battle_controller_opponent.c" 2
# 1 "include/pokeball.h" 1
# 21 "src/battle_controller_opponent.c" 2
# 1 "include/pokemon.h" 1
# 22 "src/battle_controller_opponent.c" 2
...
# 23 "src/battle_controller_opponent.c" 2
...
# 24 "src/battle_controller_opponent.c" 2
# 1 "include/sound.h" 1
...
# 25 "src/battle_controller_opponent.c" 2
...
# 26 "src/battle_controller_opponent.c" 2
# 1 "include/task.h" 1
# 27 "src/battle_controller_opponent.c" 2
# 1 "gflib/text.h" 1
# 272 "gflib/text.h"
enum
{
...
# 28 "src/battle_controller_opponent.c" 2
# 1 "include/util.h" 1
...
# 29 "src/battle_controller_opponent.c" 2
# 1 "gflib/window.h" 1
...
# 30 "src/battle_controller_opponent.c" 2
# 1 "include/constants/battle_anim.h" 1
# 31 "src/battle_controller_opponent.c" 2
# 1 "include/constants/items.h" 1
# 32 "src/battle_controller_opponent.c" 2
# 1 "include/constants/moves.h" 1
# 33 "src/battle_controller_opponent.c" 2
# 1 "include/constants/songs.h" 1
# 34 "src/battle_controller_opponent.c" 2
...
# 35 "src/battle_controller_opponent.c" 2
...
# 36 "src/battle_controller_opponent.c" 2
...
static void OpponentBufferRunCommand(void)
{
    ...
    {
        if (gBattleResources->bufferA[gActiveBattler][0] < (size_t)(sizeof(sOpponentBufferCommands) / sizeof((sOpponentBufferCommands)[0])))
...
static void sub_805F2F0(void)
{
    ...
    if (!IsDoubleBattle() || ((IsDoubleBattle() && (gBattleTypeFlags & (1 << 6)) && !((gBattleTypeFlags & (1 << 22) && gTrainerBattleOpponent_B == 0xFFFF))) || (gBattleTypeFlags & (1 << 15))))
    {
    ...
    gUnknown_020244DC = &gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2];
...
static void sub_805F560(void)
{
    ...
    if (!(gBattleTypeFlags & (1 << 15))
     && (!(gBattleTypeFlags & (1 << 6)) || ((gBattleTypeFlags & (1 << 22) && gTrainerBattleOpponent_B == 0xFFFF)))
     && IsDoubleBattle()
     && !gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].triedShinyMonAnim
    ...
    if (!gBattleSpritesDataPtr->healthBoxesData[gActiveBattler].ballAnimActive && !gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].ballAnimActive)
    {
        ...
        {
            if (IsDoubleBattle() && (!(gBattleTypeFlags & (1 << 6)) || ((gBattleTypeFlags & (1 << 22) && gTrainerBattleOpponent_B == 0xFFFF))))
            {
                UpdateHealthboxAttribute(gHealthboxSpriteIds[gActiveBattler ^ 2], &gEnemyParty[gBattlerPartyIndexes[gActiveBattler ^ 2]], HEALTHBOX_ALL);
    ...
    if (!IsDoubleBattle() || (IsDoubleBattle() && gBattleTypeFlags & (1 << 6) && !((gBattleTypeFlags & (1 << 22) && gTrainerBattleOpponent_B == 0xFFFF))))
    {
...
static u32 GetOpponentMonData(u8 monId, u8 *dst)
{
    ...
    case REQUEST_ALL_BATTLE:
        ...
        battleMon.formId = GetMonData(&gEnemyParty[monId], 89);
    ...
    case REQUEST_MOVE4_BATTLE:
        data16 = GetMonData(&gEnemyParty[monId], 13 + gBattleResources->bufferA[gActiveBattler][1] - REQUEST_MOVE1_BATTLE);
        dst[0] = data16;
        dst[1] = data16 >> 8;
        size = 2;
        break;
    ...
    case REQUEST_PPMOVE4_BATTLE:
        dst[0] = GetMonData(&gEnemyParty[monId], 17 + gBattleResources->bufferA[gActiveBattler][1] - REQUEST_PPMOVE1_BATTLE);
        size = 1;
        break;
...
static void SetOpponentMonData(u8 monId)
{
    ...
    case REQUEST_ALL_BATTLE:
        {
            ...
            SetMonData(&gEnemyParty[monId], 11, &species);
            SetMonData(&gEnemyParty[monId], 89, &formId);
        ...
        break;
    case REQUEST_SPECIES_BATTLE:
        SetMonData(&gEnemyParty[monId], 11, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_HELDITEM_BATTLE:
        SetMonData(&gEnemyParty[monId], 12, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_MOVES_PP_BATTLE:
        for (i = 0; i < 4; i++)
        {
    ...
    case REQUEST_MOVE3_BATTLE:
    case REQUEST_MOVE4_BATTLE:
        SetMonData(&gEnemyParty[monId], 13 + gBattleResources->bufferA[gActiveBattler][1] - REQUEST_MOVE1_BATTLE, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_PP_DATA_BATTLE:
        SetMonData(&gEnemyParty[monId], 17, &gBattleResources->bufferA[gActiveBattler][3]);
        SetMonData(&gEnemyParty[monId], 18, &gBattleResources->bufferA[gActiveBattler][4]);
        SetMonData(&gEnemyParty[monId], 19, &gBattleResources->bufferA[gActiveBattler][5]);
        SetMonData(&gEnemyParty[monId], 20, &gBattleResources->bufferA[gActiveBattler][6]);
        SetMonData(&gEnemyParty[monId], 21, &gBattleResources->bufferA[gActiveBattler][7]);
        break;
    case REQUEST_PPMOVE1_BATTLE:
    case REQUEST_PPMOVE2_BATTLE:
    case REQUEST_PPMOVE3_BATTLE:
    case REQUEST_PPMOVE4_BATTLE:
        SetMonData(&gEnemyParty[monId], 17 + gBattleResources->bufferA[gActiveBattler][1] - REQUEST_PPMOVE1_BATTLE, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_OTID_BATTLE:
        SetMonData(&gEnemyParty[monId], 1, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_EXP_BATTLE:
        SetMonData(&gEnemyParty[monId], 25, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_HP_EV_BATTLE:
        SetMonData(&gEnemyParty[monId], 26, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_ATK_EV_BATTLE:
        SetMonData(&gEnemyParty[monId], 27, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_DEF_EV_BATTLE:
        SetMonData(&gEnemyParty[monId], 28, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPEED_EV_BATTLE:
        SetMonData(&gEnemyParty[monId], 29, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPATK_EV_BATTLE:
        SetMonData(&gEnemyParty[monId], 30, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPDEF_EV_BATTLE:
        SetMonData(&gEnemyParty[monId], 31, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_FRIENDSHIP_BATTLE:
        SetMonData(&gEnemyParty[monId], 32, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_POKERUS_BATTLE:
        SetMonData(&gEnemyParty[monId], 34, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_MET_LOCATION_BATTLE:
        SetMonData(&gEnemyParty[monId], 35, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_MET_LEVEL_BATTLE:
        SetMonData(&gEnemyParty[monId], 36, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_MET_GAME_BATTLE:
        SetMonData(&gEnemyParty[monId], 37, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_POKEBALL_BATTLE:
        SetMonData(&gEnemyParty[monId], 38, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_ALL_IVS_BATTLE:
        SetMonData(&gEnemyParty[monId], 39, &gBattleResources->bufferA[gActiveBattler][3]);
        SetMonData(&gEnemyParty[monId], 40, &gBattleResources->bufferA[gActiveBattler][4]);
        SetMonData(&gEnemyParty[monId], 41, &gBattleResources->bufferA[gActiveBattler][5]);
        SetMonData(&gEnemyParty[monId], 42, &gBattleResources->bufferA[gActiveBattler][6]);
        SetMonData(&gEnemyParty[monId], 43, &gBattleResources->bufferA[gActiveBattler][7]);
        SetMonData(&gEnemyParty[monId], 44, &gBattleResources->bufferA[gActiveBattler][8]);
        break;
    case REQUEST_HP_IV_BATTLE:
        SetMonData(&gEnemyParty[monId], 39, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_ATK_IV_BATTLE:
        SetMonData(&gEnemyParty[monId], 40, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_DEF_IV_BATTLE:
        SetMonData(&gEnemyParty[monId], 41, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPEED_IV_BATTLE:
        SetMonData(&gEnemyParty[monId], 42, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPATK_IV_BATTLE:
        SetMonData(&gEnemyParty[monId], 43, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPDEF_IV_BATTLE:
        SetMonData(&gEnemyParty[monId], 44, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_PERSONALITY_BATTLE:
        SetMonData(&gEnemyParty[monId], 0, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_CHECKSUM_BATTLE:
        SetMonData(&gEnemyParty[monId], 9, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_STATUS_BATTLE:
        SetMonData(&gEnemyParty[monId], 55, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_LEVEL_BATTLE:
        SetMonData(&gEnemyParty[monId], 56, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_HP_BATTLE:
        SetMonData(&gEnemyParty[monId], 57, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_MAX_HP_BATTLE:
        SetMonData(&gEnemyParty[monId], 58, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_ATK_BATTLE:
        SetMonData(&gEnemyParty[monId], 59, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_DEF_BATTLE:
        SetMonData(&gEnemyParty[monId], 60, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPEED_BATTLE:
        SetMonData(&gEnemyParty[monId], 61, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPATK_BATTLE:
        SetMonData(&gEnemyParty[monId], 62, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPDEF_BATTLE:
        SetMonData(&gEnemyParty[monId], 63, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_COOL_BATTLE:
        SetMonData(&gEnemyParty[monId], 22, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_BEAUTY_BATTLE:
        SetMonData(&gEnemyParty[monId], 23, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_CUTE_BATTLE:
        SetMonData(&gEnemyParty[monId], 24, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SMART_BATTLE:
        SetMonData(&gEnemyParty[monId], 33, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_TOUGH_BATTLE:
        SetMonData(&gEnemyParty[monId], 47, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SHEEN_BATTLE:
        SetMonData(&gEnemyParty[monId], 48, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_COOL_RIBBON_BATTLE:
        SetMonData(&gEnemyParty[monId], 50, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_BEAUTY_RIBBON_BATTLE:
        SetMonData(&gEnemyParty[monId], 51, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_CUTE_RIBBON_BATTLE:
        SetMonData(&gEnemyParty[monId], 52, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_SMART_RIBBON_BATTLE:
        SetMonData(&gEnemyParty[monId], 53, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    case REQUEST_TOUGH_RIBBON_BATTLE:
        SetMonData(&gEnemyParty[monId], 54, &gBattleResources->bufferA[gActiveBattler][3]);
        break;
    }
}
...
static void OpponentHandleLoadMonSprite(void)
{
    ...
    u8 formId = GetMonData(&gEnemyParty[gBattlerPartyIndexes[gActiveBattler]], 89);
...
static void sub_80613DC(u8 battlerId, bool8 dontClearSubstituteBit)
{
    ...
    formId = GetMonData(&gEnemyParty[gBattlerPartyIndexes[battlerId]], 89);
    ...
    gSprites[gUnknown_03005D7C[battlerId]].data[0] = DoPokeballSendOutAnimation(0, 0xFE);
}
...
static void DoSwitchOutAnimation(void)
{
    ...
    case 1:
        ...
        {
            gBattleSpritesDataPtr->healthBoxesData[gActiveBattler].animationState = 0;
            InitAndLaunchSpecialAnimation(gActiveBattler, gActiveBattler, gActiveBattler, 0x2);
...
static void OpponentHandleDrawTrainerPic(void)
{
    ...
    if (gBattleTypeFlags & ((1 << 6) | (1 << 15)) && !((gBattleTypeFlags & (1 << 22) && gTrainerBattleOpponent_B == 0xFFFF)))
    {
    ...
    else
    {
        ...
        if (gBattleTypeFlags & ((1 << 3) | (1 << 4) | (1 << 7) | (1 << 10)))
        {
            ...
            case 6:
                ...
                break;
            default:
                if (gBattleMoves[moveInfo->moves[chosenMoveId]].target & (0x2 | 0x10))
        ...
        else
        {
            ...
            if (gBattleMoves[move].target & (0x2 | 0x10))
                ...
                BtlController_EmitTwoReturnValues(1, 10, (chosenMoveId) | (GetBattlerAtPosition(0) << 8));
...
static void OpponentHandleChoosePokemon(void)
{
    ...
    if (*(gBattleStruct->AI_monToSwitchIntoId + gActiveBattler) == 6)
    {
        ...
        if (chosenMonId == 6)
        {
            ...
            {
                battler2 = battler1 = GetBattlerAtPosition(1);
            }
            else
            {
                battler1 = GetBattlerAtPosition(1);
                battler2 = GetBattlerAtPosition(3);
            }
            ...
            {
                if (GetMonData(&gEnemyParty[chosenMonId], 57) != 0
