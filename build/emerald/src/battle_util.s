...
IsBattlerAlive:
	...
	ldrh	r0, [r0, #0x2a]
	cmp	r0, #0
	beq	.L3120	@cond_branch
	ldr	r0, .L3123+0x4
	ldrb	r0, [r0]
	cmp	r2, r0
	bcs	.L3120	@cond_branch
	ldr	r0, .L3123+0x8
	ldrb	r1, [r0]
	ldr	r2, .L3123+0xc
	lsl	r0, r3, #0x2
...
.L3155:
	sub	r0, r3, #0x6
	cmp	r0, #0x1
	bhi	.L3156	@cond_branch
	cmp	r5, #0
	beq	.L3154	@cond_branch
.L3156:
	mov	r0, #0x0
	ldrsb	r0, [r2, r0]
	cmp	r0, #0x6
	ble	.L3154	@cond_branch
	sub	r1, r4, #0x6
	add	r4, r1, r0
.L3154:
	add	r2, r2, #0x1
...
.LCB30842:
	cmp	r1, #0xe9
	bgt	.L3479	@cond_branch
	cmp	r1, #0xe7
	beq	.L3460	@cond_branch
	cmp	r1, #0xe8
...
.LCB31423:
	cmp	r0, #0x7a
	bhi	.L3607	@cond_branch
	cmp	r0, #0x70
	beq	.L3573	@cond_branch
	b	.L3569
.L3607:
	cmp	r0, #0x81
	beq	.L3577	@cond_branch
	cmp	r0, #0xc6
	bne	.LCB31434
	b	.L3597	@long jump
.LCB31434:
...
.L3569:
	...
	bl	GetBattlerAbility
	cmp	r0, #0x2f
	bne	.L3608	@cond_branch
	mov	r3, r8
	cmp	r3, #0xa
	beq	.L3611	@cond_branch
	cmp	r3, #0xf
	bne	.L3608	@cond_branch
.L3611:
	mov	r1, #0x80
...
.L3622:
	...
	lsr	r0, r0, #0x10
	cmp	r0, #0x1
	bhi	.L3621	@cond_branch
	add	r0, r6, #0
	bl	GetBattleMoveSplit
	lsl	r0, r0, #0x18
	cmp	r0, #0
	bne	.L3621	@cond_branch
	mov	r1, #0x80
	lsl	r1, r1, #0x6
	b	.L3640
.L3672:
...
.L3694:
	...
	cmp	r4, #0x6
	bls	.L3695	@cond_branch
	mov	r4, #0x6
.L3695:
	ldr	r0, [sp, #0x4]
	bl	GetBattlerAbility
	cmp	r0, #0x6d
	bne	.L3696	@cond_branch
	mov	r4, #0x6
.L3696:
	ldr	r0, .L3740+0x4
	mov	r1, r8
...
.L3944:
	...
	cmp	r1, r0
	bgt	.L3945	@cond_branch
	cmp	r1, r9
	beq	.L3936	@cond_branch
	b	.L3930
.L3945:
	mov	r0, #0x80
	lsl	r0, r0, #0x7
