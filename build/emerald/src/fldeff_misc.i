...
{
    {.data = (u8 *)sSecretPowerCave_Gfx + (2 * 2 * 0 * 64)/2, .size = (2 * 2 * 64)/2},
    {.data = (u8 *)sSecretPowerCave_Gfx + (2 * 2 * 1 * 64)/2, .size = (2 * 2 * 64)/2},
    {.data = (u8 *)sSecretPowerCave_Gfx + (2 * 2 * 2 * 64)/2, .size = (2 * 2 * 64)/2},
    {.data = (u8 *)sSecretPowerCave_Gfx + (2 * 2 * 3 * 64)/2, .size = (2 * 2 * 64)/2},
    {.data = (u8 *)sSecretPowerCave_Gfx + (2 * 2 * 4 * 64)/2, .size = (2 * 2 * 64)/2},
};

static const struct SpriteFrameImage sPicTable_SecretPowerTree[] =
{
    {.data = (u8 *)sSecretPowerTree_Gfx + (2 * 2 * 0 * 64)/2, .size = (2 * 2 * 64)/2},
    {.data = (u8 *)sSecretPowerTree_Gfx + (2 * 2 * 1 * 64)/2, .size = (2 * 2 * 64)/2},
    {.data = (u8 *)sSecretPowerTree_Gfx + (2 * 2 * 2 * 64)/2, .size = (2 * 2 * 64)/2},
    {.data = (u8 *)sSecretPowerTree_Gfx + (2 * 2 * 3 * 64)/2, .size = (2 * 2 * 64)/2},
    {.data = (u8 *)sSecretPowerTree_Gfx + (2 * 2 * 4 * 64)/2, .size = (2 * 2 * 64)/2},

};

static const struct SpriteFrameImage sPicTable_SecretPowerShrub[] =
{
    {.data = (u8 *)sSecretPowerShrub_Gfx + (2 * 2 * 0 * 64)/2, .size = (2 * 2 * 64)/2},
    {.data = (u8 *)sSecretPowerShrub_Gfx + (2 * 2 * 1 * 64)/2, .size = (2 * 2 * 64)/2},
    {.data = (u8 *)sSecretPowerShrub_Gfx + (2 * 2 * 2 * 64)/2, .size = (2 * 2 * 64)/2},
    {.data = (u8 *)sSecretPowerShrub_Gfx + (2 * 2 * 3 * 64)/2, .size = (2 * 2 * 64)/2},
    {.data = (u8 *)sSecretPowerShrub_Gfx + (2 * 2 * 4 * 64)/2, .size = (2 * 2 * 64)/2},
};
...
const struct SpritePalette gSpritePalette_SecretPower_Cave = {sSecretPowerCave_Pal, 0x1003};
const struct SpritePalette gSpritePalette_SecretPower_Plant = {sSecretPowerPlant_Pal, 0x1008};
...
const struct SpritePalette gSpritePalette_SandPillar = {gTilesetPalettes_SecretBase[5], 0x100E};
...
{
    {.data = (u8 *)sRecordMixLights_Gfx + (4 * 1 * 0 * 64)/2, .size = (4 * 1 * 64)/2},
    {.data = (u8 *)sRecordMixLights_Gfx + (4 * 1 * 1 * 64)/2, .size = (4 * 1 * 64)/2},
    {.data = (u8 *)sRecordMixLights_Gfx + (4 * 1 * 2 * 64)/2, .size = (4 * 1 * 64)/2},
};
...
static void CreateComputerScreenEffectTask(void (*taskfunc) (u8), u16 increment, u16 unused, u8 priority)
{
    ...
    gTasks[taskId].data[1] = increment == 0 ? 16 : increment;
    gTasks[taskId].data[2] = increment == 0 ? 20 : increment;
...
static void Task_ComputerScreenOpenEffect(u8 taskId)
{
    ...
    case 2:
        ...
        if (task->data[3] < 1 || task->data[4] > 240 - 1)
        {
            task->data[3] = 0;
            task->data[4] = 240;
            SetGpuReg(0x54, 0);
    ...
    case 3:
        ...
        if (task->data[5] < 1 || task->data[6] > 160 - 1)
        {
            task->data[5] = 0;
            task->data[6] = 160;
...
static void Task_ComputerScreenCloseEffect(u8 taskId)
{
    ...
    case 2:
        ...
        if (task->data[5] >= 160 / 2 || task->data[6] <= 160 / 2 + 1)
        {
            task->data[5] = 160 / 2;
            task->data[6] = 160 / 2 + 1;
            SetGpuReg(0x50, (((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)) | (1 << 4) | (1 << 5)) | (2 << 6));
    ...
    case 3:
        ...
        if (task->data[3] >= 240 / 2 || task->data[4] <= 240 / 2)
        {
            task->data[3] = 240 / 2;
            task->data[4] = 240 / 2;
