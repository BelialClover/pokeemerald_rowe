# 0 "src/fldeff_softboiled.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/fldeff_softboiled.c"
...
# 4 "src/fldeff_softboiled.c" 2
# 1 "include/pokemon.h" 1
# 5 "src/fldeff_softboiled.c" 2
# 1 "include/sound.h" 1
...
# 9 "src/fldeff_softboiled.c" 2
# 1 "include/task.h" 1
# 10 "src/fldeff_softboiled.c" 2
# 1 "include/constants/party_menu.h" 1
# 11 "src/fldeff_softboiled.c" 2
# 1 "include/constants/songs.h" 1
# 12 "src/fldeff_softboiled.c" 2
...
bool8 SetUpFieldMove_SoftBoiled(void)
{
    ...
    maxHp = GetMonData(&gPlayerParty[GetCursorSelectionMonId()], 58);
    hp = GetMonData(&gPlayerParty[GetCursorSelectionMonId()], 57);
...
void Task_TryUseSoftboiledOnPartyMon(u8 taskId)
{
    ...
    hp = GetMonData(&gPlayerParty[recipientPartyId], 57);
    if(hp == 0 || userPartyId == recipientPartyId || GetMonData(&gPlayerParty[recipientPartyId], 58) == hp)
    {
    ...
    PlaySE(1);
    PartyMenuModifyHP(taskId, userPartyId, -1, GetMonData(&gPlayerParty[userPartyId], 58)/5, Task_SoftboiledRestoreHealth);
}

static void Task_SoftboiledRestoreHealth(u8 taskId)
{
    PlaySE(1);
    PartyMenuModifyHP(taskId, gPartyMenu.slotId2, 1, GetMonData(&gPlayerParty[gPartyMenu.slotId], 58)/5, Task_DisplayHPRestoredMessage);
}
