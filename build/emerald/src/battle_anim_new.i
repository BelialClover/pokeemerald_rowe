...
{
    {.frame = {.xScale = 0, .yScale = 64, .rotation = 0, .duration = 16}},
...
{
    {.frame = {.xScale = 0xa0, .yScale = 0x100, .rotation = 0x50, .duration = 0x0}},
    {.type = 0x7FFF}
};
...
{
    {.frame = {.xScale = 8, .yScale = 8, .rotation = 9, .duration = 15}},
    {.frame = {.xScale = -8, .yScale = -8, .rotation = 9, .duration = 15}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 128, .duration = 1}},
    {.type = 0x7FFF}
};
...
{
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 0xb9, .duration = 1}},
    {.type = 0x7FFF},
};
static const union AffineAnimCmd sSpriteAffineAnim_DrakeStrikeOpponent[] =
{
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 0x50, .duration = 1}},
    {.type = 0x7FFF},
};
...
static const u16 sPetalBlizzardFlowerOam[] = {0x0, 0x2000,0x0800,0x0};
...
{
    {.frame = {.xScale = 8, .yScale = 8, .rotation = 0, .duration = 16}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 256, .yScale = 256, .rotation = 0, .duration = 1}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 0, .yScale = 0, .rotation = -64, .duration = 1}},
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 0, .duration = 7}},
...
static const union AffineAnimCmd sSpriteAffineAnim_PhotonGeyserBeam[] =
{
    ...
    {.frame = {.xScale = 64, .yScale = 64, .rotation = 0, .duration = 4}},

    {.frame = {.xScale = -128, .yScale = -128, .rotation = 0, .duration = 1}},
    {.frame = {.xScale = 128, .yScale = 128, .rotation = 0, .duration = 1}},
    {.jump = {.type = 0x7FFE, .target = 2}},
};
...
{
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 32, .duration = 1}},
    {.type = 0x7FFF}
};
...
const struct SpriteTemplate gSnipeShotBallTemplate =
{
    .tileTag = (10000 + 84),
    .paletteTag = (10000 + 84),
    .oam = &gOamData_AffineNormal_ObjNormal_32x32,
...
{
    {.frame = {.xScale = 64, .yScale = 64, .rotation = 0, .duration = 10}},
    {.type = 0x7FFF}
};
...
{
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 128, .duration = 1}},
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 0, .duration = 2}},
    {.frame = {.xScale = 16, .yScale = 16, .rotation = 0, .duration = 15}},
    {.type = 0x7FFF}
};
...
const struct SpriteTemplate gGrowingSuperpowerTemplate =
{
    .tileTag = (10000 + 256),
    .paletteTag = (10000 + 256),
...
{
    if (gBattleTypeFlags & (1 << 0))
        return (GetBattlerSpriteCoord2(battler, coordType) + GetBattlerSpriteCoord2(((battler) ^ 2), coordType)) / 2;
...
static void InitSpritePosToAnimTargetsCentre(struct Sprite *sprite, bool8 respectMonPicOffsets)
{
    if (!respectMonPicOffsets)
    {
        sprite->pos1.x = (GetBattlerSpriteCoord2(gBattleAnimTarget, BATTLER_COORD_X)
                       + GetBattlerSpriteCoord2(((gBattleAnimTarget) ^ 2), BATTLER_COORD_X)) / 2;
        sprite->pos1.y = (GetBattlerSpriteCoord2(gBattleAnimTarget, BATTLER_COORD_Y)
                       + GetBattlerSpriteCoord2(((gBattleAnimTarget) ^ 2), BATTLER_COORD_Y)) / 2;
    }
...
static void InitSpritePosToAnimAttackersCentre(struct Sprite *sprite, bool8 respectMonPicOffsets)
{
    if (!respectMonPicOffsets)
    {
        sprite->pos1.x = (GetBattlerSpriteCoord2(gBattleAnimAttacker, BATTLER_COORD_X)
                       + GetBattlerSpriteCoord2(((gBattleAnimAttacker) ^ 2), BATTLER_COORD_X)) / 2;
        sprite->pos1.y = (GetBattlerSpriteCoord2(gBattleAnimAttacker, BATTLER_COORD_Y)
                       + GetBattlerSpriteCoord2(((gBattleAnimAttacker) ^ 2), BATTLER_COORD_Y)) / 2;
    }
    else
    {
        sprite->pos1.x = (GetBattlerSpriteCoord2(gBattleAnimAttacker, BATTLER_COORD_X_2)
                       + GetBattlerSpriteCoord2(((gBattleAnimAttacker) ^ 2), BATTLER_COORD_X_2)) / 2;
        sprite->pos1.y = (GetBattlerSpriteCoord2(gBattleAnimAttacker, BATTLER_COORD_Y_PIC_OFFSET)
                       + GetBattlerSpriteCoord2(((gBattleAnimAttacker) ^ 2), BATTLER_COORD_Y_PIC_OFFSET)) / 2;
    }
...
{
    if (gBattleTypeFlags & (1 << 0))
        InitSpritePosToAnimTargetsCentre(sprite, 0);
    else
...
static void SpriteCB_CoreEnforcerHits(struct Sprite* sprite)
{
    ...
    {
        if (gBattleTypeFlags & (1 << 0))
            InitSpritePosToAnimAttackersCentre(sprite, 0);
        else
...
static void SpriteCB_CoreEnforcerBeam(struct Sprite* sprite)
{
    ...
    else
    {
        ...
        sprite->data[2] = (GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_X_2)
                        + GetBattlerSpriteCoord(((gBattleAnimTarget) ^ 2), BATTLER_COORD_X_2)) / 2;


        sprite->data[4] = (GetBattlerSpriteCoord(gBattleAnimTarget, BATTLER_COORD_Y_PIC_OFFSET)
                        + GetBattlerSpriteCoord(((gBattleAnimTarget) ^ 2), BATTLER_COORD_Y_PIC_OFFSET)) / 2;
...
static void SpriteCB_PyroBallRockBounceStep(struct Sprite* sprite)
{
    ...
    if (sprite->pos2.y > 0)
    {
        if (gBattleAnimArgs[2] || sprite->data[2])
            DestroyAnimSprite(sprite);
        else
        {
            sprite->data[0] = 0;
    ...
    initialHorizontalVelocity = -1;





    sprite->pos2.y = (initialVerticalVelocity * sprite->data[0] + (1 * sprite->data[0] * sprite->data[0]) / 4);




    if (!gBattleAnimArgs[2])
        sprite->pos2.x = (initialHorizontalVelocity * sprite->data[1]);
...
{
    u8 iconSpriteId = AddItemIconSprite((10000 + 224), (10000 + 224), gLastUsedItem);
