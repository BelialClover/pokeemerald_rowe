# 0 "src/field_region_map.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/field_region_map.c"
...
# 7 "src/field_region_map.c" 2
# 1 "include/menu.h" 1
# 8 "src/field_region_map.c" 2
...
# 13 "src/field_region_map.c" 2

# 1 "include/constants/rgb.h" 1
# 15 "src/field_region_map.c" 2
# 30 "src/field_region_map.c"
static __attribute__((section("ewram_data"))) struct {
    MainCallback callback;
    u32 unused;
    struct RegionMap regionMap;
    u16 state;
} *sFieldRegionMapHandler = ((void *)0);
...
static void MCB2_InitRegionMapRegisters(void)
{
    ...
    InitBgsFromTemplates(1, sFieldRegionMapBgTemplates, (size_t)(sizeof(sFieldRegionMapBgTemplates) / sizeof((sFieldRegionMapBgTemplates)[0])));
...
static void FieldUpdateRegionMap(void)
{
    ...
    switch (sFieldRegionMapHandler->state)
    {
        ...
        case 1:
            ...
            AddTextPrinterParameterized(1, 1, gText_Hoenn, offset, 1, 0, ((void *)0));
        ...
        case 6:
            if (!gPaletteFade.active)
            {
                ...
                if (sFieldRegionMapHandler != ((void *)0))
                {
                    { Free(sFieldRegionMapHandler); sFieldRegionMapHandler = ((void *)0); };
                }
...
static void PrintRegionMapSecName(void)
{
    if (sFieldRegionMapHandler->regionMap.mapSecType != MAPSECTYPE_NONE)
    {
        ...
        AddTextPrinterParameterized(0, 1, sFieldRegionMapHandler->regionMap.mapSecName, 0, 1, 0, ((void *)0));
        ScheduleBgCopyTilemapToVram(0);
    }
    else
    {
