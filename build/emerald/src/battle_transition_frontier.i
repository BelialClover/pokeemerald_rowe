# 0 "src/battle_transition_frontier.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_transition_frontier.c"
...
# 2 "src/battle_transition_frontier.c" 2
...
# 4 "src/battle_transition_frontier.c" 2
...
# 5 "src/battle_transition_frontier.c" 2
...
# 6 "src/battle_transition_frontier.c" 2
# 1 "include/task.h" 1
# 10 "include/task.h"
...
# 7 "src/battle_transition_frontier.c" 2
...
# 8 "src/battle_transition_frontier.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 9 "src/battle_transition_frontier.c" 2
# 1 "gflib/bg.h" 1
...
# 10 "src/battle_transition_frontier.c" 2
...
# 11 "src/battle_transition_frontier.c" 2
# 1 "include/constants/rgb.h" 1
# 12 "src/battle_transition_frontier.c" 2
# 22 "src/battle_transition_frontier.c"
...
static void SpriteCB_LogoCircleSpiral(struct Sprite *sprite)
{
    sprite->pos2.x = (Sin2(sprite->data[2]) * sprite->data[4]) >> 12;
    sprite->pos2.y = (Cos2(sprite->data[2]) * sprite->data[4]) >> 12;
...
static bool8 Circles_Init(struct Task *task)
{
    ...
    {
        LoadLogoGfx();
        SetGpuReg(0x50, (1 << 0) | (1 << 6) | (((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12) | (1 << 13)));
...
static bool8 WaitForLogoCirclesAnim(struct Task *task)
{
    if (IsLogoCirclesAnimFinished(task) == 1)
        task->data[0]++;
...
void Phase2Task_FrontierCirclesMeet(u8 taskId)
{
    while (sPhase2_FrontierCirclesMeet_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
void Phase2Task_FrontierCirclesCross(u8 taskId)
{
    while (sPhase2_FrontierCirclesCross_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
void Phase2Task_FrontierCirclesAsymmetricSpiral(u8 taskId)
{
    while (sPhase2_FrontierCirclesAsymmetricSpiral_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
void Phase2Task_FrontierCirclesSymmetricSpiral(u8 taskId)
{
    while (sPhase2_FrontierCirclesSymmetricSpiral_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
void Phase2Task_FrontierCirclesMeetInSeq(u8 taskId)
{
    while (sPhase2_FrontierCirclesMeetInSeq_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
void Phase2Task_FrontierCirclesCrossInSeq(u8 taskId)
{
    while (sPhase2_FrontierCirclesCrossInSeq_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
void Phase2Task_FrontierCirclesAsymmetricSpiralInSeq(u8 taskId)
{
    while (sPhase2_FrontierCirclesAsymmetricSpiralInSeq_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
void Phase2Task_FrontierCirclesSymmetricSpiralInSeq(u8 taskId)
{
    while (sPhase2_FrontierCirclesSymmetricSpiralInSeq_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
