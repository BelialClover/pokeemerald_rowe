# 0 "src/fldeff_teleport.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/fldeff_teleport.c"
...
# 7 "src/fldeff_teleport.c" 2
# 1 "include/task.h" 1
# 8 "src/fldeff_teleport.c" 2
# 1 "include/constants/field_effects.h" 1
# 9 "src/fldeff_teleport.c" 2
