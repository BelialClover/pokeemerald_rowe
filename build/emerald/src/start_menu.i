...
__attribute__((section("ewram_data"))) static u8 (*sSaveDialogCallback)(void) = ((void *)0);
__attribute__((section("ewram_data"))) static u8 sSaveDialogTimer = 0;
__attribute__((section("ewram_data"))) static bool8 sSavingComplete = 0;
__attribute__((section("ewram_data"))) static u8 sSaveInfoWindowId = 0;
...
static void ShowPyramidFloorWindow(void)
{
    ...
    DrawStdWindowFrame(sBattlePyramidFloorWindowId, 0);
    StringCopy(gStringVar1, sPyramindFloorNames[gSaveBlock2Ptr->frontier.curChallengeBattleNum]);
    StringExpandPlaceholders(gStringVar4, gText_BattlePyramidFloor);
    AddTextPrinterParameterized(sBattlePyramidFloorWindowId, 1, gStringVar4, 0, 1, 0xFF, ((void *)0));
...
static bool32 PrintStartMenuActions(s8 *pIndex, u32 count)
{
    ...
    do
    {
        ...
        else
        {
            ...
            AddTextPrinterParameterized(GetStartMenuWindowId(), 1, gStringVar4, 8, (index << 4) + 9, 0xFF, ((void *)0));
        }
...
static bool32 InitStartMenuStep(void)
{
    ...
    case 2:
        ...
        DrawStdWindowFrame(sub_81979C4(sNumStartMenuActions), 0);
...
static bool8 SaveCallback(void)
{
    ...
    case SAVE_SUCCESS:
    case SAVE_ERROR:
        ClearDialogWindowAndFrameToTransparent(0, 1);
        ScriptUnfreezeObjectEvents();
...
static u8 SaveConfirmSaveCallback(void)
{
    ClearStdWindowAndFrame(GetStartMenuWindowId(), 0);
...
static bool32 InitSaveWindowAfterLinkBattle(u8 *state)
{
    ...
    case 2:
        ...
        InitBgsFromTemplates(0, sUnknown_085105A8, (size_t)(sizeof(sUnknown_085105A8) / sizeof((sUnknown_085105A8)[0])));
...
static void ShowSaveInfoWindow(void)
{
    ...
    DrawStdWindowFrame(sSaveInfoWindowId, 0);
    ...
    AddTextPrinterParameterized(sSaveInfoWindowId, 1, gStringVar4, 0, yOffset, 0xFF, ((void *)0));


    yOffset += 16;
    AddTextPrinterParameterized(sSaveInfoWindowId, 1, gText_SavingPlayer, 0, yOffset, 0xFF, ((void *)0));
    ...
    yOffset += 16;
    AddTextPrinterParameterized(sSaveInfoWindowId, 1, gText_SavingBadges, 0, yOffset, 0xFF, ((void *)0));
    ...
    if (FlagGet(0x33) == 1)
    {
        ...
        yOffset += 16;
        AddTextPrinterParameterized(sSaveInfoWindowId, 1, gText_SavingPokedex, 0, yOffset, 0xFF, ((void *)0));
    ...
    yOffset += 16;
    AddTextPrinterParameterized(sSaveInfoWindowId, 1, gText_SavingTime, 0, yOffset, 0xFF, ((void *)0));
...
static void RemoveSaveInfoWindow(void)
{
    ClearStdWindowAndFrame(sSaveInfoWindowId, 0);
