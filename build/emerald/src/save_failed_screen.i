# 0 "src/save_failed_screen.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/save_failed_screen.c"
...
# 16 "src/save_failed_screen.c" 2
# 1 "include/constants/rgb.h" 1
# 17 "src/save_failed_screen.c" 2
...
__attribute__((section("ewram_data"))) u16 gSaveFailedType = {0};
__attribute__((section("ewram_data"))) u16 gSaveFailedClockInfo[2] = {0};
__attribute__((section("ewram_data"))) u8 gSaveFailedUnused1[12] = {0};
__attribute__((section("ewram_data"))) u8 gSaveFailedWindowIds[2] = {0};
__attribute__((section("ewram_data"))) u8 gSaveFailedUnused2[4] = {0};
...
void DoSaveFailedScreen(u8 saveType)
{
    ...
    gSaveFailedClockInfo[CLOCK_RUNNING] = 0;
...
static void CB2_SaveFailedScreen(void)
{
    ...
    default:
        ...
        LZ77UnCompVram(sSaveFailedClockGfx, (void *)(0x6000000 + 0x10020));
        ResetBgsAndClearDma3BusyFlags(0);
        InitBgsFromTemplates(0, gUnknown_085EFD88, 3);
        SetBgTilemapBuffer(0, (void *)&gDecompressionBuffer[0x2000]);
        { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, &gDecompressionBuffer[0x2000], 0x04000000 | 0x01000000 | ((0x800)/(32/8) & 0x1FFFFF)); };
        ...
        DrawStdFrameWithCustomTileAndPalette(gSaveFailedWindowIds[TEXT_WIN_ID], 0, 0x214, 0xE);
        DrawStdFrameWithCustomTileAndPalette(gSaveFailedWindowIds[CLOCK_WIN_ID], 0, 0x214, 0xE);
        FillWindowPixelBuffer(gSaveFailedWindowIds[CLOCK_WIN_ID], ((1) | ((1) << 4)));
        FillWindowPixelBuffer(gSaveFailedWindowIds[TEXT_WIN_ID], ((1) | ((1) << 4)));
        CopyWindowToVram(gSaveFailedWindowIds[CLOCK_WIN_ID], 2);
...
static void CB2_WipeSave(void)
{
    ...
    gSaveFailedClockInfo[CLOCK_RUNNING] = 1;

    while (gDamagedSaveSectors != 0 && wipeTries < 3)
    {
        if (WipeSectors(gDamagedSaveSectors) != 0)
        {
            FillWindowPixelBuffer(gSaveFailedWindowIds[TEXT_WIN_ID], ((1) | ((1) << 4)));
    ...
    else
    {
        ...
        if (gGameContinueCallback == ((void *)0))
...
static void VBlankCB_UpdateClockGraphics(void)
{
    ...
    if (gSaveFailedClockInfo[CLOCK_RUNNING] != 0)
    {
    ...
    CpuFastSet(gMain.oamBuffer, (void *)0x7000000, ((4)/(32/8) & 0x1FFFFF));
