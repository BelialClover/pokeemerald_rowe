# 0 "src/heal_location.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/heal_location.c"
...
# 4 "src/heal_location.c" 2
# 1 "include/constants/heal_locations.h" 1
# 5 "src/heal_location.c" 2

# 1 "src/data/heal_locations.h" 1
static const struct HealLocation sHealLocations[] =
{
    [1 - 1] = {((1 | (1 << 8)) >> 8), ((1 | (1 << 8)) & 0xFF), 4, 2},
    [2 - 1] = {((3 | (1 << 8)) >> 8), ((3 | (1 << 8)) & 0xFF), 4, 2},
    [3 - 1] = {((0 | (0 << 8)) >> 8), ((0 | (0 << 8)) & 0xFF), 20, 17},
    [4 - 1] = {((1 | (0 << 8)) >> 8), ((1 | (0 << 8)) & 0xFF), 19, 20},
    [5 - 1] = {((2 | (0 << 8)) >> 8), ((2 | (0 << 8)) & 0xFF), 22, 6},
    [6 - 1] = {((3 | (0 << 8)) >> 8), ((3 | (0 << 8)) & 0xFF), 16, 39},
    [7 - 1] = {((4 | (0 << 8)) >> 8), ((4 | (0 << 8)) & 0xFF), 5, 7},
    [8 - 1] = {((5 | (0 << 8)) >> 8), ((5 | (0 << 8)) & 0xFF), 24, 15},
    [9 - 1] = {((6 | (0 << 8)) >> 8), ((6 | (0 << 8)) & 0xFF), 28, 17},
    [10 - 1] = {((7 | (0 << 8)) >> 8), ((7 | (0 << 8)) & 0xFF), 43, 32},
    [11 - 1] = {((8 | (0 << 8)) >> 8), ((8 | (0 << 8)) & 0xFF), 27, 49},
    [12 - 1] = {((9 | (0 << 8)) >> 8), ((9 | (0 << 8)) & 0xFF), 5, 9},
    [13 - 1] = {((9 | (0 << 8)) >> 8), ((9 | (0 << 8)) & 0xFF), 14, 9},
    [14 - 1] = {((10 | (0 << 8)) >> 8), ((10 | (0 << 8)) & 0xFF), 6, 17},
    [15 - 1] = {((11 | (0 << 8)) >> 8), ((11 | (0 << 8)) & 0xFF), 2, 11},
    [16 - 1] = {((12 | (0 << 8)) >> 8), ((12 | (0 << 8)) & 0xFF), 9, 7},
    [17 - 1] = {((13 | (0 << 8)) >> 8), ((13 | (0 << 8)) & 0xFF), 14, 8},
    [18 - 1] = {((14 | (0 << 8)) >> 8), ((14 | (0 << 8)) & 0xFF), 16, 4},
    [19 - 1] = {((15 | (0 << 8)) >> 8), ((15 | (0 << 8)) & 0xFF), 8, 16},
    [20 - 1] = {((8 | (0 << 8)) >> 8), ((8 | (0 << 8)) & 0xFF), 18, 6},
    [21 - 1] = {((9 | (26 << 8)) >> 8), ((9 | (26 << 8)) & 0xFF), 15, 20},
    [22 - 1] = {((14 | (26 << 8)) >> 8), ((14 | (26 << 8)) & 0xFF), 3, 52},
    ...
    [30 - 1] = {((23 | (0 << 8)) >> 8), ((23 | (0 << 8)) & 0xFF), 30, 6},
    [31 - 1] = {((24 | (0 << 8)) >> 8), ((24 | (0 << 8)) & 0xFF), 19, 22},
    [32 - 1] = {((25 | (0 << 8)) >> 8), ((25 | (0 << 8)) & 0xFF), 4, 17},
    [33 - 1] = {((26 | (0 << 8)) >> 8), ((26 | (0 << 8)) & 0xFF), 6, 66},
    [34 - 1] = {((27 | (0 << 8)) >> 8), ((27 | (0 << 8)) & 0xFF), 27, 9},
    [35 - 1] = {((28 | (0 << 8)) >> 8), ((28 | (0 << 8)) & 0xFF), 88, 6},
    [36 - 1] = {((29 | (0 << 8)) >> 8), ((29 | (0 << 8)) & 0xFF), 28, 37},
    [37 - 1] = {((30 | (0 << 8)) >> 8), ((30 | (0 << 8)) & 0xFF), 26, 38},
    [38 - 1] = {((31 | (0 << 8)) >> 8), ((31 | (0 << 8)) & 0xFF), 41, 9},
    ...
    [46 - 1] = {((39 | (0 << 8)) >> 8), ((39 | (0 << 8)) & 0xFF), 70, 49},
    [47 - 1] = {((40 | (0 << 8)) >> 8), ((40 | (0 << 8)) & 0xFF), 22, 20},
    [48 - 1] = {((41 | (0 << 8)) >> 8), ((41 | (0 << 8)) & 0xFF), 1, 1},
    [49 - 1] = {((42 | (0 << 8)) >> 8), ((42 | (0 << 8)) & 0xFF), 19, 12},
    [50 - 1] = {((43 | (0 << 8)) >> 8), ((43 | (0 << 8)) & 0xFF), 50, 10},
    [51 - 1] = {((44 | (0 << 8)) >> 8), ((44 | (0 << 8)) & 0xFF), 1, 1},
    [52 - 1] = {((45 | (0 << 8)) >> 8), ((45 | (0 << 8)) & 0xFF), 1, 1},
    [53 - 1] = {((46 | (0 << 8)) >> 8), ((46 | (0 << 8)) & 0xFF), 1, 1},
    [54 - 1] = {((47 | (0 << 8)) >> 8), ((47 | (0 << 8)) & 0xFF), 31, 23},
    [55 - 1] = {((48 | (0 << 8)) >> 8), ((48 | (0 << 8)) & 0xFF), 62, 14},
    [56 - 1] = {((49 | (0 << 8)) >> 8), ((49 | (0 << 8)) & 0xFF), 76, 31},
    [57 - 1] = {((12 | (24 << 8)) >> 8), ((12 | (24 << 8)) & 0xFF), 20, 36},
};
# 7 "src/heal_location.c" 2

u32 GetHealLocationIndexByMap(u16 mapGroup, u16 mapNum)
{
    u32 i;

    for (i = 0; i < (size_t)(sizeof(sHealLocations) / sizeof((sHealLocations)[0])); i++)
    {
...
const struct HealLocation *GetHealLocation(u32 index)
{
    if (index == 0)
        return ((void *)0);
    else if (index > (size_t)(sizeof(sHealLocations) / sizeof((sHealLocations)[0])))
        return ((void *)0);
    else
        return &sHealLocations[index - 1];
}
