# 0 "src/battle_anim_electric.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_anim_electric.c"
...
# 2 "src/battle_anim_electric.c" 2
...
# 3 "src/battle_anim_electric.c" 2
# 1 "include/constants/rgb.h" 1
# 4 "src/battle_anim_electric.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 5 "src/battle_anim_electric.c" 2
# 1 "include/constants/songs.h" 1
# 6 "src/battle_anim_electric.c" 2
# 1 "include/sound.h" 1
...
# 7 "src/battle_anim_electric.c" 2
# 1 "include/constants/moves.h" 1
# 8 "src/battle_anim_electric.c" 2
...
static const union AffineAnimCmd gUnknown_085956D8[] =
{
    ...
    {.frame = {.xScale = 0x0, .yScale = 0x0, .rotation = 0, .duration = 20}},
    {.frame = {.xScale = 0x0, .yScale = 0x0, .rotation = -16, .duration = 60}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 0xE8, .yScale = 0xE8, .rotation = 0, .duration = 0}},
...
static const union AffineAnimCmd sAffineAnim_GrowingElectricOrb_0[] =
{
    ...
    {.frame = {.xScale = 0x4, .yScale = 0x4, .rotation = 0, .duration = 60}},
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0, .duration = 0}},
    {.loop = {.type = 0x7FFD, .count = 0}},
    {.frame = {.xScale = 0xFFFC, .yScale = 0xFFFC, .rotation = 0, .duration = 5}},
    {.frame = {.xScale = 0x4, .yScale = 0x4, .rotation = 0, .duration = 5}},
...
{
    {.frame = {.xScale = 0x10, .yScale = 0x10, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0x8, .yScale = 0x8, .rotation = 0, .duration = 30}},
    {.frame = {.xScale = 0x100, .yScale = 0x100, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0xFFFC, .yScale = 0xFFFC, .rotation = 0, .duration = 5}},
    {.frame = {.xScale = 0x4, .yScale = 0x4, .rotation = 0, .duration = 5}},
    {.jump = {.type = 0x7FFE, .target = 3}},
};
...
static const union AffineAnimCmd sAffineAnim_GrowingElectricOrb_2[] =
{
    {.frame = {.xScale = 0x10, .yScale = 0x10, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0x8, .yScale = 0x8, .rotation = 0, .duration = 30}},
    {.frame = {.xScale = 0xFFF8, .yScale = 0xFFF8, .rotation = 0, .duration = 30}},
    {.type = 0x7FFF},
};
...
static const union AffineAnimCmd sAffineAnim_GrowingElectricOrb_4[] =
{
    ...
    {.frame = {.xScale = 0x2, .yScale = 0x2, .rotation = 0, .duration = 20}},
    {.frame = {.xScale = 0x3, .yScale = 0x3, .rotation = 0, .duration = 15}},
    {.frame = {.xScale = 0x1, .yScale = 0x1, .rotation = 0, .duration = 25}},
    {.frame = {.xScale = 0xFFFC, .yScale = 0xFFFC, .rotation = 0, .duration = 5}},
    {.frame = {.xScale = 0x3, .yScale = 0x3, .rotation = 0, .duration = 5}},
    {.frame = {.xScale = 0xFFFB, .yScale = 0xFFFB, .rotation = 0, .duration = 5}},
    {.frame = {.xScale = 0x4, .yScale = 0x4, .rotation = 0, .duration = 5}},
    {.type = 0x7FFF}
};
...
static const union AffineAnimCmd sSpriteAffineAnim_JudgmentBall[] =
{
 ...
 {.frame = {.xScale = 8, .yScale = 8, .rotation = 0, .duration = 15}},
 {.frame = {.xScale = 0, .yScale = 0, .rotation = 0, .duration = 120}},
 {.frame = {.xScale = 24, .yScale = 24, .rotation = 0, .duration = 5}},
...
{
    if (!InitSpritePosToAnimBattler(gBattleAnimArgs[4], sprite, 0))
        return;
...
static void AnimElectricBoltSegment(struct Sprite *sprite)
{
    if (!sprite->data[0])
    {
        sprite->oam.shape = (((0 << 2) | (2)) & 0x03);
        sprite->oam.size = ((((0 << 2) | (2)) >> 2) & 0x03);
    }
    else
    {
        sprite->oam.shape = (((1 << 2) | (0)) & 0x03);
        sprite->oam.size = ((((1 << 2) | (0)) >> 2) & 0x03);
    }
    if (++sprite->data[1] == 15)
...
static void AnimTask_ElectricChargingParticles_Step(u8 taskId)
{
    ...
    if (task->data[6])
    {
        if (++task->data[12] > task->data[13])
        {
            u8 spriteId;
            task->data[12] = 0;
            if (gAnimMoveIndex == 430 || gAnimMoveIndex == 724)
