...
# 19 "src/battle_bg.c" 2

# 1 "include/task.h" 1
# 21 "src/battle_bg.c" 2
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 23 "src/battle_bg.c" 2

# 1 "include/constants/map_types.h" 1
# 25 "src/battle_bg.c" 2
# 1 "include/constants/songs.h" 1
# 26 "src/battle_bg.c" 2
...
# 27 "src/battle_bg.c" 2
# 1 "include/constants/battle_anim.h" 1
# 28 "src/battle_bg.c" 2
...
static const u16 sUnrefArray[] = {0x0300, 0x0000};
...
{
    {.frame = {.xScale = 0x0080, .yScale = 0x0080, .rotation = 0x00, .duration = 0x00}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 0x0080, .yScale = 0x0080, .rotation = 0x00, .duration = 0x00}},
    {.frame = {.xScale = 0x0018, .yScale = 0x0018, .rotation = 0x00, .duration = 0x80}},
    {.frame = {.xScale = 0x0018, .yScale = 0x0018, .rotation = 0x00, .duration = 0x80}},
    {.type = 0x7FFF},
};
...
static const struct BattleBackground gBattleTerrainTable[] =
{
    ...
    [10] =
    {
        ...
        .entryTileset = gBattleTerrainAnimTiles_TallGrass,
        .entryTilemap = gBattleTerrainAnimTilemap_TallGrass,
        .palette = gBattleTerrainPalette_TallGrass_Dusk,
    },
    ...
    [11] =
    {
        ...
        .entryTileset = gBattleTerrainAnimTiles_TallGrass,
        .entryTilemap = gBattleTerrainAnimTilemap_TallGrass,
        .palette = gBattleTerrainPalette_TallGrass_Night,
    },
...
void BattleInitBgsAndWindows(void)
{
    ...
    InitBgsFromTemplates(0, gBattleBgTemplates, (size_t)(sizeof(gBattleBgTemplates) / sizeof((gBattleBgTemplates)[0])));
...
void InitBattleBgsVideo(void)
{
    ...
    SetGpuReg(0x52, 0);
    SetGpuReg(0x54, 0);
    SetGpuReg(0x0, 0x8000 | 0x2000 | 0x1000 | 0x0040);
}
...
void LoadBattleMenuWindowGfx(void)
{
    ...
    if (gBattleTypeFlags & (1 << 18))
    {
        ...
        CpuSet(&gPlttBufferUnfaded[0x76], &gPlttBufferFaded[0x76], 0x00000000 | ((2)/(16/8) & 0x1FFFFF));
    }
}

void DrawMainBattleBackground(void)
{
    if (gBattleTypeFlags & ((1 << 1) | ((1 << 8) | (1 << 16) | (1 << 17) | (1 << 18) | (1 << 19) | (1 << 20) | (1 << 21)) | (1 << 11) | (1 << 25)))
    {
        LZDecompressVram(gBattleTerrainTiles_Building, (void*)((0x6000000 + (0x4000 * (2)))));
        LZDecompressVram(gBattleTerrainTilemap_Building, (void*)((0x6000000 + (0x800 * (26)))));
        LoadCompressedPalette(gBattleTerrainPalette_Frontier, 0x20, 0x60);
    }
    else if (gBattleTypeFlags & (1 << 28))
    {
        LZDecompressVram(gBattleTerrainTiles_Cave, (void*)((0x6000000 + (0x4000 * (2)))));
        LZDecompressVram(gBattleTerrainTilemap_Cave, (void*)((0x6000000 + (0x800 * (26)))));
        LoadCompressedPalette(gBattleTerrainPalette_Groudon, 0x20, 0x60);
    }
    else if (gBattleTypeFlags & (1 << 29))
    {
        LZDecompressVram(gBattleTerrainTiles_Water, (void*)((0x6000000 + (0x4000 * (2)))));
        LZDecompressVram(gBattleTerrainTilemap_Water, (void*)((0x6000000 + (0x800 * (26)))));
        LoadCompressedPalette(gBattleTerrainPalette_Kyogre, 0x20, 0x60);
    }
    else if (gBattleTypeFlags & (1 << 30))
    {
        LZDecompressVram(gBattleTerrainTiles_Rayquaza, (void*)((0x6000000 + (0x4000 * (2)))));
        LZDecompressVram(gBattleTerrainTilemap_Rayquaza, (void*)((0x6000000 + (0x800 * (26)))));
    ...
    else
    {
        if (gBattleTypeFlags & (1 << 3))
        {
            ...
            {
                LZDecompressVram(gBattleTerrainTiles_Stadium, (void*)((0x6000000 + (0x4000 * (2)))));
                LZDecompressVram(gBattleTerrainTilemap_Stadium, (void*)((0x6000000 + (0x800 * (26)))));
        ...
        default:
        case 0:
            LZDecompressVram(gBattleTerrainTable[gBattleTerrain].tileset, (void*)((0x6000000 + (0x4000 * (2)))));
            LZDecompressVram(gBattleTerrainTable[gBattleTerrain].tilemap, (void*)((0x6000000 + (0x800 * (26)))));
...
void LoadBattleTextboxAndBackground(void)
{
    LZDecompressVram(gBattleTextboxTiles, (void*)((0x6000000 + (0x4000 * (0)))));
...
void InitLinkBattleVsScreen(u8 taskId)
{
    ...
    case 1:
        ...
        gSprites[gBattleStruct->linkBattleVsSpriteId_V].invisible = 1;
        gSprites[gBattleStruct->linkBattleVsSpriteId_S].invisible = 1;
        gTasks[taskId].data[0]++;
        break;
    case 2:
        if (gTasks[taskId].data[5] != 0)
        ...
        else
        {
            ...
            PlaySE(120);
            DestroyTask(taskId);
            gSprites[gBattleStruct->linkBattleVsSpriteId_V].invisible = 0;
            gSprites[gBattleStruct->linkBattleVsSpriteId_S].invisible = 0;
...
void DrawBattleEntryBackground(void)
{
    ...
    {
        LZDecompressVram(gUnknown_08D778F0, (void*)((0x6000000 + (0x4000 * (1)))));
        LZDecompressVram(gVsLettersGfx, (void*)(0x6000000 + 0x10000));
        LoadCompressedPalette(gUnknown_08D77AE4, 0x60, 0x20);
        SetBgAttribute(1, BG_ATTR_SCREENSIZE, 1);
        SetGpuReg(0xa, 0x5C04);
    ...
    else if (gBattleTypeFlags & (((1 << 8) | (1 << 16) | (1 << 17) | (1 << 18) | (1 << 19) | (1 << 20) | (1 << 21)) | (1 << 1) | (1 << 25) | (1 << 11)))
    {
        if (!(gBattleTypeFlags & (1 << 22)) || gPartnerTrainerId == 3075 || gPartnerTrainerId >= 3076)
        {
            LZDecompressVram(gBattleTerrainAnimTiles_Building, (void*)((0x6000000 + (0x4000 * (1)))));
            LZDecompressVram(gBattleTerrainAnimTilemap_Building, (void*)((0x6000000 + (0x800 * (28)))));
        }
        else
        {
    ...
    {
        LZDecompressVram(gBattleTerrainAnimTiles_Cave, (void*)((0x6000000 + (0x4000 * (1)))));
        LZDecompressVram(gBattleTerrainAnimTilemap_Cave, (void*)((0x6000000 + (0x800 * (28)))));
    }
    else if (gBattleTypeFlags & (1 << 29))
    {
        LZDecompressVram(gBattleTerrainAnimTiles_Underwater, (void*)((0x6000000 + (0x4000 * (1)))));
        LZDecompressVram(gBattleTerrainAnimTilemap_Underwater, (void*)((0x6000000 + (0x800 * (28)))));
    }
    else if (gBattleTypeFlags & (1 << 30))
    {
        LZDecompressVram(gBattleTerrainAnimTiles_Rayquaza, (void*)((0x6000000 + (0x4000 * (1)))));
        LZDecompressVram(gBattleTerrainAnimTilemap_Rayquaza, (void*)((0x6000000 + (0x800 * (28)))));
    }
    else
    {
        if (gBattleTypeFlags & (1 << 3))
        ...
        {
            LZDecompressVram(gBattleTerrainTable[gBattleTerrain].entryTileset, (void*)((0x6000000 + (0x4000 * (1)))));
            LZDecompressVram(gBattleTerrainTable[gBattleTerrain].entryTilemap, (void*)((0x6000000 + (0x800 * (28)))));
        }
        else
        {
            LZDecompressVram(gBattleTerrainAnimTiles_Building, (void*)((0x6000000 + (0x4000 * (1)))));
...
bool8 LoadChosenBattleElement(u8 caseId)
{
    ...
    case 2:
        ...
        break;
    case 3:
        if (gBattleTypeFlags & (((1 << 8) | (1 << 16) | (1 << 17) | (1 << 18) | (1 << 19) | (1 << 20) | (1 << 21)) | (1 << 1) | (1 << 25) | (1 << 11)))
        {
            LZDecompressVram(gBattleTerrainTiles_Building, (void*)((0x6000000 + (0x4000 * (2)))));
        }
        else if (gBattleTypeFlags & (1 << 28))
...
void DrawTerrainTypeBattleBackground(void)
{
    switch (gFieldStatuses & (0x40 | 0x80 | 0x100 | 0x200))
    {
    case 0x40:
        LoadMoveBg(46);
        break;
